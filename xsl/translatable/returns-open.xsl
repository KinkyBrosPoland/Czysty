...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (returns_open_form, 60dd8e85ed9602.02846939.4)-->
	<section class="returns_open mb-4">
		
		<h1 class="returns_open__label headline">
			<span class="returns_open__label_txt headline__name">iai_i18n:[V3liaWVyeiB6YW3Ds3dpZW5pZSwgeiBrdMOzcmVnbyBjaGNlc3ogendyw7NjacSHIHByb2R1a3Q=]</span>
		</h1>
		...
		<div class="returns_open__description menu_messages_message mb-4">
			<iaixsl:choose>
				<iaixsl:when test="/shop/page/returns-open/@returns_exist_link and not(/shop/page/returns-open/@returns_exist_link = '')">
					iai_i18n:[RGxhIHRlZ28gemFtw7N3aWVuaWEgem9zdGHFgiBqdcW8IHd5Z2VuZXJvd2FueSB6d3JvdC4gUHJvc2lteSBvIHNwcmF3ZHplbmllIHN0YXR1c3Ugb2JlY255Y2ggemfFgm9zemXFhCBsdWIgZG9kYW5pZSBrb2xlam5lZ28geiBwb3ppb211IHBhbmVsdSB6d3JvdHU=].
				</iaixsl:when>
				<iaixsl:when test="/shop/page/returns-open/@client = 'false' or /shop/page/returns-open/@client_orders = 'true'">
					iai_i18n:[].
				</iaixsl:when>
				<iaixsl:otherwise>
			...
			<iaixsl:when test="/shop/page/returns-open/@returns_exist_link and not(/shop/page/returns-open/@returns_exist_link = '')">
				<div class="returns_open__exists d-flex align-items-center flex-column">
					<a class="returns_open__exist btn --solid --medium mb-3">
						...
						iai_i18n:[UHJ6ZWpkxbogZG8gendyb3R1]
					</a>
					<a class="returns_open__new btn --solid --medium mb-3">
						...
						iai_i18n:[WsWCw7PFvCBub3d5IHp3cm90]
					</a>
				</div>
			</iaixsl:when>
			<iaixsl:otherwise>
					...
					<div class="returns_open__inputs col-12 col-sm-7">
						...
						<div class="f-group returns_open__email">
							<div class="f-feedback returns_open__feedback --email">
								<input id="returns_open__email_input" type="text" class="f-control --validate" name="contact_type" required="required" data-graphql="phone email">
