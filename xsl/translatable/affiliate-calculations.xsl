...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (affiliate_calculations_list, 60dd8e83cac149.65539594.3)-->
  <iaixsl:variable name="affiliate_1">iai_i18n:[RGF0YSBwcnp5em5hbmlhIHByb3dpempp]</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">iai_i18n:[V2HFvG5hIG9k]</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">iai_i18n:[V2HFvG5hIGRv]</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">iai_i18n:[VHdvamUgd3luYWdyb2R6ZW5pZQ==]</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">iai_i18n:[T3Bpcw==]</iaixsl:variable>
  <iaixsl:if test="page/calculations">
    <h1 class="headline">
      <span class="headline__name">
        iai_i18n:[Um96bGljemVuaWE=]
      </span>
    </h1>
    <iaixsl:choose>
      <iaixsl:when test="count(page/calculations/payment)">
        <section class="affiliate --calculations mb-4">
          <div class="affiliate__desc mb-4">
            iai_i18n:[UG9uacW8c3phIHRhYmVsYSB6YXdpZXJhIGt3b3R5LCBrdMOzcmUgbmFsZcW8xIUgQ2kgc2nEmSBvZCBuYXMgemEgemFtw7N3aWVuaWEgcG96eXNrYW5lIHcgcmFtYWNoIHVkemlhxYJ1IHcgcHJvZ3JhbWllIHBhcnRuZXJza2ltLiBTxIUgdG8gcHJ6ZXDFgnl3eSBuYSBUd29pbSBrb25jaWUgcGFydG5lcnNraW0=]:
            <ol class="pl-5">
              <li>
                  ...
                  <iaixsl:variable name="orderid"><iaixsl:choose><iaixsl:when test="@orderid"><iaixsl:value-of select="@orderid"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="@id"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable> 
                    <iaixsl:choose>
                      <iaixsl:when test="@type = 'gd'">
                        iai_i18n:[V3luYWdyb2R6ZW5pZSBiZXpwb8WbcmVkbmllIHphIHphbcOzd2llbmll] <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'rd'">
                      iai_i18n:[QW51bG93YW5vIHd5bmFncm9kemVuaWUgYmV6cG/Fm3JlZG5pZSB6YSB6YW3Ds3dpZW5pZQ==]  <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'gi'">
                        iai_i18n:[V3luYWdyb2R6ZW5pZSBwb8WbcmVkbmllIHphIHphbcOzd2llbmll] <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'ri'">
                        iai_i18n:[QW51bG93YW5vIHd5bmFncm9kemVuaWUgcG/Fm3JlZG5pZSB6YSB6YW3Ds3dpZW5pZQ==] <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'gv'">
                        iai_i18n:[V3lnZW5lcm93YW5vIGJvbiBvIG51bWVyemU=] <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'rv'">
                        iai_i18n:[WmFibG9rb3dhbm8gYm9uIG8gbnVtZXJ6ZQ==] <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'gc'">
                        iai_i18n:[V3lwxYJhY29ubyBnb3TDs3drxJk=] 
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'rc'">
                        iai_i18n:[V3lwxYJhdGEgZ290w7N3a2kgem9zdGHFgmEgb2RyenVjb25h] 
                      </iaixsl:when>

                      <iaixsl:when test="@type = 'rr'">
                        iai_i18n:[Wndyb3QgcHJvZHVrdHU=]
                      </iaixsl:when>
                    </iaixsl:choose>
                </span>
              </div>
      ...
      <iaixsl:otherwise>
        <div class="affiliate__info">
          iai_i18n:[QnJhayByb3psaWN6ZcWE]
        </div>
      </iaixsl:otherwise>
    </iaixsl:choose>
  </iaixsl:if>
<!-- (affiliate_calculations_paging, 60dd8e7f07d1f0.26319465.5)-->
      ...
      <iaixsl:if test="page/calculations/navigation/prev">
        <li class="pagination__element --prev">
          ...
          <a class="pagination__link">
            <iaixsl:attribute name="href"><iaixsl:choose><iaixsl:when test="page/calculations/navigation/prev/@counter = '0'"><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/calculations/navigation/path/@value, '&amp;counter=')"/><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/calculations/navigation/path/@value, '?counter=')"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of disable-output-escaping="yes" select="page/calculations/navigation/path/@value"/><iaixsl:value-of select="page/calculations/navigation/prev/@counter"/></iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>
