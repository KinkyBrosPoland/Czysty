...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (opinions_add_aggregator, 60dd8e7e943151.91162670.5)-->
	<section id="opinion_order" class="opinion_order">
		<h2 class="headline">
			<span class="headline__name">iai_i18n:[T2NlxYQgemFkb3dvbGVuaWUgeiBwcnplYmllZ3UgemFtw7N3aWVuaWEgbnI=] <iaixsl:value-of select="/shop/page/opinions/@order_id"/></span>
		</h2>
		<form class="opinion_order__form" action="/ajax/opinions.php?action=insert" method="POST">
			...
			<div class="note_wrapper">
				<span class="note_invitation">
					<span class="note_invitation_desktop">iai_i18n:[].</span>
					<span class="note_invitation_mobile">iai_i18n:[SmFrIG9jZW5pYXN6IG9ic8WCdWfEmSBUd29qZWdvIHphbcOzd2llbmlhPw==]</span>
				</span>
			...
			<div class="f-group">
				<div class="has-feedback">
					...
					<label class="f-label">iai_i18n:[TmFwaXN6IHN3b2rEhSBvcGluacSZIG8gb2JzxYJ1ZHplIHphbcOzd2llbmlh]</label>
				...
				<iaixsl:if test="/shop/page/opinions/@order_sum_loyalty_points and not(/shop/page/opinions/@order_sum_loyalty_points = '')">
					<div class="opinions_points_sum">
						iai_i18n:[WmEgb2NlbsSZIHRlZ28gemFtw7N3aWVuaWEgbW/FvGVzeiBvdHJ6eW1hxIcgxYLEhWN6bmll]
						<strong>
							<iaixsl:choose>
			...
			<div class="f-button">
				<button class="btn --medium --solid" type="submit">iai_i18n:[V3nFm2xpaiBuYW0gc3dvasSFIG9waW5pxJk=]</button>
			</div>
		</form>
	</section>
	<section id="opinion_products" class="opinion_products">
		<h2 class="headline">
			<span class="headline__name">iai_i18n:[UG9uacW8ZWogbW/FvGVzeiBvY2VuacSHIHBvc3pjemVnw7NsbmUgcHJvZHVrdHkgeiB6YW3Ds3dpZW5pYQ==]</span>
		</h2>
		<iaixsl:for-each select="/shop/page/opinions/opinions_products/opinion_product">
			<form class="opinion_products__form" action="/ajax/opinions.php?action=insert" method="POST">
					...
					<div class="opinion_products__block --opinion col-md-8">
						...
						<div class="f-group">
							<div class="has-feedback">
								...
								<label class="f-label">iai_i18n:[TmFwaXN6IHN3b2rEhSBvcGluacSZIG8gcHJvZHVrY2ll]</label>
						...
						<div class="opinion_products__photo d-md-flex">
							...
							<div class="f-button">
								<button class="btn --medium --solid" type="submit">iai_i18n:[V3nFm2xpaiBvcGluacSZ]</button>
							</div>
						</div>
					</div>
				</div>
				<iaixsl:if test="/shop/page/opinions/@product_sum_loyalty_points and not(/shop/page/opinions/@product_sum_loyalty_points = '')">
					<div class="opinions_points_sum">
						iai_i18n:[WmEgb2NlbsSZIHRlZ28gcHJvZHVrdHUgbW/FvGVzeiBvdHJ6eW1hxIcgxYLEhWN6bmll]
						<strong>
							<iaixsl:choose>
