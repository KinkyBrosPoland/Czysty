...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (password-recover, 60dd8e7e14d055.39041804.3)-->
            ...
            <div id="signin_password_recovery">
                <h1 class="big_label">
                    iai_i18n:[TmllIHBhbWnEmXRhc3ogbG9naW51IGx1YiBoYXPFgmE/]
                </h1>
                <div class="row flex-column align-items-center ">
                    <p class="reminder_desc col-12 col-sm-6 mb-3">iai_i18n:[TmEgVHfDs2ogYWRyZXMgem9zdGFuaWUgd3lzxYJhbnkgZS1tYWlsLCBrdMOzcnkgcG96d2FsYSBuYSBhdXRvbWF0eWN6bmUgemFsb2dvd2FuaWUgc2nEmS4gWm1pYW5hIGhhc8WCYSBixJlkemllIG1vxbxsaXdhIHBvIHphbG9nb3dhbml1IG5hIHN0cm9uaWUgZWR5Y2ppIFR3b2ljaCBkYW55Y2g=].</p>
                    <form class="password-recover col-12 col-sm-6 mb-3" action="/password-recover.php" method="post">
                        ...
                        <button class="signin_password-recover btn --solid --medium" type="submit">
                            iai_i18n:[V3nFm2xpaiBlLW1haWw=]
                        </button>
                    </form>

                    <div class="password_recovery_phone col-12 col-sm-6">
                        iai_i18n:[SmXFvGVsaSBuaWUgamVzdGXFmyB3IHN0YW5pZSBwcnp5cG9tbmllxIcgc29iaWUgbG9naW51IGx1YiBuaWUgbW/FvGVzeiBvZGVicmHEhyB6IHByenljenluIG5pZXphbGXFvG55Y2ggcG9kYW5lZ28gcHJ6eSByZWplc3RyYWNqaSBlLW1haWxhIHRvIHByb3NpbXkgbyBrb250YWt0IHRlbGVmb25pY3p5IHBvZCBuciB0ZWxlZm9udQ==]<b><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/login/response/@tel"/></b><iaixsl:text> </iaixsl:text>iai_i18n:[bHViIHd5c8WCYW5pZSBlLW1haWxhIHcgdGVqIHNwcmF3aWUgbmEgYWRyZXM=] <iaixsl:text> </iaixsl:text><a class="mail_54144"><iaixsl:attribute name="href">mailto:<iaixsl:value-of select="page/login/response/@email"/></iaixsl:attribute><iaixsl:value-of select="page/login/response/@email"/></a>.
                    </div>
                </div>
            </div>
