...
<h1 class="big_label product_compare_label">iai_i18n:[UHJvZHVrdHkgdyBwb3LDs3duYW5pdQ==]</h1>
...
<iaixsl:if test="/shop/compare/@active"> </iaixsl:if>
    <!-- (product_compare_list, 614c5da6a40b48.32753671.8)-->
						...
						<tbody>
								...
								<th class="cmp_product configure"><div class="item_width">
									<iaixsl:if test="lastsearch">
										<a class="btn --solid --secondary --medium d-block mb-2">
											...
											iai_i18n:[V3LDs8SHIGRvIGxpc3R5IHByb2R1a3TDs3c=]
										</a>
									</iaixsl:if>
									<a class="btn --solid --medium d-block mb-2">
										<iaixsl:attribute name="href">#differences</iaixsl:attribute>
										<iaixsl:attribute name="data-toggleTxt">iai_i18n:[VWtyeWogcsOzxbxuaWNl]</iaixsl:attribute>
										iai_i18n:[WmF6bmFjeiByw7PFvG5pY2U=]
									</a>
								</div></th>
									...
									<td class="cmp_product">
										<div class="configure_item item_width">
											<a>
												...
												<iaixsl:attribute name="data-toggleTxt"><i class="icon-plus"/> iai_i18n:[UG9rYcW8]</iaixsl:attribute>
												<i class="icon-minus"/> iai_i18n:[VWtyeWo=]
											</a>
											<a class="hideCol">
												...
												<i class="icon-remove"/> iai_i18n:[VXN1xYQ=]
											</a>
										</div>
													...
													<iaixsl:when test="$var_size_min_formatted != $var_size_max_formatted">
														...
														<iaixsl:if test="$var_points">
															<span class="point-price">
																<iaixsl:value-of select="$var_points"/><span class="currency">iai_i18n:[UEtU]</span>
															</span>
														</iaixsl:if>
													</iaixsl:when>
												...
												<div class="list_traits hideCol">
													<ul>
														<iaixsl:if test="producer != ''">
															<li class="producer">
																<span>iai_i18n:[UHJvZHVjZW50]</span>
																<div>
							...
							<iaixsl:if test="page/products/product/size">
								<iaixsl:if test="not(page/products/product/size/size/@name = 'uniw')">
									<tr>
										<th><div class="item_width"> iai_i18n:[Um96bWlhcnk=]</div></th>
										<iaixsl:for-each select="page/products/product">
											<td>
							...
							<iaixsl:if test="page/products/versions">
								<iaixsl:for-each select="page/products/versions/version">
									<tr>
										<th><div class="item_width">iai_i18n:[V2FyaWFudHkgZGxh]  <iaixsl:value-of select="@name"/></div></th>
							...
							<iaixsl:if test="page/products/product/description">
								<tr>
									<th><div class="item_width"> iai_i18n:[T3Bpcw==]</div></th>
									<iaixsl:for-each select="page/products/product">
										<td>
											<div class="hideCol item_width">
												<iaixsl:value-of disable-output-escaping="yes" select="description"/>
