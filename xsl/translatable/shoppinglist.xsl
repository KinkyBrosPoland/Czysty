...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (shoppinglist_manage, 61f913c9037c60.97603384.12)-->
	...
	<section class="shopping_list mb-5">
		...
		<div class="shopping_list__block --header sl_header d-flex align-items-center justify-content-between mb-2 justify-content-md-start mb-3">
			<h1 class="sl_header__headline headline px-0 py-2 m-0 mr-2">
			...
			<span class="sl_header__total d-none d-md-block mr-md-2">
				<span class="sl_header__total_before">(iai_i18n:[aWxvxZvEhyBwcm9kdWt0w7N3]: </span>
			...
			<div class="sl_header__options ml-md-auto">
				...
				<a href="#share" class="sl_header__share d-none d-md-flex align-items-md-center">iai_i18n:[VWRvc3TEmXBuaWogdMSZIGxpc3TEmQ==]</a>
			</div>
		</div>
		<div class="shopping_list__block --settings sl_settings d-flex mx-n1 mx-md-n2">
			<div class="sl_settings__item --group px-1 px-md-2">
				<a href="#groupEdit" class="sl_settings__group d-block">
					<span class="sl_settings__group_button --mobile d-flex align-items-center btn --outline --large --icon-left mb-2 mb-sm-3 d-md-none">iai_i18n:[RWR5Y2phIGdydXBvd2E=]</span>
					<span class="sl_settings__group_button --desktop btn --outline --icon-left mb-2 d-none mb-sm-3 d-md-inline-block">iai_i18n:[RWR5Y2phIGdydXBvd2E=]</span>
				</a>
			</div>
			<iaixsl:if test="/shop/page/navigation/@sort">
				<form class="sl_settings__item --sort px-0 col-sm-4 px-sm-1 col-md-auto px-md-2" action="/settings.php">
					<span class="sl_settings__label --sort">iai_i18n:[U29ydHVq]</span>
					<select class="sl_settings__select --sort --small-md" name="sort_order">
						<option value="name-a">iai_i18n:[U29ydHVqIHBvIG5hendpZSByb3NuxIVjbw==]</option>
						<option value="name-d">iai_i18n:[U29ydHVqIHBvIG5hendpZSBtYWxlasSFY28=]</option>
						<option value="price-a">iai_i18n:[U29ydHVqIHBvIGNlbmllIHJvc27EhWNv]</option>
						<option value="price-d">iai_i18n:[U29ydHVqIHBvIGNlbmllIG1hbGVqxIVjbw==]</option>
						<option value="date-a">iai_i18n:[U29ydHVqIHBvIGRhY2llIHJvc27EhWNv]</option>
						<option value="date-d">iai_i18n:[U29ydHVqIHBvIGRhY2llIG1hbGVqxIVjbw==]</option>
					</select>
				</form>
			</iaixsl:if>
			<iaixsl:if test="/shop/page/navigation/category">
				<form class="sl_settings__item --category px-0 col-sm-4 px-sm-1 col-md-auto px-md-2" action="/settings.php">
					<span class="sl_settings__label --category">iai_i18n:[S2F0ZWdvcmlh]</span>
					<select class="sl_settings__select --category --small-md --placeholder" name="category">
						<option>iai_i18n:[V3liaWVyeiBrYXRlZ29yacSZ]</option>
			...
			<div class="sl_settings__item --view d-flex ml-auto align-items-center mb-2 mb-sm-3 px-1 px-md-2">
				<span class="sl_settings__label --view">iai_i18n:[V2lkb2s=]</span>
				<div class="sl_settings__view d-flex">
					
					<a href="#gallery" class="sl_settings__view_link --gallery --active btn --solid p-1 d-flex align-items-center justify-content-center ml-2" data-inactive-class="--outline" data-active-class="--solid">
						<iaixsl:attribute name="aria-label">iai_i18n:[Tm9ybWFsbnkgd2lkb2s=]</iaixsl:attribute>
					</a>
					<a href="#list" class="sl_settings__view_link --list btn --outline p-1 d-flex align-items-center justify-content-center ml-2" data-inactive-class="--outline" data-active-class="--solid">
						<iaixsl:attribute name="aria-label">iai_i18n:[V2lkb2sgbGlzdHk=]</iaixsl:attribute>
					</a>
				</div>
			</div>
		</div>
        ...
        <iaixsl:variable name="product_minimum_quantity">
          <iaixsl:choose>
            <iaixsl:when test="order_quantity_range/min_quantity_per_order">
              <iaixsl:value-of select="order_quantity_range/min_quantity_per_order/text()"/>
            </iaixsl:when>
            <iaixsl:otherwise>
              <iaixsl:value-of select="sizes/@unit_sellby"/>
				...
				<div class="sl_products__product col-6 py-3 col-md-4 py-lg-4">
					...
					<iaixsl:choose>
						...
						<iaixsl:otherwise>
							<iaixsl:attribute name="data-set_quantity"><iaixsl:value-of select="$product_minimum_quantity"/></iaixsl:attribute>
						</iaixsl:otherwise>
					</iaixsl:choose>
					<div class="sl_products__item --top">
						<div class="sl_products__select f-group --checkbox">
							...
							<label class="sl_products__select_label f-label">
								...
								<span class="sr-only">iai_i18n:[V3liaWVyeiBwcm9kdWt0] <iaixsl:value-of disable-output-escaping="yes" select="name"/></span>
							</label>
						</div>
						<iaixsl:if test="/shop/page/@is_owner = 'true'">
							<div class="sl_products__remove --top">
								<a href="#remove" class="sl_products__link --remove">
									<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IHVzdW7EhcSHIHByb2R1a3QgeiB0ZWogbGlzdHk=]</iaixsl:attribute>
									<iaixsl:attribute name="aria-label">iai_i18n:[VXN1xYQgcHJvZHVrdCB6IHRlaiBsaXN0eQ==]</iaixsl:attribute>
								</a>
							</div>
						</iaixsl:if>
						<a class="sl_products__icon d-flex justify-content-center align-items-center" tabindex="-1">
							<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
              <iaixsl:choose>
                ...
                <iaixsl:otherwise>
                  <img src="/gfx/standards/loader.gif?r=1765442497" class="b-lazy">
                    ...
                    <iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="name"/></iaixsl:attribute>
							...
							<iaixsl:if test="sizes/size[1]/availability/@status = 'disable' or (not($var_net_prices = '') and price/@price_net = 0) or ($var_net_prices = '' and price/@value = 0)">
								<strong class="label_icons">
									<span class="label --disable">iai_i18n:[Q2h3aWxvd28gbmllZG9zdMSZcG55]</span>
								</strong>
							</iaixsl:if>
						</a>
					</div>
					<h2 class="sl_products__item --name">
					...
					<iaixsl:variable name="var_deposit_price_html"><iaixsl:if test="$var_deposit_price != ''">
						<span class="sl_products__price_deposit deposit_price">
							...
							<iaixsl:when test="$var_net_prices and not($var_net_prices = '')">
								<iaixsl:choose>
									<iaixsl:when test="price/@price_net = 0">
										<a class="sl_products__price --phone" href="/contact.php">iai_i18n:[Q2VuYSBuYSB0ZWxlZm9u]</a>
									</iaixsl:when>
									<iaixsl:otherwise>
						...
						<iaixsl:if test="/shop/page/@is_owner = 'true'">
							<div class="sl_products__move">
								<a href="#move" class="sl_products__link --move btn --outline p-1 d-flex align-items-center justify-content-center">
									<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IHByemVuaWXFm8SHL3Nrb3Bpb3dhxIcgcHJvZHVrdCBkbyBpbm5laiBsaXN0eQ==]</iaixsl:attribute>
									<iaixsl:if test="sizes/size[1]/availability/@status = 'disable' or (not($var_net_prices = '') and price/@price_net = 0) or ($var_net_prices = '' and price/@value = 0)">
										<iaixsl:attribute name="data-disabled">true</iaixsl:attribute>
									</iaixsl:if>
									<iaixsl:attribute name="aria-label">iai_i18n:[UHJ6ZW5pZcWbIC8ga29waXVq] iai_i18n:[ZG8gaW5uZWogbGlzdHk=]</iaixsl:attribute>
								</a>
								<div class="sl_products__move_options p-4 px-sm-0 p-md-3">
									<a href="#close" class="sl_products__option --close d-none align-items-center d-md-flex">
										<iaixsl:attribute name="aria-label">iai_i18n:[QW51bHVq]</iaixsl:attribute>
									</a>
									<a href="#move" class="sl_products__option --move d-flex align-items-center mb-1">iai_i18n:[UHJ6ZW5pZcWbIGRvIGlubmVqIGxpc3R5]</a>
									<a href="#copy" class="sl_products__option --copy d-flex align-items-center">iai_i18n:[S29waXVqIGRvIGlubmVqIGxpc3R5]</a>
								</div>
							</div>
						</iaixsl:if>
						<iaixsl:choose>
							<iaixsl:when test="@product_type = 'product_bundle' or @product_type = 'product_configurable'">
								<a href="#card" class="sl_products__card btn --solid --secondary">
									<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
									<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IHByemVqxZvEhyBkbyBrYXJ0eSBwcm9kdWt0dQ==]</iaixsl:attribute>
									iai_i18n:[UHJ6ZWpkxbogZG8gcHJvZHVrdHU=]
								</a>
							</iaixsl:when>
							<iaixsl:otherwise>
								<div class="sl_products__buy_wrapper">
									<div class="sl_products__number_wrapper">
										<button class="sl_products__number_down" type="button"><iaixsl:attribute name="aria-label">iai_i18n:[Wm1uaWVqc3ogaWxvxZvEhw==]</iaixsl:attribute>-</button>
										...
										<button class="sl_products__number_up" type="button"><iaixsl:attribute name="aria-label">iai_i18n:[WndpxJlrc3ogaWxvxZvEhw==]</iaixsl:attribute>+</button>
									</div>
									<a href="#buy" class="sl_products__buy btn --solid">
										<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IGRvZGHEhyBkbyBrb3N6eWth]</iaixsl:attribute>
										iai_i18n:[RG8ga29zenlrYQ==]
									</a>
								</div>
							</iaixsl:otherwise>
						</iaixsl:choose>
		...
		<div class="shopping_list__block --footer sl_footer">
			<div class="sl_footer__wrapper row flex-nowrap mx-sm-0 py-md-3">
				<div class="sl_footer__item --select f-group --checkbox col-3 align-self-center pl-sm-0 col-md-auto ">
					...
					<label for="checkboxSelectAll" class="sl_footer__label f-label p-0 d-flex flex-column align-items-center justify-content-center d-md-block">iai_i18n:[V3liaWVyeiB3c3p5c3RraWU=]</label>
				</div>
				<iaixsl:if test="/shop/page/@is_owner = 'true'">
					<div class="sl_footer__item --move col-3 col-md-auto">
						<a href="#move" class="sl_footer__link --move d-flex flex-column align-items-center justify-content-center flex-md-row">
							<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IHByemVuaWXFm8SHL3Nrb3Bpb3dhxIcgd3licmFuZSBwcm9kdWt0eSBkbyBpbm5laiBsaXN0eQ==]</iaixsl:attribute>
							iai_i18n:[UHJ6ZW5pZcWbIC8ga29waXVq]<span> iai_i18n:[ZG8gaW5uZWogbGlzdHk=]</span>
						</a>
						<div class="sl_footer__move_options p-4 px-sm-0 py-md-3">
							...
							<a href="#move" class="sl_footer__option --move d-flex align-items-center mb-1 px-md-3 mb-md-0 px-lg-4">iai_i18n:[UHJ6ZW5pZcWbIGRvIGlubmVqIGxpc3R5]</a>
							<a href="#copy" class="sl_footer__option --copy d-flex align-items-center px-md-3 px-lg-4">iai_i18n:[S29waXVqIGRvIGlubmVqIGxpc3R5]</a>
						</div>
					</div>
				</iaixsl:if>
				<div class="sl_footer__item --buy col-3 col-md-auto">
					<a href="#buy" class="sl_footer__link --buy btn --solid d-flex flex-column align-items-center justify-content-center flex-md-row">
						<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IGRvZGHEhyB3eWJyYW5lIHByb2R1a3R5IGRvIGtvc3p5a2E=]</iaixsl:attribute>
				...
				<iaixsl:if test="/shop/page/@is_owner = 'true'">
					<div class="sl_footer__item --remove col-3 col-md-auto">
						<a href="#remove" class="sl_footer__link --remove d-flex flex-column align-items-center justify-content-center flex-md-row">
							<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IHVzdW7EhcSHIHd5YnJhbmUgcHJvZHVrdHkgeiB0ZWogbGlzdHk=]</iaixsl:attribute>
							iai_i18n:[VXN1xYQgeiB0ZWogbGlzdHk=]
						</a>
					</div>
				</iaixsl:if>
			</div>
		        ...
		        <iaixsl:attribute name="data-list_id"><iaixsl:value-of select="/shop/page/list/@id"/></iaixsl:attribute>
						...
						<div class="sl_m_manage__options">
							<div class="sl_m_manage__option --share py-4">
								<a href="#share" class="sl_m_manage__link --share align-items-center">iai_i18n:[VWRvc3TEmXBuaWogdMSZIGxpc3TEmQ==]</a>
								<iaixsl:if test="/shop/page/@is_owner = 'true'">
									<iaixsl:choose>
										<iaixsl:when test="/shop/page/list/@shared = 'true'">
											<a href="#stop" class="sl_m_manage__link --stop align-items-center mt-2">iai_i18n:[V3nFgsSFY3ogdWRvc3TEmXBuaWFuaWUgdGVqIGxpc3R5]</a>
										</iaixsl:when>
										<iaixsl:otherwise>
											<a href="#start" class="sl_m_manage__link --start align-items-center mt-2">iai_i18n:[V8WCxIVjeiB1ZG9zdMSZcG5pYW5pZSB0ZWogbGlzdHk=]</a>
										</iaixsl:otherwise>
									</iaixsl:choose>
								</iaixsl:if>
							</div>
							<iaixsl:if test="/shop/page/@is_owner = 'true'">
								<div class="sl_m_manage__option --change-name py-4">
									<a href="#change-name" class="sl_m_manage__link --change-name align-items-center">iai_i18n:[Wm1pZcWEIG5henfEmSBsaXN0eQ==]</a>
									<form class="sl_change_name align-items-center">
										...
										<button type="submit" class="sl_change_name__button btn --solid ml-2 ml-md-3">iai_i18n:[Wm1pZcWEIG5henfEmQ==]</button>
									</form>
								</div>
								<div class="sl_m_manage__option --remove py-4">
									<a href="#remove" class="sl_m_manage__link --remove align-items-center">iai_i18n:[VXN1xYQgdMSZIGxpc3TEmQ==]</a>
									<div class="sl_remove align-items-center justify-content-center">
										<div class="sl_remove__label mr-2">
											<span class="sl_remove__txt_before">iai_i18n:[VXN1bsSFxIcgbGlzdMSZ] &apos;</span>
										...
										<div class="sl_remove__sure d-flex">
											<a href="#yes" class="sl_remove__link --yes btn --outline mr-2">iai_i18n:[VGFr]</a>
											<a href="#no" class="sl_remove__link --no btn --outline --secondary">iai_i18n:[Tmll]</a>
										</div>
									</div>
								</div>
							</iaixsl:if>
					...
					<div class="sl_m_manage__item --other mx-n4 mb-n4 p-4">
						<div class="sl_m_manage__top --other mb-1">
							<strong class="sl_m_manage__label --other">iai_i18n:[SW5uZSBsaXN0eSB6YWt1cG93ZQ==]</strong>
						</div>
						<div class="sl_m_manage__lists" data-empty="false">
							...
							<div class="sl_m_manage__list d-flex align-items-center py-2" data-list_skeleton="true" data-list_id="true" data-shared="true">
								...
								<a href="#change-name" class="sl_m_manage__edit --change-name btn --outline align-items-center justify-content-center ml-auto">
									<iaixsl:attribute name="aria-label">iai_i18n:[Wm1pZcWEIG5henfEmQ==]</iaixsl:attribute>
								</a>
								<a href="#remove" class="sl_m_manage__edit --remove btn --outline align-items-center justify-content-center ml-2">
									<iaixsl:attribute name="aria-label">iai_i18n:[VXN1xYQ=]</iaixsl:attribute>
								</a>
							</div>
						...
						<div class="sl_create mt-4">
							...
							<form class="sl_create__form align-items-center">
								<div class="sl_create__group f-group --small mb-0">
									<input type="text" class="sl_create__input f-control" required="required" id="sl_create_form_input_1"/>
									<label class="sl_create__label f-label" for="sl_create_form_input_1">iai_i18n:[TmF6d2Egbm93ZWogbGlzdHk=]</label>
								</div>
			...
			<div class="sl_manage__sub --desktop sl_d_manage sl_dialog d-none d-md-flex">
				<div class="sl_d_manage__wrapper sl_dialog__wrapper">
					<div class="sl_d_manage__top mb-3">
						<strong class="sl_d_manage__label">iai_i18n:[TGlzdHkgemFrdXBvd2U=]</strong>
					</div>
					...
					<div class="sl_create mt-4">
						...
						<form class="sl_create__form align-items-center">
							<div class="sl_create__group f-group --small mb-0">
								<input type="text" class="sl_create__input f-control" required="required" id="sl_create_form_input_2"/>
								<label class="sl_create__label f-label" for="sl_create_form_input_2">iai_i18n:[TmF6d2Egbm93ZWogbGlzdHk=]</label>
							</div>
							<button type="submit" class="sl_create__button btn --solid ml-2 ml-md-3">iai_i18n:[VXR3w7NyeiBsaXN0xJk=]</button>
						</form>
					</div>
		...
		<div class="shopping_list__block --share sl_share sl_dialog">
			<div class="sl_share__wrapper sl_dialog__wrapper">
				<div class="sl_share__top mb-3 mb-md-4">
					<strong class="sl_share__label sl_dialog_close">iai_i18n:[VWRvc3TEmXBuaWogbGlzdMSZ]</strong>
					<iaixsl:if test="/shop/page/@is_owner = 'true'">
						<p class="sl_share__description d-block">iai_i18n:[S2HFvGRhIG9zb2JhIHBvc2lhZGFqxIVjYSBsaW5rIGRvIGxpc3R5IG1vxbxlIGrEhSB3ecWbd2lldGxpxIcsIGFsZSBuaWUgbW/FvGUgamVqIGVkeXRvd2HEhw==].</p>
					</iaixsl:if>
				</div>
				<div class="sl_share__options">
					<div class="sl_share__option --copy py-4 d-md-flex justify-content-md-between">
						<a href="#copy" class="sl_share__link --copy d-flex align-items-center">iai_i18n:[U2tvcGl1aiBsaW5rIGRvIHRlaiBsaXN0eSB6YWt1cG93ZWo=]</a>
						<div class="sl_share__copy d-flex align-items-center mt-2 ml-md-2 mt-md-0">
							<span class="sl_share__copy_txt ml-2 align-items-center ml-md-0 mr-md-2">iai_i18n:[U2tvcGlvd2Fubw==]</span>
							<input type="text" class="sl_share__copy_input" readonly="readonly" tabindex="-1">
					...
					<div class="sl_share__option --mail py-4 d-md-flex justify-content-md-between">
						<a class="sl_share__link --mail d-flex align-items-center">
							<iaixsl:attribute name="href">mailto:?subject=iai_i18n:[U3ByYXdkxbogbW9qxIUgbGlzdMSZIHpha3Vwb3fEhQ==] - <iaixsl:value-of disable-output-escaping="yes" select="/shop/page/list/@name"/>&amp;body=Link: <iaixsl:value-of select="/shop/page/list/share/@link"/></iaixsl:attribute>
							iai_i18n:[V3nFm2xpaiBsaW5rIGRvIHRlaiBsaXN0eSB6YWt1cG93ZWogZS1tYWlsZW0=]
						</a>
					</div>
				</div>
				<iaixsl:if test="/shop/page/@is_owner = 'true'">
					<div class="sl_share__stop">
						<iaixsl:choose>
							<iaixsl:when test="/shop/page/list/@shared = 'true'">
								<a href="#stop" class="sl_share__link --stop btn --outline --medium">iai_i18n:[V3nFgsSFY3ogdWRvc3TEmXBuaWFuaWUgdGVqIGxpc3R5]</a>
							</iaixsl:when>
							<iaixsl:otherwise>
								<a href="#start" class="sl_share__link --start btn --outline --medium">iai_i18n:[V8WCxIVjeiB1ZG9zdMSZcG5pYW5pZSB0ZWogbGlzdHk=]</a>
							</iaixsl:otherwise>
						</iaixsl:choose>
					</div>
				</iaixsl:if>
			...
			<div class="shopping_list__block --move sl_move sl_dialog">
				<div class="sl_move__wrapper sl_dialog__wrapper">
					<div class="sl_move__item --top sl_dialog_close mb-2">
						<strong class="sl_move__label --move">iai_i18n:[UHJ6ZW5pZcWbIGRvIGlubmVqIGxpc3R5]</strong>
						<strong class="sl_move__label --copy">iai_i18n:[S29waXVqIGRvIGlubmVqIGxpc3R5]</strong>
					</div>
						...
						<div class="sl_move__list f-group --radio m-0 d-md-flex align-items-md-center justify-content-md-between" data-list_skeleton="true" data-list_id="true" data-shared="true">
							...
							<label for="slMoveRadioSelect" class="sl_move__group_label f-label py-4" data-list_position="true">
								<span class="sl_move__sub d-flex align-items-center">
									...
									<span class="sl_move__count" data-list_count="true" aria-hidden="true">0</span>
								</span>
							</label>
							<button class="sl_move__button --desktop btn --solid ml-md-2">
								<span class="sl_move__button_txt --move">iai_i18n:[UHJ6ZW5pZcWb]</span>
								<span class="sl_move__button_txt --copy">iai_i18n:[S29waXVq]</span>
							</button>
						</div>
						<iaixsl:for-each select="/shop/shopping_lists/list[not(@id = /shop/page/list/@id)]">
							<div class="sl_move__list f-group --radio m-0 d-md-flex align-items-md-center justify-content-md-between">
								...
								<label class="sl_move__group_label f-label py-4">
									...
									<span class="sl_move__sub d-flex align-items-center">
										...
										<span class="sl_move__count" data-list_count="true" aria-hidden="true"><iaixsl:value-of select="@count"/></span>
									</span>
								</label>
								<button class="sl_move__button --desktop btn --solid ml-md-2">
									<span class="sl_move__button_txt --move">iai_i18n:[UHJ6ZW5pZcWb]</span>
					...
					<div class="sl_create mt-4">
						...
						<form class="sl_create__form align-items-center">
							<div class="sl_create__group f-group --small mb-0">
								<input type="text" class="sl_create__input f-control" id="sl_create_form_input_3" required="required"/>
								<label class="sl_create__label f-label" for="sl_create_form_input_3">iai_i18n:[TmF6d2Egbm93ZWogbGlzdHk=]</label>
							</div>
							<button type="submit" class="sl_create__button btn --solid ml-2 ml-md-3">iai_i18n:[VXR3w7NyeiBsaXN0xJk=]</button>
						</form>
					</div>
