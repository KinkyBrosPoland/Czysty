...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
    ...
    <!-- (rma_details_form, 61f913c73a10f4.46187235.6)-->
		...
		<div class="step_confirmation">
			<iaixsl:if test="/shop/page/details/@status=1">
				<div class="progress_bar_wrapper pb_step confirmation rma_progress_bar">
					<iaixsl:attribute name="aria-label">iai_i18n:[UGFzZWsgcG9zdMSZcHU=]</iaixsl:attribute>
					...
					<div class="_step _step6" aria-current="step">
						<span>6</span>
						<p>
							<i/>
			...
			<div id="orderdetails_info" class="rma_orderdetails_info">
				<h1 class="big_label">
					<span>iai_i18n:[U3pjemVnw7PFgnkgcmVrbGFtYWNqaQ==]</span>
					<span class="order-date">
						iai_i18n:[RGF0YSB3eWdlbmVyb3dhbmlhIHJla2xhbWFjamk=]: <iaixsl:value-of select="page/details/@datetime"/>
					</span>
				</h1>
					...
					<div class="prepaid-status">
						<div class="orderdetails-label">
							<strong>
								<iaixsl:choose>
									<iaixsl:when test="page/details/@status=1">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyeXdhbmE=] 
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=2">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmll]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=3">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBuZWdhdHl3bmll]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=4">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyeXdhbmEgLSBTa2llcm93YW5vIGRvIHRlc3TDs3c=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=5">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyeXdhbmEgLSBQcm9kdWt0IHd5c8WCYW55IGRvIHByb2R1Y2VudGE=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=6">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyeXdhbmEgLSBUcndhIG5hcHJhd2lhbmll]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=7">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBuZWdhdHl3bmllIC0gTmllIHN0d2llcmR6b25vIHVzdGVya2k=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=8">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBuZWdhdHl3bmllIC0gV2FkYSBzcG93b2Rvd2FuYSB6xYLEhSBla3NwbG9hdGFjasSF]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=9">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBuZWdhdHl3bmllIC0gUHJ6ZWtyb2N6b25vIHRlcm1pbiBnd2FyYW5jamk=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=10">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gWndyb3QgcGllbmnEmWR6eSAtIHNraWVyb3dhbmllIGRvIHd5cMWCYXR5]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=11">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gWndyb3QgcGllbmnEmWR6eSAtIHd5cMWCYXRh]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=12">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gV3ltaWFuYSBuYSBub3d5IHByb2R1a3Q=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=13">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gV3ltaWFuYSBwcm9kdWt0dSBuYSBpbm55]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=14">
											iai_i18n:[UmVrbGFtYWNqYSBuaWUgZG90YXLFgmE=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=15">
										iai_i18n:[S2xpZW50IHd5Z2VuZXJvd2HFgiByZWtsYW1hY2rEmQ==]
									</iaixsl:when>
									...
									<iaixsl:when test="page/details/@status=17">
										iai_i18n:[UmVrbGFtYWNqYSBhbnVsb3dhbmE=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=18">
										iai_i18n:[UmVrbGFtYWNqYSBhbnVsb3dhbmEgcHJ6ZXoga2xpZW50YQ==]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=19">
										iai_i18n:[UmVrbGFtYWNqYSBwb3R3aWVyZHpvbmE=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=20">
										iai_i18n:[UmVrbGFtYWNqYSBuaWVvYnPFgnXFvG9uYQ==]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=21">
										iai_i18n:[UmVrbGFtYWNqYSBvZHJ6dWNvbmE=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=22">
										iai_i18n:[UmVrbGFtYWNqYSBvZHJ6dWNvbmEgLSBOaWUgc3R3aWVyZHpvbm8gdXN0ZXJraQ==]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=23">
										iai_i18n:[UmVrbGFtYWNqYSBvZHJ6dWNvbmEgLSBQcnpla3JvY3pvbm8gdGVybWluIGd3YXJhbmNqaQ==]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=24">
										iai_i18n:[UmVrbGFtYWNqYSBvZHJ6dWNvbmEgLSBXYWRhIHNwb3dvZG93YW5hIHrFgsSFIGVrc3Bsb2F0YWNqxIU=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=25">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gUHJ6ZXN5xYJrYSB6d3JvdG5hIHd5c8WCYW5hIGRvIGtsaWVudGE=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=26">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gV3lzxYJhbm8gbm93eSBwcm9kdWt0IGJleiBvY3pla2l3YW5pYSBuYSBwaWVyd290bnk=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=27">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gWm1pYW5hIGRhbnljaCBvZGJpb3JjeSBuYSBkb2t1bWVuY2llIHNwcnplZGHFvHk=]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=28">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyeXdhbmEgLSBOYXByYXdhIHpha2/FhGN6b25h]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=29">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyeXdhbmEgLSBXeW1hZ2EgZG9kYXRrb3d5Y2ggaW5mb3JtYWNqaSBvZCBrbGllbnRh]
									</iaixsl:when>
									<iaixsl:when test="page/details/@status=30">
										iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBuZWdhdHl3bmllIC0gUHJ6ZXN5xYJrYSB6d3JvdG5hIHd5c8WCYW5hIGRvIGtsaWVudGE=]
									</iaixsl:when>
								</iaixsl:choose>
							</strong>
						...
						<div class="orderdetails_info__dates">
							<span>iai_i18n:[TnIgcmVrbGFtYWNqaQ==]: <iaixsl:value-of select="page/details/@id"/></span>
							<iaixsl:if test="not(page/details/@status_description = '')">
			...
			<iaixsl:if test="/shop/page/documentlink/@url">
				<div class="orderdetails_documentlink">
					<h2 class="orderdetails_label">
						<span>iai_i18n:[V3lkcnVrIHpnxYJvc3plbmlhIHJla2xhbWFjamk=]</span>
					</h2>
					<div class="documentlink_image row">
						<div class="document_img_1 col-12 col-sm-4">
							<img src="/gfx/standards/documentlink_1.png?r=1765442497" alt=""/>
							<span>iai_i18n:[V3lkcnVrdWogemfFgm9zemVuaWUgcmVrbGFtYWNqaSBpIGV0eWtpZXR5]</span>
						</div>
						<div class="document_img_2 col-12 col-sm-4">
							<img src="/gfx/standards/documentlink_2.png?r=1765442497" alt=""/>
							<span>iai_i18n:[UHJ6eWdvdHVqIHBhY3prxJkuIERvxYLEhWN6IGZvcm11bGFyeiByZWtsYW1hY2pp].</span>
						</div>
						<div class="document_img_3 col-12 col-sm-4">
							<img src="/gfx/standards/documentlink_3.png?r=1765442497" alt=""/>
							<span>iai_i18n:[TmFkYWogcGFjemvEmS4gWmEgbmFkYW5pZSBuaWMgZG9kYXRrb3dvIG5pZSBwxYJhY2lzeg==].</span>
						</div>
					</div>
					<iaixsl:if test="/shop/page/documentlink/@url">
						<div class="return_wrapper2">
							<a class="btn --solid --large" target="blank">
								...
								iai_i18n:[V3lkcnVrdWogemfFgm9zemVuaWUgcmVrbGFtYWNqaQ==]
							</a>
						</div>
					</iaixsl:if>
				</div>
			...
			<iaixsl:if test="/shop/page/rma_questions">
				<div class="rma_questions">
					<h2 class="orderdetails_label">
						<span>iai_i18n:[S29yZXNwb25kZW5jamEgZG90eWN6xIVjYSByZWtsYW1hY2pp]</span>
					</h2>
												...
												<iaixsl:for-each select="added_files/file">
													<li>
														<a class="previewFile" href="#previewFile">
															...
															<span class="sr-only">iai_i18n:[UG9iaWVyeiBwbGlr]</span>
					...
					<form class="rma_added_files" method="post" enctype="multipart/form-data">
						<div class="rma_af_input">
							<div class="f-group">
								<label for="comment" class="control-label">
									<div class="rma_af_info">
										<strong>iai_i18n:[RG9kYWogd2lhZG9tb8WbxIc=]</strong>
										<span>iai_i18n:[T2JzxYJ1Z2Egc2tsZXB1IHVkemllbGkgb2Rwb3dpZWR6aSB3IG5hamtyw7N0c3p5bSBtb8W8bGl3eW0gY3phc2ll].</span>
									</div>
								</label>
								<div class="control-label f-feedback has-required">
									<textarea name="comment" id="comment" class="f-control --validate" minlength="3" required="required">
							...
							<div class="rma_af_files">
								<span>iai_i18n:[WmHFgsSFY3ogcGxpaw==]: </span>
								...
								<a href="#addMoreAttachments" class="rma_af_addMoreAttachments">iai_i18n:[RG9kYWoga29sZWpueSB6YcWCxIVjem5paw==]</a>
							</div>
							<div class="rma_af_buttons">
								<a class="btn --icon-left icon-paperclip rma_attach_file" href="#rmaAttachFile">
									iai_i18n:[WmHFgsSFY3ogemRqxJljaWEgLyBwbGlraQ==]
								</a>
								<button class="btn --solid --medium" type="submit">
									iai_i18n:[V3nFm2xpag==]<span class="sr-only">iai_i18n:[d2lhZG9tb8WbxIcgZG8gb2JzxYJ1Z2kgc2tsZXB1]</span>
								</button>
								<div class="button_legend">
									<i class="icon-need"/> iai_i18n:[UG9sYSBvem5hY3pvbmUgZ3dpYXpka8SFIHPEhSB3eW1hZ2FuZQ==]
								</div>
							</div>
						</div>
					</form>
	...
	<iaixsl:if test="page/returnproducts/products">
		...
		<div id="return_order_products" class="mb-4 pb-md-1">
			<iaixsl:attribute name="aria-label">iai_i18n:[UmVrbGFtb3dhbnkgcHJvZHVrdA==]</iaixsl:attribute>
			<h2 class="orderdetails_label"><span>iai_i18n:[UmVrbGFtb3dhbnkgcHJvZHVrdA==]</span></h2>
								...
								<ul>
									...
									<li>
										<iaixsl:choose>
											...
											<iaixsl:otherwise>
												<b>iai_i18n:[TnVtZXJ5IHNlcnlqbmU=]:</b>
											</iaixsl:otherwise>
										</iaixsl:choose>
	...
	<iaixsl:if test="/shop/page/pickup/name">
		<div id="returnDetails_adress" class="mb-5 pb-md-3">
			<iaixsl:attribute name="aria-label">iai_i18n:[QWRyZXMgcHVua3R1IHJla2xhbWFjeWpuZWdv]</iaixsl:attribute>
			<h3 class="orderdetails_label">
				<span>iai_i18n:[QWRyZXMgcHVua3R1IHJla2xhbWFjeWpuZWdv]</span>
			</h3>
			<div class="returnDetails__adres">
				...
				<div class="mt-3">
					<a>
						<iaixsl:attribute name="title">iai_i18n:[U3pjemVnw7PFgm93ZSBpbmZvcm1hY2pl]</iaixsl:attribute>
						<iaixsl:attribute name="href">
							<iaixsl:value-of select="/shop/page/pickup/link"/>
						</iaixsl:attribute>
						iai_i18n:[U3pjemVnw7PFgm93ZSBpbmZvcm1hY2pl]
					</a>
				</div>
			</div>
		</div>
	...
	<iaixsl:variable name="txt_54116_1">iai_i18n:[RG9rdW1lbnR5IHd5c3Rhd2lvbmUgZGxhIHRlaiByZWtsYW1hY2pp]</iaixsl:variable>
	<iaixsl:if test="$txt_54116_1 and count(page/documents/document) &gt; 0">
		<div id="returnDetails_documents" class="mb-4">
			<iaixsl:attribute name="aria-label"><iaixsl:value-of select="$txt_54116_1"/></iaixsl:attribute>
			<h3 class="orderdetails_label">
		...
		<div class="returnDetails__summarySub">
			<iaixsl:if test="/shop/page/costs/cost[@type='products']/@value_formatted">
				<div class="returnDetails__summaryItem">
					<label>iai_i18n:[V2FydG/Fm8SHIHJla2xhbW93YW5lZ28gcHJvZHVrdHU=]: </label>
			...
			<div class="returnDetails__buttons">
				<iaixsl:if test="/shop/page/editlink/@url">
					<a class="btn --solid --medium --outline prepaid-edit">
						<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IHByemVqxZvEhyBkbyBlZHljamkgcmVrbGFtYWNqaQ==].</iaixsl:attribute>
						<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute>iai_i18n:[Wm1pZcWEIHJla2xhbWFjasSZ]
					</a>
				</iaixsl:if>
				<iaixsl:if test="/shop/page/cancellink/@url">
					<a class="btn --solid --medium --outline prepaid-cancel">
						<iaixsl:attribute name="onclick">return confirm(&apos;iai_i18n:[QW51bG93YW5pZSByZWtsYW1hY2ppIGplc3QgY3p5bm5vxZtjacSFIG5pZW9kd3JhY2FsbsSFLiBBYnkga29udHludW93YcSHIHdjacWbbmlqIHByenljaXNrICJBbnVsdWogcmVrbGFtYWNqxJk=]&quot;.&gt;&apos;)</iaixsl:attribute>
						<iaixsl:attribute name="title">iai_i18n:[QW51bHVqIHJla2xhbWFjasSZ]</iaixsl:attribute>
						<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/cancellink/@url"/></iaixsl:attribute>
						iai_i18n:[QW51bHVqIHJla2xhbWFjasSZ]
					</a>
				</iaixsl:if>
			</div>
		</div>
		...
		<div class="prepaid_summary_buttons">
			<iaixsl:if test="page/backlink/@url">
				<a class="btn --solid --medium">
					...
					iai_i18n:[UmVrbGFtdWogaW5ueSBwcm9kdWt0]
				</a>
			</iaixsl:if>
			<iaixsl:if test="page/backlink_other/@url">
				<a class="btn --solid --medium">
					...
					iai_i18n:[UmVrbGFtdWogaW5ueSBwcm9kdWt0IHogdGVnbyB6YW3Ds3dpZW5pYQ==]
				</a>
			</iaixsl:if>
		</div>
	</iaixsl:if>
