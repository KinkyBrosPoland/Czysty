...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (affiliate_client_orders, 60dd8e83d9a076.30620063.3)-->
  <iaixsl:variable name="affiliate_1">iai_i18n:[SWQgemFtw7N3aWVuaWE=]</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">iai_i18n:[RGF0YSB6YW3Ds3dpZW5pYQ==]</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">iai_i18n:[RGF0YSB3eXN5xYJraQ==]</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">iai_i18n:[V2FydG/Fm8SHIHphbcOzd2llbmlh]</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">iai_i18n:[SWxvxZvEhyBwcm9kdWt0w7N3]</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">iai_i18n:[UMWCYXRub8WbxIc=]</iaixsl:variable>
  <iaixsl:variable name="affiliate_7">Status</iaixsl:variable>
  <iaixsl:variable name="affiliate_8">Partner</iaixsl:variable>
  <iaixsl:variable name="affiliate_9">iai_i18n:[UHJvd2l6amE=]</iaixsl:variable>
  <iaixsl:if test="page/client/item">
    <h1 class="headline">
      <span class="headline__name">
        iai_i18n:[WmFtw7N3aWVuaWEga2xpZW50YQ==] <iaixsl:value-of select="page/client/@id"/>
      </span>
    </h1>
...
<!-- (affiliate_client_paging, 60dd8e7f1696c2.31458425.5)-->
      ...
      <iaixsl:if test="page/client/navigation/prev">
        <li class="pagination__element --prev">
          ...
          <a class="pagination__link">
            <iaixsl:attribute name="href"><iaixsl:choose><iaixsl:when test="page/client/navigation/prev/@counter = '0'"><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/client/navigation/path/@value, '&amp;counter=')"/><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/client/navigation/path/@value, '?counter=')"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of disable-output-escaping="yes" select="page/client/navigation/path/@value"/><iaixsl:value-of select="page/client/navigation/prev/@counter"/></iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>
