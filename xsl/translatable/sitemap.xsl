...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
	...
	<iaixsl:variable name="login">iai_i18n:[VHdvamUga29udG8=]</iaixsl:variable>
	<iaixsl:variable name="loginedit">iai_i18n:[Wm1pZcWEIHN3b2plIGRhbmU=]</iaixsl:variable>
	<iaixsl:variable name="address">iai_i18n:[QWRyZXN5IGRvc3Rhdw==]</iaixsl:variable>
	<iaixsl:variable name="orders_opened">iai_i18n:[QmllxbzEhWNlIHphbcOzd2llbmlh]</iaixsl:variable>
	<iaixsl:variable name="orders_closed">iai_i18n:[WmFta25pxJl0ZSB6YW3Ds3dpZW5pYQ==]</iaixsl:variable>
	<iaixsl:variable name="affiliate">iai_i18n:[UHJvZ3JhbSBwYXJ0bmVyc2tp]</iaixsl:variable>
	<iaixsl:variable name="rma">iai_i18n:[UmVrbGFtYWNqZQ==]</iaixsl:variable>
	

	<section id="Sitemap" class="sitemap_tree">
		<h1 class="headline">
			<span class="headline__name">iai_i18n:[TWFwYSBzdHJvbnk=]</span>
		</h1>
			...
			<div class="sitemap_tree__wrapper">
				...
				<iaixsl:choose>
					<iaixsl:when test="@id='mainpage'">
						<label class="sitemap_tree__label">iai_i18n:[SW5mb3JtYWNqZQ==]</label>
					</iaixsl:when>
					<iaixsl:when test="@id='searchpage'">
						<label class="sitemap_tree__label">iai_i18n:[QXNvcnR5bWVudA==]</label>
					</iaixsl:when>
					<iaixsl:otherwise>
						<label class="sitemap_tree__label">iai_i18n:[S29udG8ga2xpZW50YQ==]</label>
					</iaixsl:otherwise>
				</iaixsl:choose>
