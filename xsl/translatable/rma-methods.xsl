		...
		<div class="step3">
			...
			<div class="progress__item --rma --third --active d-md-none py-3">
				...
				<div class="progress__text">
					<strong class="progress__name">iai_i18n:[VyBqYWtpIHNwb3PDs2IgY2hjaWHFgmJ5xZsgZG9zdGFyY3p5xIcgcmVrbGFtb3dhbnkgcHJvZHVrdD8=]</strong>
				</div>
			</div>
			<h1 class="big_label return_label d-none d-md-block" id="return_label">iai_i18n:[VyBqYWtpIHNwb3PDs2IgY2hjaWHFgmJ5xZsgZG9zdGFyY3p5xIcgcmVrbGFtb3dhbnkgcHJvZHVrdD8=]</h1>
								...
								<div class="return_type choose_return_type">
									...
									<input class="return_type" name="rma_type" type="radio">
										<iaixsl:choose>
											...
											<iaixsl:when test="position() = 1 and not(/shop/page/rma_methods/rma_method[@checked = 'true'])">
									...
									<div class="return_inner">
										<div class="return_inner_content">
											<label class="return_name">
												<iaixsl:choose>
													...
													<iaixsl:when test="@id = 1">
														iai_i18n:[RG9zdGFyY3rEmSBvc29iacWbY2llIGRvIGplZG5lZ28geiBwdW5rdMOzdyBvYnPFgnVnaSByZWtsYW1hY2pp]
													</iaixsl:when>
													<iaixsl:when test="@id = 2">
														iai_i18n:[U2tvcnp5c3RhbSB6IHByemVzecWCa2kgb3DFgmFjb25laiBwcnpleiBza2xlcA==]
													</iaixsl:when>
											...
											<div class="return_desc">
												<iaixsl:choose>
													...
													<iaixsl:when test="@id = 1">
														iai_i18n:[Wm9ib3dpxIV6dWrEmSBzacSZIGRvIG9zb2Jpc3RlZ28gZG9zdGFyY3plbmlhIHBhY3praSBkbyB3eWJyYW5lZ28gcHVua3R1IG9ic8WCdWdpIHJla2xhbWFjamk=].
													</iaixsl:when>
													<iaixsl:when test="@id = 2 and @shipping_cost='client'">
														iai_i18n:[S29zenQgcHJ6ZXN5xYJraSB6b3N0YW5pZSBvZGxpY3pvbnkgb2QgendyYWNhbmVqIG1pIGt3b3R5IGRvIHJla2xhbWFjamk=].
													</iaixsl:when>
													<iaixsl:when test="@id = 2 and @shipping_cost='shop'">
														iai_i18n:[S29zenQgcHJ6ZXN5xYJraSBwb25vc2kgc2tsZXA=]
													</iaixsl:when>
													<iaixsl:when test="@id = 3">
														iai_i18n:[Wm9ib3dpxIV6dWrEmSBzacSZIGRvIHNhbW9kemllbG5lZ28gbmFkYW5pYSBwYWN6a2kgd3JheiB6IHBvbmllc2llbmllbSB3c3p5c3RraWNoIGtvc3p0w7N3IHp3acSFemFueWNoIHogZG9zdGFyY3plbmllbSBwcm9kdWt0dSBkbyBza2xlcHU=].
													</iaixsl:when>
												</iaixsl:choose>
											</div>
											<iaixsl:if test="$n69372_p_txt and shipping/delivery">
												<iaixsl:if test="$n69372_shipping_title and  /shop/page/return_methods/@shipping_balanced_refund = 'true'">
													<div class="n69372_shipping_balance">
														...
														<div>
															iai_i18n:[UHJ6eSB3eWJvcnpl] <b>iai_i18n:[endyb3R1IMWbcm9ka8OzdyBuYSBzYWxkbyBrbGllbnRh].</b><br/>iai_i18n:[RGxhIHd5YnJhbmVqIGZvcm15IHJla2xhbWFjamk=].
														</div>
													</div>
												</iaixsl:if>
												...
												<div class="return_methods_info">
													iai_i18n:[Rm9ybcSZIHJla2xhbWFjamkgd3liaWVyemVzeiB3IG5hc3TEmXBueW0ga3Jva3U=].
												</div>
											</iaixsl:if>
										</div>
										<iaixsl:if test="$n69372_icon_txt and @icon">
											<iaixsl:choose>
												<iaixsl:when test="@id = 3">
													<img class="n69372_icon" src="/gfx/standards/delivery-logistic-parcel_box-shipping-hand.svg?r=1765442497">
														<iaixsl:attribute name="alt"><iaixsl:value-of select="@name"/></iaixsl:attribute>
													</img>
												</iaixsl:when>
												<iaixsl:when test="@id = 1">
													<img class="n69372_icon" src="/gfx/standards/delivery-man.svg?r=1765442497">
														<iaixsl:attribute name="alt"><iaixsl:value-of select="@name"/></iaixsl:attribute>
													</img>
												</iaixsl:when>
												<iaixsl:otherwise>
