...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/search_style.css?r=1765442856</iaixsl:attribute></link></iaixsl:when>
    <iaixsl:otherwise><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/search_style.css.gzip?r=1765442856</iaixsl:attribute></link></iaixsl:otherwise>
</iaixsl:choose>
...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/search_shop.js?r=1765442856</iaixsl:attribute></script></iaixsl:when>
    <iaixsl:otherwise><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/search_shop.js.gzip?r=1765442856</iaixsl:attribute></script></iaixsl:otherwise>
</iaixsl:choose>
		...
		<iaixsl:choose>
			...
			<iaixsl:when test="navigation/descendant::item[@ni=/shop/navigation/current/@ni] and not(navigation/descendant::item[@ni=/shop/navigation/current/@ni]/item) and page/@type='search'">
				<iaixsl:choose>
					...
					<iaixsl:otherwise>
						<a class="menu_categories_label" href="/categories.php">iai_i18n:[S2F0ZWdvcmll] </a>
					</iaixsl:otherwise>
				</iaixsl:choose>
				<ul>
					<iaixsl:if test="not(navigation/descendant::item[@ni=/shop/navigation/current/@ni]/../item[@ni = /shop/navigation/current/@ni])">
...
<!-- (menu_buttons3, 60dd8e7e6e3ca3.91526215.6)-->
	...
	<iaixsl:if test="not($hidebuttons3COP) or ( $hidebuttons3COP and not(( page/@type = 'basketedit') or ( page/@type='login' and page/login/onceorder/@display='y') or ( ((page/@type = 'client-new') and not(page/client-data/@register='true') and not(page/client-data/@edit='true'))) or ( page/@type = 'order1') or ( page/@type = 'order-nonstandardized') or ( page/@type = 'pickup-sites') or ( page/@type = 'order2') or ( page/@type = 'client-save') or ( page/@type = 'prepaid') or ( page/@type = 'order-payment') or ( page/@type = 'order-newpayment')) ) ">
									...
									<iaixsl:when test="@href">
										<a target="_self" href="{@href}">
											...
											<iaixsl:attribute name="aria-label"><iaixsl:choose>
												...
												<iaixsl:otherwise>iai_i18n:[T2JyYXplayB3IHNla2NqaSBncmFmaWN6bmVq] 3 - <iaixsl:value-of select="position()"/></iaixsl:otherwise>
        ...
        <!-- (search_categoriesdescription, 61b0b16a502885.53008740.5)-->
				...
				<h1 class="search_name__label headline">
					<span class="headline__name">
						<iaixsl:choose>
							...
							<iaixsl:otherwise>
								iai_i18n:[V3luaWtpIHd5c3p1a2l3YW5pYQ==]
							</iaixsl:otherwise>
						</iaixsl:choose>
					</span>
				</h1>
				<iaixsl:if test="not(/shop/page/products/@hideproducts = 'true')">
					<span class="search_name__total">( iai_i18n:[aWxvxZvEhyBwcm9kdWt0w7N3]: <span class="search_name__total_value"><iaixsl:value-of select="/shop/page/products/navigation/@total"/></span> )</span>
				</iaixsl:if>
			</section>
		...
		<!-- (search_paging, 61b0b16dc07a33.01252614.7)-->

	<iaixsl:variable name="select_sort_label"/>
	<iaixsl:variable name="select_portions_label"/>
	<iaixsl:variable name="prev_page">iai_i18n:[UG9wcnplZG5pYSBzdHJvbmE=]</iaixsl:variable>
				...
				<form class="s_paging__item --sort" action="/settings.php">
					...
					<select class="s_paging__select --order --small-md" id="select_top_sort" name="sort_order">
					  <iaixsl:attribute name="aria-label">iai_i18n:[Wm1pZcWEIHNvcnRvd2FuaWU=]</iaixsl:attribute>
						<option value="relevance-d" class="option_relevance-d"><iaixsl:if test="page/products/navigation/@sort = 'relevance' and page/products/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[TmFqbGVwc3phIHRyYWZub8WbxIc=]</option>
						<option value="name-a" class="option_name-a"><iaixsl:if test="page/products/navigation/@sort = 'name' and page/products/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[U29ydHVqIHBvIG5hendpZSByb3NuxIVjbw==]</option>
						<option value="name-d" class="option_name-d"><iaixsl:if test="page/products/navigation/@sort = 'name' and page/products/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[U29ydHVqIHBvIG5hendpZSBtYWxlasSFY28=]</option>
						<option value="price-a" class="option_price-a"><iaixsl:if test="page/products/navigation/@sort = 'price' and page/products/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[U29ydHVqIHBvIGNlbmllIHJvc27EhWNv]</option>
						<option value="price-d" class="option_price-d"><iaixsl:if test="page/products/navigation/@sort = 'price' and page/products/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[U29ydHVqIHBvIGNlbmllIG1hbGVqxIVjbw==]</option>
						<option value="date-a" class="option_date-a"><iaixsl:if test="page/products/navigation/@sort = 'date' and page/products/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[U29ydHVqIHBvIGRhY2llIHJvc27EhWNv]</option>
						<option value="date-d" class="option_date-d"><iaixsl:if test="page/products/navigation/@sort = 'date' and page/products/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[U29ydHVqIHBvIGRhY2llIG1hbGVqxIVjbw==]</option>
					</select>
				</form>
			</iaixsl:if>
			...
			<iaixsl:if test="not(/shop/page/products/navigation/@disable_portions_change = 'y') and count(page/products/navigation/portions) &gt; 1">
				<form class="s_paging__item --portions d-none d-md-block" action="/settings.php">
					...
					<select class="s_paging__select --portions --small-md" id="select_top_portions" name="portions">
						<iaixsl:attribute name="aria-label">iai_i18n:[Wm1pZcWEIGlsb8WbxIcgd3nFm3dpZXRsYW55Y2ggcHJvZHVrdMOzdw==]</iaixsl:attribute>
			...
			<div class="filter_list_content">
				<iaixsl:if test="$show_remove_button">
					<a class="remove_all_list_filters btn --solid --secondary mr-2 mr-sm-3" href="/settings.php?filter_remove=all">
						...
						<iaixsl:attribute name="title">iai_i18n:[VXN1xYQgd3N6eXN0a2llIGZpbHRyeQ==]</iaixsl:attribute>
						iai_i18n:[VXN1xYQgZmlsdHJ5]
					</a>
				</iaixsl:if>
									...
									<iaixsl:when test="item[@selected = 'selected']">
										<iaixsl:for-each select="item[@selected = 'selected']">
											<a class="filter_list_remove btn --solid --icon-right icon-x mr-2 mr-sm-3">
												...
												<span class="sr-only">iai_i18n:[VXN1xYQgZmlsdHI=]</span>
...
<!-- (search, 614c5d2fce57f6.27912971.17)-->
          ...
          <iaixsl:variable name="var_new_price_date"><iaixsl:choose>
              ...
              <iaixsl:otherwise>
                <picture>
						...
						<iaixsl:variable name="productUnavailable">iai_i18n:[Q2h3aWxvd28gbmllZG9zdMSZcG55]</iaixsl:variable>
						<iaixsl:choose>
									...
									<iaixsl:choose>
										<iaixsl:when test="(sizes/prices/@minprice_net_formatted != sizes/prices/@maxprice_net_formatted) or (sizes/prices/@minprice_unit_net_formatted != sizes/prices/@maxprice_unit_net_formatted)">
											<strong class="price --main">
											  <span class="sr-only">iai_i18n:[b2Q=] </span>
												<span class="price__range --min"><iaixsl:choose>
													...
													-
											  <span class="sr-only">iai_i18n:[ZG8=] </span>
										...
										<iaixsl:otherwise>
											...
											<iaixsl:if test="price/@points">
											  <span class="price --points"><iaixsl:value-of select="price/@points"/><span class="currency" aria-hidden="true"> iai_i18n:[UEtU]</span><span class="sr-only">iai_i18n:[cHVua3TDs3c=]</span></span>
											</iaixsl:if>
							...
							<iaixsl:choose>
								<iaixsl:when test="@id = /shop/compare/product/@id">
									<a class="product__compare_item --remove btn" rel="nofollow">
										...
										<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IHVzdW7EhcSHIHByb2R1a3QgeiBwb3LDs3dueXdhcmtp]</iaixsl:attribute>
										- iai_i18n:[VXN1xYQgeiBwb3LDs3duYW5pYQ==]
									</a>
								</iaixsl:when>
								<iaixsl:otherwise>
									<a class="product__compare_item --add btn" rel="nofollow">
										...
										<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IGRvZGHEhyBwcm9kdWt0IGRvIHBvcsOzd25hbmlh]</iaixsl:attribute>
								...
								<div class="product__details">
										<iaixsl:if test="sizes/size/@type and not(sizes/size/@type='uniw')">
												<div class="product__sizes">
														<label class="product__size --label">iai_i18n:[Um96bWlhcg==]:</label>
...
<!-- (search_hotspot_zone1, 60dd8e786dac63.37616518.2)-->
	...
	<iaixsl:if test="not(action/set_render/item) or (action/set_render/item/@name = 'footer')">
		<footer>
			...
			<!-- (menu_search_hotspot1_bis, 665ebddbd6a433.04343879.6)-->
  ...
  <iaixsl:if test="page/products/additional/hotspot/products_zone1">
    <section id="search_hotspot_zone1" class="hotspot__wrapper">
      ...
      <iaixsl:attribute name="data-zone">1</iaixsl:attribute>
			<iaixsl:attribute name="aria-label">iai_i18n:[RG9kYXRrb3dhIHN0cmVmYSBwcm9kdWt0b3dh]</iaixsl:attribute>
