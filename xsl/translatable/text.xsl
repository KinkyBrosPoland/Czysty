...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (text, 60dd8e849cfa75.78919745.6)-->
			<section id="Text" class="section text_menu">
				...
				<iaixsl:if test="/shop/page/text/@displayindex='true' and /shop/page/cmsindex/documentsgroup[@type = /shop/page/text/@type]/subdocument">
					<div class="text_menu__wrapper px-3 pt-3 pb-2 mb-4">
						<strong class="text_menu__sublabel d-block mb-2">iai_i18n:[U3BpcyB0cmXFm2Np]</strong>
		...
		<!-- (text_facebook_comments, 60dd8e7d79b0f8.86094661.3)-->
            <iaixsl:if test="page/facebook_comments">
                <div class="section cms_fb_comments">
                    <div class="headline cms_fb_comments_label">
                        <span class="headline__name">iai_i18n:[UG9kemllbCBzacSZIHN3b2ltIGtvbWVudGFyemVtIHogaW5ueW1p]</span>
                    </div>
                    <div id="fb-root"/>
                    <script>
        ...
        <!-- (text_cms_associated, 67ef7f2d3c9964.62226502.3)-->
	<iaixsl:if test="/shop/page/cms_products/product or /shop/page/cms_products/opinion">

		<section id="text_cms_associated" class="hotspot__wrapper">
      <div class="hotspot">
        
        <iaixsl:variable name="headline_after_text_cms_associated">iai_i18n:[Wm9iYWN6IHdzenlzdGtpZQ==]</iaixsl:variable>
