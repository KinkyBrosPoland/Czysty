...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
    ...
    <!-- (returns_confirmation_form, 60dd8e7b94cfc9.15254466.10)-->
		...
		<div class="step6">
			<div class="progress_bar_wrapper pb_step6">
				...
				<a class="_step _step1">
					...
					<span class="sr-only">iai_i18n:[V3LDs8SHIGRv]</span>
					<span>1</span>
					<p>
						<i/>
				...
				<a class="_step _step4">
					<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/returnsMethod/@url"/>?return_type=<iaixsl:value-of select="/shop/page/return_method/@id"/></iaixsl:attribute>
					<span class="sr-only">iai_i18n:[V3LDs8SHIGRv]</span>
					<span>4</span>
					<p>
						<i/>
			...
			<div class="n57856_order_overtaker">
				<form class="returns_form" method="post">
					...
					<div class="big_label order2_info_label">
						iai_i18n:[RGFuZSBpIHV3YWdp]
					</div>

					<div class="order2_info">
						<div class="order2_info_sub" id="order2_info_sub1">
							<h3 class="order2_info1" id="order2_nagl_1">
								iai_i18n:[RGFuZSBiaWxpbmdvd2U=]
							</h3>
							<div class="order2_info1" id="order2_box_1">
								<div class="order2_info1_sub">
									<iaixsl:if test="page/orderclient/@firm">
										<span class="order2_info1_sub__item --firm"><iaixsl:value-of select="page/orderclient/@firm"/></span>
									</iaixsl:if>
									<iaixsl:if test="not(page/orderclient/@firm)">
										<span class="order2_info1_sub__item --name"><iaixsl:value-of select="page/orderclient/@firstname"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/orderclient/@lastname"/></span>
									</iaixsl:if>
									<span class="order2_info1_sub__item --street"><iaixsl:value-of select="page/orderclient/@street"/></span>
									<span class="order2_info1_sub__item --city"><iaixsl:value-of select="page/orderclient/@zipcode"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/orderclient/@city"/> (<iaixsl:value-of select="page/orderclient/@country_long"/>)</span>
									<iaixsl:if test="page/orderclient/@nip">
										<span class="order2_info1_sub__item --nip">iai_i18n:[TklQ]: <iaixsl:value-of select="page/orderclient/@nip"/></span>
									</iaixsl:if>
									<span class="order2_info1_sub__item --email">e-mail <iaixsl:value-of select="page/orderclient/@email"/></span>
								</div>
								<a class="order2_button_change_address mt-2 mt-sm-0">
									...
									iai_i18n:[Wm1pZcWEIGRhbmUgYmlsbGluZ293ZQ==]
								</a>
							</div>
						</div>
							...
							<iaixsl:choose>
								<iaixsl:when test="page/pickup">
									<h3 class="order2_info1" id="order2_nagl_2a">
										iai_i18n:[QWRyZXMgcHVua3R1IHp3cm90dQ==]
									</h3>
									<div class="order2_info1" id="order2_box_2b">
										<div class="order2_info1_sub">
											<span class="order2_stock_name"><iaixsl:value-of select="page/pickup/name"/></span>
											<span class="order2_info1_sub__item --street"><iaixsl:value-of select="page/pickup/address"/></span>
											<span class="order2_info1_sub__item --city"><iaixsl:value-of select="page/pickup/zipcode"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/pickup/city"/> (<iaixsl:value-of select="page/pickup/country"/>)</span>
										...
										<a class="order2_button_change_address mt-2 mt-sm-0" target="_blank">
											...
											iai_i18n:[Wm1pZcWEIGFkcmVzIHB1bmt0dSB6d3JvdHU=]
										</a>
									</div>
								</iaixsl:when>
								<iaixsl:otherwise>
									<h3 class="order2_info1" id="order2_nagl_2b">
										iai_i18n:[UHVua3QgZG9zdGFyY3plbmlhIHp3cm90dQ==]
									</h3>
									<div class="order2_info1" id="order2_box_2b">
									<div class="order2_info1_sub">
											<iaixsl:if test="page/deliveryaddress/@additional">
												<span class="order2_info1_sub__item --additional"><iaixsl:value-of select="page/deliveryaddress/@additional"/></span>
											</iaixsl:if>
											<span class="order2_info1_sub__item --street"><iaixsl:value-of select="page/deliveryaddress/@street"/></span>
											<span class="order2_info1_sub__item --city"><iaixsl:value-of select="page/deliveryaddress/@zipcode"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/deliveryaddress/@city"/> (<iaixsl:value-of select="page/deliveryaddress/@country_long"/>)</span>
										</div>
										<a class="order2_button_change_address mt-2 mt-sm-0">
											<iaixsl:attribute name="href"><iaixsl:value-of select="page/deliveryaddress/@changelink"/></iaixsl:attribute>
											iai_i18n:[Wm1pZcWEIHB1bmt0IGRvc3RhcmN6ZW5pYSB6d3JvdHU=]
										</a>
									</div>
								</iaixsl:otherwise>
							</iaixsl:choose>
						...
						<iaixsl:if test="/shop/page/remarks">
							<div class="order2_info_sub">
								<h3 class="order2_info1">
									iai_i18n:[VXdhZ2kgZGxhIHNrbGVwdQ==]
								</h3>
								<div class="order2_info1" id="order2_box_1">
									<div class="order2_info1_sub">
					...
					<div id="return_products_list" class="order2_products">
						<iaixsl:variable name="return_with_special_offer">iai_i18n:[].</iaixsl:variable>
						<iaixsl:variable name="required_from_special_offer"><span>iai_i18n:[VGVuIHByb2R1a3Qgd3DFgnluxIXFgiBzd29qxIUgY2VuxIU=]</span> iai_i18n:[bmEgY2VueSBpbm55Y2ggcHJvZHVrdMOzdyB3IGtvc3p5a3U=].</iaixsl:variable>
						...
						<table class="order2_table">
							<tr>
								<th class="order2_name">
									iai_i18n:[UHJvZHVrdHkgZG8gendyb3R1]
								</th>
								<iaixsl:if test="/shop/page/returnproducts/products/product/@required_from_special_offer = 'true' and $required_from_special_offer != ''">
									<th class="order2_special_offer">
										<span class="sr-only">iai_i18n:[T2ZlcnRhIHNwZWNqYWxuYQ==]</span>
									</th>
								</iaixsl:if>
								<th class="order2_price">
									iai_i18n:[Q2VuYSBqZWRu] <span class="price_vat"> iai_i18n:[YnJ1dHRv]</span>
								</th>
								<th class="order2_quantity">
									iai_i18n:[SWxvxZvEhw==]
								</th>
								<th class="order2_worth">
									iai_i18n:[V2FydG/Fm8SH]<span class="price_vat"> iai_i18n:[YnJ1dHRv]</span>
								</th>
							</tr>
								...
								<tr>
										...
										<iaixsl:if test="@required_from_special_offer = 'true' and $required_from_special_offer != ''">
											<iaixsl:if test="@required_from_special_offer = 'true'">
												<div class="productslist_product_special_offer">
													...
													<span>iai_i18n:[VGVuIHByb2R1a3Qgd3DFgnluxIXFgiBzd29qxIUgY2VuxIU=]</span> iai_i18n:[bmEgY2VueSBpbm55Y2ggcHJvZHVrdMOzdyB3IGtvc3p5a3U=].
												</div>
											</iaixsl:if>
										</iaixsl:if>
									</td>
									...
									<td class="order2_price">
										<iaixsl:if test="@forpoints">
											<iaixsl:value-of select="@points_for_one"/>iai_i18n:[cGt0]. 
										</iaixsl:if>
					...
					<div id="return_products_delivery" class="order2_products">
						<table class="order2_table">
							<tr>
								<th class="order2_name">
									iai_i18n:[U3Bvc8OzYiB6d3JvdHUgcHJvZHVrdMOzdyBpIGZvcm1hIHp3cm90dSBuYWxlxbxub8WbY2k=]
								</th>
								<th class="order2_worth">
									iai_i18n:[S29zenQgZG9zdGFyY3plbmlhIHBhY3praQ==]
								</th>
							</tr>
									...
									<td class="order2_name">
										<iaixsl:choose>
											<iaixsl:when test="/shop/page/return_method/@description">
													<span class="order2_name">iai_i18n:[U3Bvc8OzYiB6d3JvdHUgcHJvZHVrdMOzdw==]: 
											...
											<iaixsl:when test="/shop/page/return_method/@id = 2 and /shop/page/return_method/@shipping_cost = 'client' and not(/shop/page/repayment_method/@id = 't')">
												<span class="order2_name">
													iai_i18n:[U3Bvc8OzYiB6d3JvdHUgcHJvZHVrdMOzdw==]: 
											...
											<iaixsl:when test="/shop/page/return_method/@id = 2 and /shop/page/return_method/@shipping_cost = 'shop'">
												...
												<div class="return_description">
													iai_i18n:[S29zenQgcHJ6ZXN5xYJraSBwb25vc2kgc2tsZXA=]
												</div>
											</iaixsl:when>
								...
								<td class="order2_name">
									<iaixsl:choose>
										<iaixsl:when test="/shop/page/repayment_method/@id = 't'">
											<span class="order2_name">iai_i18n:[Rm9ybWEgendyb3R1IG5hbGXFvG5vxZtjaTogU2FsZG8ga2xpZW50YQ==]</span>
											<div class="return_description">
										...
										<iaixsl:when test="/shop/page/repayment_method/@id = 'b'">
											<span class="order2_name">iai_i18n:[Rm9ybWEgendyb3R1IG5hbGXFvG5vxZtjaTogUHJ6ZWxldw==]</span>
											<div class="return_description">
										...
										<iaixsl:when test="/shop/page/repayment_method/@id = 'tc'">
											<span class="order2_name">iai_i18n:[Rm9ybWEgendyb3R1IG5hbGXFvG5vxZtjaTogUHJ6eXdyw7PEhyBrcmVkeXQga3VwaWVja2k=]</span>
											<div class="return_description">
					...
					<div class="basketedit_summary">
						<div class="basketedit_summary_sub">
							<div class="basketedit_summary_right">
								<iaixsl:if test="/shop/page/costs/cost[@type='products']/@value_formatted or /shop/page/costs/cost[@type='shipping']/@value_formatted or /shop/page/costs/cost[@type='shop_shipping']/@value_formatted">
									<div class="basketedit_calculations">
										<iaixsl:if test="/shop/page/costs/cost[@type='products']/@value_formatted">
											<div class="basketedit_product_summary">
												<label>
													iai_i18n:[V2FydG/Fm8SHIHp3cmFjYW55Y2ggcHJvZHVrdMOzdw==]:
												</label>
												<strong>
										...
										<iaixsl:if test="/shop/page/costs/cost[@type='shipping']/@value_formatted">
											<div class="basketedit_product_summary">
												<label>
													iai_i18n:[Wndyb3Qga29zenR1IGRvc3Rhd3kgZG8ga2xpZW50YQ==]:
												</label>
												<strong>
										...
										<iaixsl:if test="/shop/page/costs/cost[@type='shop_shipping']/@value_formatted">
											<div class="basketedit_product_summary">
												<label>
													iai_i18n:[S29zenQgcHJ6ZXN5xYJraSB6d3JvdG5lag==]:
												</label>
								...
								<iaixsl:if test="/shop/page/costs/@value_formatted">
									<div class="basketedit_total_summary">
										...
										<strong>
											<iaixsl:value-of select="/shop/page/costs/@value_formatted"/><span class="price_vat"> iai_i18n:[YnJ1dHRv]</span>
										</strong>
									</div>
								</iaixsl:if>
							</div>
								...
								<div class="btn_wrapper backlink">
									<iaixsl:if test="page/backlink/@url">
										<a class="btn --medium pl-sm-0">
											...
											iai_i18n:[V3LDs8SHIGRvIHBvcHJ6ZWRuaWVnbyBrcm9rdQ==]
										</a>
									</iaixsl:if>
								</div>
								<div class="btn_wrapper">
									<input class="btn --solid --large" type="submit">
										<iaixsl:attribute name="value">iai_i18n:[RG9kYWogemfFgm9zemVuaWUgendyb3R1]</iaixsl:attribute>
										<iaixsl:if test="/shop/return_edit/@return_id">
											<iaixsl:attribute name="value">iai_i18n:[WmFwaXN6IHptaWFueQ==]</iaixsl:attribute>
										</iaixsl:if>
									</input>
								</div>
							</div>
