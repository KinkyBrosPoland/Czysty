...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (cop_modules_place-order, 686278c4a21bb6.63493693.6)-->
	...
	<script>
      ...
      associationTxt: &quot;iai_i18n:[UMWCYXRub8WbxIcgeiBwb3ppb211IGtvbnRhIG9yZ2FuaXphY2ppIHogb2Rwb3dpZWRuaW1pIHVwcmF3bmllbmlhbWk=]&quot;,
    };
  </script>
	<form method="POST" id="COP" class="cop --oscop" action="/place-order.php">
      ...
      <div class="cop__step --small" data-skeleton="documents">
        <div class="cop__skeleton --content"/>
      </div>
      ...
      <div class="cop__step --small" data-skeleton="remarks">
        <div class="cop__skeleton --content"/>
      </div>
		</div>
  ...
  <iaixsl:if test="$isLogged = 'false' or (/shop/page/@type = 'client-new' and not(page/client-data/@operation = 'register-wholesale-add' or page/client-data/@operation = 'edit-wholesale-add' or page/client-data/@operation = 'edit-wholesale-edit'))">
    ...
    <template id="cop_login_template">
      <div class="cop_login">
        <h2 class="cop__title">iai_i18n:[UG/FgsSFY3oga29udG8geiBpbm55bSBzZXJ3aXNlbQ==]</h2>
        <div class="cop_login__wrapper">
          <span class="cop_login__label">
            iai_i18n:[TWFzeiBqdcW8IHUgbmFzIGtvbnRv]? <a href="/login.php" class="cop_login__link">iai_i18n:[WmFsb2d1aiBzacSZ]</a><iaixsl:if test="count(/shop/login_options/service[not(@name='shop_register')]) &gt; 0"> iai_i18n:[bHViIHBvxYLEhWN6IGtvbnRv]:</iaixsl:if>
          </span>
                ...
                <a class="cop_login__service" href="#serviceLogin">
                  ...
                  <iaixsl:attribute name="data-id"><iaixsl:value-of select="@id"/></iaixsl:attribute>
										<img class="service_icon">
											<iaixsl:attribute name="alt">iai_i18n:[WmFsb2d1aiBzacSZIHByemV6] <iaixsl:value-of select="translate(@name, ' +', '_')"/></iaixsl:attribute>
        ...
        <div class="cop_login__separator"><span>iai_i18n:[bHVi]</span></div>
      </div>
    </template>

    <template id="cop_signin_template">
      <div class="cop_signin">
        <h5 class="cop__title --small">iai_i18n:[WmFsb2d1aiBzacSZ]</h5>
        <div class="cop_signin__inputs f-group">
          <div class="cop_signin__item --login f-feedback">
            ...
            <label for="cop_user_login" class="f-label">iai_i18n:[TG9naW4gLyBOciBrYXJ0eSBzdGHFgmVnbyBrbGllbnRhIC8gRS1tYWls]</label>
            <div class="f-message"/>
          </div>
          <div class="cop_signin__item --password f-feedback">
            ...
            <label for="cop_user_password" class="f-label">iai_i18n:[SGFzxYJvIC8gUGluIGthcnR5IHN0YcWCZWdvIGtsaWVudGE=]</label>
            <div class="f-message"/>
          </div>
        </div>
        <div class="cop_signin__buttons">
          <button type="button" class="cop_signin__button --submit btn --solid --medium">iai_i18n:[WmFsb2d1aiBzacSZ]</button>
          <a href="/password-recover.php" target="_blank" class="cop_signin__recover"><iaixsl:choose><iaixsl:when test="/shop/client_data/@signin = 'cookie'">iai_i18n:[TmllIHBhbWnEmXRhbSBoYXPFgmE=]</iaixsl:when><iaixsl:otherwise>iai_i18n:[TmllIHBhbWnEmXRhbSBsb2dpbnUgbHViIGhhc8WCYQ==]</iaixsl:otherwise></iaixsl:choose></a>
        </div>
      </div>
    </template>
  ...
  <iaixsl:if test="(/shop/page/@type = 'place-order' and $isLogged = 'false') or (/shop/page/@type = 'order1' and $isLogged = 'false') or (/shop/page/@type = 'client-new' and (/shop/page/client-data/@edit='true' or /shop/page/client-data/@register='true'))">
    ...
    <template id="cop_registration_template">
      <div class="cop_registration">
        <h2 class="cop__title">iai_i18n:[S29udG8gdyBza2xlcGll]</h2>
        <iaixsl:if test="/shop/action/registration_options/retail">     
          <div class="cop_registration__item --register-switch f-group --checkbox">
            ...
            <label class="f-label" for="register_client_checkbox">iai_i18n:[WmHFgsOzxbwga29udG8gdyBza2xlcGll] <span class="cop__title_desc">iai_i18n:[T3Bjam9uYWxuaWU=]</span></label>
          </div>
        </iaixsl:if>
				<iaixsl:if test="/shop/page/client-data/@edit = 'true'">
					<div class="cop_registration__item --password-switch cop_password_switch">
						<div class="cop_password_switch__radio --not-change f-group --radio">
							...
							<label class="f-label" for="client_generate_password1">iai_i18n:[TmllIHptaWVuaWFqIGhhc8WCYQ==]</label>
						</div>
						<div class="cop_password_switch__radio --change f-group --radio">
							...
							<label class="f-label" for="client_generate_password2">iai_i18n:[Wm1pZcWEIHN3b2plIGhhc8WCbw==]</label>
						</div>
					</div>
				</iaixsl:if>
        <div class="cop_registration__item --register-data cop_register f-group">
          <iaixsl:if test="/shop/action/registration_options/wholesale and not(/shop/basket/@login) and not(/shop/page/@type = 'client-new')">     
            <div class="cop_contact__wholesaler">
              <span>iai_i18n:[SmVzdGXFmyBodXJ0b3duaWtpZW0/IFNrb3J6eXN0YWogeg==] </span>
              <a>
                ...
                <iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IHByemVqxZvEhyBkbyBmb3JtdWxhcnphIHJlamVzdHJhY2ppIGRsYSBodXJ0b3duaWvDs3c=]</iaixsl:attribute>
                iai_i18n:[Zm9ybXVsYXJ6YSByZWplc3RyYWNqaSBkbGEgaHVydG93bmlrw7N3]
              </a>
            </div>
          </iaixsl:if>
          ...
          <div class="cop_register__item --login f-feedback">
            ...
            <label for="client_login" class="f-label">iai_i18n:[TG9naW4=]</label>
            <div class="f-message"/>
            <div class="f-description">
              iai_i18n:[TG9naW4gbXVzaSBtaWXEhyBtaW5pbXVtIDMsIGEgbWFrc2ltdW0gNDAgem5ha8Ozdy4gTW/FvGVzeiB1xbx5xIcgbGl0ZXIgaSBjeWZyIG9yYXogc3ltYm9saSBAIC4gLSBf]
            </div>
          </div>
          ...
          <div class="cop_register__item --password f-feedback">
            ...
            <label for="client_password" class="f-label">iai_i18n:[SGFzxYJv]</label>
            <div class="f-message"/>
            <div class="f-description">
              iai_i18n:[SGFzxYJvIG11c2kgc2vFgmFkYcSHIHNpxJkgeiBtaW5pbXVtIDYgem5ha8Ozdw==]
            </div>
    ...
    <template id="cop_client_exists_template">
      <div class="cop_client_exists">
        <div class="cop_client_exists__item --info">
          <span class="cop_client_exists__info_text">iai_i18n:[TWFteSBqdcW8IHphcmVqZXN0cm93YW5lIGtvbnRvIGRsYSBwb2RhbmVnbyBhZHJlc3UgZS1tYWls]:</span>
          <strong class="cop_client_exists__email"/>
        </div>
        <div class="cop_client_exists__item --desc">iai_i18n:[].</div>
        <div class="cop_client_exists__item --actions">
          <a class="cop_client_exists__action --recover btn --solid" href="/password-recover.php?operation=recover&amp;email=" data-link="/password-recover.php?operation=recover&amp;email=">iai_i18n:[V3nFm2xpaiBlLW1haWwgcG96d2FsYWrEhWN5IG5hIGF1dG9tYXR5Y3puZSB6YWxvZ293YW5pZQ==]</a>
          <a class="cop_client_exists__action --signin" href="#signin">iai_i18n:[UGFtacSZdGFtIHN3w7NqIGxvZ2luIGkgaGFzxYJvIGkgbW9nxJkgamUgcG9kYcSH]</a>
        </div>
      </div>
    </template>
  ...
  <template id="cop_contact_template">
    <div class="cop_contact">
      <h2 class="cop__title">iai_i18n:[RGFuZSBrb250YWt0b3dl]</h2>
      <div class="cop_contact__wrapper f-group">
        <div class="smile_web_authn">
          <span class="smile_web_authn__info --success_checked" role="alert">iai_i18n:[U2tvcnp5c3RhaiB6IGLFgnlza2F3aWN6bmVnbyB1enVwZcWCbmlhbmlhIGRhbnljaCBkbyBkb3N0YXd5]</span>
          <span class="smile_web_authn__info --success" role="alert">iai_i18n:[UG9tecWbbG5pZSB1enVwZcWCbmlvbm8gZGFuZSBkb3N0YXd5]</span>
          <span class="smile_web_authn__info --error --authn" role="alert">iai_i18n:[QmlvbWV0cnljem5lIHV3aWVyenl0ZWxuaWVuaWUgdXJ6xIVkemVuaWEgbmllIHBvd2lvZMWCbyBzacSZ]</span>
          <span class="smile_web_authn__info --error --saveDevice" role="alert">iai_i18n:[TmllIHVkYcWCbyBzacSZIHphcGlzYcSHIHVyesSFZHplbmlh]</span>
          <a href="" class="smile_web_authn__link">
            <iaixsl:attribute name="title">iai_i18n:[U3p5YmtpZSBsb2dvd2FuaWU=]</iaixsl:attribute>
            <img src="/gfx/custom/smile_icon_small.svg?r=1765442497" alt="smile"/>
            <strong>iai_i18n:[QsWCeXNrYXdpY3puaWUgdXp1cGXFgm5paiBkYW5lIGRvc3Rhd3k=]</strong>
          </a>
        </div>
        ...
        <div class="cop_contact__item --phone f-feedback">
            ...
            <div class="client_prefix__input_wrapper">
              <input id="client_phone_prefix" autocomplete="tel-local-prefix" data-graphql="phone" data-concat-to="#client_phone" class="client_prefix__input --validate" type="text" name="client_phone_prefix">
                <iaixsl:attribute name="aria-label">iai_i18n:[V3Bpc3ogcHJlZml4]</iaixsl:attribute>
              </input>
            </div>
          </div>
          ...
          <label for="client_phone" class="f-label">iai_i18n:[VGVsZWZvbg==]</label>
        ...
        <div class="smile_web_authn__generate_pin_wrapper">
          <a href="" class="smile_web_authn__generate_pin btn --solid --large">
            <iaixsl:attribute name="title">iai_i18n:[V3lnZW5lcnVqIGtvZCBQSU4=]</iaixsl:attribute>
            iai_i18n:[V3lnZW5lcnVqIGtvZCBQSU4=]
          </a>
          <span>iai_i18n:[V3nFm2xlbXkgY2kgU01TIHcgY2VsdSB3ZXJ5ZmlrYWNqaQ==]</span>
        </div>
        ...
        <div class="cop_contact__item --email f-feedback">
          ...
          <label for="client_email" class="f-label">iai_i18n:[RW1haWw=]</label>
          <div class="f-message"/>
          <div class="f-description">
            <a href="" class="smile_logout">
              <iaixsl:attribute name="title">iai_i18n:[Wm1pZcWEIGtvbnRv]</iaixsl:attribute>
              iai_i18n:[Q2hjxJkgc2tvcnp5c3RhxIcgeiBpbm55Y2ggemFwaXNhbnljaCBkYW55Y2g=]
            </a>
          </div>
        </div>
...
<template id="smile_login_verify_pin">
  <div class="smile_login --verify_pin d-flex flex-column">
    <div class="smile_login__header">
      <img src="/gfx/custom/logo_smile.png?r=1765442497" alt="smile"/>
    </div>
    <span class="smile_login__label">iai_i18n:[QsWCeXNrYXdpY3puZSB1enVwZcWCbmllbmllIGRhbnljaA==]</span>
    <span class="smile_login__text">iai_i18n:[U2tvcnp5c3RhaiB6IGLFgnlza2F3aWN6bmVnbyB1enVwZcWCbmllbmlhIGFkcmVzdSBkb3N0YXd5]</span>
    <span class="smile_login__label --small">iai_i18n:[V3Bpc3oga29k]</span>
    <span class="smile_login__text --pin_phone mb-3">iai_i18n:[V3lzxYJhbGnFm215IG5hIG51bWVy] <strong class="smile_login__pin_phone"/> iai_i18n:[Ni1jeWZyb3d5IGtvZC4gRG90cnplIGRvIENpZWJpZSB6YSBraWxrYW5hxZtjaWUgc2VrdW5k].</span>
    ...
    <a href="#change_pin_option" class="smile_login__change_pin_option mb-5 mt-2">iai_i18n:[Wm1pZcWEIG51bWVyIHRlbGVmb251]</a>
    ...
    <div class="smile_login__save_device align-items-center d-flex mb-5 pb-2">
      <div class="f-group --switch --save-device mb-0 mr-2">
        ...
        <label class="f-label" for="smile_save_device" tabindex="3">
          <iaixsl:attribute name="aria-label">
            iai_i18n:[QXV0b21hdHljem5lIGxvZ293YW5pZSBiaW9tZXRyeWN6bmU=]
          </iaixsl:attribute>
        </label>
      </div>
       <span aria-hidden="true">iai_i18n:[QXV0b21hdHljem5lIGxvZ293YW5pZSBiaW9tZXRyeWN6bmU=]</span>
    </div>

    <div class="smile_login__buttons">
      <a class="btn --solid --large d-flex justify-content-center mb-5" href="#signin">iai_i18n:[WmF0d2llcmTFuiBpIGtvbnR5bnV1ag==]</a>
    </div>
    <div class="smile_login__send_pin d-flex justify-content-center mb-md-1">
      <a href="#send_pin">iai_i18n:[V3nFm2xpaiBrb2QgcG9ub3duaWU=]</a>
    </div>
  </div>
</template>
  ...
  <template id="cop_address_template">
    <div class="cop_address">
      <h2 class="cop__title">iai_i18n:[RGFuZSBhZHJlc293ZQ==]</h2>
			...
			<iaixsl:choose>
				<iaixsl:when test="/shop/page/client-data/@operation = 'register' and /shop/action/registration_options/wholesale">
					<div class="cop_address__item --other-form --hurt">
						<span>iai_i18n:[SmVzdGXFmyBodXJ0b3duaWtpZW0/IFNrb3J6eXN0YWogeg==]</span> <a>
							<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/registration_options/wholesale/@registration_url"/></iaixsl:attribute>
							<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IHByemVqxZvEhyBkbyBmb3JtdWxhcnphIHJlamVzdHJhY2ppIGRsYSBodXJ0b3duaWvDs3c=]</iaixsl:attribute>
							iai_i18n:[Zm9ybXVsYXJ6YSByZWplc3RyYWNqaSBkbGEgaHVydG93bmlrw7N3]
						</a>
				...
				<iaixsl:when test="/shop/page/client-data/@operation = 'register-wholesale-add' and /shop/action/registration_options/retail">
					<div class="cop_address__item --other-form --detal">
						<span>iai_i18n:[SmVzdGXFmyBrbGllbnRlbSBkZXRhbGljem55bT8gU2tvcnp5c3RhaiB6]</span> <a>
							<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/registration_options/retail/@registration_url"/></iaixsl:attribute>
							<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IHByemVqxZvEhyBkbyBmb3JtdWxhcnphIHJlamVzdHJhY2ppIGRsYSBkZXRhbGlzdMOzdw==]</iaixsl:attribute>
							iai_i18n:[dXByb3N6Y3pvbmVnbyBmb3JtdWxhcnphIHJlamVzdHJhY2pp].
						</a>
					</div>
				</iaixsl:when>
			</iaixsl:choose>
      ...
      <div class="cop_address__item --switch cop_switch">
        ...
        <span class="cop_switch__label">iai_i18n:[WmFtYXdpYXN6IGpha28=]:</span>
      ...
      <div class="cop_address__item --client-data cop_client_data f-group">
          ...
          <iaixsl:otherwise>
            <div class="cop_client_data__item --country f-feedback">
              <select id="client_region" name="client_region" class="f-select" data-name="region" autocomplete="country">
                <iaixsl:attribute name="data-label">iai_i18n:[S3Jhag==]: </iaixsl:attribute>
        ...
        <iaixsl:if test="/shop/page/client-data/client_type/@active = 'y'">
          <div class="cop_client_data__item --sex f-feedback cop_sex_switch" data-firm="hide">
            ...
            <span class="cop_sex_switch__label">iai_i18n:[UMWCZcSH]:</span>
            <div class="cop_sex_switch__radio --male f-group --radio">
              ...
              <label class="f-label" for="client_sex_male">iai_i18n:[TcSZxbxjenl6bmE=]</label>
            </div>
            <div class="cop_sex_switch__radio --female f-group --radio">
              ...
              <label class="f-label" for="client_sex_female">iai_i18n:[S29iaWV0YQ==]</label>
            </div>
          </div>
        </iaixsl:if>
        ...
        <iaixsl:if test="/shop/page/client-data/birth_date/@active != 'hide'">
          <div class="cop_client_data__item --birthdate f-feedback" data-firm="hide">
            ...
            <label for="birth_date" class="f-label">iai_i18n:[RGF0YSB1cm9kemVuaWE=]</label>
        ...
        <iaixsl:for-each select="/shop/page/options/countries/country[provinces/province]">
          ...
          <div class="cop_client_data__item --province f-feedback --hidden">
            ...
            <select name="client_province" class="f-select --validate" data-name="province" autocomplete="address-level1">
              <iaixsl:attribute name="data-label"><iaixsl:for-each select="province_types/type"><iaixsl:choose><iaixsl:when test="text() = 'state'">iai_i18n:[U3Rhbg==]</iaixsl:when><iaixsl:when test="text() = 'province'">iai_i18n:[UHJvd2luY2ph]</iaixsl:when><iaixsl:when test="text() = 'territory'">iai_i18n:[VGVyeXRvcml1bQ==]</iaixsl:when><iaixsl:otherwise>iai_i18n:[UmVnaW9u]</iaixsl:otherwise></iaixsl:choose><iaixsl:if test="not(position() = last())">/</iaixsl:if></iaixsl:for-each>:</iaixsl:attribute>
              ...
              <iaixsl:if test="not(provinces/province/@id = /shop/page/client-data/invoice_data/@province or provinces/province/@selected)">
                ...
                <option>iai_i18n:[V3liaWVyeg==]<iaixsl:choose><iaixsl:when test="province_types/type/text() = 'state'"> iai_i18n:[c3Rhbg==]</iaixsl:when><iaixsl:when test="province_types/type/text() = 'province'"> iai_i18n:[cHJvd2luY2rEmQ==]</iaixsl:when><iaixsl:when test="province_types/type/text() = 'territory'"> iai_i18n:[dGVyeXRvcml1bQ==]</iaixsl:when><iaixsl:otherwise> iai_i18n:[cmVnaW9u]</iaixsl:otherwise></iaixsl:choose></option>
              </iaixsl:if>
      ...
      <iaixsl:if test="/shop/page/client-data/delivery_data/@use != 'hide'">
        <div class="cop_address__item --address-switch f-group --checkbox">
          ...
          <label class="f-label" for="deliver_to_another_address">iai_i18n:[V3lzecWCa2EgbmEgaW5ueSBhZHJlcw==] <span class="cop__title_desc">iai_i18n:[T3Bjam9uYWxuaWU=]</span></label>
        </div>
        ...
        <div class="cop_address__item --address-data cop_address_data f-group --hidden">
          ...
          <iaixsl:if test="count(/shop/page/client-data/addresses-list/address) &gt; 1">
            <div class="cop_address_data__item --addresses cop_addresses">
              <a href="#selectAddress" class="cop_addresses__select btn --solid --icon-right icon-reorder">
                ...
                iai_i18n:[V3liaWVyeiB6IGxpc3R5IGFkcmVzw7N3]
              </a>
          ...
          <div class="cop_address_data__item --firstname f-feedback">
            ...
            <label for="delivery_firstname" class="f-label">iai_i18n:[SW1pxJk=]</label>
            <div class="f-message"/>
          </div>
          ...
          <div class="cop_address_data__item --lastname f-feedback">
            ...
            <label for="delivery_lastname" class="f-label">iai_i18n:[TmF6d2lza28=]</label>
          ...
          <div class="cop_address_data__item --firm f-feedback">
            ...
            <label for="delivery_additional" class="f-label">iai_i18n:[TmF6d2EgZmlybXk=]</label>
          ...
          <div class="cop_address_data__item --street f-feedback">
            ...
            <label for="delivery_street" class="f-label">iai_i18n:[VWxpY2E=]</label>
          ...
          <div class="cop_address_data__item --street-number f-feedback">
            ...
            <label for="delivery_street_number" class="f-label">iai_i18n:[TnIgZG9tdSAvIGxva2FsdQ==]</label>
          ...
          <div class="cop_address_data__item --zipcode f-feedback">
            ...
            <label for="delivery_zipcode" class="f-label">iai_i18n:[S29kIHBvY3p0b3d5]</label>
          ...
          <div class="cop_address_data__item --city f-feedback">
            ...
            <label for="delivery_city" class="f-label">iai_i18n:[TWllanNjb3dvxZvEhw==]</label>
          ...
          <div class="cop_address_data__item --phone f-feedback">
            ...
            <label for="delivery_phone" class="f-label">iai_i18n:[VGVsZWZvbg==]</label>
             
            <div class="f-message"/>
            <div class="f-description">
              iai_i18n:[TmEgcG90cnplYnkgcmVhbGl6YWNqaSBkb3N0YXd5IHByemV6IGt1cmllcmE=]
            </div>
          </div>
        </div>
      </iaixsl:if>
      ...
      <iaixsl:if test="/shop/page/client-data/payer_data/@use != 'hide'">
        <div class="cop_address__item --invoice-switch f-group --checkbox">
          ...
          <label class="f-label" for="invoice_for_another_address">iai_i18n:[RmFrdHVyYSBuYSBpbm5lIGRhbmU=] <span class="cop__title_desc">iai_i18n:[T3Bjam9uYWxuaWU=]</span></label>
        </div>
        ...
        <div class="cop_address__item --invoice-data cop_invoice_data f-group --hidden">
          ...
          <div class="cop_invoice_data__item --firm f-feedback">
            ...
            <label for="invoice_firm" class="f-label">iai_i18n:[TmF6d2EgZmlybXk=]</label>
          ...
          <iaixsl:if test="/shop/page/client-data/nip/@active != 'hide'">
            <div class="cop_invoice_data__item --nip f-feedback">
              ...
              <label for="invoice_nip" class="f-label">iai_i18n:[TklQ]</label>
          ...
          <div class="cop_invoice_data__item --firstname f-feedback">
            ...
            <label for="invoice_firstname" class="f-label">iai_i18n:[SW1pxJk=]</label>
          ...
          <div class="cop_invoice_data__item --lastname f-feedback">
            ...
            <label for="invoice_lastname" class="f-label">iai_i18n:[TmF6d2lza28=]</label>
          ...
          <div class="cop_invoice_data__item --street f-feedback">
            ...
            <label for="invoice_street" class="f-label">iai_i18n:[VWxpY2E=]</label>
          ...
          <div class="cop_invoice_data__item --street-number f-feedback">
            ...
            <label for="invoice_street_number" class="f-label">iai_i18n:[TnIgZG9tdSAvIGxva2FsdQ==]</label>
          ...
          <div class="cop_invoice_data__item --zipcode f-feedback">
            ...
            <label for="invoice_zipcode" class="f-label">iai_i18n:[S29kIHBvY3p0b3d5]</label>
          ...
          <div class="cop_invoice_data__item --city f-feedback">
            ...
            <label for="invoice_city" class="f-label">iai_i18n:[TWllanNjb3dvxZvEhw==]</label>
  ...
  <template id="cop_street_number_template">
    <div class="cop_street_number">
      <img src="/gfx/custom/streetNumber.svg?r=1765442497" alt="streetNumber"/>
      <strong>iai_i18n:[TmllIHV6dXBlxYJuacWCZcWbIG51bWVyIGRvbXUgLyBsb2thbHU=]</strong>
      <span>iai_i18n:[Q3p5IHRhayBtYSBiecSHPyBQYW1pxJl0YWosIMW8ZSBiZXogcG9kYW5pYSBudW1lcnUgcHJ6ZXN5xYJrYSBtb8W8ZSBuaWUgZG9qxZvEhw==].</span>
      <a class="cop_street_number__close btn --solid --large" href="#streetNumberShowClose">
        <iaixsl:attribute name="title">iai_i18n:[S29udHludXVqxJksIGJleiBwb2Rhd2FuaWEgbnVtZXJ1]</iaixsl:attribute>
        iai_i18n:[S29udHludXVqxJksIGJleiBwb2Rhd2FuaWEgbnVtZXJ1]
      </a>
      <a class="cop_street_number__focus btn" href="#streetNumberShowFocus">
        <iaixsl:attribute name="title">iai_i18n:[Q2hjxJkgcG9kYcSHIG51bWVy]</iaixsl:attribute>
        iai_i18n:[Q2hjxJkgcG9kYcSHIG51bWVy]
      </a>
    </div>
  </template>
	<template id="cop_addresses_address_wrapper">
		<div class="cop_address_data__item --addresses cop_addresses">
			<a href="#selectAddress" class="cop_addresses__select btn --solid --icon-right icon-reorder" tabindex="-1">iai_i18n:[V3liaWVyeiB6IGxpc3R5IGFkcmVzw7N3]</a>
			<div class="cop_addresses__wrapper"/>
		</div>
	</template>
  ...
  <template id="cop_clause_item_template">
	...
	<template id="cop_payments_template">
		<div class="cop_payments">
			<h2 class="cop__title">iai_i18n:[UMWCYXRub8WbxIc=]</h2>
			<div class="cop_payments__clause_top"/>
			<div class="cop_payments__wrapper"/>
			<div class="cop_payments__change">
				<a href="changeSelectedPayment" class="cop_payments__change_link">iai_i18n:[Wm1pZcWE]</a>
			</div>
			<div class="cop_payments__association --hidden">
				<span>iai_i18n:[UMWCYXRub8WbxIcgeiBwb3ppb211IGtvbnRhIG9yZ2FuaXphY2ppIHogb2Rwb3dpZWRuaW1pIHVwcmF3bmllbmlhbWk=]</span>
			</div>
		</div>
	</template>
  <template id="cop_payments_item">
    <div class="cop_payments__item f-group --radio">
      ...
      <a href="selectPayment" class="sr-only cop_payments__select_payment">iai_i18n:[V3liaWVyeiB0xJkgbWV0b2TEmSBwxYJhdG5vxZtjaQ==]</a>
      <a href="changePayment" class="sr-only cop_payments__change_payment" tabindex="-1" aria-hidden="true">iai_i18n:[Wm1pZcWEIG1ldG9kxJkgcMWCYXRub8WbY2k=]</a>
  ...
  <template id="cop_payments_details">
    ...
    <span class="cop_payments__popular">
      iai_i18n:[TmFqY3rEmcWbY2llaiB3eWJpZXJhbmU=]:
    </span>
    <div class="cop_payments__options"/>
    <a href="#showAllPaymentMethods" class="cop_payments__show_all" tabindex="-1">iai_i18n:[UG9rYcW8IHdzenlzdGtpZQ==]</a>
  </template>
  <template id="cop_payments_option">
    <div class="cop_payments__option" aria-hidden="true">
      ...
      <a href="selectPayment" class="sr-only cop_payments__select_payment" tabindex="-1">iai_i18n:[V3liaWVyeiB0xJkgbWV0b2TEmSBwxYJhdG5vxZtjaQ==]</a>
      <a href="changePayment" class="sr-only cop_payments__change_payment" tabindex="-1" aria-hidden="true">iai_i18n:[Wm1pZcWEIG1ldG9kxJkgcMWCYXRub8WbY2k=]</a>
    </div>
  </template>
  <template id="cop_giftcard_template">
    <div class="cop_giftcard">
      <h5 class="cop__title --small">iai_i18n:[S2FydGEgcG9kYXJ1bmtvd2E=]</h5>
      <div class="cop_giftcard__inputs f-group">
        <div class="cop_giftcard__item --giftcard_numer f-feedback">
          ...
          <label for="cop_giftcard_id" class="f-label">iai_i18n:[TnVtZXI=]</label>
          <div class="f-message"/>
        </div>
      ...
      <div class="cop_giftcard__buttons">
        <button type="button" class="cop_giftcard__button --submit btn --solid --medium">iai_i18n:[WmF0d2llcmTFuiBrYXJ0xJk=]</button>
      </div>
    </div>
  </template>
  ...
  <template id="cop_voucher_template">
    <div class="cop_voucher">
      <h5 class="cop__title --small">iai_i18n:[Qm9uIHRvd2Fyb3d5]</h5>
      <div class="cop_voucher__inputs f-group">
        <div class="cop_voucher__item --voucher_numer f-feedback">
          ...
          <label for="cop_voucher_id" class="f-label">iai_i18n:[TnVtZXI=]</label>
          <div class="f-message"/>
        </div>
      </div>
      <div class="cop_voucher__buttons">
        <button type="button" class="cop_voucher__button --submit btn --solid --medium">iai_i18n:[WmF0d2llcmTFuiBib24=]</button>
        <small class="cop_voucher__info">iai_i18n:[SmXFvGVsaSBwb3NpYWRhc3ogd2nEmWNlaiBib27Ds3csIG1vxbxlc3ogd3Bpc2HEhyBpY2ggbnVtZXJ5IHByenkgcG9kc3Vtb3dhbml1IHphbcOzd2llbmlh].</small>
      </div>
    </div>
  </template>
	...
	<template id="cop_deliveries_template">
		<div class="cop_deliveries">
			<h2 class="cop__title">iai_i18n:[RG9zdGF3YQ==]</h2>
		</div>
	</template>
		...
		<div class="cop_deliveries__item cop_delivery f-group --radio" aria-hidden="true">
			...
			<label class="f-label cop_delivery__label">
				...
				<span class="cop_delivery__names">
					...
					<span class="cop_delivery__time">
						<span class="cop_delivery__time_label">iai_i18n:[UHJ6ZXdpZHl3YW5hIGRvc3Rhd2E=] - </span>
						<strong class="cop_delivery__time_value"/>
					</span>
					<span class="cop_delivery__minworth">
						<span class="cop_delivery__minworth_label">iai_i18n:[Rm9ybWEgZG9zdGF3eSBkb3N0xJlwbmEgb2Q=] </span>
						<span class="cop_delivery__minworth_value"/>
					</span>
					<span class="cop_delivery__select_day">iai_i18n:[V3liaWVyeiBkemllxYQgZG9zdGF3eQ==]</span>
					<span class="cop_delivery__comment"/>
					<span class="cop_delivery__pickup">
						<a class="cop_delivery__pickup_find btn --solid" href="#findYourNearestPickupPoint" tabindex="-1">iai_i18n:[Wm5hamTFuiBuYWpibGnFvHN6eSBwdW5rdCBvZGJpb3J1]</a>
              ...
              <input type="hidden" name="pickup_point" class="cop_delivery__pickup_input" disabled="disabled" tabindex="-1"/>
							...
							<div class="cop_delivery__client_courier_number">
								...
								<span class="cop_delivery__client_courier_number_label">iai_i18n:[TnIga2xpZW50YSB3IHN5c3RlbWllIGt1cmllcmE=]: </span>
								<strong class="cop_delivery__client_courier_number_value"/>
							</div>
							<a class="cop_delivery__pickup_other btn --outline" href="#chooseAnotherPickupPoint" tabindex="-1">iai_i18n:[V3liaWVyeiBpbm55IHB1bmt0]</a>
						</span>
					</span>
				</span>
			...
			<div class="cop_delivery__calendar">
				<div class="cop_delivery__calendar_days">
					...
					<span class="cop_delivery__calendar_label">iai_i18n:[V3liaWVyeiBwcmVmZXJvd2FueSBkemllxYQgZG9zdGF3eQ==]:</span>
					<div class="cop_delivery__dates">
						<div class="cop_delivery__date --other">
							<a class="cop_delivery__other_link" href="#chooseAnotherDay" tabindex="-1">iai_i18n:[SW5ueSBkemllxYQ=]</a>
							<div class="cop_delivery__datepicker vanilla-calendar"/>
						</div>
					</div>
				</div>
				<div class="cop_delivery__calendar_hours">
					<span class="cop_delivery__calendar_label">iai_i18n:[V3liaWVyeiBjemFzIGRvc3Rhd3k=]:</span>
				...
				<div class="cop_delivery__calendar_services">
					<span class="cop_delivery__calendar_label">iai_i18n:[V3liaWVyeiBkb2RhdGtvd8SFIHVzxYJ1Z8SZ]:</span>
					<div class="cop_delivery__services_wrapper"/>
				</div>
			</div>
			<a href="selectDelivery" class="sr-only cop_deliveries__select_delivery" tabindex="-1">iai_i18n:[V3liaWVyeiB0xJkgZm9ybcSZIGRvc3Rhd3k=]</a>
			<a href="changeDelivery" class="sr-only cop_deliveries__change_delivery" aria-hidden="true" tabindex="-1">iai_i18n:[Wm1pZcWEIGZvcm3EmSBkb3N0YXd5]</a>
		</div>
	</template>
	...
	<template id="cop_deliveries_block">
		<div class="cop_deliveries__block">
			...
			<div class="cop_deliveries__change">
				<a href="changeSelectedDelivery" class="cop_deliveries__change_link">iai_i18n:[Wm1pZcWE]</a>
			</div>
		</div>
	</template>
	<template id="cop_deliveries_non_standardized">
		<div class="cop_deliveries__non_standardized">
			...
			<div class="menu_messages_warning">
				<p>iai_i18n:[], <a href="/contact.php" target="_blank">iai_i18n:[c2tvbnRha3R1aiBzacSZIHogbmFtaQ==]</a> iai_i18n:[dyBjZWx1IHV6eXNrYW5pYSBiYXJkemllaiBzemN6ZWfDs8WCb3d5Y2ggaW5mb3JtYWNqaSBuYSB0ZW1hdCBrb3N6dHUgZG9zdGF3eSBsdWIgbW/FvGxpd2/Fm2NpIHrFgm/FvGVuaWEgemFtw7N3aWVuaWEgaW5keXdpZHVhbG5pZQ==].</p>
			</div>
		</div>
	</template>
  ...
  <template id="cop_documents_template">
    <div class="cop_documents">
      <h2 class="cop__title">iai_i18n:[RG9rdW1lbnR5IHpha3Vwb3dl]</h2>
      <div class="cop_documents__block">
                ...
                <option value="{@value}">
                  ...
                  <iaixsl:choose>
                    <iaixsl:when test="@type = 'confirmation'">
                      iai_i18n:[UG90d2llcmR6ZW5pZSB6YWt1cHU=]
                    </iaixsl:when>
                    <iaixsl:when test="@type = 'invoice'">
                      iai_i18n:[RmFrdHVyYSBkcnVrb3dhbmE=]
                    </iaixsl:when>
                    <iaixsl:when test="@type = 'e-invoice'">
                      iai_i18n:[RmFrdHVyYSB3IG1haWx1IGkgbmEga29uY2llIGtsaWVudGE=]
                    </iaixsl:when>
                    <iaixsl:when test="@type = 'receipt'">
                      iai_i18n:[UmFjaHVuZWs=]
                    </iaixsl:when>
                  </iaixsl:choose>
                </option>
              </iaixsl:for-each>
        ...
        <div class="cop_documents__descriptions">
          ...
          <p class="cop_documents__description --e-invoice">iai_i18n:[U2tsZXAgd3lzdGF3aWEgZmFrdHVyeSB3IHdlcnNqaSBlbGVrdHJvbmljem5laiwga3TDs3JlIGRvc3TEmXBuZSBzxIUgdyBtYWlsYWNoIG9yYXogbmEga29uY2llIGtsaWVudGEgdyBzemN6ZWfDs8WCYWNoIHphbcOzd2llbmlh].</p>
        </div>
      </div>
    </div>
  </template>
	...
	<template id="cop_division_template">
		<div class="cop_division">
			<h3 class="cop_division__label cop__title --small">iai_i18n:[Wm1pZW5pxYJlxZsgb3BjasSZIHd5c3nFgmtpIHphbcOzd2llbmlh]</h3>
			<div class="cop_division__wrapper">
			  <span class="cop_division__icon" aria-hidden="true"/>
				<p class="cop_division__text --on">iai_i18n:[VHdvamUgemFtw7N3aWVuaWUgZG90cnplIGRvIENpZWJpZSB3IDIgcHJ6ZXN5xYJrYWNoLiBQcm9kdWt0eSBkb3N0xJlwbmUgb2QgcsSZa2kgc2tsZXAgd3nFm2xlIG9kIHJhenUgKHByemVzecWCa2EgMSB6IDIpLCBhIGlubmUgcG8gaWNoIHNrb21wbGV0b3dhbml1IChwcnplc3nFgmthIDIgeiAyKQ==]. <a href="#changeDivision" class="cop_division__change --on">iai_i18n:[Wm1pZcWE]</a></p>
				<p class="cop_division__text --off">iai_i18n:[WmFtw7N3aWVuaWUgZG90cnplIGRvIENpZWJpZSBww7PFum5pZWogdyBqZWRuZWogcHJ6ZXN5xYJjZSwgcG8gc2tvbXBsZXRvd2FuaXUgcHJ6ZXogc2tsZXAgd3N6eXN0a2ljaCBwcm9kdWt0w7N3IHoga29zenlrYQ==]. <a href="#changeDivision" class="cop_division__change --off">iai_i18n:[UG9kemllbCB6YW3Ds3dpZW5pZQ==]</a></p>
			</div>
				...
				<div class="cop_division__items">
					<div class="cop_division__item --on f-group --radio">
						...
						<label class="f-label" for="cop_division_turn_on">
							<b>iai_i18n:[Q2hjxJksIGFieSBza2xlcCB3eXPFgmHFgiBzenliY2llaiBwcm9kdWt0eSBkb3N0xJlwbmUgb2QgcsSZa2k=]</b>
							(iai_i18n:[emFtw7N3aWVuaWUgZG90cnplIHcgMiBwcnplc3nFgmthY2g=])
						</label>
					</div>
					<div class="cop_division__item --off f-group --radio">
						...
						<label class="f-label" for="cop_division_turn_off">
							<b>iai_i18n:[UG9jemVrYW0gbmEgc2tvbXBsZXRvd2FuaWUgemFtw7N3aWVuaWE=]</b>
							(iai_i18n:[emFtw7N3aWVuaWUgZG90cnplIHDDs8W6bmllaiB3IGplZG5laiBwcnplc3nFgmNl])
						</label>
					</div>
				</div>
				<div class="cop_division__hide">
					<a href="#hideSelection" class="cop_division__hide_link" tabindex="-1">iai_i18n:[WndpxYQ=]</a>
				</div>
			</div>
			<div class="cop_division__confirmation">
				<h5 class="cop_division__confirmation_label cop__title --small">iai_i18n:[Wm1pZW5pYXN6IG9wY2rEmSB3eXN5xYJraSB6YW3Ds3dpZW5pYQ==]</h5>
				<div class="cop_division__confirmation_info">
					<p class="cop_division__confirmation_text --on">iai_i18n:[WmFtw7N3aWVuaWUgZG90cnplIGRvIENpZWJpZSBww7PFum5pZWogdyBqZWRuZWogcHJ6ZXN5xYJjZSwgcG8gc2tvbXBsZXRvd2FuaXUgcHJ6ZXogc2tsZXAgd3N6eXN0a2ljaCBwcm9kdWt0w7N3IHoga29zenlrYQ==]</p>
					<p class="cop_division__confirmation_text --off">iai_i18n:[VHdvamUgemFtw7N3aWVuaWUgZG90cnplIGRvIENpZWJpZSB3IDIgcHJ6ZXN5xYJrYWNoLiBQcm9kdWt0eSBkb3N0xJlwbmUgb2QgcsSZa2kgc2tsZXAgd3nFm2xlIG9kIHJhenUgKHByemVzecWCa2EgMSB6IDIpLCBhIGlubmUgcG8gaWNoIHNrb21wbGV0b3dhbml1IChwcnplc3nFgmthIDIgeiAyKQ==]</p>
				</div>
				<div class="cop_division__confirmation_buttons">
					<a href="#cancel" class="cop_division__confirmation_button --cancel btn --outline --large">iai_i18n:[QW51bHVq]</a>
					<a href="#confirm" class="cop_division__confirmation_button --confirm btn --solid --large">iai_i18n:[UG90d2llcmTFug==]</a>
				</div>
			</div>
		</div>
	</template>
  ...
  <template id="cop_pickup_points_template">
    <div class="cop_pickup_points --search">
			<h2 class="cop__title">iai_i18n:[T2RiacOzciB3IHB1bmtjaWU=]</h2>
      <div class="cop_pickup_points__wrapper">
        ...
        <div class="cop_pickup_points__filters cop_pickup_filters">
          <div class="cop_pickup_filters__sub --deliveries">
            <strong class="cop_pickup_filters__name">iai_i18n:[UHVua3R5IG9kYmlvcnU=]</strong>
          </div>
          <div class="cop_pickup_filters__sub --submit">
            <a class="cop_pickup_filters__submit btn --solid --large" href="#filtersPoints">iai_i18n:[WmFzdG9zdWogZmlsdHJvd2FuaWU=]</a>
          </div>
        </div>
        ...
        <div class="cop_pickup_points__items cop_pickup_items">
          ...
          <div class="cop_pickup_items__message menu_messages_message">iai_i18n:[QnJhayBwdW5rdMOzdyBvZGJpb3J1LCBzcHJhd2TFuiBpbm55IGFkcmVz]</div>
        </div>
        <div class="cop_pickup_points__map cop_pickup_map">
          <div class="cop_pickup_map__area">
            <a href="#searchHere" class="cop_pickup_map__area_button btn --solid --secondary --outline --icon-left icon-search --gps" tabindex="0">iai_i18n:[VcW8eWogbG9rYWxpemFjamk=]</a>
            <a href="#searchHere" class="cop_pickup_map__area_button btn --solid --secondary --outline --icon-left icon-search --area" tabindex="0">iai_i18n:[U3p1a2FqIHcgdHltIG9ic3phcnpl]</a>
          </div>
  ...
  <template id="cop_pickup_points_item_template">
    <div class="cop_pickup_items__item cop_pickup_item">
      ...
      <div class="cop_pickup_item__choose">
        ...
        <a href="#selectThisPoint" class="cop_pickup_item__choose_link" tabindex="0"><iaixsl:attribute name="aria-label">iai_i18n:[V3liaWVyeiBwdW5rdCBvZGJpb3J1]</iaixsl:attribute></a>
      </div>
  ...
  <template id="cop_pickup_points_marker_template">
      ...
      <div class="cop_pickup_marker__details">
        <strong class="cop_pickup_marker__name"/>
			...
			<div class="cop_pickup_marker__choose">
				<a href="#selectThisPoint" tabindex="0" class="cop_pickup_marker__choose_link btn --solid --large --secondary">iai_i18n:[V3liaWVyeiB0ZW4gcHVua3Q=]</a>
			</div>
    </div>
  </template>
	...
	<template id="cop_products_template">
		<div class="cop_products">
			<h3 class="cop__title --small">iai_i18n:[WmFtw7N3aW9uZSBwcm9kdWt0eQ==]<span class="cop__title_desc"/></h3>
			<div class="cop_products__division">
				<a href="divisionNow" class="cop_products__division_item --now">
					<span class="cop_products__division_label">iai_i18n:[UHJ6ZXN5xYJrYSAxIHogMg==]</span>
					<span class="cop_products__division_time"/>
				</a>
				<a href="divisionLater" class="cop_products__division_item --later">
					<span class="cop_products__division_label">iai_i18n:[UHJ6ZXN5xYJrYSAyIHogMg==]</span>
					<span class="cop_products__division_time"/>
				</a>
			</div>
			  ...
			  <span class="cop_product__badge"/>
				...
				<div class="cop_product__traits">
					<div class="cop_product__trait --barcode">
						<span class="cop_product__trait_label">iai_i18n:[U3ltYm9s]: </span>
						<span class="cop_product__trait_value"/>
					</div>
					<div class="cop_product__trait --size">
						<span class="cop_product__trait_label">iai_i18n:[Um96bWlhcg==]: </span>
						<span class="cop_product__trait_value"/>
					</div>
					...
					<div class="cop_product__trait --subscription-period">
						<span class="cop_product__trait_label">iai_i18n:[V3lzecWCa2EgY28=]: </span>
						<span class="cop_product__trait_value"/>
					</div>
					<div class="cop_product__trait --subscription-next">
						<span class="cop_product__trait_label">iai_i18n:[S29sZWpuYSBkb3N0YXdh]: </span>
						<span class="cop_product__trait_value"/>
					</div>
				</div>
	...
	<template id="cop_remarks_template">
		<div class="cop_remarks">
			<h3 class="cop__title">iai_i18n:[VXdhZ2kgZG8gemFtw7N3aWVuaWE=]<span class="cop__title_desc">iai_i18n:[T3Bjam9uYWxuaWU=]</span></h3>
			<div class="cop_remarks__block">
				<div class="cop_remarks__item --shop">
					...
					<div class="cop_remarks__textarea_wrapper f-group --textarea" aria-hidden="true">
						...
						<button type="button" class="cop_remarks__save btn --solid --outline --large" tabindex="-1">iai_i18n:[WmFwaXN6IHdpYWRvbW/Fm8SH]</button>
					</div>
					<div class="cop_remarks__message_wrapper" aria-hidden="true">
						<strong class="cop_remarks__text"/>
						<div class="cop_remarks__links">
							<a href="#editRemarkMessage" class="cop_remarks__link --edit" tabindex="-1">iai_i18n:[RWR5dHVq]</a>
							<a href="#removeRemarkMessage" class="cop_remarks__link --remove" tabindex="-1">iai_i18n:[VXN1xYQ=]</a>
						</div>
					</div>
				</div>
...
<iaixsl:choose>
	...
	<script src="/gfx/translatable/envelope.js.gzip?r=1765442856"></script><script src="/gfx/translatable/menu_suggested_shop_for_language.js.gzip?r=1765442856"></script><script src="/gfx/translatable/menu_basket.js.gzip?r=1765442856"></script><script src="/gfx/translatable/hotspots_javascript.js.gzip?r=1765442856"></script><script src="/gfx/translatable/hotspots_slider.js.gzip?r=1765442856"></script><script src="/gfx/translatable/hotspots_add_to_basket.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_place-order.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_literals.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_signin.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_registration.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_client.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_smile_login.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_address.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_rebate_code.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_summary.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_payments.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_deliveries.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_documents.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_division.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_pickup.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_products.js.gzip?r=1765442856"></script><script src="/gfx/translatable/cop_modules_remarks.js.gzip?r=1765442856"></script>
