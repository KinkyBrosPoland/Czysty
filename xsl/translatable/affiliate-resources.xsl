...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (affiliate_resources_form, 60dd8e84b52373.86599897.4)-->
  <iaixsl:if test="page/resources">
    <h1 class="headline">
      <span class="headline__name">
        iai_i18n:[VHdvamUgxZtyb2RraSBkbyB3eWtvcnp5c3Rhbmlh]
      </span>
    </h1>
    <iaixsl:choose>
      <iaixsl:when test="not((0 &gt; page/payments/@total) or (page/payments/@total = '0.00'))">
        <section class="affiliate --resources --withdraw mb-4">
          <div class="affiliate__desc mb-4">
            iai_i18n:[U3RhbiBUd29qZWdvIGtvbnRhIHBhcnRuZXJza2llZ28gd3lub3Np]:
            <ol class="pl-5">
              <li>
                iai_i18n:[Y2HFgmtvd2l0eSBzdGFuIGtvbnRh]: 
                <strong><iaixsl:value-of select="page/payments/@total_formatted"/></strong>
              </li>
              <li>
                iai_i18n:[xYLEhWN6bmEga3dvdGEgcG9tbmllanN6b255Y2ggcHJvd2l6amkgeiBwb3dvZHUgendyb3TDs3cgcHJvZHVrdMOzdw==]: 
                <strong><iaixsl:value-of select="page/payments/@returns_formatted"/></strong>
              </li>
            </ol>
            <iaixsl:if test="page/client/@loyalty_points = 'true'">
              iai_i18n:[UHJvd2l6amEgemEgemFtw7N3aWVuaWEgcG96eXNrYW55Y2gga2xpZW50w7N3IGplc3Qgd3lwxYJhY2FuYSB3IGZvcm1pZSBwdW5rdMOzdyBuYSBUd29qZQ==] <a href="/affiliate-main.php">iai_i18n:[c2FsZG8gdyBwcm9ncmFtaWUgbG9qYWxub8WbY2lvd3lt]</a>
            </iaixsl:if>
            iai_i18n:[SmXFm2xpIGNoY2VzeiB6YW1pZW5pxIcgemdyb21hZHpvbmUgxZtyb2RraSBuYSBib24gdG93YXJvd3ksIHdwaXN6IHcgcG9uacW8c3plIHBvbGEga3dvdMSZIG5pZSBtbmllanN6xIUgbmnFvA==]  
            <iaixsl:value-of select="page/shop/@minpayment"/><iaixsl:value-of select="/shop/currency/@name"/>
             iai_i18n:[aSBuaWUgd2nEmWtzesSFIG5pxbwgxZtyb2RraSB6Z3JvbWFkem9uZSBuYSBUd29pbSBrb25jaWUsIGEgbmFzdMSZcG5pZSBrbGlrbmlqIHByenljaXNrICJaZ8WCb8WbIGNoxJnEhyB3eXDFgmF0eQ==]&quot;.
          </div>
          <form class="d-flex flex-column align-items-center justify-content-center p-4 bg_alter" method="post">
            <div class="d-flex align-items-center f-group">
              iai_i18n:[S3dvdGEgZG8gd3lwxYJhdHk=] 
              <input class="affiliate__input --amount f-control mx-1" type="number" name="amount" value="0">
                ...
                <iaixsl:attribute name="data-min"><iaixsl:value-of select="page/shop/@minpayment"/></iaixsl:attribute>
								<iaixsl:attribute name="aria-label">iai_i18n:[V3Bpc3ogcGXFgm7EhSBrd290xJk=]</iaixsl:attribute>
              </input>
              ,
              <input class="affiliate__input --cent f-control mx-1" type="number" name="cent" min="0" max="99" value="00" maxlength="2">
								<iaixsl:attribute name="aria-label">iai_i18n:[V3Bpc3oga3dvdMSZIHBvIHByemVjaW5rdQ==]</iaixsl:attribute>
							</input>
              <iaixsl:value-of select="/shop/currency/@name"/>
            </div>
            <iaixsl:choose>
              <iaixsl:when test="page/client/@paymenttype = 'cash'">
                <div class="f-group --radio">
                  ...
                  <label class="f-label mx-1" for="voucher">iai_i18n:[Qm9u] </label>
                  <input type="radio" name="method" class="f-control" value="cash" id="cash"/>
                  <label class="f-label mx-1" for="cash">iai_i18n:[UHJ6ZWxldw==]</label>
                </div>
              </iaixsl:when>
              <iaixsl:otherwise>
                <span class="mb-3">iai_i18n:[UG93ecW8c3phIHdhcnRvxZvEhyBixJlkemllIHd5cMWCYWNvbmEgdyBib25pZSB0b3dhcm93eW0=].</span>
              </iaixsl:otherwise>
            </iaixsl:choose>
            <button type="submit" class="affiliate__submit btn --solid --medium">
              iai_i18n:[WmfFgm/FmyBjaMSZxIcgd3lwxYJhdHk=]
            </button>
          </form>
        </section>
      </iaixsl:when>
      <iaixsl:otherwise>
        <div class="affiliate__info">
          iai_i18n:[T2JlY25pZSBuaWUgbWFzeiDFm3JvZGvDs3cga3TDs3JlIG3Ds2fFgmJ5xZsgd3lrb3J6eXN0YcSH].
        </div>
      </iaixsl:otherwise>
    </iaixsl:choose>
  </iaixsl:if>
<!-- (affiliate_resources_list, 60dd8e84da9e33.27373055.2)-->
  <iaixsl:variable name="affiliate_1">iai_i18n:[RGF0YSB3eXDFgmF0eQ==]</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">iai_i18n:[Um9kemFqIHd5cMWCYXR5]</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">iai_i18n:[TnVtZXIgYm9udQ==]</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">iai_i18n:[QWt0dWFsbmUgZG8=]</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">iai_i18n:[S3dvdGE=]</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">iai_i18n:[V3lrb3J6eXN0YW5v]</iaixsl:variable>
            ...
            <span class="status --table">
              <iaixsl:choose>
                ...
                <iaixsl:otherwise>
                  ...
                  <span>iai_i18n:[UG90d2llcmR6b25l] <small>(<iaixsl:value-of select="@status"/>)</small></span>
                </iaixsl:otherwise>
              </iaixsl:choose>
            </span>
          </span>
...
<!-- (affiliate_resources_paging, 60dd8e7f576118.87343244.5)-->
