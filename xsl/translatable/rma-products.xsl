...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
    ...
    <!-- (rma_products_list, 61f913c6f3b9d2.49558513.12)-->
	<iaixsl:if test="page/@type = 'rma_products' and page/@display = 'add'">
		<div class="step2">
			<div class="progress_bar_wrapper pb_step2 rma_progress_bar">
				...
				<div class="_step _step2" aria-current="step">
					<span>2</span>
					<p>
						<i> </i>
			...
			<div class="progress__item --rma --second --active d-md-none py-3">
				...
				<div class="progress__text">
					<strong class="progress__name">iai_i18n:[V3liaWVyeiBwcm9kdWt0eSBkbyByZWtsYW1hY2pp]</strong>
				</div>
			</div>

			<h1 class="big_label return_label d-none d-md-block" id="return_label">iai_i18n:[V3liaWVyeiB0b3dhcnkgZG8gcmVrbGFtYWNqaSBpIG9waXN6IHVzdGVya8SZ]</h1>

			<iaixsl:variable name="return_with_special_offer">iai_i18n:[].</iaixsl:variable>
			...
			<iaixsl:if test="page/products">
				...
				<form class="returns_productslist" action="/rma-method.php?type=multiproduct" method="post" aria-labelledby="return_label">
								...
								<div class="rma__name --name">
									<iaixsl:choose>
										<iaixsl:when test="page/@type = 'rma_products'">
											iai_i18n:[VG93YXJ5IHogemFtw7N3aWVuaWE=]
										</iaixsl:when>
										<iaixsl:otherwise>
											iai_i18n:[UHJvZHVrdA==]
										</iaixsl:otherwise>
							...
							<iaixsl:for-each select="page/products/product">
								...
								<div class="rma__row --items productslist_item">
											...
											<div class="productslist_warranty">
												...
												<iaixsl:if test="not(warranty/text() = '') and not(warranty/text() = ' ')">
													<div class="productslist_warranty_info__more orderdetails_info__more d-none d-md-flex">
														<a href="#showDescription" class="productslist_warranty_info__show d-none d-md-flex">iai_i18n:[V2nEmWNlag==]</a>
									...
									<div class="rma__col --comment productslist_product_comment has-feedback has-required">
										<label class="rma__label">
											<iaixsl:attribute name="for">rma_comment_<iaixsl:value-of select="position()"/></iaixsl:attribute>
											iai_i18n:[T3Bpc3ogdXN0ZXJrxJk=]:
										</label>
										<textarea>
											<iaixsl:attribute name="name">comment[<iaixsl:value-of select="position()"/>]</iaixsl:attribute>
											<iaixsl:attribute name="id">rma_comment_<iaixsl:value-of select="position()"/></iaixsl:attribute>
									...
									<div class="rma__col --atachment productslist_product_attachments">
										<iaixsl:if test="not(@allowReturn='0') and not(@allowReturn='2')">
											<a href="#addComment">
												<iaixsl:attribute name="title">iai_i18n:[a2xpa25paiBhYnkgZG9kYcSHIHphxYLEhWN6bmlr]</iaixsl:attribute>
												<i class="icon-image"/>
												<span>
													<span>iai_i18n:[RG9kYWogemRqxJljaWU=]</span>
													<span>iai_i18n:[KGx1YiBpbm55IHphxYLEhWN6bmlrKQ==]</span>
												</span>
											</a>
												...
												<div class="prodl_comment_foto">
													<label>
														<iaixsl:attribute name="for">comment_photo[<iaixsl:value-of select="@id"/>][<iaixsl:value-of select="size/@type"/>][<iaixsl:choose><iaixsl:when test="additional/@hash"><iaixsl:value-of select="additional/@hash"/></iaixsl:when><iaixsl:otherwise>0</iaixsl:otherwise></iaixsl:choose>][]</iaixsl:attribute>
															<span class="fakeButton" aria-hidden="true">iai_i18n:[V3liaWVyeiBwbGlr]</span>
															...
															<span class="prodl_comment_foto__imageName" aria-hidden="true">iai_i18n:[TmllIHd5YnJhbm8gcGxpa3U=]</span>
													</label>
												</div>
												<div class="prodl_comment_button">
													<a href="#addMoreFiles" class="addMoreFiles">
														iai_i18n:[RG9kYWoga29sZWpueSB6YcWCxIVjem5paw==]</a>
												</div>
											</div>
											...
											<iaixsl:when test="@allowReturn='0'">
												<div class="productslist_product_info">
													<div class="btn-icon allowReturn_1">
														...
														<span>iai_i18n:[VGVnbyBwcm9kdWt0dSBwcmF3ZG9wb2RvYm5pZSBuaWUgbW/FvGVzeiByZWtsYW1vd2HEhy4gVyByYXppZSBwb3RyemVieSBwcm9zaW15IG8=] <a href="/contact.php">iai_i18n:[a29udGFrdA==]</a>.</span>
													</div>
												</div>
											</iaixsl:when>
											<iaixsl:when test="@allowReturn='2'">
												<div class="productslist_product_info">
													<div class="btn-icon allowReturn_2">
														<span>iai_i18n:[VXBld25paiBzacSZIGN6eSBtb8W8ZXN6IHJla2xhbW93YcSHIHRlbiBwcm9kdWt0].</span>
													</div>
												</div>
											</iaixsl:when>
										</iaixsl:choose>
										<iaixsl:if test="not(@allowReturn='0')">
											<div class="rma__label d-sm-none">iai_i18n:[SWxvxZvEhw==]:</div>
											<div>
												<iaixsl:choose>
													...
													<iaixsl:otherwise>
														<span class="productslist_quantity">
															...
															<select class="f-select">
																<iaixsl:attribute name="name">set_quantity[<iaixsl:value-of select="position()"/>]</iaixsl:attribute>
																<iaixsl:attribute name="aria-label">iai_i18n:[V3liaWVyeiBpbG/Fm8SH]</iaixsl:attribute>
																<option>
																	<iaixsl:if test="@selected_quantity = 0"/>
														...
														<iaixsl:if test="not(size/@unit_sellby = '1')">
															<div class="productslist_product_sellby_info">iai_i18n:[c3ByemVkYXdhbmUgcG8=]:
																<span class="price_sellby"><iaixsl:value-of select="size/@unit_sellby"/><iaixsl:text> </iaixsl:text>
																<span class="price_sellby_unit"><iaixsl:choose>
																	<iaixsl:when test="not(size/@ordered &gt; 1)">
																		<iaixsl:value-of select="size/@unit_singular"/>
																	</iaixsl:when>
																	<iaixsl:otherwise>
									...
									<span>
										<iaixsl:choose>
											<iaixsl:when test="@selected_quantity &gt; 0">
												iai_i18n:[WnJlenlnbnVqIHogcmVrbGFtYWNqaQ==]
											</iaixsl:when>
											<iaixsl:otherwise>
												<i class="icon-plus"/>iai_i18n:[UmVrbGFtdWogdG93YXI=]
											</iaixsl:otherwise>
										</iaixsl:choose>
									</span>
								</a>
