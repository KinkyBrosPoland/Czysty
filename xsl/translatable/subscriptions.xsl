...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
	...
	<iaixsl:if test="/shop/page/products/navigation/filtering/filter/@id='filter_instock'"> </iaixsl:if>
        ...
        <!-- (subscriptions_list, 63775d578a87c0.84408745.4)-->
		...
		<div class="subscriptions_list__header">
				...
				<span class="headline__name">
					<iaixsl:choose>
						<iaixsl:when test="/shop/page/subscriptions/@display = 'active'">
							iai_i18n:[TGlzdGEgYWt0eXdueWNoIHN1YnNrcnlwY2pp]
						</iaixsl:when>
						<iaixsl:otherwise>
							iai_i18n:[TGlzdGEgemFrb8WEY3pvbnljaCBzdWJza3J5cGNqaQ==]
						</iaixsl:otherwise>
			...
			<iaixsl:if test="(/shop/page/subscriptions/@display = 'active' and /shop/action/subscriptions_terminated/@count != 0) or (/shop/page/subscriptions/@display != 'active' and /shop/action/subscriptions_active/@count != 0) ">
				<div class="subscriptions_list__see_also">
					<span class="subscriptions_list__see_also_text">iai_i18n:[Wm9iYWN6IHRlxbw=]: </span>
					<a class="subscriptions_list__see_also_link">
						<iaixsl:choose>
							<iaixsl:when test="/shop/page/subscriptions/@display = 'active'">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_terminated/@url"/></iaixsl:attribute>iai_i18n:[TGlzdGEgemFrb8WEY3pvbnljaCBzdWJza3J5cGNqaQ==]
							</iaixsl:when>
							<iaixsl:otherwise>
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_active/@url"/></iaixsl:attribute>iai_i18n:[TGlzdGEgYWt0eXdueWNoIHN1YnNrcnlwY2pp]
							</iaixsl:otherwise>
						</iaixsl:choose>
					</a>
				</div>
				...
				<div class="subscriptions__item">
							...
							<div class="subscriptions__product">
								...
								<a class="subscriptions__product_icon">
									<iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute>
									 <iaixsl:choose>
                    <iaixsl:when test="icons/@small_second and not(icons/@small_second = '' or icons/@small_second = '/')">
                      <picture>
                        <source type="image/webp">
                          <iaixsl:attribute name="srcset"><iaixsl:value-of select="icons/@small"/></iaixsl:attribute>
                        </source>
                        <img src="/gfx/standards/loader.gif?r=1765442497" class="b-lazy">
                          <iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="@name"/></iaixsl:attribute>
                          <iaixsl:attribute name="data-src"><iaixsl:value-of disable-output-escaping="yes" select="icons/@small_second"/></iaixsl:attribute>
                        </img>
                      </picture>                    
                    </iaixsl:when>
                    <iaixsl:otherwise>
								...
								<div class="subscriptions__product_info">
									...
									<div class="subscriptions__product_details">
										<div class="subscription_settings__product_detail --quantity">
											<span class="subscription_settings__product_detail_name">iai_i18n:[SWxvxZvEhw==]:</span>
										...
										<iaixsl:if test="@symbol != ''">
											<div class="subscriptions__product_detail --symbol">
												<span class="subscriptions__product_detail_name">iai_i18n:[U3ltYm9s]:</span>
										...
										<iaixsl:if test="size/@name != '' and size/@id != 'uniw'">
											<div class="subscriptions__product_detail --size">
												<span class="subscriptions__product_detail_name">iai_i18n:[Um96bWlhcg==]:</span>
					...
					<div class="subscriptions__info">
						<div class="subscriptions__price">
							...
							<span> / iai_i18n:[Y28=] <span class="subscriptions__product_price_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="@days_in_period"/> iai_i18n:[ZG5p]</span></span>
						</div>
						<div class="subscriptions__dates">
							<div class="subscriptions__date --order">
								<span class="subscriptions__date_name">iai_i18n:[S29sZWpuYSBkb3N0YXdh]</span>
							...
							<div class="subscriptions__date --payment">
								<span class="subscriptions__date_name">iai_i18n:[RGF0YSBrb2xlam5laiBwxYJhdG5vxZtjaQ==]</span>
								<strong class="subscriptions__date_value">
									<span class="subscriptions__day_name">
										<iaixsl:choose>
					...
					<iaixsl:if test="count(products/product) &gt; $subscriptionProductsHidden">
						<a href="#moreProducts" class="subscriptions__more_products">
							<iaixsl:attribute name="data-literal">iai_i18n:[VWtyeWo=]</iaixsl:attribute>
							+<iaixsl:value-of select="count(products/product) - $subscriptionProductsHidden"/> iai_i18n:[cHJvZHVrdHkgdyBzdWJza3J5cGNqaQ==]
						</a>
					</iaixsl:if>
				</div>
			</iaixsl:for-each>
