...
<!-- (menu_messages, 60dd8e79b18501.50382803.13)-->
        ...
        <!-- (client_new_cms, 60dd8e7ac01704.75042056.9)-->
            <iaixsl:if test="page/text/body">
                <iaixsl:variable name="loginedit_cms_label">iai_i18n:[RG9kYXRrb3dlIGluZm9ybWFjamU=]</iaixsl:variable>
        ...
        <!-- (cop_modules_client-new, 686289894e23f9.47648050.6)-->
...
<iaixsl:if test="not(/shop/page/client-data/@associated = 'true')">
	<form method="POST" id="COP" class="cop --client-new" action="/client-new.php" enctype="multipart/form-data">
	  <iaixsl:if test="/shop/page/client-data/@operation = 'onceorder'">
				<iaixsl:attribute name="data-userOnceData">true</iaixsl:attribute>
			</iaixsl:if>
		<iaixsl:choose>
			<iaixsl:when test="/shop/page/client-data/@operation = 'register-wholesale-add'">
				<iaixsl:attribute name="action">/client-new.php?register&amp;wholesaler=true</iaixsl:attribute>
			</iaixsl:when>
			<iaixsl:when test="not(/shop/page/client-data/@operation = '')">
		...
		<iaixsl:if test="page/client-data/@operation = 'register-wholesale-add' or page/client-data/@operation = 'edit-wholesale-add' or page/client-data/@operation = 'edit-wholesale-edit'">
		  <iaixsl:attribute name="class">cop --client-new --wholesale</iaixsl:attribute>
		</iaixsl:if>
		<input type="hidden" name="operation">
			<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/client-data/@operation"/></iaixsl:attribute>
		</input>
		...
		<div class="cop__content">
			<iaixsl:if test="not(/shop/basket/@login) or (/shop/page/@type = 'client-new' and not(page/client-data/@operation = 'register-wholesale-add' or page/client-data/@operation = 'edit-wholesale-add' or page/client-data/@operation = 'edit-wholesale-edit'))">
				
				<div class="cop__step" data-skeleton="signin">
			...
			<iaixsl:if test="page/client-data/@operation = 'register-wholesale-add' or page/client-data/@operation = 'edit-wholesale-add' or page/client-data/@operation = 'edit-wholesale-edit'">
				...
				<div class="cop__step" data-skeleton="wholesaler">
					<div class="cop__skeleton"/>
					<div class="cop__skeleton --content"/>
				</div>
			</iaixsl:if>
      ...
      <div class="cop__step" data-skeleton="address">
        ...
        <div class="cop__skeleton --content"/>
			...
			<iaixsl:if test="(/shop/page/@type = 'place-order' and not(/shop/basket/@login)) or (/shop/page/@type = 'client-new' and (/shop/page/client-data/@edit='true' or /shop/page/client-data/@register='true'))">
				
				<div class="cop__step" data-skeleton="registration">
					<div class="cop__skeleton"/>
					<div class="cop__skeleton --content"/>
				</div>
			</iaixsl:if>
			...
			<iaixsl:if test="/shop/page/client-data/@card_discount_program_activated='true' and not(/shop/page/client-data/@associated = 'true')">
  			<div class="cop__step" data-skeleton="card">
  				<div class="cop__skeleton"/>
  				<div class="cop__skeleton --content"/>
  			</div>
			</iaixsl:if>
			
			<div class="cop__step" data-skeleton="summary">
				<div class="cop__skeleton"/>
				<div class="cop__skeleton --content"/>
			</div>
		</div>
	...
	<iaixsl:if test="page/client-data/@operation = 'register-wholesale-add' or page/client-data/@operation = 'edit-wholesale-add' or page/client-data/@operation = 'edit-wholesale-edit'">
		<template id="cop_wholesaler_template">
			<div class="cop_wholesaler">
        <h2 class="cop__title">iai_i18n:[UmVqZXN0cmFjamEgaHVydG93bmlrYQ==]</h2>
				<div class="cop_wholesaler__item --invoices cop_wholesaler_invoices">
					<span class="cop_wholesaler_invoices__label">iai_i18n:[RmFrdHVyeQ==]:</span>
					<div class="cop_wholesaler_invoices__radio --domestic f-group --radio">
						<input type="radio" name="client_vat_payer" id="invoice_type_domestic" value="k" class="f-control">
							<iaixsl:if test="/shop/page/client-data/wholesale_data/@vat_payer = 'k'">
								<iaixsl:attribute name="checked">checked</iaixsl:attribute>
							</iaixsl:if>
						</input>
						<label class="f-label" for="invoice_type_domestic">iai_i18n:[a3Jham93ZQ==]</label>
					</div>
					<div class="cop_wholesaler_invoices__radio --european f-group --radio">
						<input type="radio" name="client_vat_payer" id="invoice_type_european" value="w" class="f-control">
							<iaixsl:if test="/shop/page/client-data/wholesale_data/@vat_payer = 'w'">
								<iaixsl:attribute name="checked">checked</iaixsl:attribute>
							</iaixsl:if>
						</input>
						<label class="f-label" for="invoice_type_european">iai_i18n:[d2V3bsSFdHJ6dW5pam5l]</label>
					</div>
					<div class="cop_wholesaler_invoices__radio --export f-group --radio">
						<input type="radio" name="client_vat_payer" id="invoice_type_export" value="e" class="f-control">
							<iaixsl:if test="/shop/page/client-data/wholesale_data/@vat_payer = 'e'">
								<iaixsl:attribute name="checked">checked</iaixsl:attribute>
							</iaixsl:if>
						</input>
						<label class="f-label" for="invoice_type_export">iai_i18n:[ZWtzcG9ydG93ZQ==]</label>
					</div>
				</div>
				<div class="cop_wholesaler__item --description cop_wholesaler_description f-group --textarea">
					<textarea name="client_description" class="f-control">
						<iaixsl:attribute name="placeholder">iai_i18n:[T3BpcyBkemlhxYJhbG5vxZtjaQ==]</iaixsl:attribute>
						<iaixsl:value-of select="/shop/page/client-data/wholesale_data/@description"/>
					</textarea>
				</div>
				<div class="cop_wholesaler__item --files cop_wholesaler_files">
					<div class="cop_wholesaler_files__item --first">
						<label class="cop_wholesaler_files__label" for="client_attachment1">iai_i18n:[WmHFgsSFY3puaWsgMQ==] <small>(iai_i18n:[bWF4IDEwTUI=])</small>:</label>
						<input id="client_attachment1" class="cop_wholesaler_files__input" type="file" name="client_attachment1">
						  <iaixsl:attribute name="aria-label">iai_i18n:[RG9kYWogemHFgsSFY3puaWs=]</iaixsl:attribute>
						</input>
						<iaixsl:if test="/shop/page/client-data/wholesale_data/@file1_link">
							<a class="cop_wholesaler_files__file_link" target="_blank">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/client-data/wholesale_data/@file1_link"/></iaixsl:attribute>
								iai_i18n:[em9iYWN6]
							</a>
						</iaixsl:if>
					</div>
					<div class="cop_wholesaler_files__item --second">
						<label class="cop_wholesaler_files__label" for="client_attachment2">iai_i18n:[WmHFgsSFY3puaWsgMg==] <small>(iai_i18n:[bWF4IDEwTUI=])</small>:</label>
						<input id="client_attachment2" class="cop_wholesaler_files__input" type="file" name="client_attachment2">
						  <iaixsl:attribute name="aria-label">iai_i18n:[RG9kYWogemHFgsSFY3puaWs=]</iaixsl:attribute>
						</input>
					...
					<div class="cop_wholesaler_files__item --third">
						<label class="cop_wholesaler_files__label" for="client_attachment3">iai_i18n:[WmHFgsSFY3puaWsgMw==] <small>(iai_i18n:[bWF4IDEwTUI=])</small>:</label>
						<input id="client_attachment3" class="cop_wholesaler_files__input" type="file" name="client_attachment3">
						  <iaixsl:attribute name="aria-label">iai_i18n:[RG9kYWogemHFgsSFY3puaWs=]</iaixsl:attribute>
						</input>
  ...
  <iaixsl:if test="/shop/page/client-data/@card_discount_program_activated='true' and not(/shop/page/client-data/@associated = 'true')">
		...
		<template id="cop_rebate_card_template">
			<div class="cop_rebate_card">
				<iaixsl:variable name="isRebateCardActive"><iaixsl:choose>
					<iaixsl:when test="/shop/page/client-data/@active_card and not(/shop/page/client-data/@active_card = '')">true</iaixsl:when>
					<iaixsl:otherwise>false</iaixsl:otherwise>
				</iaixsl:choose></iaixsl:variable>

				<p class="cop_rebate_card__description"><iaixsl:choose>
					<iaixsl:when test="$isRebateCardActive = 'true'">
            iai_i18n:[TW/FvGVzeiB6bWllbmnEhyBha3R5d27EhSBrYXJ0xJkgcmFiYXRvd8SFIHdwaXN1asSFYyBub3d5IG51bWVyIHBvd3nFvGVqLiBTcHJhd2TFuiBzemN6ZWfDs8WCeSBwcnp5em5hbnljaCB6bmnFvGVrLCBwcnplZMW6IGRvIHN0cm9ueQ==] <a href="/client-rebate.php" title="Twoje rabaty">iai_i18n:[VHdvaWNoIHJhYmF0w7N3]</a>.
					</iaixsl:when>
					<iaixsl:otherwise>
            iai_i18n:[SmXFm2xpIHBvc2lhZGFzeiBuYXN6xIUgcGxhc3Rpa293xIUga2FydMSZIHJhYmF0b3fEhSB3cGlzeiBqZWogbnVtZXIuIFcgdGVuIHNwb3PDs2Igenlza2FzeiByYWJhdHkgdGFraWUsIGphayB3IG5hc3p5Y2ggdHJhZHljeWpueWNoIHNrbGVwYWNo].
					</iaixsl:otherwise>
				</iaixsl:choose></p>

				<iaixsl:if test="$isRebateCardActive = 'true'">
					<span class="cop_rebate_card__header">iai_i18n:[VHdvamEga2FydGEgcmFiYXRvd2EgamVzdCBha3R5d25hIQ==]</span>
				</iaixsl:if>

				<div class="cop_rebate_card__wrapper f-group">
					<input type="hidden" value="add" name="global_rebates_codes"/>
					<div class="cop_rebate_card__item f-feedback">
          	<span class="cop_rebate_card__icon"><i class="icon-credit-card"/></span>
						<input id="rebate_card_input" type="text" name="card_discount_code" class="f-control">
							<iaixsl:if test="$isRebateCardActive = 'true'">
								<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/client-data/@active_card"/></iaixsl:attribute>
								<iaixsl:attribute name="class">f-control focused</iaixsl:attribute>
							</iaixsl:if>
						</input>
            <label for="rebate_card_input" class="f-label">iai_i18n:[TnVtZXIga2FydHkgcmFiYXRvd2Vq]</label>
					</div>
				</div>
			</div>
		</template>
	...
	<template id="cop_summary_client_template">
		<div class="cop_summary_client">
			<div class="cop_summary_client__item --terms cop_terms">
		  
					<iaixsl:if test="(page/client-data/@operation = 'edit') and login_options/service[@connected='true']">
						<div class="cop_terms__item --service">
							<span>iai_i18n:[VHdvamUga29udG8gamVzdCBwb8WCxIVjem9uZSB6IGtvbnRlbSB3IHNlcndpc2ll] <iaixsl:value-of select="login_options/service[@connected='true']/@name"/></span><iaixsl:text> </iaixsl:text><a><iaixsl:attribute name="href"><iaixsl:value-of select="login_options/service[@connected='true']/@disconnect_url"/></iaixsl:attribute>iai_i18n:[Um96xYLEhWN6IGtvbnRv]</a>
						</div>
					</iaixsl:if>
			<iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
					<div class="cop_terms__item --vat f-group --checkbox">
						...
						<label class="f-label" for="cop_terms_vat_checkbox">iai_i18n:[SmVzdGVtIHDFgmF0bmlraWVtIFZBVCBFVS4gWmFtYXdpYW0gYmV6IFZBVCBpIHpvYm93acSFenVqxJkgc2nEmSBnbyByb3psaWN6ecSHIG5hIHRlcmVuaWUgc3dvamVnbyBrcmFqdQ==].</label>
					</div>
				</iaixsl:if>
				...
				<div class="cop_terms__item --mailing f-group --checkbox">
					<input type="checkbox" name="client_mailing" class="f-control" id="cop_terms_mailing_checkbox" value="y">
					...
					<label class="f-label" for="cop_terms_mailing_checkbox">iai_i18n:[Q2hjxJkgb3RyenlteXdhxIcgRS1tYWlsIE5ld3NsZXR0ZXIgKG1vxbxsaXdvxZvEhyBww7PFum5pZWpzemVqIHJlenlnbmFjamkp].</label>
				</div>
				<iaixsl:if test="/shop/page/client-data/contact_data/@send_sms">
					<div class="cop_terms__item --sms f-group --checkbox">
						<input type="checkbox" name="client_send_sms" class="f-control" id="cop_terms_sms_checkbox" value="y">
						...
						<label class="f-label" for="cop_terms_sms_checkbox">iai_i18n:[Q2hjxJkgb3RyenlteXdhxIcgU01TIE5ld3NsZXR0ZXIgKG1vxbxsaXdvxZvEhyBww7PFum5pZWpzemVqIHJlenlnbmFjamkp].</label>
					</div>
				</iaixsl:if>
			</div>
			<div class="cop_summary_client__item --buttons cop_buttons">
				<button type="submit" class="cop_buttons__button btn --solid --large --submit"><iaixsl:choose>
					<iaixsl:when test="/shop/page/client-data/@edit = 'true'">
						iai_i18n:[WmFwaXN6IHptaWFueQ==]
					</iaixsl:when>
					<iaixsl:when test="/shop/page/client-data/@register = 'true'">
						iai_i18n:[WmFyZWplc3RydWoga29udG8=]
					</iaixsl:when>
					<iaixsl:otherwise>
						iai_i18n:[UHJ6ZWpkxbogZGFsZWo=]
					</iaixsl:otherwise>
				</iaixsl:choose></button>
			</div>
		</div>
	</template>
	
		<iaixsl:if test="/shop/page/client-data/delivery_data/@use='hide'"/>
		<iaixsl:if test="/shop/page/client-data/allow_change_company_data"/>
		<iaixsl:if test="/shop/page/communicates/warning/@type='illegal_characters_client_firstname'"/>
