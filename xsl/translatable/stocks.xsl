...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
  ...
  <h1 class="headline">
    <span class="headline__name">iai_i18n:[TGlzdGEgcHVua3TDs3cgb2RiaW9ydQ==]</span>
  </h1>
  <div id="stocks_map"/>
  <div class="stocks_list">
    <iaixsl:for-each select="/shop/page/stocks/stock">
      <div class="stocks_list__item">
        ...
        <a class="stocks_list__show_on_map btn --solid" href="showOnMap">iai_i18n:[UG9rYcW8IG5hIG1hcGll]</a>
      </div>
    </iaixsl:for-each>
  </div>
