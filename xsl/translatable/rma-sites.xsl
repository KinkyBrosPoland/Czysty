...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
    ...
    <!-- (rma_sites_form, 61f913c77e41f2.01513174.5)-->
		...
		<div class="step4a">
			...
			<div class="progress__item --rma --fourth --active d-md-none py-3">
				...
				<div class="progress__text">
					<strong class="progress__name"><iaixsl:choose><iaixsl:when test="count(page/pickups/pickup) &gt; 1">iai_i18n:[V3liaWVyeiBhZHJlcyBwdW5rdHUgcmVrbGFtYWN5am5lZ28=]</iaixsl:when><iaixsl:otherwise>iai_i18n:[QWRyZXMgcHVua3R1IHJla2xhbWFjeWpuZWdv]</iaixsl:otherwise></iaixsl:choose></strong>
				</div>
			</div>
			<h1 class="big_label return_label d-none d-md-block" id="return_label"><iaixsl:choose><iaixsl:when test="count(page/pickups/pickup) &gt; 1">iai_i18n:[V3liaWVyeiBhZHJlcyBwdW5rdHUgcmVrbGFtYWN5am5lZ28=]</iaixsl:when><iaixsl:otherwise>iai_i18n:[QWRyZXMgcHVua3R1IHJla2xhbWFjeWpuZWdv]</iaixsl:otherwise></iaixsl:choose></h1>
