...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/common_style.css?r=1765442857</iaixsl:attribute></link></iaixsl:when>
    <iaixsl:otherwise><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/common_style.css.gzip?r=1765442857</iaixsl:attribute></link></iaixsl:otherwise>
</iaixsl:choose>
			...
			<iaixsl:if test="not(/shop/page/@type = 'main') and not(/shop/page/@type = 'search') and not(/shop/page/@type = 'place-order') and not(/shop/page/@type = 'noproduct') and not($projector_script_bottom and /shop/page/@type = 'projector')">
				<script src="/gfx/translatable/jquery.js.gzip?r=1765442857"></script>
				<iaixsl:choose>
					<iaixsl:when test="/shop/@preview &gt; 0">
...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/common_shop.js?r=1765442857</iaixsl:attribute></script></iaixsl:when>
    <iaixsl:otherwise><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/common_shop.js.gzip?r=1765442857</iaixsl:attribute></script></iaixsl:otherwise>
</iaixsl:choose>
...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
    ...
    <!-- (returns_details_form, 61f913c7c80b92.84644434.12)-->
	<iaixsl:variable name="nettoPriceReturnDetails"><iaixsl:if test="/shop/page/@price_type = 'net'">true</iaixsl:if></iaixsl:variable>
	<iaixsl:variable name="grossPriceReturnDetails"> iai_i18n:[YnJ1dHRv]</iaixsl:variable>
	<iaixsl:if test="page/@display = 'details'">

		<iaixsl:variable name="prepaid016txt">iai_i18n:[bnVtZXIgcHJ6ZXN5xYJraQ==]: </iaixsl:variable>
		<iaixsl:variable name="prepaid017atxt">iai_i18n:[xZtsZWR6ZW5pZSBwcnplc3nFgmtp]: </iaixsl:variable>
		<iaixsl:variable name="prepaid017txt">iai_i18n:[c3Ryb25hIHByemV3b8W6bmlrYQ==]</iaixsl:variable>
		<iaixsl:variable name="n5_4atxt">iai_i18n:[TmFkYWogcGFjemvEmQ==] <small>iai_i18n:[WmEgbmFkYW5pZSBuaWMgZG9kYXRrb3dvIG5pZSBwxYJhY2lzeg==]</small></iaixsl:variable>

		<div class="step7 returnDetails">
			<div id="orderdetails_info" class="returnDetails__wrapper">
			  <iaixsl:choose>
			    <iaixsl:when test="/shop/action/smile/@returns_url and /shop/page/return_method/@id = 3 and (/shop/page/pickup/region = '1143020003' or not(/shop/page/pickup/region)) and (/shop/page/return_method/@international_shipment = 'false' or not(/shop/page/return_method/@international_shipment))">
			      <iaixsl:attribute name="class">returnDetails__wrapper returnDetails__new</iaixsl:attribute>
			      <div class="returnDetails__info">
									...
									<div class="returnDetails__method_desc">
										<iaixsl:choose>
											...
											<iaixsl:when test="/shop/page/return_method/@id = 1">
												<b>
													iai_i18n:[RG9zdGFyY3rEmSBvc29iacWbY2llIGRvIGplZG5lZ28geiBwdW5rdMOzdyBvYnPFgnVnaSB6d3JvdMOzdw==]
												</b>
												<div class="return_description">
													iai_i18n:[Wm9ib3dpxIV6dWrEmSBzacSZIGRvIG9zb2Jpc3RlZ28gZG9zdGFyY3plbmlhIHBhY3praSBkbyB3eWJyYW5lZ28gcHVua3R1IG9ic8WCdWdpIHp3cm90w7N3].
												</div>
											</iaixsl:when>
											<iaixsl:when test="/shop/page/return_method/@id = 2">
												<b>
													iai_i18n:[U2tvcnp5c3RhbSB6IHByemVzecWCZWsgc2tsZXB1]
												</b>
												<div class="return_description">
													iai_i18n:[T3DFgmF0YSB6b3N0YW5pZSBvZGxpY3pvbmEgb2Qgd2FydG/Fm2NpIHp3cmFjYW55Y2ggcHJvZHVrdMOzdw==].
												</div>
											</iaixsl:when>
											<iaixsl:when test="/shop/page/return_method/@id = 3">
												<b>
													iai_i18n:[V3nFm2zEmSBzYW1vZHppZWxuaWUgaSBzYW1vZHppZWxuaWUgb3DFgmFjxJkgcHJ6ZXN5xYJrxJk=]
												</b>
												<div class="return_description">
													iai_i18n:[Wm9ib3dpxIV6dWrEmSBzacSZIGRvIHNhbW9kemllbG5lZ28gbmFkYW5pYSBwYWN6a2kgd3JheiB6IHBvbmllc2llbmllbSB3c3p5c3RraWNoIGtvc3p0w7N3IHp3acSFemFueWNoIHogZG9zdGFyY3plbmllbSB6d3JvdHUgZG8gc2tsZXB1].
												</div>
											</iaixsl:when>
										</iaixsl:choose>
							...
							<iaixsl:choose>
								...
								<iaixsl:when test="page/return_method/@id=1">
									<iaixsl:variable name="returns_1">iai_i18n:[UG9iaWVyeiBmb3JtdWxhcnogendyb3R1IG9yYXogZXR5a2lldMSZIG5hIHByemVzecWCa8SZ].</iaixsl:variable>
									<iaixsl:variable name="returns_1_2">iai_i18n:[QsSZZHppZSBwb3RyemVib3dhxIcgZ28gb2JzxYJ1Z2Egc2tsZXB1].</iaixsl:variable>
									<iaixsl:variable name="returns_1_3">iai_i18n:[UG9iaWVyeiBmb3JtdWxhcnogendyb3R1]</iaixsl:variable>

									<iaixsl:variable name="returns_2">iai_i18n:[U3Bha3VqIHp3cmFjYW5lIHByb2R1a3R5IG9yYXogZG/FgsSFY3ogd3lkcnVrb3dhbnkgZm9ybXVsYXJ6IHp3cm90dQ==].</iaixsl:variable>
									<iaixsl:variable name="returns_2_2">iai_i18n:[RG9rdW1lbnQgdcWCYXR3aSBvYnPFgnVnxJkgVHdvamVnbyB6d3JvdHU=].</iaixsl:variable>

									<iaixsl:variable name="returns_3">iai_i18n:[RG9zdGFyY3ogc2Ftb2R6aWVsbmllIHByemVzecWCa8SZIHBvZA==] </iaixsl:variable>
									<iaixsl:variable name="returns_3_2">iai_i18n:[UHJ6ZWQgd3lqYXpkZW0gc3ByYXdkxbogZ29kemlueSBwcmFjeSBwdW5rdHUgendyb3R1].</iaixsl:variable>
									...
									<div class="returnDetails__listItem --second">
										...
										<div class="returnDetails__listIcons">
											<img src="/gfx/standards/returns_3.svg?r=1765442497" alt="return"/>
											<img src="/gfx/standards/arrow.svg?r=1765442497" alt="arrow"/>
											<img src="/gfx/standards/returns_4.svg?r=1765442497" alt="return"/>
										</div>
									</div>
									<div class="returnDetails__listItem --third">
											...
											<b>
												...
												<iaixsl:if test="page/return_method/@id=1 or page/return_method/@id=3">
													<a>
														...
														<iaixsl:attribute name="title"> iai_i18n:[YWRyZXMgcHVua3R1IHp3cm90dQ==].</iaixsl:attribute>
															iai_i18n:[YWRyZXMgcHVua3R1IHp3cm90dQ==].
													</a>
												</iaixsl:if>
											</b>
										...
										<div class="returnDetails__listIcons">
											<img src="/gfx/standards/returns_9.svg?r=1765442497" alt="return"/>
											<img src="/gfx/standards/arrow.svg?r=1765442497" alt="arrow"/>
											<img src="/gfx/standards/returns_1.svg?r=1765442497" alt="return"/>
										</div>
									</div>
								...
								<iaixsl:when test="page/return_method/@id=2 or page/return_method/@id=5">
									<iaixsl:variable name="returns_1">iai_i18n:[UG9iaWVyeiBmb3JtdWxhcnogendyb3R1IG9yYXogZXR5a2lldMSZIG5hIHByemVzecWCa8SZ].</iaixsl:variable>
									<iaixsl:variable name="returns_1_2">iai_i18n:[RXR5a2lldGEgcG90cnplYm5hIGLEmWR6aWUgYWJ5IG5hZGHEhyBwYWN6a8SZ].</iaixsl:variable>
									<iaixsl:variable name="returns_1_3">iai_i18n:[UG9iaWVyeiBmb3JtdWxhcnogaSBldHlraWV0xJkgbmEgcHJ6ZXN5xYJrxJk=]</iaixsl:variable>

									<iaixsl:variable name="returns_2">iai_i18n:[U3Bha3VqIHp3cmFjYW5lIHByb2R1a3R5IG9yYXogZG/FgsSFY3ogd3lkcnVrb3dhbnkgZm9ybXVsYXJ6IHp3cm90dQ==].</iaixsl:variable>
									<iaixsl:variable name="returns_2_2">iai_i18n:[TmEgcGFjemvEmSBuYWtsZWogZG/FgsSFY3pvbsSFIGV0eWtpZXTEmS4gRG9rdW1lbnQgdcWCYXR3aSBvYnPFgnVnxJkgVHdvamVnbyB6d3JvdHU=].</iaixsl:variable>

									<iaixsl:variable name="returns_3">iai_i18n:[TmFkYWogcHJ6ZXN5xYJrxJkgemdvZG5pZSB6IGluc3RydWtjasSFIHBvZGFuxIUgdyBmb3JtdWxhcnphIHp3cm90dQ==].</iaixsl:variable>
									<iaixsl:variable name="returns_3_2">iai_i18n:[UGFtacSZdGFqLCBhYnkgcGFjemthIG1pYcWCYSBuYWtsZWpvbsSFIGV0eWtpZXTEmSBrdXJpZXJh].</iaixsl:variable>
									...
									<div class="returnDetails__listItem --second">
										...
										<div class="returnDetails__listIcons">
											<img src="/gfx/standards/returns_3.svg?r=1765442497" alt="return"/>
											<img src="/gfx/standards/arrow.svg?r=1765442497" alt="arrow"/>
											<img src="/gfx/standards/returns_7.svg?r=1765442497" alt="return"/>
										</div>
									</div>
									<div class="returnDetails__listItem --third">
										<span class="returnDetails__listCounter">3</span>
										...
										<div class="returnDetails__listIcons">
											<img src="/gfx/standards/returns_2.svg?r=1765442497" alt="return"/>
											<img src="/gfx/standards/arrow.svg?r=1765442497" alt="arrow"/>
											<img src="/gfx/standards/returns_5.svg?r=1765442497" alt="return"/>
										</div>
									</div>
								...
								<iaixsl:when test="page/return_method/@id=4">
									<iaixsl:variable name="returns_1">iai_i18n:[UG9iaWVyeiBmb3JtdWxhcnogendyb3R1IG9yYXoga29kIHp3cm90dQ==].</iaixsl:variable>
									<iaixsl:variable name="returns_1_2">iai_i18n:[S29kIHp3cm90dSBwb3RyemVibnkgYsSZZHppZSBhYnkgbmFkYcSHIHBhY3prxJkgdyBwYWN6a29tYWNpZQ==].</iaixsl:variable>
									<iaixsl:variable name="returns_1_3">iai_i18n:[UG9iaWVyeiBmb3JtdWxhcnogaSBrb2Qgendyb3R1]</iaixsl:variable>

									<iaixsl:variable name="returns_2">iai_i18n:[U3Bha3VqIHp3cmFjYW5lIHByb2R1a3R5IG9yYXogamFrIG1vxbxlc3ogd3lkcnVrdWogaSBkb8WCxIVjeiBmb3JtdWxhcnogendyb3R1].</iaixsl:variable>
									<iaixsl:variable name="returns_2_2">iai_i18n:[RG9rdW1lbnQgdcWCYXR3aSBvYnPFgnVnxJkgVHdvamVnbyB6d3JvdHU=].</iaixsl:variable>

									<iaixsl:variable name="returns_3">iai_i18n:[TmFkYWogcHJ6ZXN5xYJrxJkgdyBQYWN6a29tYWNpZSBJblBvc3R1IGx1YiBQYWN6a29QdW5rY2ll].</iaixsl:variable>
										...
										<div class="returnDetails__listDesc">
											...
											<iaixsl:choose>
												<iaixsl:when test="page/return_method/@return_code">
													iai_i18n:[VcW8eWogd3lnZW5lcm93YW5lZ28ga29kdSB6d3JvdHU=]:
												</iaixsl:when>
												<iaixsl:otherwise>
													iai_i18n:[VcW8eWogd3lnZW5lcm93YW5lZ28ga29kdSB6d3JvdHUsIGt0w7NyeSB6bmFqZHppZXN6IHcgcG9icmFueW0gZm9ybXVsYXJ6dQ==].
												</iaixsl:otherwise>
											</iaixsl:choose>
											</span>
										</div>
								...
								<iaixsl:otherwise>
									...
									<iaixsl:variable name="returns_3">iai_i18n:[TmFkYWogcHJ6ZXN5xYJrxJkgbmE=] </iaixsl:variable>
									<iaixsl:variable name="returns_3_2">iai_i18n:[QWRyZXMgem5hamR6aWVzeiBuYSBkb2xlIHN0cm9ueQ==].</iaixsl:variable>
									...
									<div class="returnDetails__listItem --third">
										...
										<div class="returnDetails__listItem --fourth">
										<div class="returnDetails__listIcons --button">
											<a class="btn --solid --medium --outline" target="blank">
												<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/documentlink/@url"/></iaixsl:attribute>
												<iaixsl:value-of select="$returns_1_3"/>
											</a>
										</div>
						...
						<iaixsl:if test="/shop/page/details/@smile_returns='true'">
							<div class="returnDetails_smile">
								<span class="returnDetails_smile__img">
									<img>
										<iaixsl:attribute name="alt">iai_i18n:[U21pbGUgWndyb3R5]</iaixsl:attribute>
										<iaixsl:attribute name="src"><iaixsl:choose>
											<iaixsl:when test="/shop/language/option[@id = 'pol']/@selected">/gfx/standards/smile_returns.svg</iaixsl:when>
											<iaixsl:otherwise>/gfx/standards/smile_returns_eng.svg</iaixsl:otherwise>
										</iaixsl:choose></iaixsl:attribute>
									</img>
								</span>
								<div class="returnDetails_smile__title">
									iai_i18n:[TmFkYW0gcHJ6ZXN5xYJrxJkgYmV6IGRydWtvd2FuaWEgZXR5a2lldHk=]
								</div>
								<span>
									iai_i18n:[U21pbGUgWndyb3R5IHRvIG5hanRhxYRzemUgcHJ6ZXN5xYJraSB6d3JvdG5lIG5hIHJ5bmt1Lg==]
								</span>
								<div class="returnDetails_smile__button">
									<a class="btn --solid --medium">
										<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/smile/@returns_url"/>?domain=<iaixsl:value-of select="/shop/@currurl_hostname"/>&amp;orderid=<iaixsl:value-of select="/shop/page/details/@order_number"/>&amp;utm_source=<iaixsl:value-of select="/shop/@currurl_hostname"/>&amp;utm_medium=banner&amp;utm_campaign=kreator_zwrotow&amp;returnid=<iaixsl:value-of select="/shop/page/details/@id"/></iaixsl:attribute>
										iai_i18n:[TmFkYWogendyb3QgemUgU21pbGUgWndyb3R5]
									</a>
								</div>
								<div class="returnDetails_smile__sub">
									iai_i18n:[V3lzdGFyY3p5LCDFvGUgdWRhc3ogc2nEmSB6IHBhY3prxIUgcG9k]
									<strong>iai_i18n:[ZG93b2xueSBQYWN6a29tYXQgaSB3cHJvd2FkemlzeiAxMC1jeWZyb3d5IGtvZCB6d3JvdHU=]</strong>
									iai_i18n:[bHViIHplc2thbnVqZXN6IGtvZCBRUiBvdHJ6eW1hbnkgdyBwb3dpYWRvbWllbml1IGVtYWlsLg==]
								</div>
								<div class="returnDetails_smile__sub">
									iai_i18n:[RGFuZSB6YW3Ds3dpZW5pYSBvcmF6IGFkcmVzIGLEmWR6aWUgYXV0b21hdHljem5pZSB1enVwZcWCbmlvbnkuIFp3cm90IHphcGlzemUgc2nEmSB3IHNrbGVwaWUgZHppxJlraSBjemVtdSBixJlkemllc3ogbcOzZ8WCIHNwcmF3ZHppxIcgamVnbyBzdGF0dXMgdyBrYcW8ZGVqIGNod2lsaS4=]
								</div>
							</div>
							<div class="returnDetails_smile__condition">
								<span>iai_i18n:[bHVi]</span>
							</div>
						</iaixsl:if>
			    </iaixsl:when>
			    <iaixsl:otherwise>
			      <div class="returnDetails__info">
											...
											<div class="moreInfo orderdetails_info__more d-none d-md-flex">
													...
													<div style="display:none;" class="moreInfo__desc"><iaixsl:value-of disable-output-escaping="yes" select="page/details/@status_description"/></div>
																	...
																	<div class="orderdetails_info__dates">
																			<span>iai_i18n:[TnIgendyb3R1]: <iaixsl:value-of select="page/details/@id"/></span>
																			<iaixsl:if test="not(page/details/@status_description = '')">
																					<a href="#showDescription" class="moreInfo__show d-md-none">iai_i18n:[V2nEmWNlag==]</a>
							...
							<iaixsl:if test="/shop/action/smile/@returns_url and /shop/page/return_method/@id = 3 and (/shop/page/pickup/region = '1143020003' or not(/shop/page/pickup/region)) and (/shop/page/return_method/@international_shipment = 'false' or not(/shop/page/return_method/@international_shipment))">
								<a class="returnDetails_smile" target="_blank">
									<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/smile/@returns_url"/>?domain=<iaixsl:value-of select="/shop/@currurl_hostname"/>&amp;orderid=<iaixsl:value-of select="/shop/page/details/@order_number"/>&amp;utm_source=<iaixsl:value-of select="/shop/@currurl_hostname"/>&amp;utm_medium=banner&amp;utm_campaign=kreator_zwrotow&amp;returnid=<iaixsl:value-of select="/shop/page/details/@id"/></iaixsl:attribute>
									<span class="returnDetails_smile__text">iai_i18n:[TW/FvGVzeiB0ZcW8IG5hZGHEhyBzenlia2kgendyb3QgemU=]<iaixsl:text> </iaixsl:text><b>iai_i18n:[U21pbGUgWndyb3R5]</b></span>
									<span class="returnDetails_smile__img">
										<img>
											<iaixsl:attribute name="alt">iai_i18n:[U21pbGUgWndyb3R5]</iaixsl:attribute>
											<iaixsl:attribute name="src"><iaixsl:choose>
									...
									<span class="returnDetails_smile__arrow"/>
								</a>
							</iaixsl:if>
						</div>
							...
							<iaixsl:choose>
								...
								<iaixsl:otherwise>
									...
									<div class="returnDetails__listItem --third">
										...
										<div class="returnDetails__listIcons">
											<img src="/gfx/standards/returns_6.svg?r=1765442497" alt="return"/>
											<img src="/gfx/standards/arrow.svg?r=1765442497" alt="arrow"/>
											<img src="/gfx/standards/returns_1.svg?r=1765442497" alt="return"/>
										</div>
									</div>
			...
			<iaixsl:if test="page/returnproducts/products">
				...
				<div id="return_order_products" class="returnDetails__section">
					<h2 class="orderdetails_label"><span>iai_i18n:[WndyYWNhbmUgcHJvZHVrdHk=]</span></h2>
                        ...
                        <img>
                          ...
                          <iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="name/text()"/></iaixsl:attribute>
							...
							<div class="ordered_product__content">
								<div class="ordered_product__name align-self-center">
									<iaixsl:choose>
										<iaixsl:when test="@link">
								  ...
								  <iaixsl:if test="not(@barcode ='') or not(@size='uniw') or ((version) and (not(version/@product_name='')) and string-length(version/@product_name) &lt; 81)">
									<div class="basket__params --traits mb-0">
										
										<iaixsl:if test="not(@barcode ='')">
											<div class="basket__param --barcode">
												<span class="param__label">
													iai_i18n:[S29kIHByb2R1a3R1]:
												</span>
												...
												<iaixsl:for-each select="bundled/product">
													<li>
														...
														<iaixsl:if test="not(@size_id = 'uniw') or ((version) and (not(version/@product_name='')))">
															(<iaixsl:if test="not(@size_id = 'uniw')">iai_i18n:[Um96bWlhcg==]: <b><iaixsl:value-of select="@size_desc"/></b></iaixsl:if>
									...
									<iaixsl:if test="order_files/file">
										<div class="ordered-files">
											<label>
												iai_i18n:[WmHFgsSFY3pvbmUgcGxpa2k=]:
											</label>
											<ul>
													...
													<li>
														...
														<iaixsl:if test="@path">
															...
															<a>
																...
																iai_i18n:[cG9kZ2zEhWQ=]</a> ]</iaixsl:if></li>
												</iaixsl:for-each>
											</ul>
										</div>
									</iaixsl:if>
									...
									<iaixsl:if test="@product_type = 'product_virtual'">
										<div class="ordered-info">
											iai_i18n:[UGxpa2kgZG8gcG9icmFuaWEgcG9qYXdpxIUgc2nEmSB3IGR6aWFsZQ==]
											<a>
												<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientFiles/@url"/></iaixsl:attribute>
												&quot;iai_i18n:[TW9qZSBwbGlraQ==]&quot;
											</a>
											iai_i18n:[dyBwYW5lbHUga2xpZW50YSBwbyBvcMWCYWNlbml1IGNhxYJlZ28gemFtw7N3aWVuaWE=].
										</div>
									</iaixsl:if>
								...
								<div class="basket__sum mx-0 my-md-auto">
			...
			<iaixsl:if test="/shop/page/repayment_method">
				<div id="returnDetails_repaymentMethod" class="returnDetails__section">
					<h3 class="orderdetails_label">
						<span>iai_i18n:[Rm9ybWEgendyb3R1]</span>
					</h3>
						...
						<div class="return_detials_shipment_desc">
							<iaixsl:choose>
								<iaixsl:when test="/shop/page/repayment_method/@id = 't'">
									<b class="product_name">iai_i18n:[U2FsZG8ga2xpZW50YQ==]</b>
									<div class="return_description">
										iai_i18n:[V3liaWVyYW0gendyb3Qga3dvdHkgbmEgc2FsZG8ga2xpZW50YSwgZG8gd3lrb3J6eXN0YW5pYSBwcnp5IG9rYXpqaSByZWFsaXphY2ppIGtvbGVqbnljaCB6YWt1cMOzdyB3IHNrbGVwaWU=].
									</div>
								</iaixsl:when>
								<iaixsl:when test="/shop/page/repayment_method/@id = 'b'">
									<b class="product_name">iai_i18n:[UHJ6ZWxldw==]</b>
									<div class="return_description">
										iai_i18n:[UsOzd25vd2FydG/Fm8SHIFR3b2ljaCB6YWt1cMOzdyB6b3N0YW5pZSB6d3LDs2NvbmEgdyBmb3JtaWUgcHJ6ZWxld3UgYmFua293ZWdvIG5hIGtvbnRv].
									</div>
								</iaixsl:when>
								<iaixsl:when test="/shop/page/repayment_method/@id = 'tc'">
									<b class="product_name">iai_i18n:[UHJ6eXdyw7PEhyBrcmVkeXQga3VwaWVja2k=]</b>
									<div class="return_description">
										iai_i18n:[UsOzd25vd2FydG/Fm8SHIFR3b2ljaCB6YWt1cMOzdyB6b3N0YW5pZSBkb2RhbmEgZG8gVHdvamVnbyBzYWxkYSB3IGZvcm1pZSBrcmVkeXR1IGt1cGllY2tpZWdv].
									</div>
								</iaixsl:when>
								<iaixsl:otherwise>
			...
			<iaixsl:if test="/shop/page/remarks">
				<div id="returnDetails_remarks" class="returnDetails__section">
					<h3 class="orderdetails_label">
						<span>iai_i18n:[VXdhZ2kgZG8gendyb3R1]</span>
					</h3>
					<div>
			...
			<iaixsl:if test="/shop/page/pickup/name">
				<div id="returnDetails_address" class="returnDetails__section">
					<h3 class="orderdetails_label">
						<span>iai_i18n:[QWRyZXMgcHVua3R1IHp3cm90dQ==]</span>
					</h3>
					<div class="returnDetails__address">
						<div>
							<span><iaixsl:value-of select="/shop/page/pickup/name"/></span>
						</div>
						<div>
			...
			<iaixsl:variable name="txt_54116_1">iai_i18n:[RG9rdW1lbnR5IHd5c3Rhd2lvbmUgZGxhIHRlZ28gendyb3R1]</iaixsl:variable>
			<iaixsl:if test="$txt_54116_1 and count(page/documents/document) &gt; 0">
				<div id="returnDetails_documents" class="returnDetails__section">
					<h3 class="orderdetails_label">
		...
		<div class="returnDetails__summarySub">
			<iaixsl:if test="/shop/page/costs/cost[@type='products']/@value_formatted">
				<div class="returnDetails__summaryItem">
					<label>iai_i18n:[V2FydG/Fm8SHIHp3cmFjYW55Y2ggcHJvZHVrdMOzdw==]: </label>
			...
			<iaixsl:if test="/shop/page/costs/cost[@type='shipping']/@value_formatted">
				<div class="returnDetails__summaryItem">
					<label>iai_i18n:[Wndyb3Qga29zenR1IGRvc3Rhd3kgZG8ga2xpZW50YQ==]: </label>
			...
			<iaixsl:if test="/shop/page/costs/cost[@type='shop_shipping']/@value_formatted">
				<div class="returnDetails__summaryItem">
					<label>iai_i18n:[S29zenQgcHJ6ZXN5xYJraSB6d3JvdG5lag==]: </label>
			...
			<iaixsl:if test="/shop/page/costs/@value_formatted">
				<div class="returnDetails__summaryItem --sum">
					<strong>
						iai_i18n:[RG8gendyb3R1]
					</strong>
					<span id="currencytotal_prepaid"><iaixsl:value-of select="/shop/page/costs/@value_formatted"/><span class="price_vat"><iaixsl:value-of select="$grossPriceReturnDetails"/></span></span>
				</div>
			</iaixsl:if>
			...
			<div class="returnDetails__buttons">
				<iaixsl:if test="/shop/page/editlink/@url">
					<a class="btn --solid --medium --outline prepaid-edit">
						<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYWJ5IHByemVqxZvEhyBkbyBlZHljamkgendyb3R1].</iaixsl:attribute>
						<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute>iai_i18n:[Wm1pZcWEIHp3cm90]</a>
				</iaixsl:if>
				<iaixsl:if test="/shop/page/cancellink/@url">
					<a class="btn --solid --medium --outline prepaid-cancel">
						<iaixsl:attribute name="onclick">return confirm(&apos;iai_i18n:[QW51bG93YW5pZSB6d3JvdHUgamVzdCBjenlubm/Fm2NpxIUgbmllb2R3cmFjYWxuxIUuIEFieSBrb250eW51b3dhxIcgd2NpxZtuaWogcHJ6eWNpc2sgIkFudWx1aiB6d3JvdA==]&quot;.&gt;&apos;)</iaixsl:attribute>
						<iaixsl:attribute name="title">iai_i18n:[QW51bHVqIHp3cm90]</iaixsl:attribute>
						<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/cancellink/@url"/></iaixsl:attribute>
						iai_i18n:[QW51bHVqIHp3cm90]
					</a>
				</iaixsl:if>
			</div>
		</div>
...
<iaixsl:choose>
	...
	<script src="/gfx/translatable/envelope.js.gzip?r=1765442857"></script><script src="/gfx/translatable/menu_suggested_shop_for_language.js.gzip?r=1765442857"></script><script src="/gfx/translatable/menu_basket.js.gzip?r=1765442857"></script><script src="/gfx/translatable/hotspots_javascript.js.gzip?r=1765442857"></script><script src="/gfx/translatable/hotspots_slider.js.gzip?r=1765442857"></script><script src="/gfx/translatable/hotspots_add_to_basket.js.gzip?r=1765442857"></script>
