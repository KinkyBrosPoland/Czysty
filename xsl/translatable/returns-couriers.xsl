...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
    ...
    <!-- (returns_couriers_form, 60dd8e894d1457.27002506.4)-->
...
<div class="step3d">
       <div class="progress_bar_wrapper">
        ...
        <h1 class="big_label return_label">iai_i18n:[V3liaWVyeiBuYWp3eWdvZG5pZWpzenkgZGxhIGNpZWJpZSBzcG9zw7NiIHd5c3nFgmtpIHp3cm90dQ==]</h1>
                    ...
                    <div class="order1_delitem_comment" style="display:none;"><iaixsl:attribute name="id">delivery_<iaixsl:value-of select="@id"/></iaixsl:attribute></div>    
                            ...
                            <label class="order1_delitem_price">
                                                ...
                                                <label class="order1_delitem_price_point_disabled showTip_order1">
                                                    <iaixsl:attribute name="title">iai_i18n:[TmllIG1hc3ogd3lzdGFyY3phasSFY2VqIGlsb8WbY2kgcHVua3TDs3c=] </iaixsl:attribute>
                                                    <input class="showTip_order1" type="checkbox" disabled="disabled">
                                                        <iaixsl:attribute name="title">iai_i18n:[TmllIG1hc3ogd3lzdGFyY3phasSFY2VqIGlsb8WbY2kgcHVua3TDs3c=] </iaixsl:attribute>
                                                    </input>

                                                    <iaixsl:value-of select="@points_cost"/>iai_i18n:[cGt0].
                                                </label>
                                            </iaixsl:when>
                                                ...
                                                <span class="order1_delitem_price">
                                                    <iaixsl:choose>
                                                        ...
                                                        <iaixsl:when test="@cost &gt; 0">
                                                            <iaixsl:if test="@limitfree &gt; 0"><iaixsl:attribute name="title">iai_i18n:[T2Q=]<iaixsl:value-of select="@limitfree_formatted"/>iai_i18n:[Z3JhdGlz] </iaixsl:attribute></iaixsl:if>
                                                            <iaixsl:value-of select="@cost_formatted"/>
                                                        </iaixsl:when>
                                                        <iaixsl:otherwise>
                                                            iai_i18n:[R3JhdGlzIQ==]
