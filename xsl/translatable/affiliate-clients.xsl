...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (affiliate_clients_list, 60dd8e84073dd6.22755800.3)-->
  ...
  <iaixsl:if test="not(page/@type='affiliate-not-active')">
    <h1 class="headline">
      <span class="headline__name">
        iai_i18n:[TGlzdGEgVHdvaWNoIGtsaWVudMOzdw==]
      </span>
    </h1>
    ...
    <iaixsl:choose>
      <iaixsl:when test="count(page/clients_list/login)">
        <section class="affiliate --clients mb-4">
          <div class="affiliate__desc mb-4">iai_i18n:[UG9uacW8ZWogem5hamR1amUgc2nEmSBsaXN0YSB3c3p5c3RraWNoIGtsaWVudMOzdywga3TDs3J6eSB6YcWCb8W8eWxpIGtvbnRvIHBvIHdlasWbY2l1IHogVHdvamVnbyBwb2xlY2VuaWE=].</div>
      ...
      <iaixsl:otherwise>
        <div class="affiliate__info">
          iai_i18n:[VyBjaHdpbGkgb2JlY25laiBuaWUgcG9zaWFkYXN6IGtsaWVudMOzdyBrdMOzcnp5IHphxYJvxbx5bGkga29udG8geiBUd29qZWdvIHBvbGVjZW5pYQ==].
        </div>
      </iaixsl:otherwise>
    </iaixsl:choose>
  </iaixsl:if>
<!-- (affiliate_clients_paging, 60dd8e7f2cae64.92284033.5)-->
      ...
      <iaixsl:if test="page/clients_list/navigation/prev">
        <li class="pagination__element --prev">
          ...
          <a class="pagination__link">
            <iaixsl:attribute name="href"><iaixsl:choose><iaixsl:when test="page/clients_list/navigation/prev/@counter = '0'"><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/clients_list/navigation/path/@value, '&amp;counter=')"/><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/clients_list/navigation/path/@value, '?counter=')"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of disable-output-escaping="yes" select="page/clients_list/navigation/path/@value"/><iaixsl:value-of select="page/clients_list/navigation/prev/@counter"/></iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>
