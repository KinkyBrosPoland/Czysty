...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
  ...
  <h1 class="headline">
    <span class="headline__name">iai_i18n:[TmFzaSBwYXJ0bmVyenk=]</span>
  </h1>
	<div class="partners_info">
		<p>iai_i18n:[WmFwcmFzemFteSBkbyB6YXBvem5hbmlhIHogbGlzdMSFIG5hc3p5Y2ggcGFydG5lcsOzdyBoYW5kbG93eWNo].</p>
	</div>
	<div id="partners_map"/>
