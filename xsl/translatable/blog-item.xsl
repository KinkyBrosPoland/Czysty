...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (menu_blog, 60dd8e799a3e69.15233232.4)-->
                ...
                <iaixsl:if test="page/navigation/bydates/item">
                    <div id="menu_blog_bydates" class="menu_blog_box">
                        <a class="menu_categories_label" href="/blog-list.php">
                            <iaixsl:attribute name="title">iai_i18n:[QXJjaGl3dW0=]</iaixsl:attribute>
                            iai_i18n:[QXJjaGl3dW0=]
                        </a>
                        <ul>
                                                    ...
                                                    <a>
                                                        ...
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="@value='01'">
                                                                <iaixsl:attribute name="title">iai_i18n:[U3R5Y3plxYQ=] <iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                iai_i18n:[U3R5Y3plxYQ=]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='02'">
                                                                <iaixsl:attribute name="title">iai_i18n:[THV0eQ==] <iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                iai_i18n:[THV0eQ==]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='03'">
                                                                <iaixsl:attribute name="title">iai_i18n:[TWFyemVj] <iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                iai_i18n:[TWFyemVj]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='04'">
                                                                <iaixsl:attribute name="title">iai_i18n:[S3dpZWNpZcWE] <iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                iai_i18n:[S3dpZWNpZcWE]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='05'">
                                                                <iaixsl:attribute name="title">iai_i18n:[TWFq] <iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                iai_i18n:[TWFq]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='06'">
                                                                <iaixsl:attribute name="title">iai_i18n:[Q3plcndpZWM=] <iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                iai_i18n:[Q3plcndpZWM=]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='07'">
                                                                <iaixsl:attribute name="title">iai_i18n:[TGlwaWVj] <iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                iai_i18n:[TGlwaWVj]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='08'">
                                                                <iaixsl:attribute name="title">iai_i18n:[U2llcnBpZcWE] <iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                iai_i18n:[U2llcnBpZcWE]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='09'">
                                                                <iaixsl:attribute name="title">iai_i18n:[V3J6ZXNpZcWE] <iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                iai_i18n:[V3J6ZXNpZcWE]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='10'">
                                                                <iaixsl:attribute name="title">iai_i18n:[UGHFumR6aWVybmlr] <iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                iai_i18n:[UGHFumR6aWVybmlr]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='11'">
                                                                <iaixsl:attribute name="title">iai_i18n:[TGlzdG9wYWQ=] <iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                iai_i18n:[TGlzdG9wYWQ=]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='12'">
                                                                <iaixsl:attribute name="title">iai_i18n:[R3J1ZHppZcWE] <iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                iai_i18n:[R3J1ZHppZcWE]
                                                            </iaixsl:when>
                                                        </iaixsl:choose>
                                                    </a>
                                                </li>
                ...
                <iaixsl:if test="action/blog_rss"> 
                    <div id="menu_blog_rss">
                        <a>
                            ...
                            <iaixsl:attribute name="title">iai_i18n:[S2FuYcWCIFJTUw==] <i class="icon-rss"/></iaixsl:attribute>
                            iai_i18n:[S2FuYcWCIFJTUw==] <i class="icon-rss"/>
                        </a>
                    </div>
                </iaixsl:if> 
        ...
        <!-- (blog_item_content, 60dd8e7b495619.39387378.4)-->
            <iaixsl:if test="/shop/page/blogitem/long_description">
                <div id="blog-item">
                    ...
                    <iaixsl:if test="/shop/page/blogitem/date/text() != ''">
                        <div class="blog_date article__date">
                ...
                <iaixsl:if test="/shop/page/navigation/bycategories/item/@current='active' or /shop/page/navigation/bydates/item/item/@current='active'">
                    <div class="blog_viewalso">
                        iai_i18n:[UG9rYcW8IHdpxJljZWogd3Bpc8OzdyB6]
                        <iaixsl:choose>
                            ...
                            <iaixsl:when test="not(/shop/page/navigation/bycategories/item/@current='active') and /shop/page/navigation/bydates/item/item/@current='active'">
                                <iaixsl:for-each select="/shop/page/navigation/bydates/item/item[@current='active'][1]">
                                    <a>
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                        <iaixsl:attribute name="title">iai_i18n:[SW5uZSB3cGlzeSB6IHRlZ28gbWllc2nEhWNh]</iaixsl:attribute>
                                        <iaixsl:choose>
                                                <iaixsl:when test="@value='01'">iai_i18n:[U3R5Y3plxYQ=]</iaixsl:when>
                                                <iaixsl:when test="@value='02'">iai_i18n:[THV0eQ==]</iaixsl:when>
                                                <iaixsl:when test="@value='03'">iai_i18n:[TWFyemVj]</iaixsl:when>
                                                <iaixsl:when test="@value='04'">iai_i18n:[S3dpZWNpZcWE]</iaixsl:when>
                                                <iaixsl:when test="@value='05'">iai_i18n:[TWFq]</iaixsl:when>
                                                <iaixsl:when test="@value='06'">iai_i18n:[Q3plcndpZWM=]</iaixsl:when>
                                                <iaixsl:when test="@value='07'">iai_i18n:[TGlwaWVj]</iaixsl:when>
                                                <iaixsl:when test="@value='08'">iai_i18n:[U2llcnBpZcWE]</iaixsl:when>
                                                <iaixsl:when test="@value='09'">iai_i18n:[V3J6ZXNpZcWE]</iaixsl:when>
                                                <iaixsl:when test="@value='10'">iai_i18n:[UGHFumR6aWVybmlr]</iaixsl:when>
                                                <iaixsl:when test="@value='11'">iai_i18n:[TGlzdG9wYWQ=]</iaixsl:when>
                                                <iaixsl:when test="@value='12'">iai_i18n:[R3J1ZHppZcWE]</iaixsl:when>
                            ...
                            <iaixsl:otherwise>
                                iai_i18n:[a2F0ZWdvcmlp] <a>
                                    ...
                                    <iaixsl:attribute name="title"><iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@value"/></iaixsl:attribute>
                                    <iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@value"/>
                                </a> iai_i18n:[bHVi] <iaixsl:for-each select="/shop/page/navigation/bydates/item/item[@current='active'][1]">
                                    <a>
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                        <iaixsl:attribute name="title">iai_i18n:[SW5uZSB3cGlzeSB6IHRlZ28gbWllc2nEhWNh]</iaixsl:attribute>
                                        <iaixsl:choose>
        ...
        <!-- (blog_item_associated, 67ef83630921a1.33937646.3)-->
	<iaixsl:if test="page/cms_products/product or page/cms_products/opinion">

		<section id="blog_item_associated" class="hotspot__wrapper">
      <div class="hotspot">
        
        <iaixsl:variable name="headline_after_blog_item_associated">iai_i18n:[Wm9iYWN6IHdzenlzdGtpZQ==]</iaixsl:variable>
        ...
        <h2 class="hotspot__name headline__wrapper">
          <iaixsl:choose>
            <iaixsl:when test="page/cms_products/@link">
              <a class="headline">
                ...
                <iaixsl:attribute name="title">iai_i18n:[S2xpa25paiBhYnkgem9iYWN6ecSHIHdzenlzdGtpZSBwcm9kdWt0eQ==] </iaixsl:attribute>

                <span class="headline__name">
                  <iaixsl:choose>
                    <iaixsl:when test="page/cms_products/@name"><iaixsl:value-of select="page/cms_products/@name"/></iaixsl:when>
                    <iaixsl:otherwise>iai_i18n:[UG9sZWNhbmU=]</iaixsl:otherwise>
                  </iaixsl:choose>
                </span>
        ...
        <div class="products__wrapper swiper">
          <div class="products hotspot__products swiper-wrapper">
            <iaixsl:for-each select="page/cms_products/*">
              ...
              <iaixsl:variable name="var_id"><iaixsl:choose><iaixsl:when test="product"><iaixsl:value-of select="product/@id"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="@id"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
              ...
              <iaixsl:variable name="var_net_prices"><iaixsl:if test="/shop/page/@price_type = 'net'"> iai_i18n:[bmV0dG8=]</iaixsl:if></iaixsl:variable>
              <iaixsl:variable name="var_gross_prices"><iaixsl:if test="/shop/page/@price_type = 'gross'"> iai_i18n:[YnJ1dHRv]</iaixsl:if></iaixsl:variable>
              ...
              <iaixsl:variable name="var_unit"><iaixsl:choose><iaixsl:when test="product"><iaixsl:choose><iaixsl:when test="not(product/price/@price_unit_formatted)"><iaixsl:value-of select="product/sizes/@unit_single"/></iaixsl:when><iaixsl:when test="product/sizes/@unit_sellby &gt; 1"><iaixsl:value-of select="product/sizes/@unit_plural"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="product/sizes/@unit_single"/></iaixsl:otherwise></iaixsl:choose></iaixsl:when><iaixsl:otherwise><iaixsl:choose><iaixsl:when test="not(price/@price_unit_formatted)"><iaixsl:value-of select="sizes/@unit_single"/></iaixsl:when><iaixsl:when test="sizes/@unit_sellby &gt; 1"><iaixsl:value-of select="sizes/@unit_plural"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="sizes/@unit_single"/></iaixsl:otherwise></iaixsl:choose></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
              <iaixsl:variable name="var_sellby"><iaixsl:choose><iaixsl:when test="product"><iaixsl:choose><iaixsl:when test="not(product/price/@price_unit_formatted)">1</iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="product/sizes/@unit_sellby"/></iaixsl:otherwise></iaixsl:choose></iaixsl:when><iaixsl:otherwise><iaixsl:choose><iaixsl:when test="not(price/@price_unit_formatted)">1</iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="sizes/@unit_sellby"/></iaixsl:otherwise></iaixsl:choose></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
              ...
              <iaixsl:variable name="var_omnibus"><iaixsl:choose>
                ...
                <iaixsl:when test="product and product/price/@size_min != product/price/@size_max"/>
                <iaixsl:when test="price/@size_min != price/@size_max"/>
              ...
              <iaixsl:variable name="var_omnibus_rebate_code"><iaixsl:if test="/shop/rebatecode/@activate_omnibus = 'true' and ((product and product/price/@rebate_code_active = 'y') or (price/@rebate_code_active = 'y'))">true</iaixsl:if></iaixsl:variable>
              ...
              <iaixsl:variable name="var_new_price_date"><iaixsl:choose>
                ...
                <iaixsl:when test="product"><iaixsl:value-of select="product/price/@omnibus_new_price_effective_until"/></iaixsl:when>
                <iaixsl:otherwise><iaixsl:value-of select="price/@omnibus_new_price_effective_until"/></iaixsl:otherwise>
							...
							<iaixsl:variable name="var_deposit_price"><iaixsl:choose>
								<iaixsl:when test="$var_net_prices != ''">
									<iaixsl:choose>
										<iaixsl:when test="(product/price | price)/@total_deposit_net_unit_formatted">
											<iaixsl:value-of select="(product/price | price)/@total_deposit_net_unit_formatted"/>
										</iaixsl:when>
										<iaixsl:when test="(product/price | price)/@total_deposit_net_formatted">
											<iaixsl:value-of select="(product/price | price)/@total_deposit_net_formatted"/>
										</iaixsl:when>
										<iaixsl:when test="(product/price | price)/@deposit_price_unit_net_formatted">
											<iaixsl:value-of select="(product/price | price)/@deposit_price_unit_net_formatted"/>
										</iaixsl:when>
										<iaixsl:otherwise>
											<iaixsl:value-of select="(product/price | price)/@deposit_price_net_formatted"/>
										</iaixsl:otherwise>
									</iaixsl:choose>
								</iaixsl:when>
								<iaixsl:otherwise>
									<iaixsl:choose>
										<iaixsl:when test="(product/price | price)/@total_deposit_unit_formatted">
											<iaixsl:value-of select="(product/price | price)/@total_deposit_unit_formatted"/>
										</iaixsl:when>
										<iaixsl:when test="(product/price | price)/@total_deposit_formatted">
											<iaixsl:value-of select="(product/price | price)/@total_deposit_formatted"/>
										</iaixsl:when>
										<iaixsl:when test="(product/price | price)/@deposit_price_unit_formatted">
											<iaixsl:value-of select="(product/price | price)/@deposit_price_unit_formatted"/>
										</iaixsl:when>
										<iaixsl:otherwise>
											<iaixsl:value-of select="(product/price | price)/@deposit_price_formatted"/>
										</iaixsl:otherwise>
									</iaixsl:choose>
								</iaixsl:otherwise>
							</iaixsl:choose></iaixsl:variable>
              ...
              <div class="product hotspot__product swiper-slide d-flex flex-column">
                ...
                <a class="product__icon d-flex justify-content-center align-items-center">
                  <iaixsl:attribute name="data-product-id"><iaixsl:value-of select="$var_id"/></iaixsl:attribute>
                  ...
                  <iaixsl:choose>
                    <iaixsl:when test="$var_icon_second and not($var_icon_second = '/' or $var_icon_second = '') and $var_icon_small_second and not($var_icon_small_second = '/' or $var_icon_small_second = '')">
                      <picture>
                        <source media="(min-width: 421px)" type="image/webp" srcset="{$var_icon}"/>
                        <source media="(min-width: 421px)" type="image/jpeg" srcset="{$var_icon_second}"/>
                        <source media="(max-width: 420px)" type="image/webp" srcset="{$var_icon_small}"/>

                        <img src="{$var_icon_second}" loading="lazy">
                    ...
                    <iaixsl:otherwise>
                      <picture>
                        <source media="(max-width: 420px)" srcset="{$var_icon_small}"/>
                        <img src="{$var_icon}" alt="{$var_name}" loading="lazy">
                          <iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="$var_name"/></iaixsl:attribute>
                        </img>
                      </picture>
                    </iaixsl:otherwise>
                  ...
                  <iaixsl:choose>
                    ...
                    <iaixsl:when test="$var_net_prices = ''">
                      ...
                      <iaixsl:variable name="var_price_formatted">
                        <iaixsl:choose>
                          <iaixsl:when test="price/@price_unit_formatted and sizes/@unit"><iaixsl:value-of select="price/@price_unit_formatted"/></iaixsl:when>
                          <iaixsl:when test="product/price/@price_unit_formatted and product/sizes/@unit"><iaixsl:value-of select="product/price/@price_unit_formatted"/></iaixsl:when>
                        ...
                        <iaixsl:choose>
                          ...
                          <iaixsl:when test="$var_size_min_formatted != $var_size_max_formatted">
                            <strong class="price --main">
                              <span class="price__range --min"><iaixsl:value-of select="$var_size_min_formatted"/></span><iaixsl:text> - </iaixsl:text><span class="price__range --max"><iaixsl:value-of select="$var_size_max_formatted"/></span><span class="price_vat"><iaixsl:value-of select="$var_gross_prices"/></span><span class="price_sellby"><span class="price_sellby__sep"><iaixsl:text>/</iaixsl:text></span><span class="price_sellby__sellby" data-sellby="{$var_sellby}"><iaixsl:value-of select="$var_sellby"/></span><span class="price_sellby__unit"><iaixsl:value-of select="$var_unit"/></span></span>
															
															<iaixsl:if test="price/@unit_converted_price_formatted or product/price/@unit_converted_price_formatted ">
																<span class="price --convert">(<iaixsl:value-of select="price/@unit_converted_price_formatted"/><iaixsl:value-of select="product/price/@unit_converted_price_formatted"/><iaixsl:text> / </iaixsl:text><iaixsl:value-of select="price/@unit_converted_format"/><span class="price_vat"><iaixsl:value-of select="$var_gross_prices"/></span>)</span>
															</iaixsl:if>
                            </strong>
                            <iaixsl:if test="$var_points != ''">
                              <span class="price --points">
                                <iaixsl:value-of select="$var_points"/><span class="currency"> iai_i18n:[cGt0].</span>
                              </span>
                            </iaixsl:if>
                          ...
                          <iaixsl:otherwise>
                            <strong class="price --main">
                              <iaixsl:value-of select="$var_price_formatted"/><span class="price_vat"><iaixsl:value-of select="$var_gross_prices"/></span><span class="price_sellby"><span class="price_sellby__sep"><iaixsl:text>/</iaixsl:text></span><span class="price_sellby__sellby" data-sellby="{$var_sellby}"><iaixsl:value-of select="$var_sellby"/></span><span class="price_sellby__unit"><iaixsl:value-of select="$var_unit"/></span></span>
                    ...
                    <iaixsl:otherwise>
                      ...
                      <iaixsl:variable name="var_price_net_formatted">
                        <iaixsl:choose>
                          <iaixsl:when test="price/@price_unit_net_formatted and sizes/@unit"><iaixsl:value-of select="price/@price_unit_net_formatted"/></iaixsl:when>
                          <iaixsl:when test="product/price/@price_unit_net_formatted and product/sizes/@unit"><iaixsl:value-of select="product/price/@price_unit_net_formatted"/></iaixsl:when>
                      ...
                      <div class="product__prices">
                        ...
                        <iaixsl:choose>
                          ...
                          <iaixsl:when test="$var_size_min_net_formatted != $var_size_max_net_formatted">
                            <strong class="price --main">
                              <span class="price__range --min"><iaixsl:value-of select="$var_size_min_net_formatted"/></span><iaixsl:text> - </iaixsl:text><span class="price__range --max"><iaixsl:value-of select="$var_size_max_net_formatted"/></span><span class="price_vat"><iaixsl:value-of select="$var_net_prices"/></span><span class="price_sellby"><span class="price_sellby__sep"><iaixsl:text>/</iaixsl:text></span><span class="price_sellby__sellby" data-sellby="{$var_sellby}"><iaixsl:value-of select="$var_sellby"/></span><span class="price_sellby__unit"><iaixsl:value-of select="$var_unit"/></span></span>
															<iaixsl:if test="price/@unit_converted_price_net_formatted or product/price/@unit_converted_price_net_formatted ">
																<span class="price --convert">(<iaixsl:value-of select="price/@unit_converted_price_net_formatted"/><iaixsl:value-of select="product/price/@unit_converted_price_net_formatted"/><iaixsl:text> / </iaixsl:text><iaixsl:value-of select="price/@unit_converted_format"/><span class="price_vat"><iaixsl:value-of select="$var_gross_prices"/></span>)</span>
															</iaixsl:if>
                            </strong>
                            <iaixsl:if test="$var_points_net != ''">
                              <span class="price --points">
                                <iaixsl:value-of select="$var_points_net"/><span class="currency"> iai_i18n:[cGt0].</span>
                              </span>
                            </iaixsl:if>
                          ...
                          <iaixsl:otherwise>
                            <strong class="price --main">
                              <iaixsl:value-of select="$var_price_net_formatted"/><span class="price_vat"><iaixsl:value-of select="$var_net_prices"/></span><span class="price_sellby"><span class="price_sellby__sep"><iaixsl:text>/</iaixsl:text></span><span class="price_sellby__sellby" data-sellby="{$var_sellby}"><iaixsl:value-of select="$var_sellby"/></span><span class="price_sellby__unit"><iaixsl:value-of select="$var_unit"/></span></span>
                                <iaixsl:if test="price/@unit_converted_price_net_formatted or product/price/@unit_converted_price_net_formatted ">
                                  <span class="price --convert">(<iaixsl:value-of select="price/@unit_converted_price_net_formatted"/><iaixsl:value-of select="product/price/@unit_converted_price_net_formatted"/><iaixsl:text> / </iaixsl:text><iaixsl:value-of select="price/@unit_converted_format"/><span class="price_vat"><iaixsl:value-of select="$var_gross_prices"/></span>)</span>
                                </iaixsl:if>
                            </strong>
                            ...
                            <iaixsl:if test="$var_regular_price != ''">
                              <span class="price --max">
                                <span class="omnibus_label">iai_i18n:[Q2VuYSByZWd1bGFybmE=]: </span>
                                <del><iaixsl:value-of select="$var_regular_price"/></del><span class="price_vat"><iaixsl:value-of select="$var_net_prices"/></span><span class="price_sellby"><span class="price_sellby__sep"><iaixsl:text>/</iaixsl:text></span><span class="price_sellby__sellby" data-sellby="{$var_sellby}"><iaixsl:value-of select="$var_sellby"/></span><span class="price_sellby__unit"><iaixsl:value-of select="$var_unit"/></span></span><span class="price_percent"><iaixsl:value-of select="$var_regular_percent"/></span>
                              </span>
                            </iaixsl:if>
                            <iaixsl:if test="$var_omnibus_rebate_code != '' and $var_beforerebate_price !=''">
                              <span class="price --before-rebate">
                                <span class="omnibus_label">iai_i18n:[Q2VuYSBiZXoga29kdQ==]: </span>
                                <del><iaixsl:value-of select="$var_beforerebate_price"/></del><span class="price_vat"><iaixsl:value-of select="$var_net_prices"/></span><span class="price_sellby"><span class="price_sellby__sep"><iaixsl:text>/</iaixsl:text></span><span class="price_sellby__sellby" data-sellby="{$var_sellby}"><iaixsl:value-of select="$var_sellby"/></span><span class="price_sellby__unit"><iaixsl:value-of select="$var_unit"/></span></span>
                                <span class="price_percent"><iaixsl:value-of select="$var_beforerebate_percent"/></span>
                              </span>
                            </iaixsl:if>
                            <iaixsl:if test="$var_new_price_date != '' and $var_regular_price != ''">
                    ...
                    <div class="product__opinion">
                      ...
                      <iaixsl:if test="@note">
                        <div class="note">
                          ...
                          <small>
                            iai_i18n:[T2NlbmE=]: <iaixsl:value-of disable-output-escaping="yes" select="@note"/>/5
                          </small>
                        </div>
                      </iaixsl:if>
            ...
            <iaixsl:if test="page/facebook_comments">
                <div class="cms_fb_comments">
                    <div class="big_label cms_fb_comments_label">
                        iai_i18n:[UG9kemllbCBzacSZIHN3b2ltIGtvbWVudGFyemVtIHogaW5ueW1p]
                    </div>
                    <div id="fb-root"/>
                    <script>
