...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (affiliate_orders_list, 60dd8e841e03e1.60115378.3)-->
  <iaixsl:variable name="affiliate_1">iai_i18n:[SWQga2xpZW50YQ==]</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">iai_i18n:[RGF0YSB6YcWCb8W8ZW5pYSBrb250YQ==]</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">iai_i18n:[SWxvxZvEhyB6xYJvxbxvbnljaCB6YW3Ds3dpZcWE]</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">iai_i18n:[V2FydG/Fm8SHIHphbcOzd2lvbnljaCBwcm9kdWt0w7N3]</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">iai_i18n:[SWxvxZvEhyB3eWtvbmFueWNoIHphbcOzd2llxYQ=]</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">iai_i18n:[S3dvdGEgd3lrb25hbnljaCB6YW3Ds3dpZcWE]</iaixsl:variable>
  <iaixsl:variable name="affiliate_7">(iai_i18n:[YmV6IGtvc3p0w7N3IHByemVzecWCa2k=])</iaixsl:variable>
  <iaixsl:if test="not(page/@type='affiliate-not-active')">
    <h1 class="headline">
      <span class="headline__name">
        iai_i18n:[WmFtw7N3aWVuaWEgVHdvaWNoIGtsaWVudMOzdw==]
      </span>
    </h1>
    ...
    <iaixsl:choose>
      <iaixsl:when test="count(page/orders/client)">
        <section class="affiliate --orders mb-4">
          <div class="affiliate__desc mb-4">
            iai_i18n:[].
          </div>
          ...
          <div class="affiliate__table --six table">
            ...
            <div class="table__row mb-5 mb-md-0 p-3 p-md-0">
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_1"/></span><a><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><span class="sr-only d-none d-md-inline"><iaixsl:value-of select="$affiliate_1"/></span><iaixsl:value-of select="@nr"/></a></span>
            ...
            <iaixsl:if test="page/orders/client_sum">
              <div class="table__row --summary mb-5 mb-md-0 p-3 p-md-0">
                <span class="table__cell d-flex justify-content-between">iai_i18n:[U3VtYQ==]</span>
      ...
      <iaixsl:otherwise>
        <div class="affiliate__info">
          iai_i18n:[QnJhayB6YW3Ds3dpZcWEIHrFgm/FvG9ueWNoIHByemV6IFR3b2ljaCBrbGllbnTDs3c=].
        </div>
      </iaixsl:otherwise>
    </iaixsl:choose>
  </iaixsl:if>
<!-- (affiliate_orders_paging, 60dd8e7f4593b9.16001856.5)-->
