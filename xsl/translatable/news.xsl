...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (news, 60dd8e81056b15.48165325.9)-->
	<iaixsl:variable name="news_item_date">true</iaixsl:variable>
	<iaixsl:variable name="news_list_date">true</iaixsl:variable>
	<iaixsl:variable name="news_list_see_more">iai_i18n:[Q3p5dGFqIHdpxJljZWo=]</iaixsl:variable>
	...
	<iaixsl:choose>
		...
		<iaixsl:when test="/shop/page/newslist">
			<section id="news_list" class="article mb-4">
				<h1 class="headline">
					<span class="headline__name">iai_i18n:[QWt0dWFsbm/Fm2Np]</span>
				</h1>
				...
				<iaixsl:choose>
					...
					<iaixsl:when test="not(/shop/page/newslist/mainpage1)">
						<div class="menu_messages_message" id="menu_messages_warning">
							<div class="menu_messages_warning_sub">
								<p>iai_i18n:[VyB0ZWogY2h3aWxpIG5pZSBtYSDFvGFkbnljaCBha3R1YWxub8WbY2k=].</p>
							</div>
						</div>
					</iaixsl:when>
					<iaixsl:otherwise>
							...
							<iaixsl:for-each select="page/newslist/mainpage1/item">
								<article class="article__item">
									...
									<iaixsl:choose>
										...
										<iaixsl:otherwise>
											<div class="article__image_wrapper --logo">
												<iaixsl:choose>
													<iaixsl:when test="/shop/mask/top/link/image_mobile/@src and /shop/mask/top/link/image_tablet/@src">
														<picture>
															<iaixsl:if test="/shop/mask/top/link/image/@src">
									...
									<div class="article__content" data-enabled-data="{$news_list_date}">
										...
										<iaixsl:choose>
											<iaixsl:when test="(link/@href) != ''">
												<h2 class="article__name_wrapper">
										...
										<iaixsl:if test="link/@href and $news_list_see_more">
											<a class="article__more_link" href="{link/@href}" tabindex="-1">
												<iaixsl:if test="not((link/@href) != '')">
													<iaixsl:attribute name="tabindex">0</iaixsl:attribute>
												</iaixsl:if>
												<iaixsl:attribute name="title"><iaixsl:value-of disable-output-escaping="yes" select="title"/></iaixsl:attribute>
												<span class="link__text"><iaixsl:value-of select="$news_list_see_more"/></span>
...
<!-- (news_paging, 60dd8e7fc611d0.13459073.5)-->
      ...
      <iaixsl:if test="page/newslist/navigation/prev">
        <li class="pagination__element --prev">
          ...
          <a class="pagination__link">
            <iaixsl:attribute name="href"><iaixsl:choose><iaixsl:when test="page/newslist/navigation/prev/@counter = '0'"><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/newslist/navigation/path/@value, '&amp;counter=')"/><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/newslist/navigation/path/@value, '?counter=')"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of disable-output-escaping="yes" select="page/newslist/navigation/path/@value"/><iaixsl:value-of select="page/newslist/navigation/prev/@counter"/></iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>
...
<!-- (news_bookmarklets, 60dd8e7c871209.72571313.9)-->
        ...
        <!-- (news_cms_associated, 67ef81c2c707c2.57276852.3)-->
	<iaixsl:if test="/shop/page/news/cms_products/product or /shop/page/news/cms_products/opinion">

		<section id="news_cms_associated" class="hotspot__wrapper">
      <div class="hotspot">
        
        <iaixsl:variable name="headline_after_news_cms_associated">iai_i18n:[Wm9iYWN6IHdzenlzdGtpZQ==]</iaixsl:variable>
