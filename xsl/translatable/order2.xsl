...
<!-- (menu_messages, 60dd8e79b18501.50382803.13)-->
        ...
        <!-- (cop_modules_order2, 66e3fd6c4b49e6.26970844.10)-->
	<script>
      ...
      buy_button_text: &quot;<iaixsl:choose>
        <iaixsl:when test="/shop/page/order2/orderdetails/@express_checkout = 'true'">iai_i18n:[UG90d2llcmTFuiB6YWt1cA==]</iaixsl:when>
        ...
        <iaixsl:otherwise>iai_i18n:[QWtjZXB0dWrEmSwgemFtYXdpYW0gaSBwxYJhY8SZ]</iaixsl:otherwise>
      </iaixsl:choose>&quot;,
		};
	</script>
	<script>
	...
	<form method="POST" id="COP" class="cop --order2">
		...
		<div class="cop__content">
			...
			<div class="cop_order_wrapper">
				<h2 class="cop__title --first">iai_i18n:[WmFtw7N3aWVuaWU=]</h2>
  ...
  <template id="cop_verification_template">
    <div class="cop_verification">
      ...
      <iaixsl:if test="/shop/page/order2/orderclient/@nip">
        <iaixsl:attribute name="data-billing-nip">iai_i18n:[TklQ]<iaixsl:text>: </iaixsl:text><iaixsl:value-of select="/shop/page/order2/orderclient/@nip"/></iaixsl:attribute>
      </iaixsl:if>
      <iaixsl:if test="/shop/page/order2/orderclient/@email and /shop/page/order2/orderclient/@email != ''">
        <iaixsl:attribute name="data-billing-email">iai_i18n:[ZS1tYWls]<iaixsl:text>: </iaixsl:text><iaixsl:value-of select="/shop/page/order2/orderclient/@email"/></iaixsl:attribute>
      </iaixsl:if>
      <iaixsl:if test="/shop/page/order2/orderclient/@phone1 and /shop/page/order2/orderclient/@phone1 != ''">
        <iaixsl:attribute name="data-billing-phone">iai_i18n:[dGVsZWZvbg==]<iaixsl:text>: </iaixsl:text><iaixsl:value-of select="/shop/page/order2/orderclient/@phone1"/></iaixsl:attribute>
      </iaixsl:if>
      ...
      <iaixsl:if test="/shop/page/order2/deliveryaddress/@phone and /shop/page/order2/deliveryaddress/@phone != ''">
        <iaixsl:attribute name="data-delivery-phone">iai_i18n:[dGVsZWZvbg==]<iaixsl:text>: </iaixsl:text><iaixsl:value-of select="/shop/page/order2/deliveryaddress/@phone"/></iaixsl:attribute>
      </iaixsl:if>
      ...
      <iaixsl:if test="/shop/page/order2/deliveryaddress/@phone and /shop/page/order2/deliveryaddress/@phone != ''">
        <iaixsl:attribute name="data-pickup-phone">iai_i18n:[dGVsZWZvbg==]<iaixsl:text>: </iaixsl:text><iaixsl:value-of select="/shop/page/order2/deliveryaddress/@phone"/></iaixsl:attribute>
      </iaixsl:if>
      ...
      <iaixsl:if test="/shop/page/order2/payer_address">
        ...
        <iaixsl:if test="/shop/page/order2/payer_address/@nip">
          <iaixsl:attribute name="data-payer-nip">iai_i18n:[TklQ]<iaixsl:text>: </iaixsl:text><iaixsl:value-of select="/shop/page/order2/payer_address/@nip"/></iaixsl:attribute>
        </iaixsl:if>
        <iaixsl:if test="/shop/page/order2/payer_address/@email and /shop/page/order2/payer_address/@email != ''">
          <iaixsl:attribute name="data-payer-email">iai_i18n:[ZS1tYWls]<iaixsl:text>: </iaixsl:text><iaixsl:value-of select="/shop/page/order2/payer_address/@email"/></iaixsl:attribute>
        </iaixsl:if>
        <iaixsl:if test="/shop/page/order2/payer_address/@phone and /shop/page/order2/payer_address/@phone != ''">
          <iaixsl:attribute name="data-payer-phone">iai_i18n:[dGVsZWZvbg==]<iaixsl:text>: </iaixsl:text><iaixsl:value-of select="/shop/page/order2/payer_address/@phone"/></iaixsl:attribute>
        </iaixsl:if>
        <iaixsl:attribute name="data-payer-edit"><iaixsl:value-of select="/shop/page/order2/orderclient/@changelink"/></iaixsl:attribute>
      </iaixsl:if>
      <h2 class="cop__title">iai_i18n:[U3ByYXdkxbogcG9wcmF3bm/Fm8SHIHphbcOzd2llbmlh]</h2>
  ...
  <template id="cop_verification_item_template">
    <div class="cop_verification__item">
      ...
      <div class="cop_verification__data">
        ...
        <a class="cop_verification__edit">iai_i18n:[RWR5dHVq]</a>
      </div>
    </div>
  </template>
  <template id="cop_verification_no_phone_template">
    <span class="cop_verification__data_item --no-phone">
      ...
      <span class="cop_verification__phone_label">iai_i18n:[dGVsZWZvbg==]<iaixsl:text>: </iaixsl:text></span>
      ...
      <span class="f-group --small cop_verification__phone_empty">
        <span class="f-feedback">
          ...
          <label class="f-label" for="order2TelInput">iai_i18n:[TnVtZXIgdGVsZWZvbnU=]</label>
