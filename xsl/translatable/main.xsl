...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/main_style.css?r=1765442856</iaixsl:attribute></link></iaixsl:when>
    <iaixsl:otherwise><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/main_style.css.gzip?r=1765442856</iaixsl:attribute></link></iaixsl:otherwise>
</iaixsl:choose>
...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/main_shop.js?r=1765442856</iaixsl:attribute></script></iaixsl:when>
    <iaixsl:otherwise><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/main_shop.js.gzip?r=1765442856</iaixsl:attribute></script></iaixsl:otherwise>
</iaixsl:choose>

				
				<script src="/gfx/translatable/main_banner_modules.js.gzip?r=1765442856" type="module"></script>
			</iaixsl:if>
...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (main_banner1, 6655c454173933.48197314.10)-->
...
<iaixsl:variable name="ThumbnailsEnable">false</iaixsl:variable>


<iaixsl:variable name="SliderEnable">true</iaixsl:variable>


<iaixsl:variable name="FadeEffect">false</iaixsl:variable>


<iaixsl:variable name="FreeMode">false</iaixsl:variable>


<iaixsl:variable name="FullWidth">false</iaixsl:variable>


<iaixsl:variable name="EnableHTML">false</iaixsl:variable>


<iaixsl:variable name="AutoplayEnable">true</iaixsl:variable>


<iaixsl:variable name="AutoplaySpeed">5000</iaixsl:variable>



  <div id="main_banner1" class="section skeleton" data-full-width="{$FullWidth}" data-html-enable="{$EnableHTML}" data-thumbnails="false" data-thumbnails-count="{$ThumbnailsCount}" data-thumbnails-enable="{$ThumbnailsEnable}" data-slider-autoplay-enable="{$AutoplayEnable}" data-slider-autoplay-speed="{$AutoplaySpeed}" data-slider-fade-effect="{$FadeEffect}" data-slider-enable="{$SliderEnable}" data-slider-freemode="{$FreeMode}">
    <div class="main_slider">
      <div class="main_slider__wrapper swiper">
        <div class="swiper-wrapper">
          <iaixsl:for-each select="commercial_banner/link">
            <iaixsl:if test="not(html)">
              
              <iaixsl:variable name="SliderLazyLoading"><iaixsl:choose>
                <iaixsl:when test="position() = 1">eager</iaixsl:when>
                <iaixsl:otherwise>lazy</iaixsl:otherwise>
              </iaixsl:choose></iaixsl:variable>

              
              <iaixsl:variable name="bannerName"><iaixsl:value-of select="substring-before(text, '#')"/></iaixsl:variable>
              
              <iaixsl:variable name="bannerDescription"><iaixsl:choose>
                <iaixsl:when test="not(substring-after(substring-after(text, '#'), '#') = '')">
                  <iaixsl:value-of select="substring-before(substring-after(text, '#'), '#')"/>
                </iaixsl:when>
                <iaixsl:otherwise>
                  <iaixsl:value-of select="substring-after(text, '#')"/>
                </iaixsl:otherwise>
              </iaixsl:choose></iaixsl:variable>
              
              <iaixsl:variable name="bannerAlign"><iaixsl:value-of select="substring-after(substring-after(text, '#'), '#')"/></iaixsl:variable>
              <iaixsl:variable name="bannerAlignClass"><iaixsl:if test="not($bannerAlign = '')">--<iaixsl:value-of select="$bannerAlign"/></iaixsl:if></iaixsl:variable>
              
              <iaixsl:variable name="name"><iaixsl:choose>
                <iaixsl:when test="$bannerName !=''"><iaixsl:value-of select="$bannerName"/></iaixsl:when>
                <iaixsl:otherwise><iaixsl:value-of select="text"/></iaixsl:otherwise>
              </iaixsl:choose></iaixsl:variable>
              
              <iaixsl:variable name="imgNotLoaded"><iaixsl:if test="not(position() = 1)">slide-lazy</iaixsl:if></iaixsl:variable>

              
              <iaixsl:variable name="hasHtmlElements"><iaixsl:if test="not($bannerName = '')">--has-html-elements</iaixsl:if></iaixsl:variable>

              <div class="main_slider__item swiper-slide {$bannerAlignClass} {$imgNotLoaded} {$hasHtmlElements}">
                <iaixsl:variable name="banerItemContent">
                  <iaixsl:choose>
                    <iaixsl:when test="image">
                      <iaixsl:if test="image/@src">
                        <img src="{image/@src}" width="{image/@width}" height="{image/@height}" alt="{$name}" loading="{$SliderLazyLoading}"/>
                      </iaixsl:if>
                    </iaixsl:when>
                    <iaixsl:when test="image_desktop or image_tablet or image_mobile">
                      <picture>
                        <iaixsl:if test="image_desktop/@src">
                          <source width="image_desktop/@width" height="image_desktop/@height" media="(min-width:979px)" srcset="{image_desktop/@src}"/>
                        </iaixsl:if>
                        <iaixsl:if test="image_tablet/@src">
                          <source width="image_tablet/@width" height="image_tablet/@height" media="(min-width:757px)" srcset="{image_tablet/@src}"/>
                        </iaixsl:if>
                        <iaixsl:if test="image_mobile/@src">
                          <img src="{image_mobile/@src}" width="{image_mobile/@width}" height="{image_mobile/@height}" alt="{$name}" loading="{$SliderLazyLoading}"/>
                        </iaixsl:if>
                      </picture>
                    </iaixsl:when>
                    <iaixsl:otherwise>
                  ...
                  <iaixsl:if test="not($bannerName = '')">
                    <div class="main_slider__content container max-width-1200">
                      ...
                      <iaixsl:if test="@href">
                        <span class="main_slider__button btn --solid --medium">iai_i18n:[U3ByYXdkxbo=]</span>
                      </iaixsl:if>
                    </div>
                  </iaixsl:if>
                </iaixsl:variable>
                <iaixsl:choose>
                  <iaixsl:when test="@href">
                    <a target="{@target}" title="{$name}" tabindex="-1" href="{@href}">
                      <iaixsl:copy-of select="$banerItemContent"/>
                    </a>
                  </iaixsl:when>
                  <iaixsl:otherwise>
                    <div><iaixsl:copy-of select="$banerItemContent"/></div>
                  </iaixsl:otherwise>
                </iaixsl:choose>
              </div>
            </iaixsl:if>
            <iaixsl:if test="html">
              <div class="main_slider__item --banner-html swiper-slide"><iaixsl:value-of disable-output-escaping="yes" select="html"/></div>
            </iaixsl:if>
          </iaixsl:for-each>
        </div>
      </div>
      ...
      <div class="sliderNavigation variable-max-width">
    ...
    <iaixsl:if test="$ThumbnailsEnable = 'true' and ($ThumbnailsCount &gt; 0 or $ThumbnailsCount = 'auto')">
      <div class="main_slider__thumbnails main_pager swiper swiperThumbs max-width-1200" thumbsSlider="" style="--thumbnails-count: {$ThumbnailsCount}" data-count="{count(commercial_banner/link)}">
        <div class="swiper-wrapper">
          <iaixsl:for-each select="commercial_banner/link">
            <iaixsl:variable name="bannerNamePager"><iaixsl:choose>
              <iaixsl:when test="not(substring-before(text, '#') = '')"><iaixsl:value-of select="substring-before(text, '#')"/></iaixsl:when>
              <iaixsl:otherwise><iaixsl:value-of select="text"/></iaixsl:otherwise>
            </iaixsl:choose></iaixsl:variable>

            <a class="main_pager__item swiper-slide" href="#mainPager{position() - 1}" slide-index="{position() - 1}">
              <iaixsl:value-of select="$bannerNamePager"/>
            </a>
          </iaixsl:for-each>
        </div>
      </div>
...
<!-- (main_buttons2, 60dd8e79255be8.84611071.7)-->
	<iaixsl:if test="count(commercial_button2/link)">
		<div id="menu_buttons2" class="section row">
			<iaixsl:variable name="MenuButtonWrapperClass"><iaixsl:choose>
				<iaixsl:when test="count(/shop/commercial_button2/link) = 1">col-12</iaixsl:when>
				<iaixsl:when test="count(/shop/commercial_button2/link) = 2">col-6</iaixsl:when>
				<iaixsl:when test="count(/shop/commercial_button2/link) = 3">col-md-4 col-6</iaixsl:when>
				<iaixsl:otherwise>col-md-3 col-6</iaixsl:otherwise>
			</iaixsl:choose></iaixsl:variable>
	
			<iaixsl:for-each select="commercial_button2/link">
				<div class="menu_button_wrapper {$MenuButtonWrapperClass}">
					<iaixsl:choose>
								...
								<iaixsl:when test="@href">
									<a target="_self" href="{@href}">
										...
										<iaixsl:attribute name="aria-label"><iaixsl:choose>
											...
											<iaixsl:otherwise>iai_i18n:[T2JyYXplayB3IHNla2NqaSBncmFmaWN6bmVq] - <iaixsl:value-of select="position()"/></iaixsl:otherwise>
										</iaixsl:choose></iaixsl:attribute>
										<iaixsl:choose>
											<iaixsl:when test="image">
												<iaixsl:if test="image/@src">
													<img width="{image/@width}" height="{image/@height}" alt="{text}" src="{image/@src}" loading="lazy"/>
												</iaixsl:if>
											</iaixsl:when>
											<iaixsl:when test="image_desktop or image_tablet or image_mobile">
												<picture>
													...
													<iaixsl:if test="image_mobile/@src">
														<img width="{image_mobile/@width}" height="{image_mobile/@height}" alt="{text}" src="{image_mobile/@src}" loading="lazy"/>
													</iaixsl:if>
												</picture>
											</iaixsl:when>
											<iaixsl:otherwise>
...
<!-- (main_news2, 60dd8e807bc210.32067134.6)-->
	<iaixsl:variable name="main_blog_date"/>
	<iaixsl:variable name="main_blog_after_label">iai_i18n:[Wm9iYWN6IHdzenlzdGtv]</iaixsl:variable>
	<iaixsl:variable name="main_blog_see_more">iai_i18n:[Q3p5dGFqIHdpxJljZWo=]</iaixsl:variable>
	...
	<iaixsl:if test="count(page/mainpage2/item) &gt; 0">
		<section id="main_blog" class="section article">
            ...
            <span class="link__text"><iaixsl:value-of select="$main_blog_after_label"/></span>
            <i class="icon icon-ds-arrow-right pl-1"/>
					</a>
				</iaixsl:if>
			</h2>
			...
			<div class="article__block">
				<iaixsl:for-each select="page/mainpage2/item">
					<article class="article__item">
						...
						<div class="article__content" data-enabled-data="{$main_blog_date}">
							...
							<iaixsl:if test="more/@href and $main_blog_see_more">
								<a class="article__more_link" href="{more/@href}" tabindex="-1">
									...
									<iaixsl:attribute name="title"><iaixsl:value-of disable-output-escaping="yes" select="title"/></iaixsl:attribute>
									<span class="link__text"><iaixsl:value-of select="$main_blog_see_more"/></span>
									<i class="icon icon-ds-arrow-right pl-1"/>
								</a>
							</iaixsl:if>
						</div>
...
<!-- (main_news1, 60dd8e80c250e0.04895316.6)-->
	<iaixsl:variable name="main_news_date">true</iaixsl:variable>
	<iaixsl:variable name="main_news_after_label">iai_i18n:[Wm9iYWN6IHdzenlzdGtv]</iaixsl:variable>
	<iaixsl:variable name="main_news_see_more">iai_i18n:[Q3p5dGFqIHdpxJljZWo=]</iaixsl:variable>
	<iaixsl:variable name="main_news_view_all"/>

	<iaixsl:if test="count(page/mainpage1/item) &gt; 0">
		<section id="main_news" class="section article">
			<h2 class="headline__wrapper">
				<a href="/news.php" class="headline">
					<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYnkgem9iYWN6ecSHIHdzenlzdGtpZSBha3R1YWxub8WbY2k=]</iaixsl:attribute>
				...
				<iaixsl:if test="$main_news_after_label">
					<a href="/news.php" class="headline__after">
						<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiwgYnkgem9iYWN6ecSHIHdzenlzdGtpZSBha3R1YWxub8WbY2k=]</iaixsl:attribute>
						<iaixsl:if test="/shop/page/mainpage1/@link and /shop/page/mainpage1/@link!=''">
							<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/mainpage1/@link"/></iaixsl:attribute>
						</iaixsl:if>
		        <span class="link__text"><iaixsl:value-of select="$main_news_after_label"/></span>
            <i class="icon icon-ds-arrow-right pl-1"/>
					</a>
				</iaixsl:if>
			</h2>
			...
			<div class="article__block">
				<iaixsl:for-each select="page/mainpage1/item">
					<article class="article__item">
						...
						<div class="article__content" data-enabled-data="{$main_news_date}">
							...
							<iaixsl:if test="more/@href and $main_news_see_more">
								<a class="article__more_link" href="{more/@href}" tabindex="-1">
									...
									<iaixsl:attribute name="title"><iaixsl:value-of disable-output-escaping="yes" select="title"/></iaixsl:attribute>
									<span class="link__text"><iaixsl:value-of select="$main_news_see_more"/></span>
									<i class="icon icon-ds-arrow-right pl-1"/>
								</a>
							</iaixsl:if>
						</div>
...
<!-- (main_cms2, 60dd8e7963f590.06535622.3)-->
	<iaixsl:if test="page/text[@id='14']">
			<iaixsl:for-each select="page/text[@id='14']">
			<div class="section" id="main_cms2">
				<iaixsl:value-of disable-output-escaping="yes" select="body"/>
			</div>
		</iaixsl:for-each>
	</iaixsl:if>
<!-- (main_banner3, 60dd8e7971b6a5.80968138.9)-->
	<iaixsl:if test="count(commercial_banner3/link)">
		<div id="menu_banners3" class="section row mx-0">
			<iaixsl:variable name="MenuButtonWrapperClass"><iaixsl:choose>
				<iaixsl:when test="count(/shop/commercial_banner3/link) = 1">col-12</iaixsl:when>
				<iaixsl:when test="count(/shop/commercial_banner3/link) = 2">col-6</iaixsl:when>
				<iaixsl:when test="count(/shop/commercial_banner3/link) = 3">col-md-4 col-6</iaixsl:when>
				<iaixsl:otherwise>col-md-3 col-6</iaixsl:otherwise>
			</iaixsl:choose></iaixsl:variable>
...
<!-- (main_instagram, 61ea6b913aaff9.86215405.11)-->
	<iaixsl:if test="/shop/integrations/instagram">
		<div id="instagram" class="section instagram --skeleton --main" numberOfElements="{/shop/integrations/instagram/@images_number}">
			<div class="instagram__label">
				<h2 class="headline__wrapper">
					<iaixsl:choose>
						<iaixsl:when test="/shop/integrations/instagram/@headline_own = 'true'">
							<a class="headline" target="blank" tabindex="0">
								...
								<iaixsl:attribute name="title">iai_i18n:[QG15IG5hIEluc3RhZ3JhbWll]</iaixsl:attribute>
								iai_i18n:[QG15IG5hIEluc3RhZ3JhbWll]
							</a>
						</iaixsl:when>
						<iaixsl:otherwise>
							<iaixsl:choose>
								<iaixsl:when test="/shop/integrations/instagram/hashtags/hashtag">
									<iaixsl:for-each select="/shop/integrations/instagram/hashtags/hashtag">
										<a class="headline" target="blank" title="{@name}" tabindex="0">
								...
								<iaixsl:otherwise>
									<a class="headline" target="blank" tabindex="0">
										<iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/integrations/instagram/@profile_url"/></iaixsl:attribute>
										<iaixsl:attribute name="title">@<iaixsl:value-of select="/shop/integrations/instagram/@profile_name"/> iai_i18n:[bmEgSW5zdGFncmFtaWU=]</iaixsl:attribute>
										@<iaixsl:value-of select="/shop/integrations/instagram/@profile_name"/> iai_i18n:[bmEgSW5zdGFncmFtaWU=]
									</a>
									<a class="headline__after" target="blank" tabindex="0">
										<iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/integrations/instagram/@profile_url"/></iaixsl:attribute>
										<iaixsl:attribute name="title">iai_i18n:[U3ByYXdkxbogbmFzeiBwcm9maWwgbmEgSW5zdGFncmFtaWU=]</iaixsl:attribute>
										<span class="link__text">iai_i18n:[U3ByYXdkxbogbmFzeiBwcm9maWwgbmEgSW5zdGFncmFtaWU=]</span>
										<i class="icon icon-ds-arrow-right pl-1"/>
									</a>
								</iaixsl:otherwise>
							</iaixsl:choose>
			...
			<div class="instagram__slider swiper">
				<div class="instagram__items swiper-wrapper">
