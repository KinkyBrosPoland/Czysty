...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
            ...
            <div id="menu_affiliate">
                <a class="btn --outline --icon-left --medium icon-angle-left" href="/affiliate-main.php">
                    <iaixsl:attribute name="title"/>
                    iai_i18n:[U3Ryb25hIGfFgsOzd25hIHByb2dyYW11IHBhcnRuZXJza2llZ28=] 
                </a>
            </div>
        ...
        <!-- (affiliate_generator_mode, 60dd8e851505b0.80343040.3)-->
  <iaixsl:if test="page/generator">
	<span class="headline d-none">
	<span class="headline__name">
		iai_i18n:[R2VuZXJhdG9yIGtvZHU=]
	</span>
	</span>
	<section class="affiliate --generator --menu px-sm-4 pb-sm-4">
		...
		<iaixsl:if test="page/generator/@type='html' or page/generator/@type='js' or page/generator/@type='php'">
			...
			<iaixsl:choose>
				<iaixsl:when test="page/generator/@type='html'">iai_i18n:[].</iaixsl:when>
				<iaixsl:when test="page/generator/@type='js'">iai_i18n:[].</iaixsl:when>
				<iaixsl:when test="page/generator/@type='php'">iai_i18n:[].</iaixsl:when>
			</iaixsl:choose>
			</div>
		</iaixsl:if>
	</section>
	<iaixsl:if test="not(page/generator/@type='promoCodes' or page/generator/@type='html' or page/generator/@type='php' or page/generator/@type='js')">
		<section class="affiliate --generator --content --noactive px-sm-4 pb-sm-4">
			<div class="affiliate__info mb-0">
				iai_i18n:[TmllIHd5YnJhbm8gdHlwdSBnZW5lcmF0b3Jh].
			</div>
		</section>
 	 </iaixsl:if>
  </iaixsl:if>
<!-- (affiliate_generator_javascript, 60dd8e852ccc30.38395459.5)-->
  <iaixsl:if test="page/generator/@type='js'">
    <section>
      <form class="affiliate --generator --content --js px-sm-4 pb-4" method="POST">
        <h1 class="headline">
          <span class="headline__name">
            iai_i18n:[S3JvayAxIC0gV3liaWVyeiBwcm9kdWt0eQ==]
          </span>
        </h1>
        <div class="f-group">
          <div class="f-feedback">
            ...
            <label for="affiliate__link" class="f-label">iai_i18n:[V3Bpc3ogVVJMIGRvIHByb2R1a3TDs3cgLCBrdMOzcmUgem9zdGFuxIUgendyw7Njb25lIHcgcmVrbGFtaWU=].</label>
            <span class="f-control-feedback"/>
            <a href="#check" class="affiliate__button --check btn --solid mt-2">iai_i18n:[U3ByYXdkxbogcHJvZHVrdHk=]</a>
          </div>
        </div>
        <span class="headline">
          <span class="headline__name">
            iai_i18n:[S3JvayAyIC0gV3lnbMSFZCByZWtsYW15]
          </span>
        </span>
        <div class="affiliate__desc mb-2">iai_i18n:[RG9zdG9zdWogd3lnbMSFZCByZWtsYW15IHBvZGFqxIVjIHBhcmFtZXRyeSBqZWogd3nFm3dpZXRsYW5pYSwgcm96bWlhciBpIGtvbG9yeXN0eWvEmS4gQWJ5IG90d29yennEhyBwcnp5Ym9ybmlrIHd5Ym9ydSBrb2xvcnUga2xpa25paiBuYSBrb2xvcm93xIUgaWtvbmvEmQ==]</div>
        <div class="row">
          <div class="col-12 col-md-6">
            <strong class="d-block mb-4">iai_i18n:[VXN0YXdpZW5pYSB3ecWbd2lldGxhbmlh]</strong>
            <div class="row">
              <div class="col-12">
                <iaixsl:choose>
                  <iaixsl:when test="count(/shop/language/option) = 1">
                  ...
                  <iaixsl:otherwise>
                    <select class="f-select --small" name="language">
                      <iaixsl:attribute name="data-label">iai_i18n:[SsSZenlr]: </iaixsl:attribute>
                      <iaixsl:for-each select="/shop/language/option">
                        <option>
                          <iaixsl:attribute name="value"><iaixsl:value-of select="@id"/></iaixsl:attribute>
                          <iaixsl:value-of select="@name"/>
                ...
                <iaixsl:choose>
                  ...
                  <iaixsl:otherwise>
                    <select class="f-select --small" name="currency">
                      <iaixsl:attribute name="data-label">iai_i18n:[V2FsdXRh]: </iaixsl:attribute>
                      <iaixsl:for-each select="/shop/currency/option">
                        <option>
                          <iaixsl:attribute name="value"><iaixsl:value-of select="@id"/></iaixsl:attribute>
              ...
              <div class="col-12">
                <select class="f-select --small" name="products_count">
                  <iaixsl:attribute name="data-label">iai_i18n:[SWxvxZvEhyBwcm9kdWt0w7N3]: </iaixsl:attribute>
                  <option>
              ...
              <div class="col-12">
                <select class="f-select --small" name="products_uklad">
                  <iaixsl:attribute name="data-label">iai_i18n:[VWvFgmFkIHByb2R1a3TDs3c=]: </iaixsl:attribute>
                  <option>
                    <iaixsl:attribute name="value">iai_i18n:[cG96aW9teQ==]</iaixsl:attribute>
                    iai_i18n:[cG96aW9teQ==]
                  </option>
                  <option>
                    <iaixsl:attribute name="value">iai_i18n:[cGlvbm93eQ==]</iaixsl:attribute>
                    iai_i18n:[cGlvbm93eQ==]
                  </option>
                </select>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  ...
                  <label for="banner_width" class="f-label">iai_i18n:[U3plcm9rb8WbxIcgamVkbmVnbyBwcm9kdWt0dSAocHgp]</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="banner_height" class="f-control" type="text" name="banner_height" value="300"/>
                  <label for="banner_height" class="f-label">iai_i18n:[V3lzb2tvxZvEhyBqZWRuZWdvIHByb2R1a3R1IChweCk=]</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="image_width" class="f-control" type="text" name="image_width" value="225"/>
                  <label for="image_width" class="f-label">iai_i18n:[U3plcm9rb8WbxIcgZ3JhZmlraSBwcm9kdWt0dSAocHgp]</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="image_height" class="f-control" type="text" name="image_height" value="220"/>
                  <label for="image_height" class="f-label">iai_i18n:[V3lzb2tvxZvEhyBncmFmaWtpIHByb2R1a3R1IChweCk=]</label>
                </div>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <strong class="d-block mb-4">iai_i18n:[S29sb3J5c3R5a2E=]</strong>
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="f-group --small --color">
                  <input id="color3" class="f-control" type="text" name="color3" maxlength="7" value="#000000"/>
                  <label for="color3" class="f-label">iai_i18n:[S29sb3IgbmF6d3kgcHJvZHVrdHU=]</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 align-self-center mb-2 mb-sm-0">
                <div class="f-group --checkbox">
                  ...
                  <label for="nazwa_bold" class="f-label">iai_i18n:[UG9ncnViaWVuaWU=]</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small --color">
                  <input id="color4" class="f-control" type="text" name="color4" maxlength="7" value="#d9592b"/>
                  <label for="color4" class="f-label">iai_i18n:[S29sb3IgY2VueQ==]</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 align-self-center mb-2 mb-sm-0">
                <div class="f-group --checkbox">
                  <input id="cena_bold" class="f-control" type="checkbox" name="cena_bold"/>
                  <label for="cena_bold" class="f-label">iai_i18n:[UG9ncnViaWVuaWU=]</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small --color">
                  <input id="color5" class="f-control" type="text" name="color5" maxlength="7" value="#8d8d8d"/>
                  <label for="color5" class="f-label">iai_i18n:[S29sb3IgcHJ6ZWtyZcWbbG9uZWogY2VueQ==]</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 align-self-center mb-2 mb-sm-0">
                <div class="f-group --checkbox">
                  <input id="cena_promo_bold" class="f-control" type="checkbox" name="cena_promo_bold"/>
                  <label for="cena_promo_bold" class="f-label">iai_i18n:[UG9ncnViaWVuaWU=]</label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
                  <span class="mr-2 d-flex align-items-center ">iai_i18n:[UmFta2E=]:</span>
                  <input name="border_radio" class="f-control" type="radio" id="border_radio1" value="nie" checked="checked"/><label for="border_radio1" class="f-label">iai_i18n:[bmll]</label>
                  <input name="border_radio" class="f-control" type="radio" id="border_radio2" value="tak"/><label for="border_radio2" class="f-label">iai_i18n:[dGFr]</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 d-none" id="border_color">
                <div class="f-group --small --color">
                  ...
                  <label for="color1" class="f-label">iai_i18n:[S29sb3IgcmFta2k=]</label>
                </div>
              </div>
              <div class="col-12 col-sm-3 d-none" id="border_width">
                <div class="f-group --small ">
                  <input id="border_width_input" class="f-control" type="text" name="border_width" value="1"/>
                  <label for="border_width_input" class="f-label">iai_i18n:[R3J1Ym/Fm8SHIChweCk=]</label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
                  <span class="mr-2 d-flex align-items-center ">iai_i18n:[VMWCbw==]:</span>
                  <input name="background_radio" class="f-control" type="radio" id="background_radio1" value="nie" checked="checked"/><label for="background_radio1" class="f-label">iai_i18n:[bmll]</label>
                  <input name="background_radio" class="f-control" type="radio" id="background_radio2" value="tak"/><label for="background_radio2" class="f-label">iai_i18n:[dGFr]</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 d-none" id="background">
                <div class="f-group --small --color">
                  ...
                  <label for="color2" class="f-label">iai_i18n:[S29sb3IgdMWCYQ==]</label>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="affiliate__desc mb-2">iai_i18n:[QWJ5IHNwcmF3ZHppxIcgamFrIGLEmWR6aWUgd3lnbMSFZGHFgmEgcmVrbGFtYSB6IHBvd3nFvHN6eW1pIHVzdGF3aWVuaWFtaSwga2xpa25paiBwcnp5Y2lzayAiUG9rYcW8IHBvZGdsxIVkIHJla2xhbXk=]&quot;.</div>
        <a href="#preview" class="affiliate__button --preview btn --solid ">iai_i18n:[UG9rYcW8IHBvZGdsxIVkIHJla2xhbXk=]</a>
        <div class="affiliate__preview pt-3 pb-3"/>
        <span class="headline">
          <span class="headline__name">
            iai_i18n:[S3JvayAzIC0gR290b3dlIQ==]
          </span>
        </span>
        <div class="affiliate__desc mb-2">iai_i18n:[].</div>
        <div class="f-group">
          <textarea class="f-control" readonly="true" cols="65" rows="4" name="output">
						<iaixsl:attribute name="aria-label">iai_i18n:[S2xpa25paiBhYnkgc2tvcGlvd2HEhw==]</iaixsl:attribute>
					</textarea>
        </div>
        <a href="#generate" class="affiliate__button --generate btn --solid">iai_i18n:[R2VuZXJ1aiBrb2QgSmF2YVNjcmlwdA==]</a>
      </form>
    </section>
</iaixsl:if>
<!-- (affiliate_generator_php, 60dd8e85b83e11.23108809.3)-->
  <iaixsl:if test="page/generator/@type='php'">
    <section>
      <form class="affiliate --generator --content --php px-sm-4 pb-4" method="POST">
        ...
        <div class="f-group">
          <div class="f-feedback">
            ...
            <label for="affiliate__link" class="f-label">iai_i18n:[V3Bpc3ogVVJMIGRvIGxpc3R5IHByb2R1a3TDs3cgbHViIGRvIGthcnR5IHBvamVkeW5jemVnbyBwcm9kdWt0dQ==].</label>
            <span class="f-control-feedback"/>
            <a href="#check" class="affiliate__button --check btn --solid mt-2">iai_i18n:[U3ByYXdkxbogcHJvZHVrdHk=]</a>
          </div>
        </div>
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-3 d-none" id="border_width">
                <div class="f-group --small ">
                  <input id="border_width_input" class="f-control" type="text" name="border_width" value="1"/>
                  <label for="border_width_input" class="f-label">iai_i18n:[R3J1Ym/Fm8SH] </label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
        ...
        <div class="affiliate__desc mb-2">iai_i18n:[QWJ5IHNwcmF3ZHppxIcgamFrIGLEmWR6aWUgd3lnbMSFZGHFgmEgcmVrbGFtYSB6IHBvd3nFvHN6eW1pIHVzdGF3aWVuaWFtaSwga2xpa25paiBrcnp5Y2lzayAiUG9rYcW8IHBvZGdsxIVkIHJla2xhbXk=]&quot;.</div>
        <a href="#preview" class="affiliate__button --preview btn --solid ">iai_i18n:[UG9rYcW8IHBvZGdsxIVkIHJla2xhbXk=]</a>
        <div class="affiliate__preview pt-3 pb-3"/>
        <span class="headline">
          <span class="headline__name">
        ...
        <div class="affiliate__desc mb-2">
          <p>iai_i18n:[UG8gd2NpxZtuacSZY2l1IHByenljaXNrdSAiR2VuZXJ1aiBrb2QgUEhQIiBwb2phd2kgc2nEmSBwcnp5a8WCYWRvd3kga29kIFBIUCwga3TDs3J5IG1vxbxlc3ogc2tvcGlvd2HEhyBpIHdrbGVpxIcgZG8gc3dvamVnbyBza3J5cHR1LiBNb8W8ZXN6IGdvIGRvd29sbmllIG1vZHlmaWtvd2HEhw==].</p>
          <p>iai_i18n:[]:</p>
          <ul class="ml-4">
            <li>iai_i18n:[d2VqxZtjaW93ZSAoSU5QVVRfRU5DT0RJTkcpOiBVVEYtOA==]</li>
            <li>iai_i18n:[d3lqxZtjaW93ZSAtIHd5xZt3aWV0bGFuZSBuYSBUd29qZWogc3Ryb25pZSAoT1VUUFVUX0VOQ09ESU5HKTogSVNPLTg4NTktMg==]</li>
          </ul>
          <p>iai_i18n:[SmVzdCB0byB1c3Rhd2llbmllIG9kcG93aWVkbmllIGRsYSBQSFA1LiBXIHByenlwYWRrdSBQSFAgNCBpIHdjemXFm25pZWpzenljaCwga29uaWVjem5lIGplc3QgdXN0YXdpZW5pZSBrb2Rvd2FuaWEgd2VqxZtjaW93ZWdvIG5hIElTTy04ODU5LTIuIE5hanBvcHVsYXJuaWVqc3plIGRvc3TEmXBuZSB3IFBIUCBrb2Rvd2FuaWEgdG8=]:</p>
          <ul class="ml-4">
            <li>UTF-8</li>
            <li>Windows-1251</li>
            <li>Windows-1252</li>
          ...
          <p>iai_i18n:[] <a href="http://php.net/">PHP.net</a></p>
        </div>
        <div class="f-group">
          <textarea class="f-control" readonly="true" cols="65" rows="4" name="output">
						<iaixsl:attribute name="aria-label">iai_i18n:[S2xpa25paiBhYnkgc2tvcGlvd2HEhw==]</iaixsl:attribute>
        ...
        <a href="#generate" class="affiliate__button --generate btn --solid">iai_i18n:[R2VuZXJ1aiBrb2QgUEhQ]</a>
      </form>
    </section>
  </iaixsl:if>
<!-- (affiliate_generator_code, 60dd8e85584e81.30672396.7)-->
  <iaixsl:if test="page/generator/@type ='promoCodes'">
    <section class="affiliate --generator --content --code px-sm-4 pb-4">
      <h1 class="headline">
        <span class="headline__name">
          iai_i18n:[UG9sZcSHIHpuYWpvbXltIGkgemFyw7Ni]
        </span>
      </h1>
      <iaixsl:choose>
        <iaixsl:when test="page/generator/rebate_codes/rebate_code">
          <div class="affiliate__desc mb-4">iai_i18n:[WmFyYWJpYW5pZSBuYSBrb2RhY2ggbmljIENpxJkgbmllIGtvc3p0dWplLCB3eW1hZ2EgamVkeW5pZSBUd29qZWdvIHphYW5nYcW8b3dhbmlhIGkgY3phc3UsIGt0w7NyeSB6YWlud2VzdHVqZXN6IHcgcHJvbW9jasSZ].<br/>iai_i18n:[U3ByYXdkxbogamFrIGplc3QgdG8gcHJvc3RlIGkgemFjem5paiB6YXJhYmlhxIcgcGllbmnEhWR6ZQ==]. </div>
          <div class="row mb-4">
            <div class="col-12 col-md-4 affiliate__manual d-flex align-items-center flex-wrap flex-md-nowrap">
              <span>
                <strong class="mb-2">iai_i18n:[V3liaWVyeiBrb2Q=]</strong>
                iai_i18n:[VWRvc3TEmXBuaWFteSBDaSBpbmR5d2lkdWFsbnkga29kIHBvd2nEhXphbnkgeiBUd29pbSBrb250ZW0gcGFydG5lcnNraW0gdyBuYXN6eW0gc2tsZXBpZQ==].
              </span>
            </div>
            <div class="col-12 col-md-4 affiliate__manual d-flex align-items-center flex-wrap flex-md-nowrap">
              <span>
                <strong class="mb-2">iai_i18n:[UHJvbXVqIGtvZHkgcmFiYXRvd2U=]</strong>
                iai_i18n:[VWRvc3TEmXBuaWogd3licmFueSBrb2QgZGFsZWogbnAuIHcgcG9ydGFsYWNoIHNwb8WCZWN6bm/Fm2Npb3d5Y2ggbHViIG5hIHN3b2plaiBzdHJvbmllIGludGVybmV0b3dlag==].
              </span>
            </div>
            <div class="col-12 col-md-4 affiliate__manual d-flex align-items-center flex-wrap flex-md-nowrap">
              <span>
                <strong class="mb-2">iai_i18n:[WmFyYWJpYWogcGllbmnEhWR6ZQ==]</strong>
                iai_i18n:[TmEgdHdvamUga29udG8gd3LDs2NpIGN6xJnFm8SHIGt3b3R5IHphcMWCYWNvbmVqIHByemV6IGtsaWVudMOzdywga3TDs3J6eSB1xbx5bGkgdGVnbyBrb2R1IHJhYmF0b3dlZ28=].
              </span>
            </div>
          </div>
          <div class="affiliate__desc mb-4">iai_i18n:[Q2hjZXN6IG90cnp5bWHEhyBuaWVzYW1vd2l0ZSB3eW5hZ3JvZHplbmllIHBpZW5pxJnFvG5lIGRsYSBzaWViaWUgaSBzd29pY2ggcHJ6eWphY2nDs8WCPyBKZcWbbGkgb2Rwb3dpZWTFuiBicnptaSB0YWssIHBvIHByb3N0dSBza29waXVqIGtvZCByYWJhdG93eSBpIHd5xZtsaWogZ28gc3dvaW0gem5ham9teW0=].</div>
          <div class="row mb-4">
                ...
                <div class="affiliate__promo p-3 d-flex align-items-center flex-wrap">
                  ...
                  <span class="affiliate__tooltip pb-1 d-block">
                    <a href="#" class="affiliate__tooltip --trigger">
                      iai_i18n:[U3pjemVnw7PFgnkgcmFiYXR1]
                    </a>
                    <small class="affiliate__tooltip --content">
                      iai_i18n:[QWt0eXdueSB3IHNrbGVwYWNo]
                      ...
                      <iaixsl:if test="products_rebate">
                        <span class="affiliate__rebate d-block">
                          <a href="/search.php">iai_i18n:[TmEgY2HFgnkgYXNvcnR5bWVudA==]</a>
                          <span><iaixsl:value-of select="products_rebate/@rebate_value_formatted"/></span>
                        </span>
                      </iaixsl:if>
                      <iaixsl:if test="producer/item">
                        <span class="d-block pt-1">iai_i18n:[TmEgd3licmFuZSBtYXJraQ==]</span>
                      ...
                      <iaixsl:if test="series/item">
                        <span class="d-block pt-1">iai_i18n:[TmEgd3licmFuZSBzZXJpZQ==]</span>
                      ...
                      <iaixsl:if test="main_cat/item">
                        <span class="d-block pt-1">iai_i18n:[TmEgd3licmFuZSBrYXRlZ29yaWU=]</span>
          ...
          <div class="affiliate__desc mb-4">iai_i18n:[SmXFm2xpIGplc3RlxZsgZG/Fm3dpYWRjem9ueW0gZGV2ZWxvcGVyZW0gaSBjaGNlc3ogcm96d2luxIXEhyBvcGNqZSBkb3N0b3Nvd2FuaWEgd3lnbMSFZHUgcHJ6eWNpc2t1IHoga29kZW0gcmFiYXRvd3ltLCBrbGlrbmlqIHByenljaXNrIHBvbmnFvGVq].</div>
          <div class="f-group">
            <a class="affiliate__button --develop btn --solid --medium" href="#develop">iai_i18n:[SmVzdGVtIGRldmVsb3BlcmVt]</a>
          </div>
          <form class="affiliate__form --code" method="POST">
            <span class="headline">
              <span class="headline__name">
                iai_i18n:[S3JvayAxIC0gV3liaWVyeiBrb2QgcmFiYXRvd3k=]
              </span>
            </span>
            <div class="affiliate__desc mb-4">iai_i18n:[UG9uacW8ZWogem5hamR1amUgc2nEmSBsaXN0YSB3c3p5c3RraWNoIGtvZMOzdyBwcm9tb2N5am55Y2ggYWt0eXdueWNoIHcgc2tsZXBhY2ggYmlvcsSFY3ljaCB1ZHppYcWCIHcgcHJvZ3JhbWllIHBhcnRuZXJza2lt]</div>
            <div class="row mb-4">
              <div class="col-12 col-sm-6">
                <select class="f-select" name="promo_codes_shop">
                  <iaixsl:attribute name="data-label">iai_i18n:[V3liaWVyeiBza2xlcA==]: </iaixsl:attribute>
                ...
                <select class="f-select" name="promo_codes_code">
                  <iaixsl:attribute name="data-label">iai_i18n:[V3liaWVyeiBrb2Q=]: </iaixsl:attribute>
              ...
              <div class="rebates_active col-12 col-sm-6">
                <iaixsl:for-each select="/shop/page/generator/rebate_codes/rebate_code">
                  <div class="rebates_active__wrapper d-sm-flex align-items-sm-center p-2 p-sm-4 mb-2">
                    ...
                    <div class="rebates_active__sub --name">
                      <span class="rebates_active__name">iai_i18n:[V3licmFueSBrb2Q=]:<strong><iaixsl:value-of select="@number"/></strong></span>
                    </div>
                    <div class="rebates_active__sub --info">
                      <iaixsl:if test="@min_order &gt; 0">
                        <div class="rebates_active__param --min_order">
                          ...
                          iai_i18n:[V3ltYWdhbmEgd2FydG/Fm8SHIHByb2R1a3TDs3cgdyBrb3N6eWt1]: 
                      ...
                      <div class="rebates_active__param --combined">
                        <iaixsl:choose>
                          <iaixsl:when test="@combined='y' or @combined='m'">
                            iai_i18n:[UmFiYXQgamVzdCBzdW1vd2FueSB6IHBvem9zdGHFgnltaSByYWJhdGFtaQ==].
                          </iaixsl:when>
                          <iaixsl:otherwise>
                            iai_i18n:[UmFiYXQgbmllIGplc3Qgc3Vtb3dhbnkgeiBwb3pvc3RhxYJ5bWkgcmFiYXRhbWk=].
                          </iaixsl:otherwise>
                        </iaixsl:choose>
                      </div>
                      <iaixsl:if test="inactive_zones/item">
                        <div class="rebates_active__param --inactive">
                          iai_i18n:[UmFiYXQgbmllIGRvdHljenkgcHJvZHVrdMOzdyBvem5hY3pvbnljaCBqYWtv]: 
                ...
                <div class="affiliate__info col-12 --no_code">
                  iai_i18n:[QnJhayBrb2R1IHNwZcWCbmlhasSFY2VnbyBwb3d5xbxzemUga3J5dGVyaWE=].
                </div>
              </div>
            </div>
            <div class="row mb-4">
              <div class="col-12 col-md-6">
                <span class="headline">
                  <span class="headline__name">
                    iai_i18n:[S3JvayAyIC0gV3liaWVyeiBzdHls]
                  </span>
                </span>
                ...
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio1" value="0-0" checked="checked"/>
									<label for="promo_code_radio1" class="f-label --text"><a>iai_i18n:[TGluayB0ZWtzdG93eQ==]</a></label>
                </div>
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio2" value="0-1"/>
									<label for="promo_code_radio2" class="f-label --text_icon"><a><i class="icon-tags"/> iai_i18n:[TGluayB0ZWtzdG93eSArIGlrb25h]</a></label>
                </div>
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio3" value="1-0"/>
									<label for="promo_code_radio3" class="f-label --button"><a class="btn --solid">iai_i18n:[UHJ6eWNpc2s=]</a></label>
                </div>
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio4" value="1-1"/>
									<label for="promo_code_radio4" class="f-label --button_icon"><a class="btn --solid"><i class="icon-tags"/> iai_i18n:[UHJ6eWNpc2sgKyBpa29uYQ==]</a></label>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <span class="headline">
                  <span class="headline__name">
                    iai_i18n:[S3JvayAzIC0gRG9wYXN1aiB3eWdsxIVk]
                  </span>
                </span>
                <div class="affiliate__desc mb-4"/>
								<div class="row mb-4">
									<div class="col-12 col-md-6">
										<div class="f-group --small">
											<input id="promo_code_text" class="f-control" type="text" name="promo_code_text">
												<iaixsl:attribute name="value">iai_i18n:[S2xpa25paiwgYWJ5IGFrdHl3b3dhxIcga29kOiAlcw==]</iaixsl:attribute>
											</input>
											<label for="promo_code_text" class="f-label">iai_i18n:[VGVrc3QgbmEgcHJ6eWNpc2t1]</label>
										</div>
									</div>
									<div class="col-12 col-md-6">
										<div class="f-group --small">
											...
											<label for="promo_code_text_size" class="f-label">iai_i18n:[V2llbGtvxZvEhyB0ZWtzdHUgKHB4KQ==]</label>
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="f-group --color --small">
											<input id="color3" class="f-control" type="text" name="color3" maxlength="7" value="#000000"/>
											<label for="color3" class="f-label">iai_i18n:[S29sb3IgdGVrc3R1]</label>
										</div>
									</div>
									...
									<div class="col-12 col-sm-3 align-self-center mb-2 mb-sm-0">
										<div class="f-group --checkbox">
											...
											<label for="nazwa_radius" class="f-label">iai_i18n:[WmFva3LEhWdsZW5pZQ==]</label>
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="f-group --color --small">
											<input id="color4" class="f-control" type="text" name="color4" maxlength="7" value="#000000"/>
											<label for="color4" class="f-label">iai_i18n:[S29sb3IgaWtvbnk=]</label>
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="f-group --color --small">
											<input id="color5" class="f-control" type="text" name="color5" maxlength="7" value="#000000"/>
											<label for="color5" class="f-label">iai_i18n:[S29sb3IgdGxh]</label>
										</div>
									</div>
									<div class="col-12">
										<div class="f-group --radio d-flex flex-wrap flex-sm-nowrap align-items-center">
											<span class="col-12 px-0 col-sm flex-sm-grow-0 mr-2 d-flex align-items-center ">iai_i18n:[V3liaWVyeiBpa29uxJk=]:</span>
											<input name="ikona" class="f-control" type="radio" id="ikona1" checked="checked"><iaixsl:attribute name="aria-label">iai_i18n:[VGFnaQ==]</iaixsl:attribute></input><label for="ikona1" class="f-label"><i class="icon-tags"/></label>
											<input name="ikona" class="f-control" type="radio" id="ikona2"><iaixsl:attribute name="aria-label">iai_i18n:[R3dpYXpka2E=]</iaixsl:attribute></input><label for="ikona2" class="f-label"><i class="icon-star"/></label>
											<input name="ikona" class="f-control" type="radio" id="ikona3"><iaixsl:attribute name="aria-label">iai_i18n:[S2FydGEga3JlZHl0b3dh]</iaixsl:attribute></input><label for="ikona3" class="f-label"><i class="icon-credit-card"/></label>
											<input name="ikona" class="f-control" type="radio" id="ikona4"><iaixsl:attribute name="aria-label">iai_i18n:[TGluaw==]</iaixsl:attribute></input><label for="ikona4" class="f-label"><i class="icon-link"/></label>
											<input name="ikona" class="f-control" type="radio" id="ikona5"><iaixsl:attribute name="aria-label">iai_i18n:[U2VyY2U=]</iaixsl:attribute></input><label for="ikona5" class="f-label"><i class="icon-heart"/></label>
										</div>
									</div>
								</div>
              </div>
            </div>
            <div class="affiliate__desc mb-4">iai_i18n:[QWJ5IHNwcmF3ZHppxIcgamFrIGLEmWR6aWUgd3lnbMSFZGHFgiBwcnp5Y2lzayB6IGtvZGVtIHJhYmF0b3d5bSB6IHBvd3nFvHN6eW1pIHVzdGF3aWVuaWFtaSwga2xpa25paiBwcnp5Y2lzayAiUG9rYcW8IHBvZGdsxIVkIHByenljaXNrdQ==]&quot;.</div>
            <a href="#preview" class="affiliate__button --previewCode btn --solid ">iai_i18n:[UG9rYcW8IHBvZGdsxIVkIHByenljaXNrdQ==]</a>
						<div class="affiliate__preview mt-3 mb-3"/>
            <span class="headline">
              <span class="headline__name">
                iai_i18n:[S3JvayA0IC0gR290b3dlIQ==]
              </span>
            </span>
            <div class="affiliate__desc mb-4">iai_i18n:[].&quot;</div>
						<div class="row mb-0">
							<div class="col-12 col-sm-3 ">
								<a class="affiliate__button --generateCode btn --solid mb-3" href="#generateCode">
									iai_i18n:[R2VuZXJ1aiBrb2QgbGlua2E=]
								</a>
								<a class="affiliate__button --generateUrl btn --solid mb-3 mb-sm-0" href="#generateUrl">
									iai_i18n:[R2VuZXJ1aiB1cmwgbGlua2E=]
								</a>
							</div>
        ...
        <iaixsl:otherwise>
          <div class="affiliate__info">
            iai_i18n:[QnJhayBha3R5d255Y2gga29kw7N3IHByb21vY3lqbnljaCE=]
          </div>
        </iaixsl:otherwise>
      </iaixsl:choose>
    </section>
  </iaixsl:if>
  <!-- (affiliate_generator_html, 60dd8e873be6b1.24407835.3)-->
	<iaixsl:if test="page/generator/@type='html'">
		<section class="affiliate --generator --content --html px-sm-4 pb-4">
			<h1 class="headline">
				<span class="headline__name">
					iai_i18n:[S1JPSyAxIC0gT0ROT8WaTklL]
				</span>
			</h1>
			<div class="row">
				<div class="col-12 col-sm-6">
					<div class="f-group">
						...
						<label for="affiliate__link" class="f-label">iai_i18n:[UG9kYWogYWRyZXMsIHBvZCBrdMOzcnkgdHJhZmkga2xpZW50IChwcnp5a8WCYWQ6IGh0dHA6Ly9uYXp3YXNrbGVwdS5wbC8p]</label>
					</div>
				</div>
				<div class="col-12 col-sm-6">
					<div class="f-group">
						...
						<label for="affiliate__link_name" class="f-label">iai_i18n:[UG9kYWogemF3YXJ0b8WbxIcgb2Rub8WbbmlrYSAoa29uaWVjem5lIHByenkgZ2VuZXJvd2FuaXUga29kdSBqYWtvIG9kbm/Fm25payk=]</label>
					</div>
				</div>
			</div>
			<span class="headline">
				<span class="headline__name">
					iai_i18n:[S1JPSyAyIC0gV1lCSUVSWiBCQU5ORVI=]
				</span>
			</span>
			<iaixsl:choose>
				...
				<iaixsl:otherwise>
					<div class="affiliate__info">iai_i18n:[QnJhayBiYW5uZXLDs3cgZG8gd3lib3J1].</div>
				</iaixsl:otherwise>
			</iaixsl:choose>
			<span class="headline">
				<span class="headline__name">
					iai_i18n:[S1JPSyAzIC0gR09UT1dFIQ==]
				</span>
			</span>
			<div class="affiliate__desc mb-2">
				iai_i18n:[]&quot;.
			</div>
			<div class="row mb-0">
				<div class="col-12 col-sm-3 ">
					<a class="affiliate__button --generateHtmlCode btn --solid mb-3" href="#generateHtmlCode">
						...
						iai_i18n:[R2VuZXJ1aiBrb2QgYmFubmVyYQ==]
					</a>
