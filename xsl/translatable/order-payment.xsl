...
<div class="payment_card">
    <div class="payment_card_sub">
        <div class="payment_card_info">
            iai_i18n:[RGFuZSBrYXJ0eSBuaWUgYsSZZMSFIHByemVjaG93eXdhbmUgdyBuYXN6eW0gc3lzdGVtaWUuIFpvc3RhbsSFIHd5a2Fzb3dhbmUgbmF0eWNobWlhc3QgcG8genJlYWxpem93YW5pdSB0cmFuc2FrY2pp].
        </div>
        ...
        <form class="payment_card">
                ...
                <iaixsl:choose>
                    <iaixsl:when test="@name = 'creditCard[system]'">
                        <div class="payment_card_formel cc_wrapper">
                            <label for="credit_card_system" class="payment_card_formel">iai_i18n:[Um9kemFqIGthcnR5]:</label>
                            ...
                            <span class="payment_card_need">
                                <img src="/gfx/standards/need.gif?r=1765442497" class="payment_card_nedd_img"><iaixsl:attribute name="alt">iai_i18n:[VG8gcG9sZSBqZXN0IHd5bWFnYW5lIGRvIGRva29uYW5pYSBwxYJhdG5vxZtjaQ==]</iaixsl:attribute><iaixsl:attribute name="title">iai_i18n:[VG8gcG9sZSBqZXN0IHd5bWFnYW5lIGRvIHrFgm/FvGVuaWEgemFtw7N3aWVuaWE=]</iaixsl:attribute></img>
                                <img src="/gfx/standards/correct.png?r=1765442497" class="payment_card_correct_img" style="display:none;"/><img src="/gfx/standards/incorrect.png?r=1765442497" class="payment_card_wrong_img" style="display:none;"/>
                                <span class="payment_card_help"><span class="payment_card_help2">iai_i18n:[V3liaWVyeiBzeXN0ZW0ga2FydCBrcmVkeXRvd3ljaA==]</span></span>
                            </span>
                    ...
                    <iaixsl:when test="@name = 'creditCard[number]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_number" class="payment_card_formel">iai_i18n:[TnVtZXIga2FydHk=]:</label>
                    ...
                    <iaixsl:when test="@name = 'creditCard[endDateMonth]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_month" class="payment_card_formel">iai_i18n:[RGF0YSB3YcW8bm/Fm2Np]:</label>
                        ...
                        <div class="payment_card_datedesc">
                            iai_i18n:[RGF0xJkgd2HFvG5vxZtjaSBuYWxlxbx5IHdwaXNhxIcgdyBwb3N0YWNpIGR3dWN5ZnJvd3ljaCBsaWN6YiwgbnAuIDA0LzEy]
                        </div>
                    </iaixsl:when>
                    <iaixsl:when test="@name = 'creditCard[securityCode]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_code" class="payment_card_formel">iai_i18n:[S29kIHphYmV6cGllY3phasSFY3kgKENWVik=]:</label>
                    ...
                    <iaixsl:when test="@name = 'creditCard[name]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_name" class="payment_card_formel">iai_i18n:[SW1pxJkgaSBuYXp3aXNrbw==]:</label>
            ...
            <div class="credit_card_submit">
                <button class="btn --solid --large credit_card_submit disabled" type="submit">
                    <iaixsl:attribute name="title">iai_i18n:[RG9rb25haiBwxYJhdG5vxZtjaQ==]</iaixsl:attribute>
                    iai_i18n:[RG9rb25haiBwxYJhdG5vxZtjaQ==]
                </button>
