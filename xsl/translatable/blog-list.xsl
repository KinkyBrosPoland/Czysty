...
<!-- (blog_list_display, 60dd8e80de4044.86435454.6)-->
		<iaixsl:variable name="blog_list_date"/>
		<iaixsl:variable name="blog_list_see_more">iai_i18n:[Q3p5dGFqIHdpxJljZWo=]</iaixsl:variable>
				...
				<div class="article__block">
					<iaixsl:for-each select="page/blogitems/blogitem">
						<article class="article__item">
								...
								<iaixsl:when test="image/@src and image/@src != ''">
									<iaixsl:choose>
										<iaixsl:when test="@link">
											<a href="{@link}" class="article__image_wrapper" tabindex="-1">
							...
							<div class="article__content" data-enabled-data="{$blog_list_date}">
								...
								<iaixsl:choose>
									<iaixsl:when test="@link">
										<h2 class="article__name_wrapper">
											<a class="article__name" href="{@link}" tabindex="0">
								...
								<iaixsl:if test="more/@href and not(more/@href = '') and $blog_list_see_more">
									<a class="article__more_link" href="{more/@href}" tabindex="-1">
										...
										<iaixsl:attribute name="title"><iaixsl:value-of disable-output-escaping="yes" select="title"/></iaixsl:attribute>
										<span class="link__text"><iaixsl:value-of select="$blog_list_see_more"/></span>
	...
	<!-- (blog_list_paging, 60dd8e7f666911.18625091.5)-->
			...
			<iaixsl:if test="page/blogitems/navigation/prev">
				<li class="pagination__element --prev">
					...
					<a class="pagination__link">
						<iaixsl:attribute name="href"><iaixsl:choose><iaixsl:when test="page/blogitems/navigation/prev/@counter = '0'"><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/blogitems/navigation/path/@value, '&amp;counter=')"/><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/blogitems/navigation/path/@value, '?counter=')"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of disable-output-escaping="yes" select="page/blogitems/navigation/path/@value"/><iaixsl:value-of select="page/blogitems/navigation/prev/@counter"/></iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>
