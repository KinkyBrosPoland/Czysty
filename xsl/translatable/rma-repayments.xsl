...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
    ...
    <!-- (rma_repayments_form, 61f913c8540824.92342060.6)-->
	<iaixsl:if test="page/@type = 'return_products' and page/@display = 'repayment'">
		<iaixsl:variable name="n83521_shipping_title">iai_i18n:[RGFybW93YSBwcnplc3nFgmthIGRvIHNrbGVwdQ==]</iaixsl:variable>
		...
		<div class="step5">
			<div class="progress_bar_wrapper pb_step5">
				...
				<div class="_step _step5" aria-current="step">
					<span>5</span>
					<p>
						<i/>
			...
			<div class="progress__item --rma --fifth --active d-md-none py-3">
				...
				<div class="progress__text">
					<strong class="progress__name">iai_i18n:[V3liaWVyeiBzcG9zw7NiIGkgZm9ybcSZIHJlYWxpemFjamkgcmVrbGFtYWNqaQ==] </strong>
				</div>
			</div>
			<h1 class="big_label return_label d-none d-md-block" id="return_label">iai_i18n:[V3liaWVyeiBzcG9zw7NiIGkgZm9ybcSZIHJlYWxpemFjamkgcmVrbGFtYWNqaQ==]</h1>
			<div id="complaint_method" class="complain_method">
			<div class="complain_method__description">iai_i18n:[]</div>
			<div class="complain_method__select">
				<select class="complain_method__select complain_select" name="complain_method">
					<iaixsl:attribute name="aria-label">iai_i18n:[V3liaWVyeiBmb3JtxJkgcmVhbGl6YWNqaSByZWtsYW1hY2pp]</iaixsl:attribute>
					<option value="first_val">iai_i18n:[V3liaWVyeg==]</option>
					<option value="Wymiana towaru">
						<iaixsl:attribute name="value">iai_i18n:[V3ltaWFuYSB0b3dhcnU=]</iaixsl:attribute>
						iai_i18n:[V3ltaWFuYSB0b3dhcnU=]
					</option>
					<option value="Usunięcie wady">
						<iaixsl:attribute name="value">iai_i18n:[VXN1bmnEmWNpZSB3YWR5]</iaixsl:attribute>
						iai_i18n:[VXN1bmnEmWNpZSB3YWR5]
					</option>
					<option value="Obniżenie ceny">
						<iaixsl:attribute name="value">iai_i18n:[T2JuacW8ZW5pZSBjZW55]</iaixsl:attribute>
						iai_i18n:[T2JuacW8ZW5pZSBjZW55]
					</option>
					<option value="Odstąpienie od umowy">
						<iaixsl:attribute name="value">iai_i18n:[T2RzdMSFcGllbmllIG9kIHVtb3d5]</iaixsl:attribute>
						iai_i18n:[T2RzdMSFcGllbmllIG9kIHVtb3d5]
					</option>
				</select>
			</div>
		</div>
			<form class="repayments_return_list_form is-validated" method="post" aria-labelledby="return_label">
				<div class="repayments_return_list_form__wrapper">
					<iaixsl:for-each select="page/repayment_methods/repayment_method">
						<div class="return_form">
							<input class="return_type" name="return_type" type="radio">
								<iaixsl:choose>
									<iaixsl:when test="position() = 1 and not(/shop/page/repayment_methods/repayment_method[@checked = 'true'])">
							...
							<div class="return_form_sub">
								...
								<div class="return_form_desc">
									<iaixsl:choose>
										...
										<iaixsl:when test="@id = 'b'">
											iai_i18n:[V3liaWVyYW0gendyb3Qga3dvdHkgdyBmb3JtaWUgcHJ6ZWxld3UgYmFua293ZWdvIG5hIGtvbnRv]:
										</iaixsl:when>
										<iaixsl:when test="@id = 'tc'">
										...
										<iaixsl:when test="@id = 'cashback'">
											iai_i18n:[V3liaWVyYW0gendyb3Qga3dvdHkgdyB0YWtpZWogc2FtZWogZm9ybWllLCB3IGpha2kgenJlYWxpem93YW5hIGJ5xYJhIHDFgmF0bm/Fm8SHIHphIHphbcOzd2llbmll].
											<iaixsl:choose>
												<iaixsl:when test="@payment_system">
													iai_i18n:[U3lzdGVtZW0gb2JzxYJ1Z3VqxIVjeW0gcMWCYXRub8WbxIcgamVzdA==] <span><iaixsl:value-of select="@payment_system"/>.</span>
												</iaixsl:when>
												<iaixsl:otherwise/>
											</iaixsl:choose>
										</iaixsl:when>
									...
									<div class="f-group">
										<div>
											<div class="f-feedback">
												<input type="text" class="return_form_iban f-control --validate" minlength="26" id="iban_number_description" aria-describedby="iban_error">
													...
													<iaixsl:attribute name="placeholder">iai_i18n:[UEwwMCAwMDAwIDAwMDAgMDAwMCAwMDAwIDAwMDAgMDAwMA==] </iaixsl:attribute>
													<iaixsl:choose>
														<iaixsl:when test="@validation = 'bank_account'">
															<iaixsl:attribute name="data-graphql">iban</iaixsl:attribute>
														</iaixsl:when>
														<iaixsl:otherwise>
															<iaixsl:attribute name="data-graphql"><iaixsl:value-of select="@validation"/></iaixsl:attribute>
														</iaixsl:otherwise>
													</iaixsl:choose>
												</input>
												<label for="iban_number_description">iai_i18n:[UG9kYWogbnVtZXIga29udGEgdyBmb3JtYWNpZSBJQkFO]</label>
												<span class="f-control-feedback"/>
												<div class="f-message" id="iban_error" aria-live="polite"/>
											</div>
										</div>
									</div>
								</iaixsl:if>
							...
							<iaixsl:if test="$n83521_shipping_title and @id = 't' and  /shop/page/repayment_methods/@shipping_balanced_refund = 'true'">
								<div class="n69372_shipping_balance">
									<strong>
										iai_i18n:[RGFybW93YSBwcnplc3nFgmthIGRvIHNrbGVwdQ==]
									</strong>
									<div>
										iai_i18n:[UHJ6eSB3eWJvcnpl] <b>iai_i18n:[endyb3R1IMWbcm9ka8OzdyBuYSBzYWxkbyBrbGllbnRh].</b><br/>iai_i18n:[RGxhIHd5YnJhbmVqIGZvcm15IHp3cm90dQ==].
									</div>
								</div>
							</iaixsl:if>
						</div>
