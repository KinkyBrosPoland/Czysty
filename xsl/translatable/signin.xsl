...
<!-- (menu_messages, 60dd8e79b18501.50382803.13)-->
        ...
        <!-- (signin-form, 61b0b16d3e6ce9.24410838.9)-->
            ...
            <div id="signin-form_box_left" class="signin-form_box col-md-8 col-sm-7 col-12">
                                            ...
                                            <iaixsl:if test="@name = $social_media_name">
                                                <div id="cookie_login_social" class="iai_accounts tooltip --top">
                                                    <span id="cookie_login_social_desc" class="iai_accounts">
                                                        iai_i18n:[WmFsb2d1aiBzacSZIHo=] <strong>iai_i18n:[SWRvQWNjb3VudHM=]</strong> iai_i18n:[cHJ6ZXo=] <iaixsl:value-of select="$social_media_name"/>, iai_i18n:[YSBUd29qZSBkYW5lIGRvIHd5c3nFgmtpIHpvc3RhbsSFIHV6dXBlxYJuaW9uZSBhdXRvbWF0eWN6bmllIG5hIHBvZHN0YXdpZSBwb3ByemVkbmljaCB6YW3Ds3dpZcWE].
                                                    </span>
                                                </div>
                                            </iaixsl:if>
                                            <iaixsl:choose>
                                                <iaixsl:when test="@login_url">
                                                    <a class="btn --outline --medium service_item">
                                                ...
                                                <iaixsl:otherwise>
                                                    <strong class="btn --outline --medium service_item">
                                                        <iaixsl:attribute name="data-name">service_<iaixsl:value-of select="translate(@name, ' +', '_')"/></iaixsl:attribute>
                                ...
                                <iaixsl:for-each select="login_options/service[not(@name='shop_register') and not(@login_url)]">
                                    <form action="login.php" method="post" style="display:none;">
                                        ...
                                        <iaixsl:if test="not(@name='OpenId')">
                                            <label><iaixsl:value-of select="@name"/><span> iai_i18n:[bG9naW4=]</span></label>
                                        </iaixsl:if>
                                                    ...
                                                    <span id="cookie_login_social_desc">
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="not(/shop/client_data/@iai_accounts = 'consent')">
                                                                <strong>iai_i18n:[SmVzdGXFmyBqdcW8IG5hc3p5bSBrbGllbnRlbQ==]. </strong>
                                                                iai_i18n:[WmFsb2d1aiBzacSZIHBvbm93bmllIHByemV6] <iaixsl:value-of select="$social_media_name"/>, iai_i18n:[YWJ5xZtteSBtaWVsaSBwZXdub8WbxIcgxbxlIHRvIFR5]. 
                                                            </iaixsl:when>
                                                            <iaixsl:otherwise>
                                                                <iaixsl:attribute name="class">iai_accounts</iaixsl:attribute>
                                                                iai_i18n:[WmFsb2d1aiBzacSZIHo=] <strong>iai_i18n:[SWRvQWNjb3VudHM=]</strong> iai_i18n:[cHJ6ZXo=] <iaixsl:value-of select="$social_media_name"/>, iai_i18n:[YSBUd29qZSBkYW5lIGRvIHd5c3nFgmtpIHpvc3RhbsSFIHV6dXBlxYJuaW9uZSBhdXRvbWF0eWN6bmllIG5hIHBvZHN0YXdpZSBwb3ByemVkbmljaCB6YW3Ds3dpZcWE].
                                ...
                                <div id="client_new_social">
                                    ...
                                    <div class="client_new_social_sub">
                                        ...
                                        <iaixsl:if test="not(page/client-data/@allow_register = 'false')">
                                            <p> iai_i18n:[SmXFvGVsaSBwb3NpYWRhc3oga29udG8gdyBqZWRueW0geiBwb25pxbxzenljaCBzZXJ3aXPDs3csIG1vxbxlc3ogamUgd3lrb3J6eXN0YcSHIGRvIHV0d29yemVuaWEga29udGEgIGkgcMOzxbpuaWVqc3plZ28gbG9nb3dhbmlh].<br/><br/> <b>iai_i18n:[SmXFvGVsaSBwb3NpYWRhc3oganXFvCB3Y3plxZtuaWVqIHphxYJvxbxvbmUga29udG8=]</b> iai_i18n:[].</p>
                                        </iaixsl:if>
                ...
                <div class="signin-form_box_sub" id="signin-form_box_sub_1">
                    <div class="signin-form_select">
                        <h3>iai_i18n:[WmFsb2d1aiBtbmllIHByemV6]</h3>
                        <input id="signin-form_radio1" type="radio" value="signin-form_box_sub_1" checked="checked" name="login_form1" data-target="login_form2"/><label for="signin-form_radio1">iai_i18n:[bG9naW4gaSBoYXPFgm8=]</label>
                        <input id="signin-form_radio2" type="radio" value="signin-form_box_sub_2" name="email_form1" data-target="email_form2"/><label for="signin-form_radio2">iai_i18n:[cHJ6eXBvbW5paiBoYXPFgm8=]</label>
                    </div>
                    ...
                    <form action="/signin.php" method="post" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                <div class="has-feedback">
                                    ...
                                    <label for="user_login" class="control-label">
                                        iai_i18n:[TG9naW4gLyBOciBrYXJ0eSBzdGHFgmVnbyBrbGllbnRhIC8gRS1tYWls]
                                    </label>
                            ...
                            <div class="form-group">
                                <div class="has-feedback">
                                    ...
                                    <label for="user_pass" class="control-label">
                                        iai_i18n:[SGFzxYJvIC8gUGluIGthcnR5IHN0YcWCZWdvIGtsaWVudGE=]
                                    </label>
                                    <span class="form-control-feedback"/>
                                </div>
                            </div>
                        ...
                        <div class="signin_buttons col-md-10 col-12">
                            ...
                            <a class="password_reminder_signin" href="#signin-form_radio2">
                                <iaixsl:choose>
                                    <iaixsl:when test="/shop/client_data/@signin = 'cookie'">
                                        iai_i18n:[TmllIHBhbWnEmXRhbSBoYXPFgmE=]
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        iai_i18n:[TmllIHBhbWnEmXRhbSBsb2dpbnUgbHViIGhhc8WCYQ==]
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                            </a>
                            <iaixsl:if test="/shop/client_data/@signin = 'cookie'">
                                <a class="cookie_login_social_new_account">
                                  <iaixsl:choose>
                    								<iaixsl:when test="count(/shop/action/registration_options/*) = 1">
                    									<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/registration_options/*/@registration_url"/></iaixsl:attribute>
                    								</iaixsl:when>
                                  ...
                                  iai_i18n:[VG8gbmllIGplc3QgbW9qZSBrb250byBpIGNoY8SZIHphxYJvxbx5xIcgbm93ZQ==]</a>
                            </iaixsl:if>
                            <iaixsl:if test="/shop/client_data/@signin = 'cookie' and not(/shop/client_data/@last_login_option = 'shop') and count(login_options/service[not(@name = $social_media_name)]) &gt; 0">
                                <a class="cookie_login_social_more_social" href="#more_social">iai_i18n:[WmFsb2d1aiBzacSZIGtvbnRlbSB6IGlubmVnbyBzZXJ3aXN1]</a>
                            </iaixsl:if>
                        </div>
                    </form>
                ...
                <div class="signin-form_box_sub" id="signin-form_box_sub_2">
                    <p class="reminder_desc">iai_i18n:[TmEgVHfDs2ogYWRyZXMgem9zdGFuaWUgd3lzxYJhbnkgZS1tYWlsLCBrdMOzcnkgcG96d2FsYSBuYSBhdXRvbWF0eWN6bmUgemFsb2dvd2FuaWUgc2nEmS4gWm1pYW5hIGhhc8WCYSBixJlkemllIG1vxbxsaXdhIHBvIHphbG9nb3dhbml1IG5hIHN0cm9uaWUgZWR5Y2ppIFR3b2ljaCBkYW55Y2g=].</p>

                    <div class="signin-form_select">
                        <h3>iai_i18n:[WmFsb2d1aiBtbmllIHByemV6]</h3>
                        <input id="signin-form_radio3" type="radio" value="signin-form_box_sub_1" name="login_form2" data-target="login_form1"/><label for="signin-form_radio3">iai_i18n:[bG9naW4gaSBoYXPFgm8=]</label>
                        <input id="signin-form_radio4" type="radio" value="signin-form_box_sub_2" name="email_form2" data-target="email_form1" checked="checked"/><label for="signin-form_radio4">iai_i18n:[cHJ6eXBvbW5paiBoYXPFgm8=]</label>
                    </div>
                        ...
                        <div class="signin_inputs col-md-10 col-12">
                            <div class="form-group">
                                <div class="has-feedback">
                                    ...
                                    <label for="user_mail_recover" class="control-label">iai_i18n:[QWRyZXMgZS1tYWls]</label>
                                    <span class="form-control-feedback"/>
                                </div>
                                <div class="form-desc">
                                    iai_i18n:[V3Bpc3ogZS1tYWlsLCBrdMOzcnkgcG9kYcWCZcWbIHBvZGN6YXMgcmVqZXN0cmFjamkgbHViIG5yIGthcnR5IHN0YcWCZWdvIGtsaWVudGE=]
                                </div>
                            </div>

                            <div class="signin_buttons col-md-10 col-12">
                                <button class="btn --solid --medium signin_password-recover" type="submit">
                                    iai_i18n:[UHJ6eXBvbW5paiBoYXPFgm8=]
                                </button>

                                <a class="password_back_signin" href="#signin-form_radio1">iai_i18n:[V3LDs8SHIGRvIHN0YW5kYXJkb3dlZ28gbG9nb3dhbmlh]</a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="signin-form_box_sub">
                        <iaixsl:choose>
                            <iaixsl:when test="page/actions/client_once">
                                <h2 class="big_label">
                                    iai_i18n:[Tm93eSBrbGllbnQ=]
                                </h2>
                                <p class="registration_desc">iai_i18n:[SmXFvGVsaSB3Y3plxZtuaWVqIG5pZSB6YcWCb8W8ecWCZcWbIGtvbnRhIHcgbmFzenltIHNrbGVwaWUsIHpvc3Rhbmllc3ogcG9wcm9zem9ueSBvIHBvZGFuaWUgc3dvaWNoIGRhbnljaCBpIGFkcmVzdSBkb3N0YXd5].</p>
                                <iaixsl:if test="page/actions/client_register">
                                    <a class="btn --solid --medium signin-form_register">
                                        ...
                                        iai_i18n:[WmFyZWplc3RydWogc2nEmSBpIHphbcOzdw==]
                                    </a>
                                    <iaixsl:if test="$register_number &gt; 1">
                                        <div class="register_wholesaler">
                                            <i class="icon-wholesaler-register"/> iai_i18n:[SmVzdGXFmyBodXJ0b3duaWtpZW0/IFNrb3J6eXN0YWogeg==] <a>
                                ...
                                <iaixsl:if test="page/actions/client_once">
                                    <a class="btn --solid --medium --secondary signin-form_once">
                                        ...
                                        iai_i18n:[WmFtw7N3IGJleiByZWplc3RyYWNqaQ==]
                                    </a>
                                </iaixsl:if>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                <h2 class="big_label">
                                    iai_i18n:[UmVqZXN0cmFjamE=]
                                </h2>
                                <p class="registration_desc">iai_i18n:[SmXFvGVsaSB3Y3plxZtuaWVqIG5pZSB6YcWCb8W8ecWCZcWbIGtvbnRhIHcgbmFzenltIHNrbGVwaWUsIHpvc3Rhbmllc3ogcG9wcm9zem9ueSBvIHBvZGFuaWUgc3dvaWNoIGRhbnljaCBpIGFkcmVzdSBkb3N0YXd5].</p>
                                <a class="btn --solid --medium signin-form_register2">
                                        ...
                                        iai_i18n:[WmHFgsOzxbwgbm93ZSBrb250bw==]
                                    </a>
                                    <iaixsl:if test="$register_number &gt; 1">
                                        <div class="register_wholesaler">
        ...
        <iaixsl:if test="shop/login_options/service/@gfx_icon_url"/>
