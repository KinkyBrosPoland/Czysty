...
<iaixsl:attribute name="class">stock_cms_label  big_label</iaixsl:attribute>
            <span class="stock_cms_label">
                    ...
                    iai_i18n:[RG9kYXRrb3dlIGluZm9ybWFjamU=]
            </span>
        </div>
        <div class="stock_cms">
    ...
    <!-- (stock_info, 60dd8e7d022be7.14557922.6)-->
  <h1 class="headline">
    <span class="headline__name">iai_i18n:[SW5mb3JtYWNqZSBvIHB1bmtjaWUgb2RiaW9ydQ==]</span>
  </h1>
  <div class="stock_info">
    <iaixsl:attribute name="data-id"><iaixsl:value-of select="/shop/page/stock/@stock_id"/></iaixsl:attribute>
    <iaixsl:attribute name="data-name"><iaixsl:value-of select="/shop/page/stock/@name"/></iaixsl:attribute>
    <iaixsl:attribute name="data-lat"><iaixsl:value-of select="/shop/page/stock/location/@latitude"/></iaixsl:attribute>
    <iaixsl:attribute name="data-lng"><iaixsl:value-of select="/shop/page/stock/location/@longitude"/></iaixsl:attribute>
    <iaixsl:attribute name="data-street"><iaixsl:value-of select="/shop/page/stock/@street"/></iaixsl:attribute>
    <iaixsl:attribute name="data-zipcode"><iaixsl:value-of select="/shop/page/stock/@zipcode"/></iaixsl:attribute>
    <iaixsl:attribute name="data-city"><iaixsl:value-of select="/shop/page/stock/@city"/></iaixsl:attribute>
    <iaixsl:attribute name="data-country"><iaixsl:value-of select="/shop/page/stock/@country"/></iaixsl:attribute>
    <div class="stock_info__wrapper --details">
      <h3 class="stock_info__name"><iaixsl:value-of select="/shop/page/stock/@name"/></h3>
      <div class="stock_info__items --contact">
        <iaixsl:if test="/shop/page/stock/@street and /shop/page/stock/@street != ''">
          <div class="stock_info__item --street">
            <strong class="stock_info__label">iai_i18n:[VWxpY2E=]</strong>
            <span class="stock_info__value"><iaixsl:value-of select="/shop/page/stock/@street"/></span>
          </div>
        </iaixsl:if>
        <iaixsl:if test="/shop/page/stock/@zipcode and /shop/page/stock/@zipcode != ''">
          <div class="stock_info__item --zipcode">
            <strong class="stock_info__label">iai_i18n:[S29kIHBvY3p0b3d5]</strong>
            <span class="stock_info__value"><iaixsl:value-of select="/shop/page/stock/@zipcode"/></span>
          </div>
        </iaixsl:if>
        <iaixsl:if test="/shop/page/stock/@city and /shop/page/stock/@city != ''">
          <div class="stock_info__item --city">
            <strong class="stock_info__label">iai_i18n:[TWlhc3Rv]</strong>
            <span class="stock_info__value"><iaixsl:value-of select="/shop/page/stock/@city"/></span>
          </div>
        </iaixsl:if>
        <iaixsl:if test="/shop/page/stock/@country and /shop/page/stock/@country != ''">
          <div class="stock_info__item --country">
            <strong class="stock_info__label">iai_i18n:[S3Jhag==]</strong>
            <span class="stock_info__value"><iaixsl:value-of select="/shop/page/stock/@country"/></span>
          </div>
        </iaixsl:if>
        <iaixsl:if test="/shop/page/stock/@phone and /shop/page/stock/@phone != ''">
          <div class="stock_info__item --phone">
            <strong class="stock_info__label">iai_i18n:[VGVsZWZvbg==]</strong>
            <a class="stock_info__value"><iaixsl:attribute name="href">tel:<iaixsl:value-of select="/shop/page/stock/@phone"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/stock/@phone"/></a>
          </div>
        </iaixsl:if>
        <iaixsl:if test="/shop/page/stock/@fax and /shop/page/stock/@fax != ''">
          <div class="stock_info__item --fax">
            <strong class="stock_info__label">iai_i18n:[RmF4]</strong>
            <a class="stock_info__value"><iaixsl:attribute name="href">fax:<iaixsl:value-of select="/shop/page/stock/@fax"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/stock/@fax"/></a>
          </div>
        </iaixsl:if>
        <iaixsl:if test="/shop/page/stock/@mail and /shop/page/stock/@mail != ''">
          <div class="stock_info__item --mail">
            <strong class="stock_info__label">iai_i18n:[RW1haWw=]</strong>
            <a class="stock_info__value"><iaixsl:attribute name="href">mailto:<iaixsl:value-of select="/shop/page/stock/@mail"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/stock/@mail"/></a>
          </div>
        </iaixsl:if>
        <iaixsl:if test="/shop/page/stock/@gg and /shop/page/stock/@gg != ''">
          <div class="stock_info__item --gg">
            <strong class="stock_info__label">iai_i18n:[R2FkdS1nYWR1]</strong>
            <a class="stock_info__value"><iaixsl:attribute name="href">gg:<iaixsl:value-of select="/shop/page/stock/@gg"/></iaixsl:attribute><img alt="gg"><iaixsl:attribute name="src">https://status.gadu-gadu.pl/users/status.asp?id=<iaixsl:value-of select="/shop/page/stock/@gg"/></iaixsl:attribute></img><iaixsl:value-of select="/shop/page/stock/@gg"/></a>
          </div>
        </iaixsl:if>
        <iaixsl:if test="/shop/page/stock/@skype and /shop/page/stock/@skype != ''">
          <div class="stock_info__item --skype">
            <strong class="stock_info__label">iai_i18n:[U2t5cGU=]</strong>
            <span class="stock_info__value"><iaixsl:value-of select="/shop/page/stock/@skype"/></span>
          </div>
        </iaixsl:if>
        <iaixsl:if test="(/shop/page/stock/@street and /shop/page/stock/@street != '') or (/shop/page/stock/@zipcode and /shop/page/stock/@zipcode != '') or (/shop/page/stock/@city and /shop/page/stock/@city != '')">
          <div class="stock_info__item --show-on-map">
            <a class="stock_info__show_on_map btn --solid" href="#showOnMap"><i class="icon-globe"/><span class="d-none d-sm-inline">iai_i18n:[UG9rYcW8IG5hIG1hcGll]</span><span class="d-sm-none">iai_i18n:[TWFwYQ==]</span></a>
          </div>
        </iaixsl:if>
      </div>
    </div>
    <div class="stock_info__wrapper --hours">
      <h3 class="stock_info__name">iai_i18n:[R29kemlueSBvdHdhcmNpYQ==]</h3>
      <div class="stock_info__items --hours">
        <iaixsl:if test="page/stock_time/monday">
          <div class="stock_info__item --hour --monday">
            <strong class="stock_info__label">iai_i18n:[UG9uaWVkemlhxYJlaw==]</strong>
            <span class="stock_info___value">
              <iaixsl:choose>
        ...
        <iaixsl:if test="page/stock_time/tuesday">
          <div class="stock_info__item --hour --tuesday">
            <strong class="stock_info__label">iai_i18n:[V3RvcmVr]</strong>
            <span class="stock_info___value">
              <iaixsl:choose>
        ...
        <iaixsl:if test="page/stock_time/wednesday">
          <div class="stock_info__item --hour --wednesday">
            <strong class="stock_info__label">iai_i18n:[xZpyb2Rh]</strong>
            <span class="stock_info___value">
              <iaixsl:choose>
        ...
        <iaixsl:if test="page/stock_time/thursday">
          <div class="stock_info__item --hour --thursday">
            <strong class="stock_info__label">iai_i18n:[Q3p3YXJ0ZWs=]</strong>
            <span class="stock_info___value">
              <iaixsl:choose>
        ...
        <iaixsl:if test="page/stock_time/friday">
          <div class="stock_info__item --hour --friday">
            <strong class="stock_info__label">iai_i18n:[UGnEhXRlaw==]</strong>
            <span class="stock_info___value">
              <iaixsl:choose>
        ...
        <iaixsl:if test="page/stock_time/saturday">
          <div class="stock_info__item --hour --saturday">
            <strong class="stock_info__label">iai_i18n:[U29ib3Rh]</strong>
            <span class="stock_info___value">
              <iaixsl:choose>
        ...
        <iaixsl:if test="page/stock_time/sunday">
          <div class="stock_info__item --hour --sunday">
            <strong class="stock_info__label">iai_i18n:[TmllZHppZWxh]</strong>
            <span class="stock_info___value">
              <iaixsl:choose>
  ...
  <div id="stock_map"/>
  <script>window.google_api_key=&apos;<iaixsl:value-of select="/shop/page/stock/google_api_key/@value"/>&apos;;</script>
	<iaixsl:if test="page/stock/text()">
		<div class="stock_info_description mt-5">
			<h2 class="headline stock_info_description__label">
				<span class="headline__name">iai_i18n:[U3pjemVnw7PFgm93ZSBpbmZvcm1hY2pl]</span>
			</h2>
			<div class="stock_info_description__text">
