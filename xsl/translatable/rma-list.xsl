...
<iaixsl:attribute name="class">rma_list_cms_label  big_label</iaixsl:attribute>
            <span class="rma_list_cms_label">
                    iai_i18n:[SmFrIHBvcHJhd25pZSB6xYJvxbx5xIcgcmVrbGFtYWNqxJk=]
            </span>
        </div>
    ...
    <!-- (rma_list_data, 61f913c8d54967.47575577.3)-->

        <iaixsl:variable name="rma_list_paymenthead">iai_i18n:[UHJlZmVyb3dhbmEgZm9ybWEgendyb3R1IHBpZW5pxJlkenk=]:</iaixsl:variable>
        ...
        <iaixsl:choose>
            <iaixsl:when test="/shop/page/rma/item">
                ...
                <div class="client_order">
                    ...
                    <h1 class="big_label">
                        <span>iai_i18n:[UmVrbGFtYWNqZSB3IHRva3U=]</span>
                    </h1>
                    ...
                    <table class="orders" cellspacing="0" cellpadding="0">
                        ...
                        <thead>
                            <tr id="orders_header">
                                <td class="ord3" id="orders_head_1">iai_i18n:[SUQgcmVrbGFtYWNqaQ==]</td>
                                <td class="ord3" id="orders_head_2">iai_i18n:[RGF0YSByZWtsYW1hY2pp]</td>
                                

                                <td class="ord3" id="orders_head_5">Status</td>
                                <td class="ord3" id="orders_head_6">iai_i18n:[QWtjamE=]</td>
                            </tr>
                        </thead>
                        <tbody>
                            <iaixsl:for-each select="/shop/page/rma/item">
                                <tr>
                                        ...
                                        <div>
                                            ...
                                            <iaixsl:choose>
                                                ...
                                                <iaixsl:when test="@status=1">
                                                    ...
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyeXdhbmE=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=2">
                                                    <span><i class="icon-ok"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmll]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=3">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBuZWdhdHl3bmll]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=4">
                                                    <span><i class="icon-clock"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyeXdhbmEgLSBTa2llcm93YW5vIGRvIHRlc3TDs3c=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=5">
                                                    <span><i class="icon-clock"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyeXdhbmEgLSBQcm9kdWt0IHd5c8WCYW55IGRvIHByb2R1Y2VudGE=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=6">
                                                    <span><i class="icon-clock"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyeXdhbmEgLSBUcndhIG5hcHJhd2lhbmll]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=7">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBuZWdhdHl3bmllIC0gTmllIHN0d2llcmR6b25vIHVzdGVya2k=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=8">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBuZWdhdHl3bmllIC0gV2FkYSBzcG93b2Rvd2FuYSB6xYLEhSBla3NwbG9hdGFjasSF]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=9">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBuZWdhdHl3bmllIC0gUHJ6ZWtyb2N6b25vIHRlcm1pbiBnd2FyYW5jamk=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=10">
                                                    <span><i class="icon-ok"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gWndyb3QgcGllbmnEmWR6eSAtIHNraWVyb3dhbmllIGRvIHd5cMWCYXR5]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=11">
                                                    <span><i class="icon-ok"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gWndyb3QgcGllbmnEmWR6eSAtIHd5cMWCYXRh]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=12">
                                                    <span><i class="icon-ok"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gV3ltaWFuYSBuYSBub3d5IHByb2R1a3Q=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=13">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSBhbnVsb3dhbmEgcHJ6ZXoga2xpZW50YQ==]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=14">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSBuaWUgZG90YXLFgmE=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=15">
                                                    <span><i class="icon-clock"/> </span>
                                                    <small>iai_i18n:[S2xpZW50IHd5Z2VuZXJvd2HFgiByZWtsYW1hY2rEmQ==]</small>
                                                </iaixsl:when>
                                                
                                                <iaixsl:when test="@status=16">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[WmFuaWVjaGFuaWUgcG9ub3duZWogd3lzecWCa2kgemFtw7N3aWVuaWE=] </small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=17">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSBhbnVsb3dhbmE=] </small>
                                                </iaixsl:when>
                                                ...
                                                <iaixsl:when test="@status=19">
                                                    <span><i class="icon-ok"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSBwb3R3aWVyZHpvbmE=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=20">
                                                    <span><i class="icon-clock"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSBuaWVvYnPFgnXFvG9uYQ==]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=21">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSBvZHJ6dWNvbmE=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=22">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSBvZHJ6dWNvbmEgLSBOaWUgc3R3aWVyZHpvbm8gdXN0ZXJraQ==]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=23">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSBvZHJ6dWNvbmEgLSBQcnpla3JvY3pvbm8gdGVybWluIGd3YXJhbmNqaQ==]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=24">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSBvZHJ6dWNvbmEgLSBXYWRhIHNwb3dvZG93YW5hIHrFgsSFIGVrc3Bsb2F0YWNqxIU=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=25">
                                                    <span><i class="icon-ok"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gUHJ6ZXN5xYJrYSB6d3JvdG5hIHd5c8WCYW5hIGRvIGtsaWVudGE=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=26">
                                                    <span><i class="icon-ok"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gV3lzxYJhbm8gbm93eSBwcm9kdWt0IGJleiBvY3pla2l3YW5pYSBuYSBwaWVyd290bnk=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=27">
                                                    <span><i class="icon-ok"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBwb3p5dHl3bmllIC0gWm1pYW5hIGRhbnljaCBvZGJpb3JjeSBuYSBkb2t1bWVuY2llIHNwcnplZGHFvHk=]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=28">
                                                    <span><i class="icon-clock"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyeXdhbmEgLSBOYXByYXdhIHpha2/FhGN6b25h]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=29">
                                                    <span><i class="icon-clock"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyeXdhbmEgLSBXeW1hZ2EgZG9kYXRrb3d5Y2ggaW5mb3JtYWNqaSBvZCBrbGllbnRh]</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=30">
                                                    <span><i class="icon-remove"/></span>
                                                    <small>iai_i18n:[UmVrbGFtYWNqYSByb3pwYXRyem9uYSBuZWdhdHl3bmllIC0gUHJ6ZXN5xYJrYSB6d3JvdG5hIHd5c8WCYW5hIGRvIGtsaWVudGE=]</small>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <span><i class="icon-ok"/></span>
                                                    <small>
                                    ...
                                    <td class="ord">
                                        <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute><span><i class="icon-plus"/></span><small>iai_i18n:[V3liaWVyeg==]</small></a>
                                    </td>
                                </tr>
                            </iaixsl:for-each>
                        </tbody>
                ...
                <div class="rma_list_data_outline">
                    <div class="rma_list_data_label">
                        <span class="rma_list_data_label">
                            iai_i18n:[RHppYcWCIHJla2xhbWFjamkgKFJNQSk=] 
                        </span>
                    </div>
                    <div class="rma_list_data_addbutton">
                        <a href="rma-add.php" class="btn --solid --medium rma_list_data_addbutton">

                            <iaixsl:attribute name="title"><i class="icon-pencil"/> iai_i18n:[RG9kYWogcmVrbGFtYWNqxJk=]</iaixsl:attribute>
                            <span class="img_button_edytujaddbutton"/>
                            <div class="addbutton_maintxt"><i class="icon-pencil"/> iai_i18n:[RG9kYWogcmVrbGFtYWNqxJk=]</div>
                            <div class="addbutton_sidetxt">iai_i18n:[TWFzeiB6YXN0cnplxbxlbmlhIGRvIG90cnp5bWFuZWdvIHByb2R1a3R1PyBaZ8WCb8WbIHJla2xhbWFjasSZ].</div>
                        </a>
                    </div>
                    <iaixsl:if test="(page/list/active/@count = 0) and (page/list/close/@count = 0)">
                        <span class="rma_list_noitem" id="rma_list_noitem">iai_i18n:[TmllIGRvZGFubyBqZXN6Y3plIMW8YWRuZWogcmVrbGFtYWNqaQ==].</span>
                    </iaixsl:if>
