...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (products_bought_list, 614c5cf1278845.84048440.11)-->
	...
	<iaixsl:variable name="next_page_bottom">iai_i18n:[TmFzdMSZcG5hIHN0cm9uYQ==]</iaixsl:variable>

	<div class="products-bought row" id="products-bought">
		<div class="col-12 products-bought__label-wrapper">
			<h1 class="big_label">iai_i18n:[TGlzdGEgemFrdXBpb255Y2ggcHJvZHVrdMOzdw==]</h1>
		</div>
		<form id="pb_paging_setting_top" class="pb_paging col-md-12" action="/settings.php">
			<iaixsl:if test="not(/shop/page/navigation/@disable_sort_change = 'y')">
				<div class="pb_paging__item --sort">
					...
					<select class="pb_paging__select --order --small-md" id="select_top_sort" name="sort_order">
					  <iaixsl:attribute name="aria-label">iai_i18n:[Wm1pZcWEIHNvcnRvd2FuaWU=]</iaixsl:attribute>
						<option value="name-a" class="option_name-a"><iaixsl:if test="page/navigation/@sort = 'name' and page/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[U29ydHVqIHBvIG5hendpZSByb3NuxIVjbw==]</option>
						<option value="name-d" class="option_name-d"><iaixsl:if test="page/navigation/@sort = 'name' and page/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[U29ydHVqIHBvIG5hendpZSBtYWxlasSFY28=]</option>
						<option value="price-a" class="option_price-a"><iaixsl:if test="page/navigation/@sort = 'price' and page/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[U29ydHVqIHBvIGNlbmllIHJvc27EhWNv]</option>
						<option value="price-d" class="option_price-d"><iaixsl:if test="page/navigation/@sort = 'price' and page/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[U29ydHVqIHBvIGNlbmllIG1hbGVqxIVjbw==]</option>
						<option value="date-a" class="option_date-a"><iaixsl:if test="page/navigation/@sort = 'date' and page/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[U29ydHVqIHBvIGRhY2llIHJvc27EhWNv]</option>
						<option value="date-d" class="option_date-d"><iaixsl:if test="page/navigation/@sort = 'date' and page/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[U29ydHVqIHBvIGRhY2llIG1hbGVqxIVjbw==]</option>
					</select>
				</div>
			</iaixsl:if>
			<iaixsl:if test="count(page/navigation/portions) &gt; 1">
				<div class="pb_paging__item --portions d-none d-md-block">
			...
			<iaixsl:if test="count(page/navigation/item) &gt; 1">
				<div id="pb_paging_top" class="pb_paging__item pagination d-none d-sm-flex mb-2 mb-sm-3">
					<ul class="pagination">
						...
						<iaixsl:if test="page/navigation/prev">
							<li class="pagination__element --prev">
								...
								<a class="pagination__link">
									<iaixsl:attribute name="href"><iaixsl:choose><iaixsl:when test="page/navigation/prev/@counter = '0'"><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/navigation/path/@value, '&amp;counter=')"/><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/navigation/path/@value, '?counter=')"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of disable-output-escaping="yes" select="page/navigation/path/@value"/><iaixsl:value-of select="page/navigation/prev/@counter"/></iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>
		...
		<div class="col-12 products-bought__list-wrapper">
			<div id="products-bought__list" class="products-bought__list">
				<div class="products-bought__list-header row d-none d-md-flex pb-2">
					...
					<div class="products-bought__header-date col-2">iai_i18n:[T3N0YXRuaSB6YWt1cA==]</div>
					<div class="products-bought__header-price col-2">iai_i18n:[QWt0dWFsbmEgY2VuYQ==]<span class="price_vat"><iaixsl:value-of select="$changePrice"/></span></div>
				</div>
				<div class="row products-bought__products">
					<iaixsl:for-each select="/shop/page/products-list/product">
						...
						<iaixsl:variable name="var_omnibus_min"><iaixsl:choose>
							<iaixsl:when test="$changePrice and not($changePrice = '')">
								<iaixsl:choose>
									<iaixsl:when test="sizes/size[@buy_date]/price/@omnibus_price_net">
										<iaixsl:value-of select="sizes/size[@buy_date]/price/@omnibus_price_net_formatted"/>
									</iaixsl:when>
								</iaixsl:choose>
							</iaixsl:when>
							<iaixsl:otherwise>
								<iaixsl:choose>
									<iaixsl:when test="sizes/size[@buy_date]/price/@omnibus_price">
										<iaixsl:value-of select="sizes/size[@buy_date]/price/@omnibus_price_formatted"/>
									</iaixsl:when>
								</iaixsl:choose>
							</iaixsl:otherwise>
						</iaixsl:choose></iaixsl:variable>
          	...
          	<iaixsl:variable name="var_omnibus"><iaixsl:choose>
							<iaixsl:when test="/shop/@omnibus != 1"/>
						...
						<iaixsl:variable name="var_regular_price"><iaixsl:choose>
							<iaixsl:when test="$changePrice and not($changePrice = '')">
								<iaixsl:choose>
									<iaixsl:when test="sizes/size[@buy_date]/price/@maxprice_net">
										<iaixsl:value-of select="sizes/size[@buy_date]/price/@maxprice_net_formatted"/>
									</iaixsl:when>
								</iaixsl:choose>
							</iaixsl:when>
							<iaixsl:otherwise>
								<iaixsl:choose>
									<iaixsl:when test="sizes/size[@buy_date]/price/@maxprice">
										<iaixsl:value-of select="sizes/size[@buy_date]/price/@maxprice_formatted"/>
									</iaixsl:when>
								</iaixsl:choose>
							</iaixsl:otherwise>
						</iaixsl:choose></iaixsl:variable>
						...
						<iaixsl:variable name="var_omnibus_short"><iaixsl:if test="$var_regular_price = $var_omnibus">true</iaixsl:if></iaixsl:variable>

						
						<iaixsl:variable name="var_omnibus_rebate_code"><iaixsl:if test="/shop/rebatecode/@activate_omnibus = 'true' and sizes/size[@buy_date]/price/@rebate_code_active = 'y'">true</iaixsl:if></iaixsl:variable>

						
						<iaixsl:variable name="var_omnibus_higher"><iaixsl:value-of select="sizes/size[@buy_date]/price/@omnibus_price_is_higher_than_selling_price"/></iaixsl:variable>

          	
						<iaixsl:variable name="var_beforerebate_price"><iaixsl:choose>
							<iaixsl:when test="$changePrice and not($changePrice = '')">
								<iaixsl:choose>
									<iaixsl:when test="sizes/size[@buy_date]/price/@beforerebate_net">
										<iaixsl:value-of select="sizes/size[@buy_date]/price/@beforerebate_net_formatted"/>
									</iaixsl:when>
								</iaixsl:choose>
							</iaixsl:when>
							<iaixsl:otherwise>
								<iaixsl:choose>
									<iaixsl:when test="sizes/size[@buy_date]/price/@beforerebate">
										<iaixsl:value-of select="sizes/size[@buy_date]/price/@beforerebate_formatted"/>
									</iaixsl:when>
								</iaixsl:choose>
							</iaixsl:otherwise>
						</iaixsl:choose></iaixsl:variable>
						...
						<iaixsl:variable name="var_beforerebate_percent">-<iaixsl:value-of select="sizes/size[@buy_date]/price/@beforerebate_yousave_percent"/>%</iaixsl:variable>

						
						<iaixsl:variable name="var_omnibus_percent"><iaixsl:choose><iaixsl:when test="sizes/size[@buy_date]/price/@omnibus_yousave_percent = '0'"/><iaixsl:when test="$var_omnibus_higher = 'false'">+</iaixsl:when><iaixsl:otherwise>-</iaixsl:otherwise></iaixsl:choose><iaixsl:value-of select="sizes/size[@buy_date]/price/@omnibus_yousave_percent"/>%</iaixsl:variable>

						
						<iaixsl:variable name="var_regular_percent">-<iaixsl:value-of select="sizes/size[@buy_date]/price/@yousave_percent"/>%</iaixsl:variable>

						
						<iaixsl:variable name="var_new_price_date"><iaixsl:choose>
							<iaixsl:when test="$var_omnibus_rebate_code != ''"/>
							<iaixsl:otherwise><iaixsl:value-of select="sizes/size[@buy_date]/price/@omnibus_new_price_effective_until"/></iaixsl:otherwise>
						</iaixsl:choose></iaixsl:variable>
								...
								<div class="row align-items-center products-bought__product-inner">
									<div class="col-md-1 col-12 mb-3 mb-md-0">
										<div class="products-bought__checkbox f-group --checkbox mb-0">
											...
											<input type="checkbox" class="f-control focused products-bought__input-checkbox">
												...
												<iaixsl:attribute name="id">choose_product_<iaixsl:value-of select="@id"/>_<iaixsl:value-of select="sizes/size[@buy_date]/@type"/></iaixsl:attribute>
											</input>
											<label class="f-label">
												<iaixsl:attribute name="for">choose_product_<iaixsl:value-of select="@id"/>_<iaixsl:value-of select="sizes/size[@buy_date]/@type"/></iaixsl:attribute>
												<span class="sr-only">iai_i18n:[V3liaWVyeiBwcm9kdWt0] <iaixsl:value-of disable-output-escaping="yes" select="name/text()"/></span>
											</label>
										</div>
									</div>
									<div class="col-md-1 col-12 mb-3 mb-md-0">
									...
									<div class="col-md-2 col-12 mb-3 mb-md-0">
										<div class="products-bought__product-date">
											<span class="d-block d-md-none">iai_i18n:[T3N0YXRuaSB6YWt1cA==]</span>
									...
									<div class="col-md-2 col-12 mb-3 mb-md-0">
										<div class="products-bought__product-price product__prices">
											...
											<span class="d-block d-md-none">iai_i18n:[QWt0dWFsbmEgY2VuYQ==]</span>
											<iaixsl:choose>
												<iaixsl:when test="sizes/size[@buy_date]/price/@value = 0">
													<a class="col2_54008x_phone" href="/contact.php">iai_i18n:[bmEgdGVsZWZvbg==]</a>
												</iaixsl:when>
												<iaixsl:otherwise>
													<iaixsl:choose>
													...
													<iaixsl:if test="$var_omnibus_rebate_code != '' and $var_beforerebate_price !=''">
														<span class="price --before-rebate">
															...
															<del><iaixsl:value-of select="$var_beforerebate_price"/></del>
											...
											<iaixsl:choose>
												...
												<iaixsl:otherwise>
													<a class="btn --solid">
														...
														<iaixsl:attribute name="title">iai_i18n:[RG8ga29zenlrYQ==]</iaixsl:attribute>
		...
		<form id="pb_paging_setting_bottom" class="pb_paging col-12 col-md-auto" action="/settings.php">
			<iaixsl:if test="not(/shop/page/navigation/@disable_sort_change = 'y')">
				<div class="pb_paging__item --sort d-none">
			...
			<iaixsl:if test="count(page/navigation/portions) &gt; 1">
				<div class="pb_paging__item --portions d-none">
			...
			<iaixsl:if test="count(page/navigation/item) &gt; 1">
				<div id="pb_paging_bottom" class="pb_paging__item pagination d-flex mb-2 mb-md-0">
					<ul class="pagination">
						<iaixsl:attribute name="aria-label">iai_i18n:[TmF3aWd1aiBtacSZZHp5IHN0cm9uYW1p]</iaixsl:attribute>
		...
		<div class="col-12">
			<div class="products-bought__products-button">
				<div class="products-bought__checkbox-all f-group --checkbox">
					<input type="checkbox" class="f-control focused products-bought__input-checkbox-all" id="choose_all_products_bought">
					</input>
					<label class="f-label" for="choose_all_products_bought">iai_i18n:[V3liaWVyeiB3c3p5c3RraWU=]</label>
				</div>
				<button class="btn --solid --medium">
					iai_i18n:[RG9kYWogd3licmFuZSBkbyBrb3N6eWth]
				</button>
			</div>
		</div>
	</div>
