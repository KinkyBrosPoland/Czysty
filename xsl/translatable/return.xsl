...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (return, 60dd8ebfe0e030.48546883.10)-->
	<iaixsl:variable name="error_undefined_ret">iai_i18n:[V3lzdMSFcGnFgiBuaWV6bmFueSBixYLEhWQ=].</iaixsl:variable>
	<iaixsl:variable name="file_upload_invalid_type">iai_i18n:[TmllIG1vxbxuYSB3Z3JhxIcgcGxpa3U=] </iaixsl:variable>
	<iaixsl:variable name="file_upload_invalid_extension">iai_i18n:[TmllIG1vxbxuYSB3Z3JhxIcgcGxpa3U=] </iaixsl:variable>
	<iaixsl:variable name="file_upload_size_exceeded">iai_i18n:[TmllIG1vxbxuYSB3Z3JhxIcgcGxpa3U=] </iaixsl:variable>
	<iaixsl:variable name="file_uploaded_remove_fail">iai_i18n:[V3lzdMSFcGnFgiBixYJhZCBwb2RjemFzIHdncnl3YW5pYSBwbGlrdQ==].</iaixsl:variable>
	<iaixsl:variable name="auction_shop_bundle_not_exist">iai_i18n:[WmVzdGF3IHogd3licmFuxIUga29tYmluYWNqxIUgcHJvZHVrdMOzdyBuaWUgem5hamR1amUgc2nEmSBuYSBha3R5d255Y2ggYXVrY2phY2guIEplxZtsaSB0byBtb8W8bGl3ZSwgdG8gd3liaWVyeiBpbm7EhSBrb21iaW5hY2rEmSBwcm9kdWt0w7N3LCBsdWIgc2tvbnRha3R1aiBzacSZIHogbmFtaQ==].</iaixsl:variable>
	<iaixsl:variable name="token_expired">iai_i18n:[TGluayBkb3N0xJlwdSBkbyBUd29pY2ggZGFueWNoIHN0cmFjacWCIGp1xbwgd2HFvG5vxZvEhy4gQWJ5IHV6eXNrYcSHIGRvc3TEmXAgZG8gZGFueWNoIG5hIFR3b2ltIGtvbmNpZSwgc2tvcnp5c3RhaiB6ZQ==] <a title="Zaloguj się" href="/signin.php">iai_i18n:[c3Ryb255IGxvZ293YW5pYQ==]</a>.</iaixsl:variable>
	<iaixsl:variable name="too_much_product">iai_i18n:[TWFrc3ltYWxuaWUgbW/FvGVzeiB6YW3Ds3dpxIc=] </iaixsl:variable>
	<iaixsl:variable name="not_enough_product">iai_i18n:[TWluaW1hbG5pZSBtdXNpc3ogemFtw7N3acSH] </iaixsl:variable>
	<iaixsl:variable name="too_much_product_size">iai_i18n:[TWFrc3ltYWxuaWUgbW/FvGVzeiB6YW3Ds3dpxIc=] </iaixsl:variable>
	<iaixsl:variable name="not_enough_product_size">iai_i18n:[TWluaW1hbG5pZSBtdXNpc3ogemFtw7N3acSH] </iaixsl:variable>
	<iaixsl:variable name="return_rebates_code_used">iai_i18n:[UG9kYW55IGtvZCByYWJhdG93eSB6b3N0YcWCIGp1xbwgd3lrb3J6eXN0YW55].</iaixsl:variable>
	<iaixsl:variable name="rebates_code_notbegun">iai_i18n:[UG9kYW55IGtvZCByYWJhdG93eSBuaWUgamVzdCBqZXN6Y3plIGFrdHl3bnkuIFRhIHByb21vY2phIGplc3pjemUgc2nEmSBuaWUgcm96cG9jesSZxYJh].</iaixsl:variable>
	<iaixsl:variable name="rebates_code_expired">iai_i18n:[VGVybWluIHdhxbxub8WbY2kgcG9kYW5lZ28ga29kdSByYWJhdG93ZWdvIGp1xbwgdXDFgnluxIXFgiBpIGplc3Qgb24gbmllYWt0eXdueQ==].</iaixsl:variable>
			...
			<iaixsl:choose>
				...
				<iaixsl:when test="page/return/@type='file_upload_invalid_type' and $file_upload_invalid_type">
					<h3 class="return_label"><iaixsl:value-of select="$file_upload_invalid_type"/>
						<span class="invalidFileName"><iaixsl:value-of select="@value"/></span>, iai_i18n:[cG9uaWV3YcW8IHphxYLEhWN6YW5pZSBwbGlrw7N3IHRlZ28gdHlwdSBqZXN0IG5pZWRvendvbG9uZQ==].</h3>
				</iaixsl:when>
				...
				<iaixsl:when test="page/return/@type='file_upload_size_exceeded' and $file_upload_size_exceeded">
					<h3 class="return_label"><iaixsl:value-of select="$file_upload_size_exceeded"/>
						<span class="invalidFileName"><iaixsl:value-of select="@value"/></span>, iai_i18n:[cG9uaWV3YcW8IHByemVrcmFjemEgbWFrc3ltYWxueSBkb3p3b2xvbnkgcm96bWlhcg==].</h3>
				</iaixsl:when>
				...
				<iaixsl:when test="page/return/@type = 'opinion_addphotoerror'">
					<h3 class="return_label">iai_i18n:[RG9kYW5lIHByemV6IENpZWJpZSB6ZGrEmWNpZSBqZXN0IG5pZXByYXdpZMWCb3dl].
						<iaixsl:if test="page/return/param[@name = 'max_height'] and page/return/param[@name = 'max_width']">
							<br/>iai_i18n:[TWF4LiByb3ptaWFyIHpkasSZY2lhIHRv]: 
						...
						<iaixsl:if test="page/return/param[@name = 'photo_format']">
							<br/>iai_i18n:[RG9wdXN6Y3phbG5lIGZvcm1hdHkgemRqxJnEhw==]: 
				...
				<iaixsl:when test="page/return/@type='token_expired' and $token_expired">
					<h3 class="return_label">iai_i18n:[TGluayBkb3N0xJlwdSBkbyBUd29pY2ggZGFueWNoIHN0cmFjacWCIGp1xbwgd2HFvG5vxZvEhy4gQWJ5IHV6eXNrYcSHIGRvc3TEmXAgZG8gZGFueWNoIG5hIFR3b2ltIGtvbmNpZSwgc2tvcnp5c3RhaiB6ZQ==] <a title="Zaloguj się" href="/signin.php">iai_i18n:[c3Ryb255IGxvZ293YW5pYQ==]</a>.</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='too_much_product' and $too_much_product">
					<h3 class="return_label"><iaixsl:value-of select="$too_much_product"/><iaixsl:value-of select="/shop/page/return/param/@value"/> iai_i18n:[c3p0].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='not_enough_product' and $not_enough_product">
					<h3 class="return_label"><iaixsl:value-of select="$not_enough_product"/><iaixsl:value-of select="/shop/page/return/param/@value"/> iai_i18n:[c3p0].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='too_much_product_size' and $too_much_product_size">
					<h3 class="return_label"><iaixsl:value-of select="$too_much_product_size"/><iaixsl:value-of select="/shop/page/return/param/@value"/> iai_i18n:[c3p0LiB3eWJyYW5lZ28gcm96bWlhcnU=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='not_enough_product_size' and $not_enough_product_size">
					<h3 class="return_label"><iaixsl:value-of select="$not_enough_product_size"/><iaixsl:value-of select="/shop/page/return/param/@value"/> iai_i18n:[c3p0LiB3eWJyYW5lZ28gcm96bWlhcnU=].</h3>
				</iaixsl:when>
				...
				<iaixsl:when test="page/return/@type = 'rma_require_one_order'">
					<h3 class="return_label">iai_i18n:[TmEgVHdvaW0ga29uY2llIGtsaWVudGEgbmllIHpvc3RhxYJvIHpyZWFsaXpvd2FuZSDFvGFkbmUgemFtw7N3aWVuaWUuIEFieSBtw7NjIGRvZGHEhyB6Z8WCb3N6ZW5pZSByZWtsYW1hY2ppIG11c2lzeiB6YWt1cGnEhyBjb2tvbHdpZWs=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'orderedit_dataerror'">
					<h3 class="return_label">iai_i18n:[QsWCxIVkIGRhbnljaCBwb2RjemFzIGVkeWNqaSB6YW3Ds3dpZW5pYQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'order_product_worth'">
					<h3 class="return_label">iai_i18n:[TmllIG1vxbxuYSB6xYJvxbx5xIcgemFtw7N3aWVuaWEsIHBvbmlld2HFvCB3IGtvc3p5a3Ugem5hamR1asSFIHNpxJkgcHJvZHVrdHkgeiBjZW7EhSAw] <iaixsl:value-of select="currency/@name"/>. iai_i18n:[UHJvc3rEmSBza29yeWdvd2HEhyB6YXdhcnRvxZvEhyBrb3N6eWth].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='order_invalidpoints'">
					<h3 class="return_label">iai_i18n:[V3lzdMSFcGnFgiBixYLEhWQgendpxIV6YW55IHogcHJvZHVrdGVtIGt1cGlvbnltIHphIHB1bmt0eQ==]. <a href="/contact.php">iai_i18n:[U2tvbnRha3R1aiBzacSZIHogb2JzxYJ1Z8SFIHNrbGVwdQ==]</a>.</h3>
				</iaixsl:when>
				
				<iaixsl:when test="page/return/@type='openid_login_canceled'">
					<h3 class="return_label">iai_i18n:[TG9nb3dhbmllIGFudWxvd2FuZQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='openid_invalid_authorization'">
					<h3 class="return_label">iai_i18n:[QsWCxIVkIGF1dG9yeXphY2pp]. </h3>
				</iaixsl:when>
				
				<iaixsl:when test="page/return/@type = 'suggestbody_illegal_urls'">
					<h3 class="return_label">iai_i18n:[TmllIHd5c8WCYWxpxZtteSBlLW1haWxhLCBnZHnFvCB6YXdpZXJhIG9uIGFkcmVzeSBpbm55Y2ggc3Ryb24uIFByb3NpbXkgbyBuaWUgdcW8eXdhbmllIHRha2ljaCBhZHJlc8OzdyBsdWIgcG96b3N0YXdpZW5pZSBkb215xZtsbmVnbyBzemFibG9udQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'account_login_disabled'">
					<h3 class="return_label">iai_i18n:[VG8ga29udG8gbmllIHVwcmF3bmlhIGRvIGxvZ293YW5pYSBzacSZIG5hIHRlaiBzdHJvbmllLiBVxbx5aiBpbm5lZ28ga29udGEgbHVi] <a href="/client-new.php?register">iai_i18n:[emHFgsOzxbwgbm93ZQ==]</a>.</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'order_notenoughpoints'">
					<h3 class="return_label">iai_i18n:[TWFzeiB6YSBtYcWCbyBwdW5rdMOzdyBsb2phbG5vxZtjaW93eWNoIG5hIHN3b2ltIGtvbmNpZQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'compare_error_minimum'">
					<h3 class="return_label">iai_i18n:[RG9kYWogY28gbmFqbW5pZWogZHdhIHByb2R1a3R5IGRvIHBvcsOzd25hbmlh]</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'questionnaire_error'">
					<h3 class="return_label">iai_i18n:[V3lzdMSFcGnFgsKgYsWCxIVkLCBhbmtpZXRhIG5pZSB6b3N0YcWCYSBwcnplc8WCYW5h]. </h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'questionnaire_sent'">
					<h3 class="return_label">iai_i18n:[RHppxJlrdWplbXkhIEFua2lldGEgem9zdGHFgmEgd3lzxYJhbmE=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'polcard_authorized'">
					<h3 class="return_label">iai_i18n:[QXV0b3J5emFjamEgcG93aW9kxYJhIHNpxJk=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'polcard_unauthorized'">
					<h3 class="return_label">iai_i18n:[QXV0b3J5emFjamEgbmllIHBvd2lvZMWCYSBzacSZ].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'payment_credit_zagiel_error'">
					<h3 class="return_label">iai_i18n:[WnJlenlnbm93YcWCZcWbIHogb3RyenltYW5pYSBrcmVkeXR1IHJhdGFsbmVnby4gUHJ6ZWpkxbogZG8gc3pjemVnw7PFgsOzdyB6YW3Ds3dpZW5pYSBpIHBvbsOzdyBwcsOzYsSZIHDFgmF0bm/Fm2NpIHJhdGFtaSBsdWIgd3liaWVyeiBpbm7EhSBmb3JtxJkgcMWCYXRub8WbY2k=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'payment_credit_zagiel_success'">
					<h3 class="return_label">iai_i18n:[T2N6ZWt1aiBuYSBrb250YWt0IHRlbGVmb25pY3pueSB6IHByemVkc3Rhd2ljaWVsZW0gQmFua3UuIFBvZGN6YXMgcm96bW93eSB0ZWxlZm9uaWN6bmVqIHNwb3J6xIVkemkgcmF6ZW0geiBUb2LEhSB1bW93xJkgcmF0YWxuxIUuIFByenlnb3R1ajogZG93w7NkIG9zb2Jpc3R5IG9yYXogZHJ1Z2kgZG9rdW1lbnQgdG/FvHNhbW/Fm2Np].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'polcard_error'">
					<h3 class="return_label">iai_i18n:[V3lzdMSFcGnFgiBixYLEhWQgYXV0b3J5emFjamkgUG9sQ2FyZA==]</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'contactus_sent'">
					<h3 class="return_label">iai_i18n:[V2lhZG9tb8WbxIcgem9zdGHFgmEgd3lzxYJhbmE=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'contactus_error'">
					<h3 class="return_label">iai_i18n:[V3lzdMSFcGnFgiBixYLEhWQuIFdpYWRvbW/Fm8SHIG5pZSB6b3N0YcWCYSB3eXPFgmFuYQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'ordercancel_ok'">
					<h3 class="return_label">iai_i18n:[WmFtw7N3aWVuaWU=] <iaixsl:if test="page/return/@extra"><iaixsl:value-of select="page/return/@extra"/></iaixsl:if> iai_i18n:[em9zdGHFgm8gYW51bG93YW5l].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'returncancel_ok'">
					<h3 class="return_label">iai_i18n:[Wndyb3Qgem9zdGHFgiBhbnVsb3dhbnk=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'returncancel_error'">
					<h3 class="return_label">&quot;iai_i18n:[Wndyb3QgbmllIG1vxbxlIHpvc3RhxIcgYW51bG93YW55LiBTa29udGFrdHVqIHNpxJkgeg==] <a href="contact.php"> iai_i18n:[b2JzxYJ1Z8SF] </a> iai_i18n:[dyBjZWx1IHV6eXNrYW5pZSBzemN6ZWfDs8WCb3d5Y2ggaW5mb3JtYWNqaQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'ordercancel_dberror'">
					<h3 class="return_label">iai_i18n:[QsWCxIVkIGJhenkgZGFueWNo].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'ordercancel_dataerror'">
					<h3 class="return_label">iai_i18n:[TmllIG1vxbxuYSBhbnVsb3dhxIcgdGVnbyB6YW3Ds3dpZW5pYQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'orderconfirm_ok'">
					<h3 class="return_label">iai_i18n:[RHppxJlrdWplbXkuIFphbcOzd2llbmll] <iaixsl:if test="page/return/@extra"><iaixsl:value-of select="page/return/@extra"/></iaixsl:if> iai_i18n:[em9zdGHFgm8gb3puYWN6b25lIGpha28gcG90d2llcmR6b25l].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'orderconfirm_noneed'">
					<h3 class="return_label">iai_i18n:[WmFtw7N3aWVuaWUgbmllIG11c2kgYnnEhyBqdcW8IHBvdHdpZXJkemFuZSBlLW1haWxlbQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'orderconfirm_confirmed'">
					<h3 class="return_label">iai_i18n:[WmFtw7N3aWVuaWUgem9zdGHFgm8ganXFvCB3Y3plxZtuaWVqIHBvdHdpZXJkem9uZQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'orderconfirm_dataerror'">
					<h3 class="return_label">iai_i18n:[UG9kYW55IGFkcmVzIGplc3QgbmllcG9wcmF3bnkgbHViIHpvc3RhxYIgbmllcG9wcmF3bmllIHdwaXNhbnk=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'prepaid_error'">
					<h3 class="return_label">iai_i18n:[TmllIG1vxbxlc3ogbW9keWZpa293YcSHIHRlZ28gemFtw7N3aWVuaWEuIFNrb250YWt0dWogc2nEmSB6] <a href="/contact.php">iai_i18n:[b2JzxYJ1Z8SFIHNrbGVwdQ==]</a>.</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'prepaid_payback'">
					<h3 class="return_label">iai_i18n:[VXN1bsSFxYJlxZsgcHJ6ZWRwxYJhdMSZLiBQaWVuacSFZHplIHpvc3RhbsSFIHp3csOzY29uZSBqYWsgcG9qYXdpxIUgc2nEmSBuYSBuYXN6eW0ga29uY2ll].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'account_badlogin'">
					<h3 class="return_label">iai_i18n:[UG9kYW55IGxvZ2luIGx1YiBoYXPFgm8gbmllIGplc3QgcG9wcmF3bmU=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'account_nouser'">
					<h3 class="return_label">iai_i18n:[TmllIHpuYWxlxbpsacWbbXkga29udGEgbyB0YWtpbSBhZHJlc2llIGUtbWFpbCBsdWIgbnIga2FydHkgc3RhxYJlZ28ga2xpZW50YQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'account_disabled'">
					<h3 class="return_label">iai_i18n:[UG9kYW5lIGtvbnRvIG5pZSBpc3RuaWVqZQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'account_wholesale_disabled'">
					<h3 class="return_label">iai_i18n:[U2tsZXAgamVzdCBkb3N0xJlwbnkgdHlsa28gZGxhIGtsaWVudMOzdyBodXJ0b3d5Y2guIEplxbxlbGkgY2hjaWHFgmJ5xZsgdXp5c2thxIcgc3RhdHVzIGh1cnRvd25pa2Egc2tvbnRha3R1aiBzacSZIHogb2JzxYJ1Z8SFIHNrbGVwdQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'account_passremind'">
					<h3 class="return_label">iai_i18n:[TmEgVHfDs2ogYWRyZXMgem9zdGHFgiB3eXPFgmFueSBlLW1haWwsIGt0w7NyeSBwb3p3YWxhIG5hIGF1dG9tYXR5Y3puZSB6YWxvZ293YW5pZSBzacSZLiBabWlhbmEgaGFzxYJhIGLEmWR6aWUgbW/FvGxpd2EgcG8gemFsb2dvd2FuaXUgbmEgc3Ryb25pZSBlZHljamkgVHdvaWNoIGRhbnljaA==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'basket_empty'">
					<div class="basket_icon_wrapper"><i class="icon-empty_basket"/></div>
					<h3 class="return_label">iai_i18n:[VHfDs2oga29zenlrIGplc3QgcHVzdHk=].</h3>
					<p>iai_i18n:[RG9kYWogZG8gbmllZ28gcHJvZHVrdHksIGFieSBtw7NjIHJvenBvY3rEhcSHIHNrxYJhZGFuaWUgemFtw7N3aWVuaWE=].</p>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'basket_size'">
					<h3 class="return_label">iai_i18n:[VHfDs2oga29zenlrIG9zacSFZ27EhcWCIG1ha3N5bWFsbsSFIGRvc3TEmXBuxIUgaWxvxZvEhyBwcm9kdWt0w7N3].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'wisheslist_empty'">
					<div class="whish_icon_wrapper"><i class="icon-heart-empty"/></div>
					<h3 class="return_label">iai_i18n:[TGlzdGEgemFrdXBvd2EgamVzdCBwdXN0YQ==].</h3>
					<p>iai_i18n:[RG9kYWogZG8gbmllaiBwcm9kdWt0eSwga3TDs3JlIGx1YmlzeiBpIGNoY2VzeiBrdXBpxIcgcMOzxbpuaWVq].</p>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'ordered_empty'">
					<div class="ordered_icon_wrapper"><i class="icon-empty_basket"/></div>
					<h3 class="return_label">iai_i18n:[TGlzdGEgemFrdXBpb255Y2ggcHJvZHVrdMOzdyBqZXN0IHB1c3Rh].</h3>
					<p>iai_i18n:[R2R5IGt1cGlzeiBqYWtpxZsgcHJvZHVrdCBwb2phd2kgc2nEmSBvbiBuYSB0ZWogbGnFm2NpZQ==].</p>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'order_minimum'">
					<h3 class="return_label">
						iai_i18n:[WmEgbWHFgmEgd2FydG/Fm8SHIHphbcOzd2llbmlh].
						<iaixsl:if test="page/return/@extra">
							<br/>iai_i18n:[TWluaW1hbG5hIHdhcnRvxZvEhyB6YW3Ds3dpZW5pYSB0bw==] 
				...
				<iaixsl:when test="page/return/@type = 'order_minimal_wholesale'">
					<h3 class="return_label">
						iai_i18n:[WmEgbWHFgmEgd2FydG/Fm8SHIHphbcOzd2llbmlh].
						<iaixsl:if test="page/return/@extra">
							<br/>iai_i18n:[TWluaW1hbG5hIHdhcnRvxZvEhyB6YWt1cMOzdyBodXJ0b3d5Y2ggd3lub3Np] 
							<iaixsl:value-of select="page/return/@extra"/><iaixsl:value-of select="currency/@name"/>
						</iaixsl:if>
					</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'order_notenough'">
					<h3 class="return_label">iai_i18n:[TmllIG1vxbxlc3ogesWCb8W8ecSHIHphbcOzd2llbmlhLCBwb25pZXdhxbwgbmlla3TDs3J5Y2ggcHJvZHVrdMOzdw==] 
						iai_i18n:[bWFteSBtbmllaiBuacW8IHByw7NidWplc3ogemFtw7N3acSH].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'order_tomuch'">
					<h3 class="return_label">iai_i18n:[xYHEhWN6bmEgc3VtYSB6xYJvxbxvbnljaCBwcnpleiBDaWViaWUgemFtw7N3aWXFhCBqZXN0IHpieXQgZHXFvGE=] 
						<iaixsl:if test="page/return/@extra">(<iaixsl:value-of select="page/return/@extra"/><iaixsl:value-of select="currency/@name"/>)</iaixsl:if>
						<br/>iai_i18n:[UG9jemVrYWogYcW8IHpyZWFsaXp1amVteSB0byBjbyB6YW3Ds3dpxYJlxZsgd2N6ZcWbbmllaiwgbHVi] <a href="/login.php">iai_i18n:[YW51bHVqIHdjemXFm25pZWpzemUgemFtw7N3aWVuaWU=].</a></h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'shipping_error'">
					<h3 class="return_label">iai_i18n:[UHJ6ZXByYXN6YW15LCBhbGUgbmllIGRvc3RhcmN6YW15IHByb2R1a3TDs3cgZG8gd3licmFuZWdvIGtyYWp1IGRvc3Rhd3kuIEplxbxlbGkgY2hjaWHFgmJ5xZsgesWCb8W8ecSHIHphbcOzd2llbmllIHcgbmFzenltIHNrbGVwaWU=] - <a href="/contact.php">iai_i18n:[c2tvbnRha3R1aiBzacSZIHogbmFtaQ==]</a> iai_i18n:[dyBjZWx1IGRvZGFuaWEgbW/FvGxpd2/Fm2NpIGRvc3RhcmN6YW5pYSBwcnplc3nFgmVrIGRvIFR3b2plZ28ga3JhanU=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'mailing_nosuchemail'">
					<h3 class="return_label">iai_i18n:[UG9kYW5lZ28gcHJ6ZXogQ2llYmllIGFkcmVzdSBlLW1haWwgbmllIG1hIG5hIG5hc3plaiBsacWbY2llIG1haWxpbmdvd2Vq].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'mailing_removesuccess'">
					<h3 class="return_label">iai_i18n:[QWRyZXMgZS1tYWlsIHpvc3RhxYIgdXN1bmnEmXR5IHogbGlzdHkgbWFpbGluZ293ZWo=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'mailing_addsuccess'">
					<h3 class="return_label">iai_i18n:[QWRyZXMgZS1tYWlsIHpvc3RhxYIgZG9kYW55IGRvIGxpc3R5IG1haWxpbmdvd2Vq].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'mailing_emailexist'">
					<h3 class="return_label">iai_i18n:[UG9kYW55IGFkcmVzIGUtbWFpbCB3aWRuaWVqZSBqdcW8IG5hIGxpxZtjaWUgbWFpbGluZ293ZWo=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'mailing_maileregerror'">
					<h3 class="return_label">iai_i18n:[TmllcHJhd2lkxYJvd3kgYWRyZXMgZS1tYWlsLiBQcm9zesSZIHNwcsOzYm93YcSHIHBvbm93bmll].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'mailing_sendingconfirm'">
					<h3 class="return_label">iai_i18n:[TmEgcG9kYW55IGFkcmVzIGUtbWFpbCB6b3N0YcWCYSB3eXPFgmFuYSB3aWFkb21vxZvEhyB6IHBvdHdpZXJkemVuaWVtIHptaWFuIHcgbmFzemVqIGxpxZtjaWUgbWFpbGluZ293ZWouIE9kYmllcnogcG9jenTEmSBpIHBvZMSFxbxhaiB6YSB3c2thesOzd2thbWkgemF3YXJ0eW1pIHcgd2lhZG9tb8WbY2k=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'payment_success'">
					<div class="paymentReturn__wrapper --return --success">
						...
						<div id="paymentReturn" class="paymentReturn">
							...
							<span class="paymentReturn__header">
								<iaixsl:choose>
									<iaixsl:when test="$subscription != ''">
										<span>iai_i18n:[UG9tecWbbG5pZSBkb2tvbmFubyB6bWlhbnkga2FydHkgcMWCYXRuaWN6ZWo=]</span>
									</iaixsl:when>
									<iaixsl:otherwise>
										<span>iai_i18n:[RHppxJlrdWplbXkgemEgemFrdXB5IHcgbmFzenltIHNrbGVwaWUh]</span>
									</iaixsl:otherwise>
								</iaixsl:choose>
								<iaixsl:choose>
									<iaixsl:when test="/shop/page/return/@checkoutType = 'idosell'">
										<img class="smile_icon" alt="Happy smile" src="/gfx/standards/smile_happy_celebrating.svg?r=1765442497"/>
									</iaixsl:when>
									<iaixsl:otherwise>
							...
							<iaixsl:choose>
								<iaixsl:when test="$subscription != ''">
									<span class="paymentReturn__txt">iai_i18n:[T3RyenltYWxpxZtteSBwb3R3aWVyZHplbmllIHBvbXnFm2xuZWdvIHByemVwcm93YWR6ZW5pYSB6bWlhbnkgZG90eWN6xIVjZWoga2FydHkgcMWCYXRuaWN6ZWogbmEgcG90cnplYnkgcMWCYXRub8WbY2kgY3lrbGljem5laiB3IHphbcOzd2llbmlhY2ggc3Vic2tyeXBjeWpueWNo].</span>
								</iaixsl:when>
								<iaixsl:otherwise>
									<span class="paymentReturn__txt">iai_i18n:[T3RyenltYWxpxZtteSBwb3R3aWVyZHplbmllIHDFgmF0bm/Fm2NpIGkgemFrc2nEmWdvd2FsacWbbXkgcMWCYXRub8WbxIcgZG8gVHdvamVnbyB6YW3Ds3dpZW5pYS4=]</span>
								</iaixsl:otherwise>
							</iaixsl:choose>
							<a class="btn --large --solid paymentReturn__btn">
								...
								<iaixsl:choose>
									<iaixsl:when test="$subscription != ''">
										iai_i18n:[UHJ6ZWpkxbogZG8gdXN0YXdpZcWEIHN1YnNrcnlwY2pp]
									</iaixsl:when>
									<iaixsl:otherwise>
										iai_i18n:[U3ByYXdkxbogc3RhdHVzIHphbcOzd2llbmlh]
									</iaixsl:otherwise>
								</iaixsl:choose>
							</a>
							<a class="paymentReturn__return">
								<iaixsl:attribute name="href">/main.php</iaixsl:attribute>
								iai_i18n:[V3LDs8SHIGRvIHN0cm9ueSBnxYLDs3duZWo=]
							</a>
						</div>
					</div>
				</iaixsl:when>
					...
					<div class="paymentReturn__wrapper --return --error">
						...
						<div id="paymentReturn" class="paymentReturn">
							...
							<span class="paymentReturn__header">
								<iaixsl:choose>
									<iaixsl:when test="$subscription != ''">
										<span>iai_i18n:[TmllIHVkYcWCbyBzacSZIGRva29uYcSHIHptaWFueSBrYXJ0eSBwxYJhdG5pY3plag==]</span>
									</iaixsl:when>
									<iaixsl:when test="page/return/@orderNumber">
										<span>iai_i18n:[T3DFgmHEhyBwcnp5asSZdGUgemFtw7N3aWVuaWUgbnI=]<span class="order_id"><iaixsl:attribute name="data-id"><iaixsl:value-of select="page/return/@referer"/></iaixsl:attribute><iaixsl:value-of select="page/return/@orderNumber"/></span></span>
									</iaixsl:when>
									<iaixsl:otherwise>
										<span>iai_i18n:[T3DFgmHEhyBwcnp5asSZdGUgemFtw7N3aWVuaWE=]</span>
									</iaixsl:otherwise>
								</iaixsl:choose>
								<iaixsl:choose>
									<iaixsl:when test="/shop/page/return/@checkoutType = 'idosell'">
										<img class="smile_icon" alt="Happy sad" src="/gfx/standards/smile_sad.svg?r=1765442497"/>
									</iaixsl:when>
									<iaixsl:otherwise>
							...
							<iaixsl:choose>
								<iaixsl:when test="$subscription != ''">
									<span class="paymentReturn__txt">iai_i18n:[WmxlY29uYSB6bWlhbmEgZG90eWN6xIVjYSBrYXJ0eSBwxYJhdG5pY3plaiBuYSBwb3RyemVieSBwxYJhdG5vxZtjaSBjeWtsaWN6bmVqIHcgemFtw7N3aWVuaWFjaCBzdWJza3J5cGN5am55Y2ggbmllIHpvc3RhxYJhIHpyZWFsaXpvd2FuYS4gU3Byw7NidWogcG9ub3duaWUgcMOzxbpuaWVq].</span>
								</iaixsl:when>
								<iaixsl:otherwise>
									<span class="paymentReturn__txt">iai_i18n:[TmllIG90cnp5bWFsacWbbXkgcG90d2llcmR6ZW5pYSBwxYJhdG5vxZtjaS4gVHdvamEgcMWCYXRub8WbxIcgbW9nxYJhIG5pZSBiecSHIHd5a29uYW5hIGx1YiBicmFta2EgcMWCYXRuaWN6YSBuYXBvdGthxYJhIG5hIGlubnkgYsWCxIVkLg==]</span>
								</iaixsl:otherwise>
							</iaixsl:choose>
							<a class="btn --large --solid paymentReturn__btn">
								<iaixsl:attribute name="href"><iaixsl:value-of select="page/return/@referer"/></iaixsl:attribute>
								<iaixsl:choose>
									...
									<iaixsl:otherwise>
										iai_i18n:[U3ByYXdkxbogc3RhdHVzIHDFgmF0bm/Fm2NpIGkgemFtw7N3aWVuaWE=]
									</iaixsl:otherwise>
								</iaixsl:choose>
							</a>
							<a class="paymentReturn__return">
				...
				<iaixsl:when test="page/return/@type = 'payment_pending'">
					<h3 class="return_label">iai_i18n:[T2N6ZWt1amUgbmEgemF0d2llcmR6ZW5pZSBwcnpleiBzeXN0ZW0gcMWCYXRub8WbY2k=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'payment_credit_success'">
					<h3 class="return_label">iai_i18n:[RHlzcG96eWNqYSBkb2tvbmFuaWEgcMWCYXRub8WbY2kgcmF0YW1pIHpvc3RhxYJhIHByenlqxJl0YQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'payment_credit_error'">
					<h3 class="return_label">iai_i18n:[V3lzdMSFcGnFgiBixYLEhWQgcMWCYXRub8WbY2kgcmF0YW1p].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'opinion_addsuccess'">
					<h3 class="return_label">iai_i18n:[S29tZW50YXJ6IHpvc3RhxYIgZG9kYW55IGkgY3pla2EgbmEgbW9kZXJhY2rEmQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'opinion_adderror'">
					<h3 class="return_label">iai_i18n:[V3lzdMSFcGnFgiBixYLEhWQgLSBrb21lbnRhcnogbmllIHpvc3RhxYIgZG9kYW55IGRvIHByb2R1a3R1].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = '403'">
					<h3 class="return_label">iai_i18n:[RG9zdMSZcCBkbyB0ZWdvIHBsaWt1IGplc3QgemFicm9uaW9ueQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = '404'">
					<h3 class="return_label">iai_i18n:[UG9kYW55IGRva3VtZW50IG5pZSB6b3N0YcWCIG9kbmFsZXppb255LiBKZcW8ZWxpIG5hIHTEhSBzdHJvbsSZIHpvc3RhxYJlxZsgb2Rlc8WCYW55IHByemV6IGLFgsSZZG55IGxpbmssIHByb3NpbXkgbw==] <a href="/contact.php">iai_i18n:[emfFgm9zemVuaWUgbmFtIHRlZ28=]</a>.</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = '500'">
					<h3 class="return_label">iai_i18n:[V3lzdMSFcGnFgiBixYLEhWQgc2Vyd2VyYS4gUG9jemVrYWogY2h3aWzEmSBpIHNwcsOzYnVqIHBvbm93bmllIG9kxZt3aWXFvHnEhyBzdHJvbsSZ]. </h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'askforproduct_sent'">
					<h3 class="return_label">iai_i18n:[UHl0YW5pZSBkb3R5Y3rEhWNlIHByb2R1a3R1]<iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/return/@extra"/><iaixsl:text> </iaixsl:text>iai_i18n:[em9zdGHFgm8gcG9tecWbbG5pZSB3eXPFgmFuZS4gUHJvc3rEmSBjemVrYcSHIG5hIG9kcG93aWVkxbo=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'askforproduct_error'">
					<h3 class="return_label">iai_i18n:[UHl0YW5pZSBkb3R5Y3rEhWNlIHByb2R1a3R1]<iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/return/@extra"/><iaixsl:text> </iaixsl:text>iai_i18n:[bmllIHpvc3RhxYJvIHd5c8WCYW5lLiBTcHLDs2J1aiBwb25vd25pZSBww7PFum5pZWo=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'incorrect_email'">
					<h3 class="return_label">iai_i18n:[TmllcHJhd2lkxYJvd3kgYWRyZXMgZS1tYWlsLiBQcm9zaW15IG8gcG9kYW5pZSBwb3ByYXduZWdvIGFkcmVzdSBlLW1haWw=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'suggestreceiver_toolong'">
					<h3 class="return_label">iai_i18n:[RMWCdWdvxZvEhyBhZHJlc8OzdyB3IHBvbHUgYWRyZXN1IGUtbWFpbCBuaWUgbW/FvGUgcHJ6ZWtyb2N6ecSHIDI1NSB6bmFrw7N3].<iaixsl:text> </iaixsl:text></h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'suggestreceiver_bademail'">
					<h3 class="return_label">iai_i18n:[V3Bpc2FueSBhZHJlcyBsdWIgYWRyZXN5IGUtbWFpbCBzxIUgbmllcG9wcmF3bmUuIFNwcmF3ZMW6IGN6eSBzxIUgb25lIHdwaXNhbmUgcHJhd2lkxYJvd28sIGEgamXFvGVsaSBwb2RhamVzeiB3acSZY2VqIG5pxbwgamVkZW4gYWRyZXMsIGN6eSB6b3N0YcWCeSBvbmUgcm96ZHppZWxvbmUgcHJ6ZWNpbmthbWk=].<iaixsl:text> </iaixsl:text></h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'suggestsignature_tooshort'">
					<h3 class="return_label">iai_i18n:[V3Bpc2FueSBwb2RwaXMgamVzdCB6YSBrcsOzdGtpLiBQb2RhaiBzd29qZSBpbWnEmSBsdWIga3N5d8SZLCBwbyBrdMOzcnltIG9kYmlvcmNhIENpxJkgcm96cG96bmE=].<iaixsl:text> </iaixsl:text></h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'suggestbody_tooshort'">
					<h3 class="return_label">iai_i18n:[UHJvc3rEmSBwb2RhxIcgdHJlxZvEhyB3aWFkb21vxZtjaSBkbGEgem5ham9tZWdv].<iaixsl:text> </iaixsl:text></h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'suggestproduct_sent'">
					<h3 class="return_label">iai_i18n:[V2lhZG9tb8WbxIcgeiBwb2xlY2VuaWVtIHByb2R1a3R1IHpvc3RhxYJhIHd5c8WCYW5h].<iaixsl:text> </iaixsl:text></h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='rebates_code_begins'">
					<h3 class="return_label">iai_i18n:[UHJvbW9jamEgZGxhIHRlZ28ga29kdSByYWJhdG93ZWdvIGplc3pjemUgc2nEmSBuaWUgcm96cG9jesSZxYJh].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='rebates_code_expires'">
					<h3 class="return_label">iai_i18n:[UHJvbW9jamEgZGxhIHRlZ28ga29kdSByYWJhdG93ZWdvIGp1xbwgc2nEmSBza2/FhGN6ecWCYQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='rebates_code_undefined'">
					<h3 class="return_label">iai_i18n:[UG9kYW55IGtvZCByYWJhdG93eSBuaWUgaXN0bmllamU=].</h3>
				</iaixsl:when>
				...
				<iaixsl:when test="page/return/@type='account_logoff'">
					<h3 class="return_label">iai_i18n:[V3lzdMSFcGnFgiBixYLEhWQgcG9kY3phcyBza8WCYWRhbmlhIHphbcOzd2llbmlhLlByb3NpbXkgemFsb2d1aiBzacSZIHBvbm93bmllIGkgZG9rb8WEY3ogemFrdXB5LiBKZcW8ZWxpIGplc3QgdG8gbmllbW/FvGxpd2UgcHJvc2lteSBv] <a href="/contact.php">iai_i18n:[a29udGFrdCB6IG9ic8WCdWfEhSBza2xlcHU=]</a>.</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='get_attachment_error'">
					<h3 class="return_label">iai_i18n:[WmHFgsSFY3puaWssIGt0w7NyeSBwcsOzYnVqZXN6IHBvYnJhxIcgbmllIGplc3QgZG9zdMSZcG55].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='stock_not_found'">
					<h3 class="return_label">iai_i18n:[TmllIHpuYWxlemlvbm8gcHVua3R1IG9kYmlvcnU=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='stock_transfer'">
					<h3 class="return_label">iai_i18n:[TmllIG1vxbxlc3ogesWCb8W8ecSHIHphbcOzd2llbmlhLCBwb25pZXdhxbwgemFtYXdpYW5lIHByb2R1a3R5IHpuYWpkdWrEhSBzacSZIHcgcsOzxbxueWNoIG1hZ2F6eW5hY2g=]. <a href="/contact.php">iai_i18n:[U2tvbnRha3R1aiBzacSZIHogb2JzxYJ1Z8SFIHNrbGVwdQ==]</a> iai_i18n:[dyBjZWx1IHV6eXNrYW5pYSBpbmZvcm1hY2ppIGphayBza29tcGxldG93YcSHIHphbcOzd2llbmll].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='insurance_error'">
					<h3 class="return_label">iai_i18n:[V3lzdMSFcGnFgiBixYLEhWQgcG9kY3phcyB1YmV6cGllY3plbmlhIFR3b2plZ28gemFtw7N3aWVuaWEgaSBuaWUgem9zdGHFgm8gb25vIHphcmVqZXN0cm93YW5l]. <a href="/contact.php">iai_i18n:[U2tvbnRha3R1aiBzacSZIHogb2JzxYJ1Z8SFIHNrbGVwdSB3IGNlbHUgd3lqYcWbbmllbmlhIHN5dHVhY2pp]. </a>  </h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='products_not_available'">
					<h3 class="return_label">iai_i18n:[UHJvZHVrdCBuaWUgd3lzdMSZcHVqZSB3IMW8YWRueW0gcHVua2NpZSBvZGJpb3J1IG9zb2Jpc3RlZ28=].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='no_partners'">
					<h3 class="return_label">iai_i18n:[UHJ6ZXByYXN6YW15LiBOYXN6IHNrbGVwIG5pZSB1ZG9zdMSZcG5pYSBpbmZvcm1hY2ppIG8gc3dvaWNoIHBhcnRuZXJhY2ggaGFuZGxvd3ljaA==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='page_only_register'">
					<h3 class="return_label">iai_i18n:[U3Ryb25hIGRvc3TEmXBuYSB0eWxrbyBkbGEgemFsb2dvd2FueWNo]. <a class="loginPopUpShow" href="/signin.php" title="Zaloguj się">iai_i18n:[WmFsb2d1aiBzacSZ].</a></h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='page_only_unregister'">
					<h3 class="return_label">iai_i18n:[U3Ryb25hIGRvc3TEmXBuYSB0eWxrbyBkbGEgbmllemFsb2dvd2FueWNo]. <a href="/login.php?operation=logout" title="Wyloguj się">iai_i18n:[V3lsb2d1aiBzacSZ].</a></h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='product_question_confirmed'">
					<h3 class="return_label">iai_i18n:[RHppxJlrdWplbXkgemEga29udGFrdC4gWmFyZWplc3Ryb3dhbGnFm215IFR3b2plIHB5dGFuaWUuIE9kcG93aWVkxbogcHJ6ZcWbbGVteSBuYSBUd8OzaiBlLW1haWwgdGFrIHN6eWJrbyBqYWsgYsSZZHppZSB0byBtb8W8bGl3ZQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='product_question_confirm_error'">
					<h3 class="return_label">iai_i18n:[V3lzdMSFcGnFgiBixYLEhWQuIFB5dGFuaWUgbyBwcm9kdWt0IG5pZSB6b3N0YcWCbyB3eXPFgmFuZQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='product_question_wrong_email'">
					<h3 class="return_label">iai_i18n:[TmllcHJhd2lkxYJvd3kgYWRyZXMgZS1tYWlsLiBQeXRhbmllIG5pZSB6b3N0YcWCbyB3eXPFgmFuZQ==].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='product_question_sent'">
					<h3 class="return_label">iai_i18n:[RHppxJlrdWplbXkgemEgemFkYW5pZSBweXRhbmlhLiBBYnkgcG90d2llcmR6acSHIGplZ28gd3lzxYJhbmllLCBrbGlrbmlqIHcgbGluayB3IGUtbWFpbHUsIGt0w7NyeSBDaSB3xYJhxZtuaWUgd3lzxYJhbGnFm215].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'to_many_products_compared'">
					<h3 class="return_label">iai_i18n:[TWFrc3ltYWxuaWUgd2llbGUgcHJvZHVrdMOzdyBqZXN0IGRvZGFueWNoIGRvIHBvcsOzd25hbmlhLiBVc3XFhCBrdMOzcnnFmywgYWJ5IG3Ds2MgZG9kYcSHIGtvbGVqbnk=]. </h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'products_not_found'">
					<h3 class="return_label">iai_i18n:[U3p1a2FueSBwcm9kdWt0IG5pZSB6b3N0YcWCIHpuYWxlemlvbnkuIFNrb3J6eXN0YWogeg==] <a href="/searching.php" title="Kliknij, aby przejść do wyszukiwarki zaawansowanej">iai_i18n:[emFhd2Fuc293YW5laiB3eXN6dWtpd2Fya2k=]</a>.</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'virtual_products_not_found'">
					<h3 class="return_label">iai_i18n:[TGlzdGEgcGxpa8Ozdywga3TDs3J5Y2ggbmllIG1vxbxlc3oganXFvCBwb2JyYcSHLCBqZXN0IHB1c3Rh].</h3>
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'virtual_products_to_download_not_found'">
					<h3 class="return_label">iai_i18n:[TmllIG1hc3ogxbxhZG55Y2ggcGxpa8OzdyBkbyBwb2JyYW5pYS4gVGEgc3Ryb25hIGLEmWR6aWUgYWt0eXduYSBwbyBpY2ggemFrdXBpZW5pdQ==].</h3>
				</iaixsl:when>
				<iaixsl:otherwise>
	...
	<div class="n54744_goback">
		<a class="btn --solid --medium n54744">
			...
			<iaixsl:choose>
				<iaixsl:when test="page/return/@type = 'account_badlogin'">
					iai_i18n:[U3Ryb25hIGxvZ293YW5pYQ==]
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'order_notenoughpoints'">
					iai_i18n:[VHfDs2oga29zenlr]
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'ordercancel_ok'">
					iai_i18n:[UG93csOzdA==]
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'orderconfirm_dataerror'">
					iai_i18n:[U3Ryb25hIGfFgsOzd25h]
				</iaixsl:when>
				<iaixsl:when test="page/return/@type='token_expired' and $token_expired">
					iai_i18n:[U3Ryb25hIGxvZ293YW5pYQ==]
				</iaixsl:when>
				...
				<iaixsl:when test="page/return/@type = 'rebates_code_begins'">
					iai_i18n:[U3ByYXdkxbogc3fDs2oga29k]
				</iaixsl:when>
				<iaixsl:when test="page/return/@type = 'rebates_code_expires'">
					iai_i18n:[U3ByYXdkxbogc3fDs2oga29k]
				</iaixsl:when>
				...
				<iaixsl:when test="(page/return/@type = 'basket_empty') or (page/return/@type = 'page_only_unregister') or (page/return/@type = 'wisheslist_empty') or (page/return/@type = 'ordered_empty')">
					iai_i18n:[Um96cG9jem5paiB6YWt1cHk=]
				</iaixsl:when>
				<iaixsl:otherwise>
					iai_i18n:[UG93csOzdA==]
				</iaixsl:otherwise>
