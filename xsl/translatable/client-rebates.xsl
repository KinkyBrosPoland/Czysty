...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
    ...
    <!-- (client_rebates_info, 60dd8f7a276ef4.64348930.9)-->
	<div id="client_rebates_info" class="rebates_info">
		<h1 class="headline">
			<span class="headline__name">iai_i18n:[VHdvamUgcmFiYXR5]</span>
		</h1>
		...
		<iaixsl:if test="not(page/rebate_code/@active = 'y') and not(page/rebates_for_points/rebate) and not(page/basket_rebate or page/global_rebate or page/rebates/range_rebate/range or (page/rebates/@type = 'z' and (page/rebates/category or page/rebates/producer or page/rebates/series or page/rebates/product)) or not(page/rebates/other/@value = '0.00'))">
			<div class="rebates_message menu_messages_message mb-4">
				iai_i18n:[TmllIG1hc3ogb2JlY25pZSDFvGFkbmVnbyByYWJhdHUuIFphcHJhc3phbXkgZG8gemFwb3puYW5pYSBzacSZIHo=] 
				<a href="/terms.php">
					...
					iai_i18n:[cmVndWxhbWluZW0gaSBwcm9nYW1pIHJhYmF0b3d5bWk=]
				</a>
					iai_i18n:[dyBuYXN6eW0gc2tsZXBpZQ==].
			</div>
		</iaixsl:if>
		...
		<iaixsl:if test="page/rebates_codes/@active = 'y' or page/rebate_code/@active = 'y' or page/@card_discount_program_activated = 'true'">
			...
			<iaixsl:variable name="cardform">
				<form class="rebates_form --card d-flex align-items-end" action="/settings.php?from=client_rebate" method="post">
					<input name="global_rebates_codes" value="add" type="hidden"/>
					<div class="f-group m-0">
						<div class="f-feedback">
							<input name="rebates_codes" type="text" value="" class="f-control" id="rebates_card_input">
							...
							<label class="f-label" for="rebates_card_input">iai_i18n:[TnVtZXIga2FydHkgcmFiYXRvd2Vq]</label>
						</div>
					</div>
					<button class="rebates_form__submit btn --large --solid ml-3" type="submit">iai_i18n:[QWt0eXd1ag==] <span class="sr-only">iai_i18n:[a2FydMSZIHJhYmF0b3fEhQ==]</span></button>
				</form>
			</iaixsl:variable>

			
			<iaixsl:variable name="codeform">
				<form class="rebates_form --code d-flex align-items-end" action="/settings.php?from=client_rebate" method="post">
					<input name="global_rebates_codes" value="add" type="hidden"/>
					<div class="f-group m-0">
						<div class="f-feedback">
							<input name="rebates_codes" type="text" value="" class="f-control" id="rebates_code_input"/>
							<label class="f-label" for="rebates_code_input">iai_i18n:[TnVtZXIga29kdSByYWJhdG93ZWdv]</label>
						</div>
					</div>
					<button class="rebates_form__submit btn --large --solid ml-3" type="submit">iai_i18n:[QWt0eXd1ag==] <span class="sr-only">iai_i18n:[a29kIHJhYmF0b3d5]</span></button>
				</form>
			</iaixsl:variable>
						...
						<div class="rebates_forms__sub --card col-sm-6 col-12 mb-3">
							...
							<iaixsl:if test="/shop/rebate_card_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_card_delete_rebate_for_profit_points/@active = 'y' ">
								<div class="rebates_forms__info d-flex mt-1">
									iai_i18n:[QWt0eXdhY2phIGthcnR5IHJhYmF0b3dlaiBzcG93b2R1amUsIMW8ZSByYWJhdCBwcnp5cGlzYW55IGRvIFR3b2plZ28ga29udGEgYsSZZHppZSBpZ25vcm93YW55IHcgdHltIHphbcOzd2llbml1].
								</div>
							</iaixsl:if>
						</div>
					</iaixsl:if>
					...
					<iaixsl:if test="(page/rebates_codes/@active =  'y' or page/rebate_code/@active = 'y') and not(page/rebate_code/@type='rebate')">
						<div class="rebates_forms__sub --code col-sm-6 col-12 mb-3">
							...
							<iaixsl:if test="/shop/rebate_code_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_code_delete_rebate_for_profit_points/@active = 'y' ">
								<div class="rebates_forms__info d-flex mt-1">
									iai_i18n:[QWt0eXdhY2phIGtvZHUgcmFiYXRvd2VnbyBzcG93b2R1amUsIMW8ZSByYWJhdCBwcnp5cGlzYW55IGRvIFR3b2plZ28ga29udGEgYsSZZHppZSBpZ25vcm93YW55IHcgdHltIHphbcOzd2llbml1].
								</div>
							</iaixsl:if>
						</div>
					</iaixsl:if>
				...
				<section class="rebates_active mb-4">
					...
					<h2 class="headline">
						<span class="headline__name">
							<iaixsl:choose>
								<iaixsl:when test="$rebate_type = 'rebate'">
									iai_i18n:[V3Bpc2FueSBrb2QgcmFiYXRvd3kgZGxhIHRlZ28gemFtw7N3aWVuaWE=] 
								</iaixsl:when>
								<iaixsl:otherwise>
									iai_i18n:[QWt0eXduYSBrYXJ0YSByYWJhdG93YQ==]
								</iaixsl:otherwise>
							</iaixsl:choose>
						</span>
					</h2>
					...
					<div class="rebates_active__wrapper p-2 d-sm-flex align-items-sm-center p-sm-4">
						...
						<div class="rebates_active__sub --name">
							<iaixsl:choose>
								<iaixsl:when test="$rebate_type = 'rebate'">
									<span class="rebates_active__name">iai_i18n:[QWt0eXdueSBrb2Q=]:<strong><iaixsl:value-of disable-output-escaping="yes" select="page/rebate_code/@number"/></strong></span>
								</iaixsl:when>
								<iaixsl:otherwise>
									...
									<iaixsl:for-each select="page/rebate_code/inactive_zones/item">
																						<iaixsl:choose>
																								<iaixsl:when test="@name = 'promotion'">
																										<strong class="label --promo">iai_i18n:[VyBwcm9tb2NqaQ==]</strong>
																								</iaixsl:when>
																								<iaixsl:when test="@name = 'new'">
																										<strong class="label --new">iai_i18n:[Tm93b8WbxIc=]</strong>
																								</iaixsl:when>
																								<iaixsl:when test="@name = 'bestseller'">
																										<strong class="label --bestseller">iai_i18n:[TmFzeiBiZXN0c2VsbGVy]</strong>
																								</iaixsl:when>
																								<iaixsl:when test="@name = 'discount'">
																										<strong class="label --discount">iai_i18n:[UHJ6ZWNlbmE=]</strong>
																								</iaixsl:when>
																								<iaixsl:when test="@name = 'distinguished'">
																										<strong class="label --distinguished">iai_i18n:[UG9sZWNhbnk=]</strong>
																								</iaixsl:when>
																								<iaixsl:when test="@name = 'special'">
																										<strong class="label --special">iai_i18n:[UHJvZHVrdCBzcGVjamFsbnk=]</strong>
																								</iaixsl:when>
																						</iaixsl:choose>
									</iaixsl:for-each>
								</div>
						...
						<div class="rebates_active__sub --buttons --code">
							<iaixsl:choose>
								<iaixsl:when test="$rebate_type = 'rebate'">
											<a class="btn --solid rebates_active__button --change" href="#">iai_i18n:[Wm1pZcWEIGtvZA==]</a>
								</iaixsl:when>
								<iaixsl:otherwise>
										<a class="btn --solid rebates_active__button --change" href="#">iai_i18n:[Wm1pZcWEIGthcnTEmQ==]</a>
								</iaixsl:otherwise>
							</iaixsl:choose>
			...
			<iaixsl:if test="page/discount_cards/item[not(@number = /shop/page/rebate_code/@number)]">
				<section class="rebates_inactive mb-4">
					<h2 class="headline">
						<span class="headline__name">
							iai_i18n:[TmllYWt0eXduZSBrYXJ0eSByYWJhdG93ZQ==]
						</span>
					</h2>
							...
							<div class="rebates_inactive__item p-2 d-sm-flex align-items-sm-center p-sm-4">
								...
								<div class="rebates_inactive__sub --buttons">
									<form class="rebates_inactive__sub --form" action="/settings.php?from=client_rebate" method="post">
										...
										<button class="btn --solid rebates_inactive__button --active" type="submit">iai_i18n:[QWt0eXd1ag==] <span class="sr-only">iai_i18n:[a2FydMSZ]<iaixsl:value-of select="@number"/></span></button>
									</form>
								</div>
							</div>
						</iaixsl:for-each>
			...
			<iaixsl:if test="page/cards/item">
				<section class="rebates_cards mb-4">
					<h2 class="headline">
						<span class="headline__name">
							iai_i18n:[S2FydHkgc3RhxYJlZ28ga2xpZW50YQ==]
						</span>
					</h2>
						...
						<iaixsl:for-each select="page/cards/item">
							<div class="rebates_cards__item p-2 d-sm-flex align-items-sm-center p-sm-4">
								...
								<div class="rebates_cards__sub --name">
									<span class="rebates_cards__name"><strong><iaixsl:value-of disable-output-escaping="yes" select="@name"/></strong>iai_i18n:[V2HFvG5hIGRv]: <iaixsl:value-of select="@expires"/></span>
								</div>
								...
								<div class="rebates_cards__sub --status">
									<iaixsl:choose>
										<iaixsl:when test="@active = 'y'">
											<strong class="rebates_cards__active">iai_i18n:[YWt0eXduYQ==]</strong>
										</iaixsl:when>
										<iaixsl:when test="@active = 'n'">
											<strong class="rebates_cards__inactive">iai_i18n:[bmllYWt0eXduYQ==]</strong>
										</iaixsl:when>
									</iaixsl:choose>
								</div>
							</div>
		...
		<iaixsl:if test="page/basket_rebate or page/global_rebate or page/rebates/range_rebate/range or (page/rebates/@type = 'z' and (page/rebates/category or page/rebates/producer or page/rebates/series or page/rebates/product)) or not(page/rebates/other/@value = '0.00')">
			<section class="rebates_range mb-4">
				<h2 class="headline">
					<span class="headline__name">
						iai_i18n:[RG9zdMSZcG5lIHJhYmF0eQ==]
					</span>
				</h2>
				...
				<iaixsl:if test="page/rebates/range_rebate/range and not(/shop/page/basket_rebate/range)">
					<div class="rebates_range__wrapper --range">
						<div class="rebates_range__label">
							<strong class="rebates_range__label_txt">iai_i18n:[UmFiYXQgcHJvZ293eQ==]</strong>
							<div class="rebates_range__description">
								iai_i18n:[TmFsaWN6YW55IG9kIHdhcnRvxZtjaSBwcm9kdWt0w7N3IHcga29zenlrdQ==]. 
								<iaixsl:choose>
							...
							<iaixsl:for-each select="page/rebates/range_rebate/range">
								<div class="rebates_range__block">
									...
									<iaixsl:if test="@points != '0.00'">
										<div class="rebates_range__item --points">
											<strong>+ <iaixsl:value-of select="format-number(@points, '#')"/> iai_i18n:[cGt0].</strong>
										</div>
									</iaixsl:if>
									<div class="rebates_range__item --value">
										<strong>
				...
				<iaixsl:if test="page/global_rebate">
					<div class="rebates_range__wrapper --global">
						<div class="rebates_range__label">
							<strong class="rebates_range__label_txt">iai_i18n:[UmFiYXQga3VtdWxhY3lqbnk=]</strong>
							<div class="rebates_range__description">
								<iaixsl:choose>
									<iaixsl:when test="page/global_rebate/@order_days">
										iai_i18n:[TmFsaWN6YW55IG9kIHdhcnRvxZtjaSBwcm9kdWt0w7N3IGt1cGlvbnljaCB3IGNpxIVndSBvc3RhdG5pY2g=] <iaixsl:value-of disable-output-escaping="yes" select="page/global_rebate/@order_days"/> iai_i18n:[ZG5p].
									</iaixsl:when>
									<iaixsl:otherwise>
										iai_i18n:[TmFsaWN6YW55IG9kIHdhcnRvxZtjaSB3Y3plxZtuaWVqIGt1cGlvbnljaCBwcm9kdWt0w7N3].
									</iaixsl:otherwise>
								</iaixsl:choose>
								<iaixsl:choose>
				...
				<iaixsl:if test="page/rebates/@type = 'z' and (page/rebates/category or page/rebates/producer or page/rebates/series)">
					<div class="rebates_range__wrapper --group">
						<div class="rebates_range__label">
							<strong class="rebates_range__label_txt">iai_i18n:[UmFiYXQgZ3J1cG93eQ==]</strong>
							<div class="rebates_range__description">
								iai_i18n:[UmFiYXR5IGdydXBvd2UgbmllIHN1bXVqxIUgc2nEmS4gVyBwcnp5cGFka3UgbmFrxYJhZGFuaWEgc2nEmSByYWJhdMOzdyBwb2QgdXdhZ8SZIGJyYW5hIGplc3QgbmFqd3nFvHN6YSB3YXJ0b8WbxIc=].
							</div>
						</div>
						...
						<div class="rebates_range__products --group">
							...
							<iaixsl:if test="page/rebates/category">
								<div class="rebates_product --category mb-3">
									<div class="rebates_product__label py-1 mb-2">
										iai_i18n:[TmEgd3licmFuZSBrYXRlZ29yaWU=]
									</div>
									<div class="rebates_product__products">
										<iaixsl:for-each select="page/rebates/category/item">
											<div class="rebates_product__product d-flex flex-column p-2">
							...
							<iaixsl:if test="page/rebates/producer">
								<div class="rebates_product --producer mb-3">
									<div class="rebates_product__label py-1 mb-2">
										iai_i18n:[TmEgd3licmFuZSBtYXJraQ==]
									</div>
									<div class="rebates_product__products">
							...
							<iaixsl:if test="page/rebates/series">
								<div class="rebates_product --series mb-3">
									<div class="rebates_product__label py-1 mb-2">
										iai_i18n:[TmEgd3licmFuZSBzZXJpZQ==]
									</div>
									<div class="rebates_product__products">
				...
				<iaixsl:if test="page/rebates/@type = 'z' and page/rebates/product">
					<div class="rebates_range__wrapper --specific">
						<div class="rebates_range__label">
							<strong class="rebates_range__label_txt">iai_i18n:[UmFiYXQgc3pjemVnw7PFgm93eQ==]</strong>
							<iaixsl:choose>
								<iaixsl:when test="((page/rebates/category) or (page/rebates/producer) or (page/rebates/series)) and ((page/rebates/other) and not(page/rebates/other/@value = '0.00'))">
									<div class="rebates_range__description">
										iai_i18n:[UmFiYXQgc3pjemVnw7PFgm93eSBqZXN0IG5hZHJ6xJlkbnkgdyBzdG9zdW5rdSBkbyByYWJhdHUgb2fDs2xuZWdvIG9yYXogZ3J1cG93ZWdv].
									</div>
								</iaixsl:when>
								<iaixsl:when test="((page/rebates/category) or (page/rebates/producer) or (page/rebates/series)) and not((page/rebates/other) and not(page/rebates/other/@value = '0.00'))">
									<div class="rebates_range__description">
										iai_i18n:[UmFiYXQgc3pjemVnw7PFgm93eSBqZXN0IG5hZHJ6xJlkbnkgdyBzdG9zdW5rdSBkbyByYWJhdHUgZ3J1cG93ZWdv].
									</div>
								</iaixsl:when>
								<iaixsl:when test="((page/rebates/other) and not(page/rebates/other/@value = '0.00')) and not(page/rebates/category) and not(page/rebates/producer) and not(page/rebates/series)">
									<div class="rebates_range__description">
										iai_i18n:[UmFiYXQgc3pjemVnw7PFgm93eSBqZXN0IG5hZHJ6xJlkbnkgdyBzdG9zdW5rdSBkbyByYWJhdHUgb2fDs2xuZWdv].
									</div>
								</iaixsl:when>
							</iaixsl:choose>
						</div>
						...
						<div class="rebates_range__products --specific">
							<div class="rebates_product --specific mb-3">
								<div class="rebates_product__label py-1 mb-2">
									iai_i18n:[TmEgd3licmFuZSBwcm9kdWt0eQ==]
								</div>
								<div class="rebates_product__products">
				...
				<iaixsl:if test="not(page/rebates/other/@value = '0.00')">
					<div class="rebates_range__wrapper --other">
						<div class="rebates_range__label">
							<strong class="rebates_range__label_txt">iai_i18n:[UmFiYXQgb2fDs2xueQ==]</strong>
							<div class="rebates_range__description">
								<iaixsl:choose>
							...
							<div class="rebates_other__value --txt">
								<iaixsl:choose>
									<iaixsl:when test="not(page/rebates/category) and not(page/rebates/producer) and not(page/rebates/series) and not(page/rebates/product)">
										iai_i18n:[TmEgY2HFgnkgYXNvcnR5bWVudA==]
									</iaixsl:when>
									<iaixsl:otherwise>
										iai_i18n:[TmEgcG96b3N0YcWCZSBwcm9kdWt0eQ==]
									</iaixsl:otherwise>
								</iaixsl:choose>
							</div>
		...
		<iaixsl:if test="page/rebate_code/@active = 'y' or page/rebates_for_points/rebate">
			<section class="rebates_individual mb-4">
				<h2 class="headline">
					<span class="headline__name">
						iai_i18n:[VHdvamUgaW5keXdpZHVhbG5lIHJhYmF0eQ==]
					</span>
				</h2>
				...
				<div class="rebates_individual__wrapper">
					...
					<iaixsl:if test="page/rebates_for_points/rebate">
						<div class="rebates_product --points mb-3">
							<div class="rebates_product__label py-1 mb-2">
							...
							<div class="rebates_product__products --points row mx-n1">
								<iaixsl:for-each select="page/rebates_for_points/rebate">
									...
									<div class="rebates_product__product --points">
										<iaixsl:choose>
											...
											<iaixsl:when test="@selected = 'selected'">
												...
												<div class="rebates_product__points --selected">
													<strong class="rebates_product__point --rebate">iai_i18n:[VFfDk0ogUkFCQVQ=]:</strong>
													...
													<span class="rebates_product__point --value"><iaixsl:value-of select="format-number(@points, '#')"/> iai_i18n:[cGt0].</span>
												</div>
											</iaixsl:when>
													...
													<iaixsl:if test="/shop/rebate_for_profit_points_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_for_profit_points_delete_rebate_code/@active = 'y'">
														<iaixsl:choose>
															<iaixsl:when test="/shop/rebate_for_profit_points_delete_client_advanced_rebate/@active = 'y'">
																<iaixsl:attribute name="title">iai_i18n:[UG8gd3ltaWFuaWUgcHVua3TDs3cgbmEgcmFiYXQgem9zdGFuaWUgc2thc293YW55IHJhYmF0IHByenlwaXNhbnkgZG8gVHdvamVnbyBrb250YQ==].</iaixsl:attribute>
															</iaixsl:when>
															<iaixsl:otherwise>
																<iaixsl:attribute name="title">iai_i18n:[UG8gd3ltaWFuaWUgcHVua3TDs3cgbmEgcmFiYXQgem9zdGFuaWUgc2thc293YW55IHJhYmF0IHByenlwaXNhbnkgZG8ga29kdSByYWJhdG93ZWdv].</iaixsl:attribute>
															</iaixsl:otherwise>
														</iaixsl:choose>
														<iaixsl:attribute name="data-title">iai_i18n:[UG90d2llcmR6ZW5pZSB3eW1pYW55IHB1bmt0w7N3IG5hIHJhYmF0]</iaixsl:attribute>
														<iaixsl:attribute name="data-button_txt">iai_i18n:[d3ltaWXFhA==]</iaixsl:attribute>
					...
					<iaixsl:if test="page/rebate_code/@active = 'y'">
						...
						<iaixsl:if test="page/rebate_code/product/@active = 'y'">
							<div class="rebates_product --products mb-3">
								<div class="rebates_product__label py-1 mb-2">
									iai_i18n:[TmEgd3licmFuZSBwcm9kdWt0eQ==]
								</div>
								<div class="rebates_product__products">
												...
												<div class="rebates_product__info">
													<iaixsl:choose>
														<iaixsl:when test="@calculate_from_price='client_price' and @price_type='net'">
															iai_i18n:[UmFiYXQgamVzdCBuYWxpY3phbnkgb2QgY2VueQ==] 
														</iaixsl:when>
														<iaixsl:when test="@calculate_from_price='suggested_retail_price'">
															iai_i18n:[UmFiYXQgamVzdCBuYWxpY3phbnkgb2Qgc3VnZXJvd2FuZWogY2VueSBkZXRhbGljem5lag==] 
														</iaixsl:when>
														<iaixsl:when test="@calculate_from_price='crossed_out_price'">
															iai_i18n:[UmFiYXQgamVzdCBuYWxpY3phbnkgb2QgY2VueSBwcnpla3JlxZtsb25lag==] 
														</iaixsl:when>
													</iaixsl:choose>
													<iaixsl:choose>
						...
						<iaixsl:if test="page/rebate_code/gratis/@active = 'y'">
							<div class="rebates_product --gratis mb-3">
								<div class="rebates_product__label py-1 mb-2">
									iai_i18n:[UHJlemVudCBkbyB6YW3Ds3dpZW5pYQ==]
								</div>
								<div class="rebates_product__products">
						...
						<iaixsl:if test="page/rebate_code/other_products_rebate/@active = 'y'">
							<div class="rebates_other --another">
								<div class="rebates_other__value --txt">
									...
									iai_i18n:[UmFiYXQgZGxhIHBvem9zdGHFgnljaCBwcm9kdWt0w7N3]
						...
						<iaixsl:if test="page/rebate_code/shipping_cost_rebate/@active = 'y'">
							<div class="rebates_other --shipping">
								<div class="rebates_other__value --txt">
									...
									iai_i18n:[UmFiYXQgZGxhIGtvc3p0w7N3IHd5c3nFgmtp]
									
									<iaixsl:if test="page/rebate_code/shipping_cost_rebate/@price_type='net'">
										<div class="rebates_other__info">
											iai_i18n:[UmFiYXQgZGxhIGtvc3p0w7N3IHd5c3nFgmtpIGplc3QgbmFsaWN6YW55IG9kIGNlbnkgbmV0dG8=]
										</div>
									</iaixsl:if>
								</div>
