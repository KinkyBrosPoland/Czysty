...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (opinions_photos_display, 60dd8e876d5374.77837218.7)-->
		<iaixsl:choose>
		<iaixsl:when test="count(page/opinions-photos/opinions/opinion[@image_small or @image_large]) &gt; 0">

			<div id="opinions">
				<h1 class="big_label">iai_i18n:[SW5zcGlyYWNqZSBpIHpkasSZY2lhIGtsaWVudMOzdw==]</h1>
				<p class="opinions-description">
					iai_i18n:[Q2hjZXN6IGRvZGHEhyBzd29qZSB6ZGrEmWNpZT8gTW/FvGVzeiB0byB6cm9iacSHIHBpc3rEhWMgb3BpbmnEmSBpIGRvZGFqxIVjIHN3b2plIHpkasSZY2llIG8gamVkbnltIHogcHJvZHVrdMOzdy4gQWJ5IHN6eWJjaWVqIHpuYWxlxbrEhyB0YWtpZSBwcm9kdWt0eSwgc2tvcnp5c3RhaiB6] <a href="/products-bought.php">iai_i18n:[bGlzdHkga3VwaW9ueWNoIHByb2R1a3TDs3c=]</a>.
					<iaixsl:if test="page/opinions-photos/opinions/@product_photo_loyalty_points">
					<br/>

						iai_i18n:[WmEga2HFvGTEhSBvcGluacSZIHplIHpkasSZY2llbSBvdHJ6eW1hc3ogb2QgbmFz] <iaixsl:value-of select="page/opinions-photos/opinions/@product_photo_loyalty_points"/> 
						iai_i18n:[cGt0LiB3IHByb2dyYW1pZSBsb2phbG5vxZtjaW93eW0=].</iaixsl:if>
								...
								<div class="opinion-hover">
									...
									<div class="product-info">
										...
										<a class="see-product">
												<iaixsl:attribute name="href"><iaixsl:value-of select="product/@link"/></iaixsl:attribute>
												<iaixsl:attribute name="title"><iaixsl:value-of select="product/@name"/></iaixsl:attribute>
												iai_i18n:[Wm9iYWN6IHByb2R1a3Q=]</a>
									</div>
								</div>
						</div>
				</div>
		...
		<iaixsl:otherwise>
			<div id="opinions" class="d-flex flex-column align-items-center --empty">
				...
				<h1 class="big_label">iai_i18n:[TmlrdCBqZXN6Y3plIG5pZSBkb2RhxYIgc3dvaWNoIHpkasSZxIcgcHJvZHVrdMOzdw==]</h1>
				<p class="opinions-description">
				    <span class="d-block">iai_i18n:[Q2hjZXN6IGJ5xIcgcGllcndzesSFIG9zb2LEhSBpIHByemVqxZvEhyB3IHRlbiBzcG9zw7NiIGRvIGhpc3RvcmlpIG5hc3plZ28gc2tsZXB1Pw==]</span>
					iai_i18n:[RG9kYWogemRqxJljaWUgZG8gb3BpbmlpIG8gZG93b2xueW0gcHJvZHVrY2llLiBBYnkgc3p5YmNpZWogem5hbGXFusSHIHRha2llIHByb2R1a3R5LCBza29yenlzdGFqIHo=] <a href="/products-bought.php">iai_i18n:[bGlzdHkga3VwaW9ueWNoIHByb2R1a3TDs3c=]</a>.
					<iaixsl:if test="false">
					
					<br/>
						iai_i18n:[WmEga2HFvGTEhSBvcGluacSZIHplIHpkasSZY2llbSBvdHJ6eW1hc3ogb2QgbmFz] %s
						iai_i18n:[cGt0LiB3IHByb2dyYW1pZSBsb2phbG5vxZtjaW93eW0=].</iaixsl:if> 
