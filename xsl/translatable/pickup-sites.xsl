...
<!-- (menu_messages, 60dd8e79b18501.50382803.13)-->
        ...
        <!-- (cop_modules_pickup_sites, 66e401b3becba8.49386876.7)-->
	<form method="POST" id="COP" class="cop --pickup-sites">
    <iaixsl:attribute name="action"><iaixsl:value-of select="/shop/page/pickups/@action"/></iaixsl:attribute>
    <iaixsl:attribute name="data-courier-id"><iaixsl:choose><iaixsl:when test="/shop/page/pickups/courier/@id"><iaixsl:value-of select="/shop/page/pickups/courier/@id"/></iaixsl:when><iaixsl:otherwise>0</iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>
    <iaixsl:attribute name="data-prepaid"><iaixsl:choose><iaixsl:when test="/shop/page/pickups/courier/@isCod = 'true'">dvp</iaixsl:when><iaixsl:otherwise>prepaid</iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>
    <iaixsl:if test="/shop/page/pickups/*/pickup[location/@latitude != '' and location/@longitude != '']">
      <iaixsl:attribute name="data-lat"><iaixsl:value-of select="/shop/page/pickups/*/pickup[location/@latitude != '' and location/@longitude != '']/location/@latitude"/></iaixsl:attribute>
      <iaixsl:attribute name="data-lng"><iaixsl:value-of select="/shop/page/pickups/*/pickup[location/@latitude != '' and location/@longitude != '']/location/@longitude"/></iaixsl:attribute>
    </iaixsl:if>
    <iaixsl:if test="/shop/page/pickups/deliveryaddress">
      <iaixsl:attribute name="data-address"><iaixsl:value-of select="/shop/page/pickups/deliveryaddress/@street"/><iaixsl:text>, </iaixsl:text><iaixsl:value-of select="/shop/page/pickups/deliveryaddress/@zipcode"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="/shop/page/pickups/deliveryaddress/@city"/></iaixsl:attribute>
    </iaixsl:if>
    <iaixsl:if test="/shop/page/pickups/google_api_key/@value and /shop/page/pickups/google_api_key/@value != ''">
      <iaixsl:attribute name="data-google-api-key"><iaixsl:value-of select="/shop/page/pickups/google_api_key/@value"/></iaixsl:attribute>
    </iaixsl:if>
    <input class="pickup_sites_point_input" type="hidden">
      <iaixsl:attribute name="name"><iaixsl:value-of select="/shop/page/pickups/@name"/></iaixsl:attribute>
    </input>
		<div class="cop__content" data-skeleton="pickup">
			<div class="cop__step">
