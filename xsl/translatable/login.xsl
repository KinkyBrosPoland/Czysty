...
<iaixsl:choose>
    ...
    <iaixsl:otherwise><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/common_shop.js.gzip?r=1765442856</iaixsl:attribute></script></iaixsl:otherwise>
			...
			<script src="/gfx/translatable/login.js.gzip?r=1765442856"></script>
...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (login-welcome, 610bfde20e4411.10548952.5)-->
	<iaixsl:if test="(page/@type = 'login') and (page/login/@type='ok') and not(page/login/response)">
		<h1 class="l_welcome headline">
			<span class="headline__name">iai_i18n:[VHdvamUga29udG8=]</span>
		</h1>
	</iaixsl:if>
<!-- (login, 610bfde21ddc07.68417574.11)-->
				...
				<div class="client_info col-md-4 col-12 col-xl-3">
					...
					<iaixsl:if test="/shop/basket/@client_id_upc != ''">
						<div class="login_menu client-barcode d-sm-none">
							<h2>
								iai_i18n:[SWRlbnR5ZmlrYXRvciBzdGHFgmVnbyBrbGllbnRh]
							</h2>
							<svg class="barcode"/>
							<strong>
								<iaixsl:choose>
						...
						<iaixsl:if test="(/shop/page/login/client_balance/balance[@value &gt; 0]) or (page/login/client_balance/limit/@value &gt; 0) or (page/login/client/invoice_data/@account_number)">
							<div class="login_menu clearfix" id="account_login">
								<div class="login_menu_sub col-12">
									<h2>iai_i18n:[SW5mb3JtYWNqZSBvIGtvbmNpZQ==]</h2>
									<div class="balance_section">
										...
										<iaixsl:if test="/shop/page/login/client_balance/balance[@value &gt; 0]">
											<div class="login_point_count">
												<span>iai_i18n:[VHdvamUgc2FsZG8gKG5hZHDFgmF0YSk=]: </span>
												<strong>
										...
										<iaixsl:if test="page/login/client_balance/limit/@value &gt; 0">
											<div class="login_point_count">
												<span>iai_i18n:[UG96b3N0YcWCeSBsaW1pdCBrcmVkeXRvd3k=]: </span>
										...
										<iaixsl:if test="page/login/client/invoice_data/@account_number">
											<div class="login_point_count">
												<span>iai_i18n:[SW5keXdpZHVhbG5lIGtvbnRvIGRvIFR3b2ljaCB3cMWCYXQ=]:</span>
			...
			<div class="login_menu_wrapper col-12 row mx-0 flex-wrap align-items-stretch">
				...
				<iaixsl:if test="/shop/action/shoppinglist/@url or /shop/page/actions/products_requests/@url">
					<div class="login_menu" id="products_login">
						<div class="login_menu_sub">
							<h2>
								<iaixsl:choose><iaixsl:when test="$iconsproducts"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsproducts"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="products" src="/gfx/standards/products.png?r=1765442497"/></iaixsl:otherwise></iaixsl:choose>
								iai_i18n:[TGlzdHkgcHJvZHVrdMOzdw==]
							</h2>
							<div><span>iai_i18n:[UHJ6ZWdsxIVkYWogaSBlZHl0dWogc3dvamUgbGlzdHkgemFrdXBvd2UuIFcgdGVqIHNla2NqaSBtb8W8ZXN6IHLDs3duaWXFvCBlZHl0b3dhxIcgbGlzdMSZIHByb2R1a3TDs3cgcG9zenVraXdhbnljaCwga3TDs3JlIGNoY2lhxYJiecWbIHpvYmFjennEhyB3IG5hc3p5bSBza2xlcGll].</span></div>
							...
							<a class="btn --outline --extrasmall">
								...
								iai_i18n:[UG9zenVraXdhbmU=]
								<span class="sr-only">iai_i18n:[cHJvZHVrdHk=]</span>
							</a>
						</div>
					</div>
				</iaixsl:if>
					...
					<div class="login_menu" id="subscriptions_login">
						<div class="login_menu_sub">
							<h2>
								...
								iai_i18n:[U3Vic2tyeXBjamU=]
							</h2>
							<div><span>iai_i18n:[UHJ6ZWdsxIVkYWogaSBlZHl0dWogc3dvasSFIGxpc3TEmSBzdWJza3J5cGNqaS4gTW/FvGVzeiB1c3Rhd2lhxIcgZMWCdWdvxZvEhyB0cndhbmlhIHN1YnNrcnlwY2ppLCB6bWllbmnEhyBmb3JtxJkgcMWCYXRub8WbY2kgY3p5IHdhcnVua2kgc3Vic2tyeXBjamk=].</span></div>
							<a class="btn --outline --extrasmall">
								...
								iai_i18n:[QWt0eXduZQ==]
								<span class="sr-only">iai_i18n:[U3Vic2tyeXBjamU=]</span>
							</a>
							<a class="btn --outline --extrasmall">
				...
				<iaixsl:if test="/shop/page/actions/orders_opened/@url or /shop/page/actions/orders_closed/@url">
					<div class="login_menu" id="orders_login">
						<div class="login_menu_sub">
							<h2>
								<iaixsl:choose><iaixsl:when test="$iconsorders"><i><iaixsl:attribute name="class"><iaixsl:value-of select="$iconsorders"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="orders" src="/gfx/standards/orders.png?r=1765442497"/></iaixsl:otherwise></iaixsl:choose>
								iai_i18n:[WmFtw7N3aWVuaWE=]
							</h2>
							<div><span>iai_i18n:[U2VrY2phLCB3IGt0w7NyZWogbW/FvGVzeiBuYSBiaWXFvMSFY28gxZtsZWR6acSHIHBvc3TEmXAgcmVhbGl6YWNqaSBiaWXFvMSFY3ljaCB6YW3Ds3dpZcWELCB6YXJ6xIVkemHEhyB3cMWCYXRhbWkgb3JheiBwcnplanJ6ZcSHIHpyZWFsaXpvd2FuZSBqdcW8IHByemV6IG5hcyB6YW3Ds3dpZW5pYQ==].</span></div>
							<a class="btn --outline --extrasmall">
								...
								iai_i18n:[QmllxbzEhWNl]
								<span class="sr-only">iai_i18n:[WmFtw7N3aWVuaWE=]</span>
							</a>
							...
							<iaixsl:if test="page/actions/associated_orders/@count &gt; 0 and $associated_clients">
								<div class="associated_orders">
									...
									<a>
										...
										<iaixsl:attribute name="title">iai_i18n:[Wm9iYWN6IGxpc3TEmQ==]</iaixsl:attribute>
										iai_i18n:[Wm9iYWN6IGxpc3TEmQ==]
										<span class="sr-only">iai_i18n:[T2N6ZWt1asSFY2UgbmEgYWtjZXB0YWNqxJk=]</span>
									</a>
								</div>
							</iaixsl:if>
						</div>
				...
				<div class="login_menu" id="client_cards">
					<div class="login_menu_sub">
						<h2>
							<iaixsl:choose><iaixsl:when test="$iconsprofit"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsprofit"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="profit" src="/gfx/standards/profity.png?r=1765442497"/></iaixsl:otherwise></iaixsl:choose>
							iai_i18n:[UmFiYXR5]
						</h2>
						<div><span>iai_i18n:[U3ByYXdkxbogY3p5IHBvc2lhZGFzeiBqYWtpZcWbIHdhxbxuZSBrYXJ0eSBzdGHFgmVnbyBrbGllbnRhIGkgY28gbW/FvG5hIHpyb2JpxIcgYWJ5IGplIG90cnp5bWHEhy4gU3ByYXdkxbogcsOzd25pZcW8IG5hIGpha2llIGdydXB5IHByb2R1a3TDs3cgdXp5c2thc3ogcmFiYXQgaSB3IGpha2llaiB3eXNva2/Fm2Np].</span></div>
				...
				<iaixsl:if test="/shop/page/actions/client_edit/@url">
					<div class="login_menu" id="dane_login">
						<div class="login_menu_sub">
							<h2>
								<iaixsl:choose><iaixsl:when test="$iconseditdata"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconseditdata"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="editdata" src="/gfx/standards/editdata.png?r=1765442497"/></iaixsl:otherwise></iaixsl:choose>
								<iaixsl:choose><iaixsl:when test="/shop/client_files/@to_download = 'true'">iai_i18n:[RGFuZSBvc29ib3dlIGkgcGxpa2kgZG8gcG9icmFuaWE=]</iaixsl:when><iaixsl:otherwise>iai_i18n:[RGFuZSBvc29ib3dl]</iaixsl:otherwise></iaixsl:choose>
							</h2>
							<div><span>iai_i18n:[VyB0eW0gbWllanNjdSBtb8W8ZXN6IHNwcmF3ZHppxIcgbHViIHptaWVuacSHIFR3b2plIGRhbmUgb3NvYm93ZSwgZG9kYcSHIG5vd2UgYWRyZXN5IGRvc3Rhdywga3TDs3J5Y2ggYsSZZHppZXN6IG3Ds2fFgiB1xbx5xIcgcHJ6eSBza8WCYWRhbml1IHphbcOzd2llbmlhIG9yYXogem1pZW5pxIcgd2FsdXTEmSBpIGrEmXp5ayBza2xlcHU=].</span></div>
				...
				<div class="login_menu" id="returns_login">
					<div class="login_menu_sub">
						<h2>
							<iaixsl:choose><iaixsl:when test="$iconsreturns"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsreturns"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="returns" src="/gfx/standards/returns.png?r=1765442497"/></iaixsl:otherwise></iaixsl:choose>
							iai_i18n:[Wndyb3R5]
						</h2>
						<div><span>iai_i18n:[WmFyesSFZHphaiBzd29pbWkgendyb3RhbWkgcHJvZHVrdMOzdy4gVyB0ZWogc2VrY2ppIG1vxbxlc3ogZG9kYcSHIHp3cm90IHpha3VwaW9uZWdvIHUgbmFzIHByb2R1a3R1IG9yYXogd3nFm3dpZXRsacSHIGluZm9ybWFjamUgbyB6Z8WCb3N6b255Y2ggd2N6ZcWbbmllaiB3IG5hc3p5bSBza2xlcGllIHp3cm90YWNo].</span></div>
						<a class="btn --outline --extrasmall">
						...
						<a class="btn --outline --extrasmall">
							...
							iai_i18n:[V3N6eXN0a2llIGRvZGFuZSB6d3JvdHk=]
						</a>
					</div>
				</div>
				...
				<iaixsl:if test="/shop/rma/@active = 'y' and /shop/rma/@link">
					<div class="login_menu" id="rma_login">
						<div class="login_menu_sub">
							<h2>
							<iaixsl:choose><iaixsl:when test="$iconsrma"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsrma"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="rma" src="/gfx/standards/rma.png?r=1765442497"/></iaixsl:otherwise></iaixsl:choose>

								iai_i18n:[UmVrbGFtYWNqZQ==]
							</h2>
							<div><span>iai_i18n:[VGEgc2VrY2phIHBvendhbGEgbmEgesWCb8W8ZW5pZSByZWtsYW1hY2ppIHByb2R1a3TDs3cgdyBuYXN6eW0gc2tsZXBpZS4gSmXFm2xpIGp1xbwgesWCb8W8ecWCZcWbIHJla2xhbWFjasSZIHpuYWpkemllc3ogdHUgamVqIHN6Y3plZ8OzxYJ5IG9yYXogaW5mb3JtYWNqZSBvIHN0YW5pZSBqZWogcmVhbGl6YWNqaQ==].</span></div>
							<a class="btn --outline --extrasmall">
								...
								iai_i18n:[RG9kYWogcmVrbGFtYWNqxJk=]
							</a>
							<a class="btn --outline --extrasmall">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/rmaList/@url"/></iaixsl:attribute>
								iai_i18n:[VHdvamUgcmVrbGFtYWNqZQ==]
							</a>
						</div>
					</div>
				</iaixsl:if>
				...
				<iaixsl:if test="(/shop/page/actions/client_rebate_points/@url and not(/shop/page/actions/client_rebate_points/@url='')) or /shop/page/actions/products_points/@available='true' or (/shop/page/actions/points_cms/@url and not(/shop/page/actions/points_cms/@url=''))">
					<div class="login_menu" id="points_login">
						<div class="login_menu_sub">
							<h2>
								<iaixsl:choose><iaixsl:when test="$iconspoints"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconspoints"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="points" src="/gfx/standards/points.png?r=1765442497"/></iaixsl:otherwise></iaixsl:choose>
								iai_i18n:[UHJvZ3JhbSBsb2phbG5vxZtjaW93eQ==]
							</h2>
							<div><span>iai_i18n:[VyB0eW0gbWllanNjdSBtb8W8ZXN6IHphcG96bmHEhyBzacSZIHogemFzYWRhbWkga29yenlzdGFuaWEgeiBQcm9ncmFtdSBMb2phbG5vxZtjaW93ZWdvIHNrbGVwdSBhIHRha8W8ZSB3IHByenlwYWRrdSBwb3NpYWRhbmlhIG5hIGtvbmNpZSBwdW5rdMOzdyBtb8W8bGl3b8WbY2kgaWNoIHd5a29yenlzdGFuaWE=].</span></div>

							<iaixsl:if test="/shop/basket/@client_points">
								<span class="points_info">iai_i18n:[T2JlY25pZSBwb3NpYWRhc3o=]<strong><iaixsl:value-of select="/shop/basket/@client_points"/> iai_i18n:[cGt0].</strong></span>
							</iaixsl:if>
							...
							<iaixsl:if test="/shop/page/actions/points_cms/@url and not(/shop/page/actions/points_cms/@url='')">
								<a class="btn --outline --extrasmall">
									...
									iai_i18n:[SmFrIHpiaWVyYcSHIHB1bmt0eQ==]
								</a>
							</iaixsl:if>
							<iaixsl:if test="/shop/page/actions/client_rebate_points and /shop/page/actions/client_rebate_points/@url and not(/shop/page/actions/client_rebate_points/@url='')">
								<a class="btn --outline --extrasmall">
									...
									iai_i18n:[V3ltaWXFhCBwdW5rdHkgbmEgcmFiYXQ=]
								</a>
							</iaixsl:if>
							<iaixsl:if test="/shop/page/actions/products_points/@available='true'">
								...
								iai_i18n:[UHJvZHVrdHkgemEgcHVua3R5]
								</a>
						</iaixsl:if>
						</div>
					</div>
				...
				<iaixsl:if test="/shop/page/affiliate and /shop/page/affiliate/@link">
					<div class="login_menu" id="affiliate_login">
						<div class="login_menu_sub">
							<h2>
								<iaixsl:choose><iaixsl:when test="$iconsaffiliate"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsaffiliate"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="affiliate" src="/gfx/standards/affiliate.png?r=1765442497"/></iaixsl:otherwise></iaixsl:choose>
								iai_i18n:[UHJvZ3JhbSBwYXJ0bmVyc2tp]
							</h2>
							<div><span>iai_i18n:[].</span></div>
							<a class="btn --outline --extrasmall">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/affiliate/@link"/></iaixsl:attribute>
								iai_i18n:[U3ByYXdkxbogc3pjemVnw7PFgnk=]
							</a>
						</div>
					</div>
				</iaixsl:if>
				...
				<iaixsl:if test="/shop/page/actions/associated_clients and /shop/page/actions/associated_clients/@url and $associated_clients">
					<div class="login_menu" id="associated_clients">
						<div class="login_menu_sub">
							<h2>
								<iaixsl:choose><iaixsl:when test="$iconsassociated"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsassociated"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="points" src="/gfx/standards/points.png?r=1765442497"/></iaixsl:otherwise></iaixsl:choose>
								iai_i18n:[RG9kYXRrb3dpIHXFvHl0a293bmljeQ==]
							</h2>
							<div><span>iai_i18n:[].</span></div>
							<a class="btn --outline --extrasmall">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/actions/associated_clients/@url"/></iaixsl:attribute>
								iai_i18n:[WmFyesSFZHphag==]
							</a>
						</div>
					</div>
				</iaixsl:if>
