...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
   ...
   <!-- (client-orders, 61f913c6db4cb5.94540049.9)-->
	
  <iaixsl:variable name="isPaymentsOrdersActive"><iaixsl:if test="(/shop/page/orders/@mode = 'opened' or /shop/page/orders/@mode = 'closed') and /shop/collective_payment_for_orders/@active = 'true'">true</iaixsl:if></iaixsl:variable>
	<div class="client_order">
		<iaixsl:choose>
			<iaixsl:when test="page/orders/@mode = 'rma'">
				<iaixsl:attribute name="class">client_order --rma</iaixsl:attribute>
				<div class="progress_bar_wrapper pb_step1 rma_progress_bar">
					...
					<div class="_step _step1">
						...
						<p>
							<i/>
							<b>iai_i18n:[V3liaWVyeg==]</b> iai_i18n:[emFtw7N3aWVuaWU=]
						</p>
					</div>
					<div class="_step _step2">
						...
						<p>
							<i/>
							<b>iai_i18n:[V3liaWVyeiBwcm9kdWt0eQ==]</b> iai_i18n:[ZG8gcmVrbGFtYWNqaQ==]
						</p>
					</div>
					<div class="_step _step3">
						...
						<p>
							<i/>
							<b>iai_i18n:[V3liaWVyeiBzcG9zw7Ni]</b> iai_i18n:[ZG9zdGFyY3plbmlh]
						</p>
					</div>
					<div class="_step _step4">
						...
						<p>
							<i/>
							<b>iai_i18n:[V3liaWVyeiBwdW5rdA==]</b> iai_i18n:[ZG9zdGFyY3plbmlhIHByb2R1a3R1]
						</p>
					</div>
					<div class="_step _step5">
						...
						<p>
							<i/>
							<b>iai_i18n:[V3liaWVyeiBzcG9zw7NiIGkgZm9ybcSZ]</b> iai_i18n:[cmVhbGl6YWNqaSByZWtsYW1hY2pp]
						</p>
					</div>
					<div class="_step _step6">
						...
						<p>
							<i/>
							<b>iai_i18n:[UG9kc3Vtb3dhbmll]</b> iai_i18n:[cmVrbGFtYWNqaQ==]
						</p>
					</div>
				</div>
				<div class="progress__item --rma --first d-md-none --active py-3">
					...
					<div class="progress__text">
						<strong class="progress__name">iai_i18n:[V3liaWVyeiB6YW3Ds3dpZW5pZSwgeiBrdMOzcmVnbyBjaGNlc3ogcmVrbGFtb3dhxIcgcHJvZHVrdA==]</strong>
					</div>
				</div>
				<div class="client_order__labelWrapper my-2">
					<h1 class="big_label d-none d-md-block">
						iai_i18n:[V3liaWVyeiB6YW3Ds3dpZW5pZSwgeiBrdMOzcmVnbyBjaGNlc3ogcmVrbGFtb3dhxIcgdG93YXJ5]
					</h1>
					<div>
						<span class="progress__listIcon"/>
						<a href="client-orders.php?display=closed"><iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=closed</iaixsl:attribute></iaixsl:if>iai_i18n:[TGlzdGEgenJlYWxpem93YW55Y2ggemFtw7N3aWXFhA==]</a>
					</div>
				</div>
        <div class="progress__rmaHelper">
          <span class="progress__iconRMA"/> iai_i18n:[V3lnb2RueSBrcmVhdG9yIHBvcHJvd2FkemkgQ2nEmSBrcm9rIHBvIGtyb2t1IHByemV6IGNhxYJ5IHByb2Nlcw==].
        </div>
			</iaixsl:when>
			<iaixsl:when test="page/orders/@mode = 'returns'">
				<iaixsl:attribute name="class">client_order --returns</iaixsl:attribute>
				<div class="progress_bar_wrapper pb_step1">
					...
					<div class="_step _step2">
						...
						<p>
							<i/>
							<b>iai_i18n:[V3liaWVyeiBwcm9kdWt0eQ==]</b> iai_i18n:[ZG8gendyb3R1]
						</p>
					</div>
					<div class="_step _step3">
						<span>3</span>
						<p>
							<i/>
							<b>iai_i18n:[V3liaWVyeiBzcG9zw7Ni]</b> iai_i18n:[endyb3R1IHByb2R1a3TDs3c=]
						</p>
					</div>
					<div class="_step _step4">
						<span>4</span>
					...
					<div class="_step _step5">
						...
						<p>
							<i/>
							<b>iai_i18n:[V3liaWVyeiBmb3JtxJk=]</b> iai_i18n:[endyb3R1IG5hbGXFvG5vxZtjaQ==]
						</p>
					</div>
					<div class="_step _step6">
						<span>6</span>
						<p>
							<i/>
							<b>iai_i18n:[WmF0d2llcmTFug==]</b> iai_i18n:[VHfDs2ogendyb3Q=]
						</p>
					</div>
				</div>
				<div class="progress__item --rma --first d-md-none --active py-3">
					...
					<div class="progress__text">
						<strong class="progress__name">iai_i18n:[V3liaWVyeiB6YW3Ds3dpZW5pZSwgeiBrdMOzcmVnbyBjaGNlc3ogendyw7NjacSHIHByb2R1a3R5]</strong>
					</div>
				</div>
				<div class="client_order__labelWrapper my-2">
					<h1 class="big_label d-none d-md-block">
						iai_i18n:[V3liaWVyeiB6YW3Ds3dpZW5pZSwgeiBrdMOzcmVnbyBjaGNlc3ogendyw7NjacSHIHByb2R1a3R5]
					</h1>
					<div>
						<span>iai_i18n:[Wm9iYWN6IHRlxbw=]: </span>
						<a href="client-orders.php?display=closed"><iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=closed</iaixsl:attribute></iaixsl:if>iai_i18n:[TGlzdGEgenJlYWxpem93YW55Y2ggemFtw7N3aWXFhA==]</a>
					</div>
				</div>
			</iaixsl:when>
			<iaixsl:when test="page/orders/@mode = 'closed'">
				<iaixsl:attribute name="class">client_order --closed</iaixsl:attribute>
				<iaixsl:if test="$isPaymentsOrdersActive">
					<iaixsl:attribute name="class">client_order --closed --payments</iaixsl:attribute>
				</iaixsl:if>
				<div class="client_order__labelWrapper my-2">
					<h1 class="big_label">
						iai_i18n:[WmFtw7N3aWVuaWEgenJlYWxpem93YW5lIGkgYW51bG93YW5l]
					</h1>
					<div>
            <span class="progress__listIcon"/>
            <a href="client-orders.php?display=opened"><iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=opened</iaixsl:attribute></iaixsl:if>iai_i18n:[TGlzdGEgYWt0dWFsbmllIHJlYWxpem93YW55Y2ggemFtw7N3aWXFhA==]</a>
          </div>
				</div>
			</iaixsl:when>
			<iaixsl:otherwise>
				<iaixsl:attribute name="class">client_order --opened</iaixsl:attribute>
				<iaixsl:if test="$isPaymentsOrdersActive">
					<iaixsl:attribute name="class">client_order --opened --payments</iaixsl:attribute>
				</iaixsl:if>
				<div class="client_order__labelWrapper my-2">
					<h1 class="big_label">
						iai_i18n:[WmFtw7N3aWVuaWEgdyB0cmFrY2llIHJlYWxpemFjamk=]
					</h1>
          <div>
            <span class="progress__listIcon"/>
            <a href="client-orders.php?display=closed"><iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=closed</iaixsl:attribute></iaixsl:if>iai_i18n:[TGlzdGEgenJlYWxpem93YW55Y2ggemFtw7N3aWXFhA==]</a>
		...
		<iaixsl:choose>
			<iaixsl:when test="/shop/page/orders/item">
						...
						<table class="orders" cellspacing="0" cellpadding="0" id="rebates">
							<tr>
								<td colspan="3" class="headerek" id="rabat_header">
									iai_i18n:[xYHEhWN6bmEgd2FydG/Fm8SHIHpyZWFsaXpvd2FueWNoIHphbcOzd2llxYQ=]
								</td>
							</tr>
							<tr>
								<td class="ord3" id="reb_head_left">
									iai_i18n:[dyBvc3RhdG5pbSBrd2FydGFsZQ==]
								</td>
								<td class="ord3" id="reb_head_center">
									iai_i18n:[dyBvc3RhdG5pbSByb2t1]
								</td>
								<td class="ord3" id="reb_head_right">
									iai_i18n:[d3N6eXN0a2ll]
								</td>
							</tr>
							<tr>
				...
				<div class="orders__top">
					<iaixsl:if test="$isPaymentsOrdersActive = 'true' and count(/shop/page/orders/item[@collective_available = 'true']) &gt; 0">
						<div class="orderpay__select_all_wrapper">
							<div class="f-group --checkbox">
								<input autocomplete="off" type="checkbox" name="orderpay__select_all" class="f-control focused" id="orderpay__select_all"/>
								<label class="f-label" for="orderpay__select_all">iai_i18n:[WmF6bmFjeiB3c3p5c3RraWU=]</label>
							</div>
						</div>
					</iaixsl:if>

					<iaixsl:if test="count(page/orders/navigation/portions) &gt; 1">
						<form class="orders__portions" action="/settings.php">
							<select class="orders__portions_select --small-md" id="select_top_portions" name="orders_portions">
								<iaixsl:attribute name="aria-label">iai_i18n:[Wm1pZcWEIGlsb8WbxIcgd3nFm3dpZXRsYW55Y2ggemFtw7N3aWXFhA==]</iaixsl:attribute>
								<iaixsl:for-each select="page/orders/navigation/portions">
									<option><iaixsl:attribute name="value"><iaixsl:value-of select="@counter"/></iaixsl:attribute><iaixsl:if test="@selected = 'true'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>iai_i18n:[UG9rYcW8] <iaixsl:value-of select="@counter"/>
									</option>
								</iaixsl:for-each>
							</select>
						</form>
					...
					<iaixsl:variable name="next_page">iai_i18n:[TmFzdMSZcG5hIHN0cm9uYQ==]</iaixsl:variable>
					<iaixsl:if test="page/orders/navigation/@total &gt; page/orders/navigation/@portions">
						<ul class="pagination">
							<iaixsl:attribute name="aria-label">iai_i18n:[TmF3aWd1aiBtacSZZHp5IHN0cm9uYW1p]</iaixsl:attribute>
							...
							<iaixsl:if test="page/orders/navigation/prev">
								<li class="pagination__element --prev">
									...
									<a class="pagination__link">
										<iaixsl:attribute name="href"><iaixsl:choose><iaixsl:when test="page/orders/navigation/prev/@counter = '0'"><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/orders/navigation/path/@value, '&amp;counter=')"/><iaixsl:value-of disable-output-escaping="yes" select="substring-before(page/orders/navigation/path/@value, '?counter=')"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of disable-output-escaping="yes" select="page/orders/navigation/path/@value"/><iaixsl:value-of select="page/orders/navigation/prev/@counter"/></iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>
										<iaixsl:attribute name="aria-label">iai_i18n:[UG9wcnplZG5pYSBzdHJvbmE=]</iaixsl:attribute>
									</a>
									<iaixsl:if test="$prev_page">
				...
				<table class="orders" cellspacing="0" cellpadding="0">
					...
					<thead>
						<tr>
							<th id="orders_th1">
								iai_i18n:[SUQgemFtw7N3aWVuaWE=]
							</th>
              <th id="orders_th2">
                iai_i18n:[U3RhdHVzIHphbcOzd2llbmlh]
							</th>
							<th id="orders_th3">
								iai_i18n:[RGF0YSB6YW3Ds3dpZW5pYQ==]
							</th>
              <th id="orders_th4">
								iai_i18n:[TnIgZmFrdHVyeQ==]
							</th>
							<th id="orders_th5">
								iai_i18n:[V2FydG/Fm8SHIHphbcOzd2llbmlh]
							</th>
							<th id="orders_th6">
								iai_i18n:[UMWCYXRub8WbxIc=]
							</th>
						</tr>
					</thead>
					<tbody>
							...
							<tr>
								...
								<td>
									<div class="orders__id">
										<iaixsl:if test="$isPaymentsOrdersActive = 'true' and @collective_available = 'true'">
											<div class="orderpay__select f-group --checkbox">
												<input type="checkbox" name="orderpay__checkbox" class="f-control focused" autocomplete="off" id="orderpay__checkbox">
													<iaixsl:attribute name="id">orderpay__checkbox_<iaixsl:value-of select="@number"/></iaixsl:attribute>
													<iaixsl:attribute name="data-id"><iaixsl:value-of select="@number"/></iaixsl:attribute>
													<iaixsl:attribute name="data-date"><iaixsl:value-of select="@date"/></iaixsl:attribute>
													<iaixsl:attribute name="data-invoice"><iaixsl:value-of select="@invoice_id"/></iaixsl:attribute>
													<iaixsl:attribute name="data-worth"><iaixsl:choose><iaixsl:when test="@to_balance_order_formatted"><iaixsl:value-of select="@to_balance_order_formatted"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="@cost_formatted"/></iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>
													<iaixsl:attribute name="data-sign"><iaixsl:value-of select="@currencySign"/></iaixsl:attribute>
												</input>
												<label class="f-label" for="orderpay__checkbox">
													<iaixsl:attribute name="for">orderpay__checkbox_<iaixsl:value-of select="@number"/></iaixsl:attribute>
													<span class="sr-only">iai_i18n:[V3liaWVyeiB6YW3Ds3dpZW5pZQ==] <iaixsl:value-of select="@number"/></span>
												</label>
											</div>
										</iaixsl:if>
										<iaixsl:choose>
											<iaixsl:when test="@returns_url">
												<a class=""><iaixsl:attribute name="href"><iaixsl:value-of select="@returns_url"/></iaixsl:attribute><b><iaixsl:value-of select="@number"/></b></a>
											</iaixsl:when>
											<iaixsl:when test="@rma_url">
												<a class=""><iaixsl:attribute name="href"><iaixsl:value-of select="@rma_url"/></iaixsl:attribute><b><iaixsl:value-of select="@number"/></b></a>
											</iaixsl:when>
											<iaixsl:otherwise>
												<a class=""><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute><b><iaixsl:value-of select="@number"/></b></a>
											</iaixsl:otherwise>
										</iaixsl:choose>
									</div>
								</td>
                ...
                <td class="orders__status">
									<div><iaixsl:attribute name="class">btn-icon prepaid-icon status-<iaixsl:value-of select="$status_order"/></iaixsl:attribute>
										<iaixsl:choose>
											<iaixsl:when test="@returned_items = 'fully'">
												<span><i class="icon-order-status_back"/></span>
												<small>iai_i18n:[endyw7Njb25l]</small>
											</iaixsl:when>
											<iaixsl:when test="@returned_items = 'partially'">
												<span><i class="icon-order-status_back"/> </span>
												<small>iai_i18n:[endyw7Njb25lIGN6xJnFm2Npb3dv]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'k'">
												<span><i class="icon-order-status_remove"/></span>
												<small>iai_i18n:[YW51bG93YW5l]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 't'">
												<span><iaixsl:choose><iaixsl:when test="@personal_collection = 'yes'"><i class="icon-order-status_box"/></iaixsl:when><iaixsl:otherwise><i class="icon-order-status_truck"/> </iaixsl:otherwise></iaixsl:choose></span>
												<small><iaixsl:choose><iaixsl:when test="@personal_collection = 'yes'">iai_i18n:[b2RlYnJhbmU=]</iaixsl:when><iaixsl:otherwise>iai_i18n:[d3lzxYJhbmU=]</iaixsl:otherwise></iaixsl:choose></small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'n'">
												<span><i class="icon-order-status_ok"/></span>
												<small>iai_i18n:[cHJ6eWrEmXRl]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'o'">
												<span><i class="icon-order-status_ok"/></span>
												<small>iai_i18n:[cmVhbGl6b3dhbmU=]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'p'">
												<span><i class="icon-order-status_ok"/></span>
												<small>iai_i18n:[Z290b3dlIGRvIHd5c8WCYW5pYSAvIG9kYmlvcnU=]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'i'">
												<span><i class="icon-order-status_remove"/></span>
												<small>iai_i18n:[b2RyenVjb25l]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 's'">
												<span><i class="icon-prder-status_remove"/></span>
												<small>iai_i18n:[YW51bG93YW5l]</small>
											</iaixsl:when>

											<iaixsl:when test="$status_order = 'z'">
												<span><i class="con-order-status_back"/></span>
												<small>iai_i18n:[endyb3Q=]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'h'">
												<span><i class="icon-order-status_pause"/></span>
												<small>iai_i18n:[d3N0cnp5bWFuZQ==]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'w'">
												<iaixsl:choose>
													<iaixsl:when test="number(@paid) = number(@cost)">
														<span><i class="icon-order-status_clock"/></span>
														<small>iai_i18n:[b2N6ZWt1amUgbmEgZGFsc3rEhSByZWFsaXphY2rEmQ==]</small>
													</iaixsl:when>
													<iaixsl:when test="number(@paid) &gt; 0">
														<span><i class="icon-order-status_clock"/></span>
														<small>iai_i18n:[b2N6ZWt1amUgbmEgZG9wxYJhdMSZ]</small>
													</iaixsl:when>
													<iaixsl:otherwise>
														<span><i class="icon-order-status_clock"/></span>
														<small>iai_i18n:[b2N6ZWt1amUgbmEgd3DFgmF0xJk=]</small>
													</iaixsl:otherwise>
												</iaixsl:choose>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'd'">
												<span><i class="icon-order-status_clock"/></span>
												<small>iai_i18n:[b2N6ZWt1amUgbmEgZG9zdGF3xJk=]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'r'">
												<span><i class="icon-order-status_comments"/></span>
												<small>iai_i18n:[cmVrbGFtYWNqYQ==]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'l'">
												<span><i class="icon-order-status_pause"/></span>
												<small>iai_i18n:[emd1YmlvbmU=]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'j'">
												<span><i class="icon-order-status_double_ok"/></span>
												<small>iai_i18n:[cG/FgsSFY3pvbmU=]</small>
											</iaixsl:when>
											...
											<iaixsl:when test="$status_order = 'b'">
												<span><i class="icon-order-status_box"/></span>
												<small>iai_i18n:[cGFrb3dhbmU=]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'wp'">
												<span><i class="icon-order-status_clock"/></span>
												<small>iai_i18n:[b2N6ZWt1amUgbmEgdGVybWluIHBha293YW5pYQ==]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'wr'">
												<span><i class="icon-order-status_clock"/></span>
												<small>iai_i18n:[b2N6ZWt1amUgbmEgdGVybWluIG9kYmlvcnU=]</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'wd'">
												<span><i class="icon-order-status_clock"/></span>
												<small>iai_i18n:[b2N6ZWt1amUgbmEgdGVybWluIHd5c8WCYW5pYQ==]</small>
											</iaixsl:when>
											<iaixsl:otherwise>
											</iaixsl:otherwise>
										</iaixsl:choose>
								...
								<td class="orders__invoice">
								  <iaixsl:choose>
    								  <iaixsl:when test="@invoice_id">
                        <span><iaixsl:value-of select="@invoice_id"/></span>
                      </iaixsl:when>
                    	<iaixsl:otherwise>
                    	  <span>-</span>
                    </iaixsl:otherwise>
								...
								<td class="orders__payment_worth rma__price">
									<b><iaixsl:value-of select="@cost_formatted"/></b>
								</td>
                
								<td class="orders__payment_status rma__status">
                  <iaixsl:if test="@paid and (number(@cost) &gt; number(@paid))">
                    <iaixsl:attribute name="class">orders__payment_status rma__status --payment</iaixsl:attribute>
                  </iaixsl:if>
									<iaixsl:choose>
										<iaixsl:when test="$isPaymentsOrdersActive = 'true' and /shop/page/orders/@mode = 'opened' and @prepaidstatus ='n' and not(@paymentstatus = 'g') and @orderdetails">
											<a class="btn --solid --small"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute>iai_i18n:[WmFwxYJhxIcgdGVyYXo=]</a>
										</iaixsl:when>
										<iaixsl:when test="$isPaymentsOrdersActive = 'true' and /shop/page/orders/@mode = 'closed' and @collective_available = 'true'">
											<a class="btn --solid --small"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute>iai_i18n:[WmFwxYJhxIcgdGVyYXo=]</a>
										</iaixsl:when>
										<iaixsl:when test="$status_order = 'k' or $status_order = 'i' or $status_order = 'j' or $status_order = 's'  or $status_order = 'l'">
											<div class="n54068_prepaid_desc">iai_i18n:[bmllIGRvdHljenk=]</div>
										</iaixsl:when>
										<iaixsl:when test="@paymentstatus = 'g' and (@paid and (number(@cost) &gt; number(@paid)))">
											<div class="n54068_prepaid_desc">iai_i18n:[d3DFgmFjb25v]: 
											<b><iaixsl:value-of select="@paid_formatted"/></b>
											iai_i18n:[b3DFgmHEhyBwb3pvc3RhxYLEhSBrd290xJkgcHJ6eSBvZGJpb3J6ZQ==]</div><br/>

										</iaixsl:when>
										<iaixsl:when test="@paymentstatus = 'g'">
											<div class="n54068_prepaid_desc">iai_i18n:[emFwxYJhxIcgcHJ6eSBvZGJpb3J6ZQ==]</div>
										</iaixsl:when>
										<iaixsl:otherwise>
											<div>
												<iaixsl:choose>
                            ...
                            <iaixsl:if test="@paid and (number(@cost) &gt; number(@paid))">
      												<div>iai_i18n:[d3DFgmFjb25v]: 
      												<b><iaixsl:value-of select="@paid_formatted"/></b></div>
      											</iaixsl:if>
														<iaixsl:choose>
															<iaixsl:when test="$status_order = 'k' or $status_order = 'i' or $status_order = 'j' or $status_order = 's'  or $status_order = 'l'">
																iai_i18n:[bmllIGRvdHljenk=]
															</iaixsl:when>
															<iaixsl:when test="@prepaidstatus ='n'">
																<iaixsl:choose>
																	<iaixsl:when test="@paid and (number(@cost) &gt; number(@paid))">
																		iai_i18n:[b3DFgmHEhyBwb3pvc3RhxYLEhSBrd290xJk=]
																	</iaixsl:when>
																	<iaixsl:otherwise>
																		iai_i18n:[b2N6ZWt1amUgbmEgemFrc2nEmWdvd2FuaWU=]
																	</iaixsl:otherwise>
																</iaixsl:choose>
															</iaixsl:when>
															<iaixsl:when test="@prepaidstatus ='c'">
																iai_i18n:[b2N6ZWt1amUgbmEgb2RibG9rb3dhbmllIHdwxYJhdHk=]
															</iaixsl:when>
															<iaixsl:when test="@prepaidstatus ='b'">
																iai_i18n:[endyb3Qgd3DFgmF0eQ==]
															</iaixsl:when>
															<iaixsl:when test="@prepaidstatus ='y'">
																iai_i18n:[b3DFgmFjb25l]
															</iaixsl:when>
															<iaixsl:when test="@prepaidstatus ='z'">
																iai_i18n:[b2RlYnJhbmU=]
															</iaixsl:when>
														</iaixsl:choose>
                            ...
                            <iaixsl:if test="@paid and (number(@cost) &gt; number(@paid))">
      												...
      												<br/>
														...
														<iaixsl:choose>
															...
															<iaixsl:when test="@prepaidstatus ='n'">
																iai_i18n:[b3DFgmHEhyB6YW3Ds3dpZW5pZQ==]
															</iaixsl:when>
															<iaixsl:when test="@prepaidstatus ='c'">
																iai_i18n:[b2N6ZWt1amUgbmEgb2RibG9rb3dhbmllIHdwxYJhdHk=]
															</iaixsl:when>
															...
															<iaixsl:when test="@prepaidstatus ='y'">
																<iaixsl:choose>
																	<iaixsl:when test="$status_order = 'w'">
																		iai_i18n:[bmllb3DFgmFjb25l]
																	</iaixsl:when>
																	<iaixsl:otherwise>
																		iai_i18n:[b3DFgmFjb25h]
																	</iaixsl:otherwise>
																</iaixsl:choose>
															</iaixsl:when>

															<iaixsl:when test="@prepaidstatus ='z'">
																iai_i18n:[YnJhayB3cMWCYXQ=]
															</iaixsl:when>
														</iaixsl:choose>
													</iaixsl:otherwise>
												</iaixsl:choose>
			...
			<iaixsl:otherwise>
				<div class="client_orders_null">
					<iaixsl:choose>
						<iaixsl:when test="page/orders/@mode = 'rma'">
							iai_i18n:[T2JlY25pZSBuaWUgbWFzeiB6YW3Ds3dpZcWELCBrdMOzcmUgbW9nxIUgcG9kbGVnYcSHIHJla2xhbWFjamk=].
						</iaixsl:when>
						<iaixsl:when test="page/orders/@mode = 'returns'">
							iai_i18n:[T2JlY25pZSBuaWUgbWFzeiB6YW3Ds3dpZcWELCBrdMOzcmUgbW9nxIUgcG9kbGVnYcSHIHp3cm90b3dp].
						</iaixsl:when>
						<iaixsl:when test="page/orders/@mode = 'closed'">
							iai_i18n:[T2JlY25pZSBuaWUgbWFzeiB6cmVhbGl6b3dhbnljaCB6YW3Ds3dpZcWE].
						</iaixsl:when>
						<iaixsl:otherwise>
							iai_i18n:[T2JlY25pZSBuaWUgbWFzeiB6YW3Ds3dpZcWEIHcgdHJha2NpZSByZWFsaXphY2pp].
						</iaixsl:otherwise>
					</iaixsl:choose>
				</div>
  ...
  <div class="orderpay__button_wrapper">
  	<div class="orderpay__button --hide">
  		<a class="btn --solid --medium" href="#orderpay">iai_i18n:[WmFwxYJhxIcgemF6bmFjem9uZQ==] - <span class="orderpay__worth"/></a>
  	</div>
  </div>
<!-- (client_orders_paging, 60dd8e7fa8b092.52997174.6)-->
	<iaixsl:variable name="prev_page"/>
	<iaixsl:variable name="next_page">iai_i18n:[TmFzdMSZcG5hIHN0cm9uYQ==]</iaixsl:variable>
...
<!-- (menu_maps, 63764495e0cb08.91568922.4)--><!-- (collective_payment, 651c2924bb4345.02166170.3)-->
  ...
  <template id="prepaid_terms_item_template">
		...
		<template id="expchck_retry_modal">
			<h4 class="expchck__title">iai_i18n:[UMWCYXRub8WbxIc=]</h4>
			
			<div class="expchck__wrapper --orders">
            ...
            <div class="expchck_summary__item --total expchck_total">
              ...
              <div class="expchck_submit__wrapper">
                <button type="submit" class="expchck_submit__button btn --solid --large">
                  iai_i18n:[WmFwxYJhxIcgemEgemFtw7N3aWVuaWE=]
                </button>
              </div>
						</div>
					</div>
    ...
    <template id="expchck_summary_orders_details">
      <div class="expchck_summary__orders__details">
        <a class="expchck_summary__more_orders" href="#showMore">
          <iaixsl:attribute name="data-alt_text"> - iai_i18n:[WndpxYQ=]</iaixsl:attribute>
           + iai_i18n:[UG9rYcW8IHdzenlzdGtpZQ==]
        </a>
      </div>
    </template>
    
    <template id="expchck_summary_order_details">
      <div class="expchck_summary__order__details">
        <span class="order_id_wrapper">iai_i18n:[SUQgemFtw7N3aWVuaWE=]: <strong class="order_id"/></span>
        <span class="order_date"/>
        <span class="order_invoice_wrapper">FV: <span class="order_invoice"/></span>
        <strong class="order_worth"/>
      </div>
    </template>

  

<!-- (menu_slider_modules, 6655a6e6f03996.64967288.4)-->
