...
<div class="client_order">
    <h1 class="big_label">
        <span>iai_i18n:[TGlzdGEgVHdvaWNoIHp3cm90w7N3]</span>
    </h1>
    <iaixsl:choose>
        <iaixsl:when test="/shop/page/returns/item">
            <table class="orders" cellspacing="0" cellpadding="0">
                ...
                <thead>
                    <tr id="orders_header">
                        <td class="ord3" id="orders_head_1">iai_i18n:[aWQgendyb3R1]</td>
                        <td class="ord3" id="orders_head_2">iai_i18n:[ZGF0YSB6d3JvdHU=]</td>
                        <td class="ord3" id="orders_head_3">iai_i18n:[ZG8gendyb3R1]</td>

                        <td class="ord3" id="orders_head_5">status</td>
                        <td class="ord3" id="orders_head_6">iai_i18n:[c3pjemVnw7PFgnk=]</td>
                    </tr>
                </thead>
                <tbody>
                            ...
                            <td>
                                <iaixsl:choose>
                                                            ...
                                                            <iaixsl:when test="@status=1">
                                                                iai_i18n:[endyb3Qgbmllb2JzxYJ1xbxvbnk=]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@status=2">
                                                                iai_i18n:[endyb3Qgcm96cGF0cnpvbnkgcG96eXR5d25pZQ==]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@status=3">
                                                                iai_i18n:[endyb3Qgcm96cGF0cnpvbnkgbmVnYXR5d25pZQ==]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@status=13">
                                                                iai_i18n:[endyb3QgYW51bG93YW55IHByemV6IGtsaWVudGE=]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@status=14">
                                                                iai_i18n:[endyb3QgYW51bG93YW55]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@status=15">
                                                                iai_i18n:[cG9ub3duYSB3eXN5xYJrYSB6YW3Ds3dpZW5pYQ==]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@status=16">
                                                                iai_i18n:[emFuaWVjaGFuaWUgcG9ub3duZWogd3lzecWCa2kgemFtw7N3aWVuaWE=]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@status=17">
                                                                iai_i18n:[a2xpZW50IHd5Z2VuZXJvd2HFgiB6d3JvdCAtIGRvc3RhcmN6eSBnbyBvc29iacWbY2ll]
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@status=18">
                                                                iai_i18n:[a2xpZW50IHd5Z2VuZXJvd2HFgiB6d3JvdCAtIHd5xZtsZSBnbyBzYW1vZHppZWxuaWU=]
                                                            </iaixsl:when>
                                </iaixsl:choose>
                            </td>
                             <td class="ord">
                                <a class="orders_more"><iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute>iai_i18n:[d2nEmWNlag==]...</a>
                            </td>
                        </tr>
                    </iaixsl:for-each>
                </tbody>
        ...
        <iaixsl:otherwise>
            <div class="return_list_noitem menu_messages_message" id="return_list_noitem">iai_i18n:[TmllIGRvZGFubyBqZXN6Y3plIMW8YWRuZWdvIHp3cm90dQ==].</div>
        </iaixsl:otherwise>
    </iaixsl:choose>
</div>
