...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
    ...
    <!-- (product_stocks_list, 614c5cf17f9072.72506872.4)-->
	<div id="product_stocks_list">
		
		<h1 class="headline">
			<span class="headline__name">iai_i18n:[RG9zdMSZcG5vxZvEhyBwcm9kdWt0dSB3IHNrbGVwYWNo]</span>
		</h1>
		<div class="product_stocks_list_productinfo product_wrapper">
			...
			<iaixsl:variable name="var_icon_second"><iaixsl:value-of select="/shop/page/product/icon_second"/></iaixsl:variable>
			<iaixsl:variable name="var_icon_small"><iaixsl:value-of select="/shop/page/product/icon_small"/></iaixsl:variable>
			<iaixsl:variable name="var_icon_small_second"><iaixsl:value-of select="/shop/page/product/icon_small_second"/></iaixsl:variable>
			...
			<a class="product-icon align_row" rel="nofollow" data-align="img#css">
				...
				<iaixsl:choose>
					<iaixsl:when test="$var_icon_small_second and not($var_icon_small_second = '' or $var_icon_small_second = '/')">
						<picture>
							...
							<img src="/gfx/standards/loader.gif?r=1765442497" class="b-lazy">
								...
								<iaixsl:attribute name="data-src"><iaixsl:value-of disable-output-escaping="yes" select="$var_icon_small_second"/></iaixsl:attribute>
							</img>
						</picture>
					</iaixsl:when>
					<iaixsl:otherwise>
						<picture>
							<source>
								...
								<iaixsl:attribute name="data-srcset"><iaixsl:value-of disable-output-escaping="yes" select="$var_icon_small"/></iaixsl:attribute>
							</source>
							<img src="/gfx/standards/loader.gif?r=1765442497" class="b-lazy">
								<iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="$var_name"/></iaixsl:attribute>
				...
				<iaixsl:when test="$var_size_min_formatted != $var_size_max_formatted">
						...
						<iaixsl:if test="$var_points != ''">
							<span class="point-price">
								<iaixsl:value-of select="$var_points"/><span class="currency"> iai_i18n:[UGt0].</span>
							</span>
						</iaixsl:if>
					</iaixsl:when>
											...
											<b>
												<iaixsl:choose>
													<iaixsl:when test="available/@status = 'enable'">
														<i class="icon-check"/> iai_i18n:[RG9zdMSZcG55]
													</iaixsl:when>
													<iaixsl:when test="available/@status = 'disable'">
														<i class="icon-remove"/> iai_i18n:[TmllZG9zdMSZcG55]
													</iaixsl:when>
													<iaixsl:when test="available/@status = 'order'">
														<i class="icon-clock"/> iai_i18n:[TmEgemFtw7N3aWVuaWU=]
													</iaixsl:when>
												</iaixsl:choose>
											</b>
											<div class="icon_next">
