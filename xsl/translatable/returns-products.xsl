...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
    ...
    <!-- (returns_products_list, 61f913c82faca4.41878282.6)-->
		...
		<div class="step2">
			...
			<div class="progress__item --rma --second --active d-md-none py-3">
				...
				<div class="progress__text">
					<strong class="progress__name">iai_i18n:[V3liaWVyeiBwcm9kdWt0eSBkbyB6d3JvdHU=]</strong>
				</div>
			</div>
			<h1 class="big_label return_label d-none d-md-block">iai_i18n:[V3liaWVyeiBwcm9kdWt0eSBkbyB6d3JvdHU=]</h1>
			<iaixsl:variable name="return_with_special_offer">iai_i18n:[].</iaixsl:variable>
			...
			<iaixsl:if test="page/products">
				...
				<iaixsl:variable name="allowReturnInfo">iai_i18n:[VGVnbyBwcm9kdWt0dSBuaWUgbW/FvGVzeiB6d3LDs2NpxIc=].</iaixsl:variable>
				<iaixsl:variable name="allowReturnInfoPoint">iai_i18n:[VGVuIHByb2R1a3Qga3VwacWCZcWbIHphIHB1bmt0eSwgZGxhdGVnbyBuaWUgbW/FvGVzeiBnbyB6d3LDs2NpxIc=].</iaixsl:variable>
				<iaixsl:variable name="allowReturnInfoGratis">iai_i18n:[VGVuIHByb2R1a3QgZG9zdGHFgmXFmyB3IGdyYXRpc2llLCBkbGF0ZWdvIG5pZSBtb8W8ZXN6IGdvIHp3csOzY2nEhw==].</iaixsl:variable>

				<form class="returns_productslist --returns" action="/returns-method.php?type=multiproduct" method="post">
					<iaixsl:attribute name="enctype">multipart/form-data</iaixsl:attribute>

					<div id="basketedit_productslist" class="basketedit_productslist return_productslist --returns">
						...
						<table>
							...
							<tr class="basketedit_productslist_label">
								...
								<th colspan="2">
									<span class="sr-only">iai_i18n:[UHJvZHVrdA==]</span>
								</th>
							...
							<iaixsl:for-each select="page/products/product">
								<tr class="productslist_item">
									...
									<td class="productslist_product_name">
										<a class="productslist_product_name__link">
											<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
									...
									<iaixsl:otherwise>
										...
										<div>
											...
											<span class="productslist_quantity">
												<a href="#delQuantity" class="delQuantity"><iaixsl:attribute name="aria-label">iai_i18n:[Wm1uaWVqc3ogaWxvxZvEhw==]</iaixsl:attribute><i class="icon-minus"/></a>
												<input type="text">
													<iaixsl:attribute name="name">set_quantity[<iaixsl:value-of select="position()"/>]</iaixsl:attribute>
												...
												<a href="#addQuantity" class="addQuantity"><iaixsl:attribute name="aria-label">iai_i18n:[WndpxJlrc3ogaWxvxZvEhw==]</iaixsl:attribute><i class="icon-plus"/></a>
									...
									<td class="productslist_product_action">
										...
										<input type="checkbox">
											...
											<iaixsl:attribute name="aria-label">iai_i18n:[V3liaWVyeiB0ZW4gcHJvZHVrdCBkbyB6d3JvdHU=]</iaixsl:attribute>
										</input>
									</td>
								</tr>
								<tr class="productslist_product_action mobile">
									<td class="productslist_product_action mobile" colspan="8">
										<div>
											<a href="#addQuantity" class="addQuantity"><iaixsl:attribute name="aria-label">iai_i18n:[WndpxJlrc3ogaWxvxZvEhw==]</iaixsl:attribute><i class="icon-plus"/></a>
											<a href="#delQuantity" class="delQuantity">iai_i18n:[Wm1uaWVqc3ogaWxvxZvEhw==]<i class="icon-minus"/></a>
										</div>
									</td>
								</tr>
							</iaixsl:for-each>
								...
								<tr class="productslist_tools_bottom">
									<td colspan="5">
										...
										<iaixsl:if test="not($allowReturnInfo) or ($allowReturnInfo and (count(/shop/page/products/product) - count(/shop/page/products/product[@allowReturn='0'])) &gt; 1)">
											<a href="#selectall" class="btn --solid --icon-left icon-plus select_all">iai_i18n:[WmF6bmFjeiB3c3p5c3RraWUgcHJvZHVrdHk=]</a>
										</iaixsl:if>

										<label class="return_product">
											<input type="checkbox" class="return_product_checkbox">
												<iaixsl:if test="/shop/page/remarks"><iaixsl:attribute name="checked">checked</iaixsl:attribute></iaixsl:if>
											</input>
											iai_i18n:[RG9kYWogdXdhZ2kgZG8gendyb3R1]
										</label>
									</td>
								</tr>
							</iaixsl:if>
						...
						<textarea name="return_comment" class="return_comment"><iaixsl:attribute name="aria-label">iai_i18n:[V3Bpc3ogdXdhZ2kgZG8gendyb3R1]</iaixsl:attribute><iaixsl:choose><iaixsl:when test="/shop/page/remarks"><iaixsl:value-of disable-output-escaping="yes" select="/shop/page/remarks"/></iaixsl:when><iaixsl:otherwise><iaixsl:attribute name="style">display:none</iaixsl:attribute></iaixsl:otherwise></iaixsl:choose></textarea>
					</div>
