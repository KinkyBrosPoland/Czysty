...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (newsletter_form, 60dd8e7cdfb471.50282137.5)-->
	<iaixsl:variable name="account_email_info">iai_i18n:[SmVzdGXFmyBqdcW8IHphcGlzYW55IGRvIG5hc3plZ28gbmV3c2xldHRlcmEuIEFkcmVzIGUtbWFpbCBwcnp5cGlzYW55IGRvIFR3b2plZ28ga29udGEgdG8=]</iaixsl:variable>
	<div id="newsletter_form">
		<div class="newsletter_form_label">
			<iaixsl:attribute name="class">newsletter_form_label big_label</iaixsl:attribute>
			<span class="newsletter_form_label">iai_i18n:[TmV3c2xldHRlcg==]</span>
		</div>
			...
			<div class="newsletter_message_wrapper">
				<div class="newsletter_message n54531_outline">
					...
					<div class="n54531_outline_sub">
						<iaixsl:choose>
							<iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_addsuccess'">iai_i18n:[].</iaixsl:when>

							<iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_maileregerror'">iai_i18n:[UG9kYW55IGFkcmVzIGUtbWFpbCBqZXN0IGLFgsSZZG55].</iaixsl:when>

							<iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_removesuccess'">iai_i18n:[VHfDs2ogZS1tYWlsIHpvc3RhxYIgd3lwaXNhbnkgeiBiYXp5IG5ld3NsZXR0ZXJh].</iaixsl:when>

							<iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_nosuchemail'">iai_i18n:[UG9kYW55IGFkcmVzIGUtbWFpbCBuaWUgem9zdGHFgiBvZG5hbGV6aW9ueSB3IGJhemllIG5ld3NsZXR0ZXJh].</iaixsl:when>

							<iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_sendingconfirm'">iai_i18n:[TmEgcG9kYW55IGFkcmVzIHpvc3RhxYIgd3lzxYJhbnkgZS1tYWlsIHphd2llcmFqxIVjeSBsaW5rIGRvIHBvdHdpZXJkemVuaWEgemFwaXNhbmlhIHNpxJkgZG8gbmV3c2xldHRlcmE=].</iaixsl:when>

							<iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_emailexist'">iai_i18n:[UG9kYW55IGFkcmVzIGUtbWFpbCB6bmFqZHVqZSBzacSZIGp1xbwgdyBuYXN6ZWogYmF6aWU=].</iaixsl:when>

							<iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_sendingconfirm_remove'">iai_i18n:[TmEgcG9kYW55IGFkcmVzIHpvc3RhxYIgd3lzxYJhbnkgZS1tYWlsIHphd2llcmFqxIVjeSBsaW5rIGRvIHBvdHdpZXJkemVuaWEgd3lwaXNhbmlhIHNpxJkgeiBuZXdzbGV0dGVyYQ==].</iaixsl:when>
						</iaixsl:choose>
					</div>
				</div>
			</div>
		...
		<iaixsl:choose>
				<iaixsl:when test="not(/shop/page/communicates_newsletter/message) or (/shop/page/communicates_newsletter/message/@type = 'mailing_maileregerror') or (/shop/page/communicates_newsletter/message/@type = 'mailing_emailexist') or (/shop/page/communicates_newsletter/message/@type = 'mailing_nosuchemail')">
					<iaixsl:choose>
										...
										<form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
												...
												<iaixsl:choose>
														<iaixsl:when test="$account_email_info">
																<p class="col-md-6 col-12">iai_i18n:[SmVzdGXFmyBqdcW8IHphcGlzYW55IGRvIG5hc3plZ28gbmV3c2xldHRlcmEuIEFkcmVzIGUtbWFpbCBwcnp5cGlzYW55IGRvIFR3b2plZ28ga29udGEgdG8=] <b><iaixsl:value-of select="/shop/page/client/@email"/></b>. iai_i18n:[VyBrYcW8ZGVqIGNod2lsaSBtb8W8ZXN6IHNpxJkgeiBuaWVnbyB3eXBpc2HEhyBrbGlrYWrEhWMgcG9uacW8c3p5IHByenljaXNr].</p>
														</iaixsl:when>
														<iaixsl:otherwise>
																<p class="col-md-6 col-12">iai_i18n:[SmVzdGXFmyBqdcW8IHphcGlzYW55IGRvIG5hc3plZ28gbmV3c2xldHRlcmEuIFcga2HFvGRlaiBjaHdpbGkgbW/FvGVzeiBzacSZIHogbmllZ28gd3lwaXNhxIcga2xpa2FqxIVjIHBvbmnFvHN6eSBwcnp5Y2lzaw==].</p>
														</iaixsl:otherwise>
												</iaixsl:choose>
												...
												<div class="newsletter_button_wrapper col-md-6 col-12">
														<button id="newsletter_button_remove" type="submit" class="btn --solid --secondary">
																<iaixsl:attribute name="value">iai_i18n:[V3lwaXN6IHNpxJk=]</iaixsl:attribute>iai_i18n:[V3lwaXN6IHNpxJk=]
														</button>
												</div>
										</form>
								</iaixsl:when>
									...
									<iaixsl:choose>
										...
										<iaixsl:when test="/shop/page/client/@email != ''">
											<form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
												...
												<p id="newsletter_longdesc" class="col-md-6 col-12">iai_i18n:[TmllIGplc3RlxZsgemFwaXNhbnkgZG8gbmFzemVnbyBuZXdzbGV0dGVyYS4gSmXFvGVsaSBjaGNlc3ogYnnEhyBpbmZvcm1vd2FueSBvIG5vd2/Fm2NpYWNoIGkgcHJvbW9jamFjaCB3IHNrbGVwaWUsIGtsaWtuaWogbmEgcHJ6eWNpc2sgcG9uacW8ZWouIE5ld3NsZXR0ZXIgYsSZZHppZSB3eXN5xYJhbnkgbmEgYWRyZXM=] <strong><iaixsl:value-of select="page/client/@email"/></strong>, iai_i18n:[a3TDs3J5IHBvZGHFgmXFmyBqYWtvIHN3w7NqIGFkcmVzIGtvbnRha3Rvd3kuIEplxZtsaSBjaGNlc3ogem1pZW5pxIcgYWRyZXMgZS1tYWlsLCBuYSBrdMOzcnkgYsSZZHppZSBwcnp5Y2hvZHppxIcgbmV3c2xldHRlciwgcHJ6ZWpkxbogZG8=] <a href="/loginedit.php?operation=edit">iai_i18n:[ZWR5Y2ppIGRhbnljaCBrb250YWt0b3d5Y2g=]</a></p>
												<input name="mailing_email" type="hidden">
													<iaixsl:attribute name="value"><iaixsl:value-of select="page/client/@email"/></iaixsl:attribute>
												</input>

												<div id="newsletter_privacy_consent" class="f-group --checkbox col-md-6 col-12">
													<input class="newsletter_form_field f-control --validate" name="newsletter_consent" id="newsletter_consent" type="checkbox"/>
													<label class="f-label" for="newsletter_consent">iai_i18n:[Q2hjxJkgb3RyenlteXdhxIcgRS1tYWlsIE5ld3NsZXR0ZXIuIFd5cmHFvGFtIHpnb2TEmSBuYSBwcnpldHdhcnphbmllIG1vaWNoIGRhbnljaCBvc29ib3d5Y2ggZG8gY2Vsw7N3IG1hcmtldGluZ293eWNoIHpnb2RuaWUgeg==] <a><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/private_policy/@url"/></iaixsl:attribute>iai_i18n:[cG9saXR5a8SFIHByeXdhdG5vxZtjaQ==]</a></label>
												</div>

												<div class="newsletter_button_wrapper col-md-6 col-12">
													<button id="newsletter_button_add" type="submit" class="btn --solid">
														<iaixsl:attribute name="value">iai_i18n:[WmFwaXN6IHNpxJk=]</iaixsl:attribute>iai_i18n:[WmFwaXN6IHNpxJk=]
													</button>
												</div>
											</form>
										</iaixsl:when>
										...
										<iaixsl:otherwise>
											<form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
												<input id="mailing_action_contact" name="mailing_action" value="add" type="hidden"/>
												<p id="newsletter_longdesc" class="col-md-6 col-12">iai_i18n:[] <a href="/loginedit.php?operation=edit">iai_i18n:[ZWR5Y2ppIGRhbnljaCBrb250YWt0b3d5Y2g=]</a></p>

												<div class="f-group col-md-6 col-12">
													<div class="f-feedback">
														<input class="newsletter_form_field f-control --validate" name="mailing_email" id="mailing_email" type="text" data-graphql="email" required="required"/>
														<label for="mailing_email" class="f-label">iai_i18n:[UG9kYWogVHfDs2ogZS1tYWls]</label>
												...
												<div class="f-group col-md-6 col-12">
													<div class="f-feedback">
														<input class="newsletter_form_field f-control --validate" name="mailing_name" id="mailing_name" type="text" maxlength="50" minlength="3" required="required">
															<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/client_data/@firstname"/></iaixsl:attribute>
														</input>
														<label for="mailing_name" class="f-label">iai_i18n:[UG9kYWogVHdvamUgaW1pxJk=]</label>
														<span class="f-control-feedback"/>
														<div class="f-message"/>
													</div>
												</div>
												...
												<div class="newsletter_button_wrapper col-md-6 col-12">
													<button id="newsletter_button_add" type="submit" class="btn --solid">iai_i18n:[WmFwaXN6IHNpxJk=]</button>
												</div>
											</form>
										</iaixsl:otherwise>
									</iaixsl:choose>
						...
						<iaixsl:otherwise>
							<form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
								<input id="mailing_action_contact" name="mailing_action" value="add" type="hidden"/>
								<p class="col-md-6 col-12">iai_i18n:[V3Bpc3ogc3fDs2ogYWRyZXMgZS1tYWlsIGkga2xpa25paiBvZHBvd2llZG5pIHByenljaXNrLCBhYnkgemFwaXNhxIcgc2nEmSBsdWIgd3lwaXNhxIcgeiBuYXN6ZWdvIG5ld3NsZXR0ZXJh].</p>
								...
								<div class="newsletter_button_wrapper col-md-6 col-12">
									<button id="newsletter_button_add" type="submit" class="btn --solid">iai_i18n:[WmFwaXN6IHNpxJk=]</button>
									<button id="newsletter_button_remove" type="submit" class="btn --solid --secondary">iai_i18n:[V3lwaXN6IHNpxJk=]</button>
								</div>
							</form>
						</iaixsl:otherwise>
					</iaixsl:choose>
				...
				<iaixsl:otherwise>
					<iaixsl:variable name="newsletter_mainpage_txt">iai_i18n:[U3Ryb25hIGfFgsOzd25h]</iaixsl:variable>
					<div class="newsletter_button_wrapper d-flex justify-content-center">
