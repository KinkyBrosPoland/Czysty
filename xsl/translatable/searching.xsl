...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (searching, 60dd8e8c619242.61646148.7)-->

        <div id="searching">
            <div class="header">
                <h1 class="big_label">
                    iai_i18n:[V3lzenVraXdhcmthIHphYXdhbnNvd2FuYQ==]</h1>
                <div class="info">iai_i18n:[QWJ5IHd5c3p1a2HEhyBpbnRlcmVzdWrEhWN5IENpxJkgcHJvZHVrdCwgd3liaWVyeiBrcnl0ZXJpYSB3eXN6dWtpd2FuaWEuIFd5c3p1a2l3YXJrYSB6YXfEmcW8YSBrcnl0ZXJpYSBkbyBpc3RuaWVqxIVjeWNoIHByb2R1a3TDs3c=].</div>
            </div>
            <div class="menu_messages_warning" id="select_products_info">
                <div class="menu_messages_warning_sub">
                    <p>iai_i18n:[TmllIHpuYWxlemlvbm8gcHJvZHVrdHUuIFd5YmllcnogaW5uZSBrcnl0ZXJpYSB3eXN6dWtpd2FuaWE=].</p>
                </div>
            </div>
            <form action="/search.php" method="get" class="searching_form" id="searching_form">
                ...
                <div id="searchingPreloader1" class="searching_wrapper">
                    <div id="searchingPreloader2" style="z-index: 100; display: none;">iai_i18n:[cHJvc3rEmSBjemVrYcSH]...</div>
                    <div class="searching_top form-group">
                        <div class="searching_text">
                            <label for="searching_text">iai_i18n:[U3p1a2Fq]</label>
                        ...
                        <div class="searching_price">
                            ...
                            <div id="contener3">
                                <div class="n59070_price_sub">
                                    <span class="label">iai_i18n:[Q2VuYSBvZA==]</span>
                                    <iaixsl:if test="$signbeforeprice = 'true'">
                                    ...
                                    <span class="searching_price_sep"> iai_i18n:[ZG8=]</span>
                            ...
                            <div id="contener4">
                                <span class="n59070_price_label">iai_i18n:[UHJvZHVrdHkgdyBjZW5pZQ==]</span>
                        ...
                        <div class="searching_checkboxes">
                            <span class="label">iai_i18n:[U3p1a2FqIHc=]</span>
                            <ul>
                                                                                        ...
                                                                                        <iaixsl:choose>
                                                                                            <iaixsl:when test="@type='duallist'">
                                                                                                <span>
                                                                                                    <select class="searching_duallist searching_ajax searching_ajax_duallist">
                                                                                                        ...
                                                                                                        <option value="">iai_i18n:[b2Q=]</option>
                                                                                                    </select>
                                                                                                </span>
                                                                                                ...
                                                                                                <span>
                                                                                                    <select class="searching_duallist searching_ajax searching_ajax_duallist">
                                                                                                        ...
                                                                                                        <option value=""> iai_i18n:[ZG8=]</option>
                                                                                                    </select>
                                                                                                </span>
                                                                                            ...
                                                                                            <iaixsl:otherwise>
                                                                                                <select>
                                                                                                    ...
                                                                                                    <option value="">iai_i18n:[d3liaWVyeg==]</option>
                                                                                                </select>
                                                                                            </iaixsl:otherwise>
                                                                                        </iaixsl:choose>
                                                                                    </span>
                    ...
                    <div class="searching_button_under">
                        <div class="searching_sort_cont">
                            <span class="searching_sort_text">iai_i18n:[U29ydHVqIHBv]:</span>
                            ...
                            <span class="searching_sort_radios">
                                ...
                                <label for="searching_dsc">iai_i18n:[Um9zbsSFY28=]</label>
                                ...
                                <label for="searching_asc">iai_i18n:[TWFsZWrEhWNv]</label>
                            </span>
                            <button class="btn --solid --medium searching_button_under" type="submit">
                                iai_i18n:[U3p1a2Fq]</button>
                        </div>
                    </div>
                </div>
