...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (menu_filter, 60dd8ecd6c73c9.01119962.15)-->
	...
	<iaixsl:if test="count(/shop/page/products/navigation/filtering/filter)">
		<section id="Filters" class="filters mb-4">
			<iaixsl:attribute name="aria-label">iai_i18n:[RmlsdHJ5]</iaixsl:attribute>
			<form class="filters__form is-validated" method="get">
								...
								<div class="btn --icon-right d-block pr-4">
									<iaixsl:choose>
										<iaixsl:when test="@type = 'dual'">
											<span>iai_i18n:[UG9rYcW8IHR5bGtv]</span>
										</iaixsl:when>
										<iaixsl:otherwise>
											<span><iaixsl:value-of select="@name"/></span>
										</iaixsl:otherwise>
															...
															<span class="--name">
																<iaixsl:if test="@gfx_normal">
																	<img class="--img">
																		...
																		<iaixsl:attribute name="alt">iai_i18n:[R3JhZmlrYQ==] <iaixsl:value-of select="@name"/></iaixsl:attribute>
										...
										<div class="filters__options">
											...
											<iaixsl:if test="count(item) &gt; $showAll and @display = 'name_gfx'">
												<a class="--show-hidden btn py-0 pl-3 pr-0" href="#showHiddenFilters">
													...
													<span class="--show">+ iai_i18n:[Um96d2nFhA==]</span>
													<span class="--hide">- iai_i18n:[VWtyeWo=]</span>
												</a>
											</iaixsl:if>
										</div>
									</iaixsl:when>
													...
													<div class="filters__price">
															...
															<div class="filters__options">
																	<button type="submit" class="btn p-md-0 mt-md-2">
																			iai_i18n:[WmFzdG9zdWogemFrcmVzIGNlbg==]
																	</button>
															</div>
													</div>
										</div>
												...
												<li class="filters__item mb-2">
													<div class="f-group --small --checkbox mb-0">
														...
														<label class="f-label">
															...
															<span class="--name">
																<iaixsl:choose>
																	<iaixsl:when test="@desc = '1week'">iai_i18n:[T3N0YXRuaSB0eWR6aWXFhA==]</iaixsl:when>
																	<iaixsl:when test="@desc = '1month'">iai_i18n:[T3N0YXRuaSBtaWVzacSFYw==]</iaixsl:when>
																	<iaixsl:when test="@desc = '3months'">iai_i18n:[T3N0YXRuaWUgMyBtaWVzacSFY2U=]</iaixsl:when>
																	<iaixsl:when test="@desc = '6months'">iai_i18n:[T3N0YXRuaWUgcMOzxYIgcm9rdQ==]</iaixsl:when>
																	<iaixsl:when test="@desc = '1year'">iai_i18n:[T3N0YXRuaSByb2s=]</iaixsl:when>
																</iaixsl:choose>
															</span>
				...
				<iaixsl:if test="/shop/page/products/navigation/filtering/filter[@type='dual'] and ($samedayCouriersAvail = 'true' and $samedayClientLocal = 'false') or ($samedayCouriersAvail = 'true' and $samedayClientLocal = 'true' and $samedayServiceAvail = 'true') or ($nextdayCouriersAvail = 'true' and $nextdayClientLocal = 'false') or ($nextdayCouriersAvail = 'true' and $nextdayClientLocal = 'true' and $nextdayServiceAvail = 'true')">
					...
					<div class="filters__block mb-1">
						<button class="filters__toggler">
							...
							<div class="btn --icon-right d-block pr-4">
								<span>iai_i18n:[RWtzcHJlc293YSBkb3N0YXdh]</span>
							</div>
						</button>
									...
									<li class="filters__item mb-2">
										<div class="f-group --small --checkbox mb-0">
											...
											<label for="filter_nextday_form" class="f-label">
												...
												<span class="--name">
													iai_i18n:[TmFzdMSZcG5lZ28gZG5pYQ==] <strong>iai_i18n:[MjRo]</strong>
												</span>
											</label>
										</div>
									</li>
									...
									<li class="filters__item mb-2">
										<div class="f-group --small --checkbox mb-0">
											...
											<label for="filter_sameday_form" class="f-label">
												...
												<span class="--name">
													iai_i18n:[VGVnbyBzYW1lZ28gZG5pYQ==] <i class="icon-clock"/>
												</span>
											</label>
										</div>
									</li>
				...
				<div class="f-group filters__buttons mt-3">
					...
					<button type="submit" class="btn --large --solid d-block">
						<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiBhYnkgemFzdG9zb3dhxIcgd3licmFuZSBmaWx0cnk=]</iaixsl:attribute>
						iai_i18n:[WmFzdG9zdWogd3licmFuZSBmaWx0cnk=]
					</button>
					...
					<iaixsl:if test="(/shop/page/products/navigation/filtering/filter/item/@selected='selected') or count(/shop/page/products/navigation/filtering/filter/@selected)">
						<a class="btn d-block" href="/settings.php?filter_remove=all">
							...
							<iaixsl:attribute name="title">iai_i18n:[S2xpa25paiBhYnkgd3ljennFm2NpxIcgbGlzdMSZIGFrdHl3bnljaCBmaWx0csOzdw==]</iaixsl:attribute>
							iai_i18n:[VXN1xYQgd3N6eXN0a2llIGZpbHRyeQ==]
						</a>
					</iaixsl:if>
				</div>
			</form>
		...
		<iaixsl:if test="(/shop/page/sameday/@couriers_available = 'true' and /shop/page/sameday/@client_localized = 'false') or (/shop/page/nextday/@couriers_available = 'true' and /shop/page/nextday/@client_localized = 'false')">
			<div id="xpress_modal" class="xpress">
				<h2 class="headline">
					<span class="headline__name">iai_i18n:[TG9rYWxpemFjamE=]</span>
				</h2>
				<div class="xpress__zipcode mb-3">
					<p class="xpress__text mb-3">iai_i18n:[UG9kYWoga29kIHBvY3p0b3d5IGFkcmVzdSBkb3N0YXd5]</p>
					<div class="f-group">
						<div class="f-feedback">
							...
							<label class="f-label">iai_i18n:[S29kIHBvY3p0b3d5]</label>
							<span class="f-control-feedback"/>
						</div>
					</div>
					<div class="xpress__submit_zipcode">
						<button class="xpress_submit btn --solid --medium" type="button">iai_i18n:[WmF0d2llcmTFug==]</button>
					</div>
				</div>
				<div class="xpress__geolocation">
					<p class="xpress__text mb-3">iai_i18n:[bHViIHVkb3N0xJlwbmlqIHBvxYJvxbxlbmllLCBhYnnFm215IG1vZ2xpIG9rcmXFm2xpxIcgY3p5IGRsYSB0ZWdvIG1pZWpzY2EgZG9zdMSZcG5hIGplc3QgZG9zdGF3YSBla3NwcmVzb3dh]</p>
					<button class="xpress__get_geo btn --solid --medium --secondary" type="button">iai_i18n:[VWRvc3TEmXBuaWogcG/Fgm/FvGVuaWU=]</button>
				</div>
			</div>
			<div id="xpress_error_modal" class="xpress_error">
				...
				<p class="xpress_error__text mb-2">iai_i18n:[UHJ6eWtybyBuYW0sIGFsZSBuYXN6IGVrc3ByZXNvd3kga3VyaWVyIG5pZSBvYnPFgnVndWplIHRlaiBva29saWN5].</p>
				<p class="xpress_error__text">iai_i18n:[VHdvamUgemFtw7N3aWVuaWUgem9zdGFuaWUgZG9zdGFyY3pvbmUgdyBzdGFuZGFyZG93eW0gY3phc2llLCBhIGt1cmllcmEgd3liaWVyemVzeiBwb2RjemFzIHNrxYJhZGFuaWEgemFtw7N3aWVuaWE=].</p>
			</div>
		</iaixsl:if>
	</iaixsl:if>
	...
	<iaixsl:if test="/shop/page/products/navigation/filtering/filter/@id='filter_instock'"> </iaixsl:if>
        ...
        <!-- (subscription_settings, 67daae3113c1a7.37972376.6)-->
	<script class="ajaxLoad">window.subscrXMLData = {
		id: <iaixsl:value-of select="/shop/page/subscription/@id"/>,
		wholesaler: <iaixsl:value-of select="/shop/basket/@wholesaler = 'true'"/>,
	};</script>
	<div class="subscription_settings subscr">
		
		<div class="subscr__step --full" data-skeleton="return">
			<div class="subscr__skeleton --label"/>
		</div>
		
		<div class="subscr__step --full" data-skeleton="status">
			<div class="subscr__skeleton --label"/>
		</div>
		
		<div class="subscr__step --full" data-skeleton="info">
			<div class="subscr__skeleton --label"/>
		</div>
		<div class="subscr__content">
			
			<div class="subscr__step" data-skeleton="products">
				<div class="subscr__skeleton --label"/>
				<div class="subscr__skeleton --content"/>
			</div>
			
			<div class="subscr__step" data-skeleton="add">
				<div class="subscr__skeleton --label"/>
				<div class="subscr__skeleton --content"/>
			</div>
			
			<div class="subscr__step" data-skeleton="rebates">
				<div class="subscr__skeleton --label"/>
				<div class="subscr__skeleton --content"/>
			</div>
			
			<div class="subscr__step" data-skeleton="renewals">
				<div class="subscr__skeleton --label"/>
				<div class="subscr__skeleton --content"/>
			</div>
		</div>
		<div class="subscr__summary">
			
			<div class="subscr__step" data-skeleton="code">
				<div class="subscr__skeleton --small"/>
			</div>
			
			<div class="subscr__step" data-skeleton="upcoming">
				<div class="subscr__skeleton --small"/>
			</div>
			
			<div class="subscr__step" data-skeleton="period">
				<div class="subscr__skeleton --small"/>
			</div>
			
			<div class="subscr__step" data-skeleton="address">
				<div class="subscr__skeleton --small"/>
			</div>
			
			<div class="subscr__step" data-skeleton="payments">
				<div class="subscr__skeleton --content"/>
			</div>
			
			<div class="subscr__step" data-skeleton="deliveries">
				<div class="subscr__skeleton --content"/>
			</div>
			
			<div class="subscr__step" data-skeleton="remarks">
				<div class="subscr__skeleton --content"/>
			</div>
			
			<div class="subscr__step" data-skeleton="unsubscribe">
				<div class="subscr__skeleton --small"/>
			</div>
		</div>
	</div>

	<div id="subscr_templates_wrapper">


  	
  	<template id="subscr_return_template">
  		<div class="subscr__return subscr_return">
  			<a class="subscr_return__link">
  				<iaixsl:choose>
  					<iaixsl:when test="/shop/page/subscription/@status = 'finished'">
  						<iaixsl:attribute name="class">subscr_return__link --terminated</iaixsl:attribute>
  						<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_terminated/@url"/></iaixsl:attribute>iai_i18n:[V3LDs8SHIGRvIGxpc3R5IHpha2/FhGN6b255Y2ggc3Vic2tyeXBjamk=]
  					</iaixsl:when>
  					<iaixsl:otherwise>
  						<iaixsl:attribute name="class">subscr_return__link --active</iaixsl:attribute>
  						<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_active/@url"/></iaixsl:attribute>iai_i18n:[V3LDs8SHIGRvIGxpc3R5IGFrdHl3bnljaCBzdWJza3J5cGNqaQ==]
  					</iaixsl:otherwise>
  				</iaixsl:choose>
  			</a>
  		</div>
		...
		<template id="subscr_status_template">
			<div class="subscr__status subscr_status">
				<iaixsl:variable name="subscriptionLabelText">iai_i18n:[U3Vic2tyeXBjamEgbnIgJXM=]</iaixsl:variable>
				<iaixsl:variable name="subscriptionId"><iaixsl:value-of select="/shop/page/subscription/@id"/></iaixsl:variable>
				<h1 class="headline">
					<span class="headline__name"><iaixsl:value-of select="php:function('sprintf', $subscriptionLabelText, $subscriptionId)"/></span>
				</h1>
				<div class="subscr_status__info">
					<strong class="subscr_status__info_text"/>
				</div>
			</div>
		</template>

		
		<template id="subscr_info_template">
			<div class="subscr__info subscr_info"/>
		</template>
		<template id="subscr_info_item_template">
			<div class="subscr_info__item --small"/>
		</template>

		
		<template id="subscr_products_template">
			<div class="subscr_products">
				<h2 class="subscr__title"/>
				<div class="subscr_products__wrapper">
					<div class="subscr_products__items"/>
					<div class="subscr_products__more">
						<a class="subscr_products__more_link" href="#moreProducts"/>
					</div>
				</div>
			</div>
		</template>
		<template id="subscr_products_summary_template">
			<div class="subscr_products__summary">
				<div class="subscr_products__summary_item --costs subscr_costs">
					
					<div class="subscr_costs__item --worth">
						<span class="subscr_costs__label">iai_i18n:[V2FydG/Fm8SHIHphbcOzd2llbmlh]:</span>
						<strong class="subscr_costs__value"/>
					</div>
					
					<div class="subscr_costs__item --worth-points">
						<span class="subscr_costs__label">iai_i18n:[V2FydG/Fm8SHIHphbcOzd2llbmlhIHcgcHVua3RhY2g=]:</span>
						<strong class="subscr_costs__value"/>
					</div>
					
					<div class="subscr_costs__item --rebate">
						<span class="subscr_costs__label">iai_i18n:[UmFiYXQ=]:</span>
						<strong class="subscr_costs__value --minus"/>
					</div>
					
					<div class="subscr_costs__item --paymentcost">
						<span class="subscr_costs__label">iai_i18n:[S29zenQgcMWCYXRub8WbY2k=]:</span>
						<strong class="subscr_costs__value --plus"/>
					</div>
					
					<div class="subscr_costs__item --shipping">
						<span class="subscr_costs__label">iai_i18n:[S29zenQgcHJ6ZXN5xYJraQ==]:</span>
						<strong class="subscr_costs__value --plus"/>
					</div>
					
					<div class="subscr_costs__item --insurance">
						<span class="subscr_costs__label">iai_i18n:[S29zenQgdWJlenBpZWN6ZW5pYQ==]:</span>
						<strong class="subscr_costs__value --plus"/>
					</div>
				</div>
				
				<div class="subscr_products__summary_item --accept subscr_summary_accept">
					
					<div class="subscr_summary_accept__item --before">
						<span class="subscr_summary_accept__label">iai_i18n:[RG8gemFwxYJhdHkgb2QgbmFqYmxpxbxzemVnbyBvZG5vd2llbmlhIHByemVkIHptaWFuxIUgY2VueQ==]:</span>
						<del class="subscr_summary_accept__value"/>
					</div>
					
					<div class="subscr_summary_accept__item --after">
						<span class="subscr_summary_accept__label">iai_i18n:[RG8gemFwxYJhdHkgb2QgbmFqYmxpxbxzemVnbyBvZG5vd2llbmlhIHBvIHptaWFuaWUgY2VueQ==]:</span>
						<strong class="subscr_summary_accept__value"/>
					</div>
				</div>
				<div class="subscr_products__summary_item --total subscr_total">
					<div class="subscr_total__item --value">
						<span class="subscr_total__label">iai_i18n:[RG8gemFwxYJhdHkgb2QgbmFqYmxpxbxzemVnbyBvZG5vd2llbmlh]:</span>
						<strong class="subscr_total__value"/>
					</div>
					<div class="subscr_total__item --points">
						<strong class="subscr_total__value --plus"/>
					</div>
				</div>
			</div>
		</template>
		<template id="subscr_products_accept_template">
			<div class="subscr_products__accept subscr_accept">
				<div class="subscr_accept__diff"/>
				<button class="subscr_accept__button btn --solid --large">iai_i18n:[QWtjZXB0dWogbm93xIUgY2VuxJk=]</button>
				<div class="subscr_accept__info"/>
			</div>
		</template>
		<template id="subscr_product_template">
			<div class="subscr_products__item subscr_product">
				<div class="subscr_product__photo">
					<a class="subscr_product__icon"><img loading="lazy"/></a>
				</div>
				<div class="subscr_product__details">
					<a class="subscr_product__name"/>
					<div class="subscr_product__traits">
						<div class="subscr_product__trait --quantity">
							<span class="subscr_product__trait_label">iai_i18n:[SWxvxZvEhw==]: </span>
							<span class="subscr_product__trait_value"/>
						</div>
						<div class="subscr_product__trait --barcode">
							<span class="subscr_product__trait_label">iai_i18n:[U3ltYm9s]: </span>
							<span class="subscr_product__trait_value"/>
						</div>
						<div class="subscr_product__trait --size">
							<span class="subscr_product__trait_label">iai_i18n:[Um96bWlhcg==]: </span>
							<span class="subscr_product__trait_value"/>
						</div>
						<div class="subscr_product__trait --version">
							<span class="subscr_product__trait_label"/>
							<span class="subscr_product__trait_value"/>
						</div>
					</div>
					<div class="subscr_product__bundle">
						<span class="subscr_product__bundle_label">iai_i18n:[U2vFgmFkb3dlIHplc3Rhd3U=]: </span>
						<div class="subscr_product__bundle_items"/>
					</div>
					<div class="subscr_product__version">
						<span class="subscr_product__version_label"/>
						<button type="button" class="subscr_product__version_value"/>
					</div>
					<div class="subscr_product__remove d-none d-md-block">
						<a href="#removeProduct" class="subscr_product__remove_link">iai_i18n:[VXN1xYQgeiBzdWJza3J5cGNqaQ==]</a>
					</div>
				</div>
				<div class="subscr_product__remove d-md-none">
					<a href="#removeProduct" class="subscr_product__remove_link">iai_i18n:[VXN1xYQgeiBzdWJza3J5cGNqaQ==]</a>
				</div>
				<div class="subscr_product__quantity">
					<select class="subscr_product__select f-select">
					  <iaixsl:attribute name="aria-label">iai_i18n:[SWxvxZvEhyBwcm9kdWt0w7N3]</iaixsl:attribute>
						...
						<option data-more="true">iai_i18n:[d2nEmWNlag==]</option>
					</select>
					<div class="subscr_product__more">
						<input class="subscr_product__input" type="number" name="set_quantity" value="1">
					    <iaixsl:attribute name="aria-label">iai_i18n:[V3Bpc3ogaWxvxZvEhw==]</iaixsl:attribute>
				    </input>
					</div>
				</div>
				<div class="subscr_product__sum">
					<strong class="subscr_product__sum_value"/>
					<span class="subscr_product__sum_period"/>
				</div>
			</div>
		</template>
		<template id="subscr_change_product_version_template">
			<div class="subscr_change_product_version">
				<strong class="subscr_change_product_version__label">iai_i18n:[Wm1pZcWEIHdhcmlhbnQgcHJvZHVrdHU=]</strong>
				<div class="subscr_change_product_version__select_wrapper">
					<span class="subscr_change_product_version__sub_label">iai_i18n:[V3liaWVyeiByb3ptaWFy]</span>
					<select class="subscr_change_product_version__select f-select"/>
				</div>
				<div class="subscr_change_product_version__buttons subscr_modal_buttons">
					<button type="button" class="subscr_change_product_version__button btn --outline --large --return">iai_i18n:[V3LDs8SH]</button>
					<button type="button" class="subscr_change_product_version__button btn --solid --large --edit">iai_i18n:[Wm1pZcWE]</button>
				</div>
			</div>
		</template>

		
		<template id="subscr_add_template">
			<div class="subscr_add">
				<h3 class="subscr__title">iai_i18n:[RG9kYWogZG8gc3Vic2tyeXBjamk=]</h3>
				<div class="subscr_add__search">
					<input class="subscr_add__search_input" type="text" name="search_product" autocomplete="off">
						<iaixsl:attribute name="placeholder">iai_i18n:[V3lzenVrYWogaW5uZSBwcm9kdWt0eQ==]</iaixsl:attribute>
						<iaixsl:attribute name="aria-label">iai_i18n:[V3lzenVrYWogaW5uZSBwcm9kdWt0eQ==]</iaixsl:attribute>
					</input>
					<button class="subscr_add__search_submit" type="button">
						<iaixsl:attribute name="aria-label">iai_i18n:[U3p1a2Fq]</iaixsl:attribute>
					</button>
					<button class="subscr_add__search_clear" type="button">
						<iaixsl:attribute name="aria-label">iai_i18n:[V3ljennFm8SHIHRla3N0]</iaixsl:attribute>
					</button>
				</div>
				<div class="subscr_add__block">
					<div class="subscr_add__products swiper">
						<div class="subscr_add__products_wrapper swiper-wrapper"/>
						<div class="subscr_add__navigation">
							<a href="#prevSlide" class="subscr_add__navigation_button --prev"><i class="icon-angle-left"/></a>
							<a href="#nextSlide" class="subscr_add__navigation_button --next"><i class="icon-angle-right"/></a>
						</div>
					</div>
				</div>
				<div class="subscr_add__not_found">
					<strong>iai_i18n:[TmllIHpuYWxlemlvbm8gcHJvZHVrdMOzdw==]</strong>
				</div>
			</div>
		</template>
		<template id="subscr_add_product_template">
			<div class="subscr_add__product subscr_add_product swiper-slide">
				<a class="subscr_add_product__icon" tabindex="-1"><img loading="lazy"/></a>
				<div class="subscr_add_product__info">
					<a class="subscr_add_product__name"/>
					<span class="subscr_add_product__size">
						<span class="subscr_add_product__size_label">iai_i18n:[Um96bWlhcg==]: </span>
						<span class="subscr_add_product__size_name"/>
					</span>
					<strong class="subscr_add_product__price"/>
					<button type="button" class="subscr_add_product__button btn --outline --medium">iai_i18n:[RG9kYWo=]</button>
				</div>
			</div>
		</template>
		<template id="subscr_add_product_modal_template">
			<div class="subscr_add_product_modal">
				<strong class="subscr_add_product_modal__label">iai_i18n:[RG9kYWogcHJvZHVrdA==]</strong>
				<div class="subscr_add_product_modal__details">
					<a class="subscr_add_product_modal__icon" tabindex="-1"><img loading="lazy"/></a>
					<div class="subscr_add_product_modal__info">
						<a class="subscr_add_product_modal__name" tabindex="-1"/>
						<span class="subscr_add_product_modal__size">
							<span class="subscr_add_product_modal__size_label">iai_i18n:[Um96bWlhcg==]: </span>
							<span class="subscr_add_product_modal__size_name"/>
						</span>
					</div>
				</div>
				<div class="subscr_add_product_modal__price_wrapper">
					<strong class="subscr_add_product_modal__price_label">iai_i18n:[U3Vic2tyeXBjamE=]</strong>
					<strong class="subscr_add_product_modal__price"/>
					<span class="subscr_add_product_modal__rebate"/>
				</div>
				<div class="subscr_add_product_modal__buttons subscr_modal_buttons">
					<div class="subscr_add_product_modal__quantity">
						<select class="subscr_add_product_modal__select f-select">
					    <iaixsl:attribute name="aria-label">iai_i18n:[SWxvxZvEhyBwcm9kdWt0w7N3]</iaixsl:attribute>
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
						...
						<div class="subscr_add_product_modal__more">
							<input class="subscr_add_product_modal__input" type="number" name="set_quantity" value="1">
  					    <iaixsl:attribute name="aria-label">iai_i18n:[V3Bpc3ogaWxvxZvEhw==]</iaixsl:attribute>
  				    </input>
						</div>
					</div>
					<button type="button" class="subscr_add_product_modal__button btn --solid --large">iai_i18n:[RG9kYWogZG8gemFtw7N3aWVuaWE=]</button>
				</div>
			</div>
		</template>

		
		<template id="subscr_rebates_template">
			<div class="subscr_rebates">
				<h3 class="subscr__title">iai_i18n:[UmFiYXR5IGRvIHphbcOzd2llbmlh]</h3>
				<strong class="subscr_rebates__current"/>
				<p class="subscr_rebates__info"/>
				<div class="subscr_rebates__progress">
					<div class="subscr_rebates__progress_info">
						<span class="subscr_rebates__progress_renewal"/>
						<strong class="subscr_rebates__progress_discount"/>
					</div>
					<div class="subscr_rebates__progress_bar">
						<span class="subscr_rebates__progress_rate"/>
					</div>
				</div>
				<div class="subscr_rebates__steps">
					<span class="subscr_rebates__steps_label">iai_i18n:[S29sZWpuZSBwcm9naQ==]:</span>
					<div class="subscr_rebates__steps_wrapper"/>
				</div>
			</div>
		</template>
		<template id="subscr_rebates_steps_template">
			<span class="subscr_rebates__step"/>
		</template>

		
		<template id="subscr_renewals_template">
			<div class="subscr_renewals">
				<iaixsl:variable name="subscriptionRenewalsTitle">iai_i18n:[SGlzdG9yaWEgemFtw7N3aWXFhCBTdWJza3J5cGNqaSBuciAlcw==]</iaixsl:variable>
				<iaixsl:variable name="subscriptionId"><iaixsl:value-of select="/shop/page/subscription/@id"/></iaixsl:variable>
				<h3 class="subscr__title"><iaixsl:value-of select="php:function('sprintf', $subscriptionRenewalsTitle, $subscriptionId)"/></h3>
				<div class="subscr_renewals__items"/>
				<div class="subscr_renewals__more">
					<a href="#showMoreRenewals" class="subscr_renewals__more_link">iai_i18n:[UG9rYcW8IHdpxJljZWo=]</a>
				</div>
			</div>
		</template>
		<template id="subscr_renewal_template">
			<div class="subscr_renewal">
				<strong class="subscr_renewal__id"/>
					<div class="subscr_renewal__order">
						<a href="#showOrderDetails" class="subscr_renewal__order_link" target="_blank"/>
						<span class="subscr_renewal__order_date"/>
					</div>
					<span class="subscr_renewal__status"/>
					<div class="subscr_renewal__details">
						<strong class="subscr_renewal__price"/>
						<div class="subscr_renewal__card">
							<span class="subscr_renewal__card_icon"><img loading="lazy"/></span>
							<span class="subscr_renewal__card_number"/>
						</div>
						<div class="subscr_renewal__documents"/>
					</div>
			</div>
		</template>

		
		<template id="subscr_rebate_code_template">
			<div class="subscr_rebate_code subscr_summary_block">
				<strong class="subscr_rebate_code__label">iai_i18n:[S29kIHJhYmF0b3d5]</strong>
				<a href="#addCode" class="subscr_rebate_code__add subscr_summary_block__link">iai_i18n:[RG9kYWo=]</a>
				<div class="subscr_rebate_code__field f-group --field" aria-hidden="true">
					<div class="subscr_rebate_code__input_wrapper f-feedback">
						<input id="rebate_code_input" type="text" class="subscr_rebate_code__input f-control" name="rebates_codes" disabled="disabled">
							<iaixsl:attribute name="aria-label">iai_i18n:[V3Bpc3oga29kIHJhYmF0b3d5]</iaixsl:attribute>
						</input>
						<div class="f-message"/>
					</div>
					<button type="button" class="subscr_rebate_code__save" tabindex="-1">
					  <iaixsl:attribute name="aria-label">iai_i18n:[WmF0d2llcmTFuiBrb2QgcmFiYXRvd3k=]</iaixsl:attribute>
  			  </button>
				</div>
				<div class="subscr_rebate_code__message" aria-hidden="true">
					<strong class="subscr_rebate_code__text"/>
					<span class="subscr_rebate_code__info"/>
					<div class="subscr_rebate_code__links">
						<a href="#editRemarkMessage" class="subscr_rebate_code__link --edit" tabindex="-1">iai_i18n:[RWR5dHVq]</a>
						<a href="#removeRemarkMessage" class="subscr_rebate_code__link --remove" tabindex="-1">iai_i18n:[VXN1xYQ=]</a>
					</div>
				</div>
			</div>
		</template>
		...
		<template id="subscr_upcoming_template">
			<div class="subscr_upcoming subscr_summary_block">
				<span class="subscr_upcoming__label">iai_i18n:[RGF0YSBuYWpibGnFvHN6ZWogZG9zdGF3eQ==]:</span>
				<a href="#editUpcoming" class="subscr_upcoming__edit subscr_summary_block__link">iai_i18n:[RWR5dHVq]</a>
				<strong class="subscr_upcoming__value"/>
				<div class="subscr_upcoming__suspended">
					<strong class="subscr_upcoming__suspended_label">iai_i18n:[U3Vic2tyeXBjamEgd3N0cnp5bWFuYQ==]</strong>
					<button type="button" class="subscr_upcoming__suspended_button btn --solid --large">iai_i18n:[V3puw7N3IHN1YnNrcnlwY2rEmQ==]</button>
				</div>
			</div>
		</template>
		<template id="subscr_change_upcoming_template">
			<div class="subscr_change_upcoming">
				<strong class="subscr_change_upcoming__label">iai_i18n:[RGF0YSBuYWpibGnFvHN6ZWogZG9zdGF3eQ==]</strong>
				<p class="subscr_change_upcoming__info_text">iai_i18n:[Wm1pYW5hIGRhdHkgd3licmFuZWogZG9zdGF3eSB3cMWCeW5pZSBuYSBkYXR5IGtvbGVqbnljaCB3ZWTFgnVnIHVzdGF3aW9uZWogY3lrbGljem5vxZtjaQ==].</p>
				<div class="subscr_change_upcoming__calendar"/>
				<div class="subscr_change_upcoming__buttons subscr_modal_buttons">
					<button type="button" class="subscr_change_upcoming__button btn --solid --large">iai_i18n:[UHJ6ZcWCw7PFvA==]</button>
				</div>
			</div>
		</template>
		<template id="subscr_upcoming_info_template">
			<div class="subscr_upcoming_info">
				<strong class="subscr_change_upcoming__label">iai_i18n:[TmFqYmxpxbxzemUgemFtw7N3aWVuaWUgem9zdGHFgm8ganXFvCB1dHdvcnpvbmU=]</strong>
				<div class="subscr_upcoming_info__details">
					<div class="subscr_upcoming_info__item --upcoming">
						<strong class="subscr_upcoming_info__date"/>
						<div class="subscr_upcoming_info__description"><b>iai_i18n:[TmFqYmxpxbxzemEgZG9zdGF3YQ==]</b> - iai_i18n:[emFtw7N3aWVuaWUgdyB0cmFrY2llIHJlYWxpemFjamkuIE5pZSBtb8W8ZXN6IGp1xbwgZ28gZWR5dG93YcSH].</div>
					</div>
					<div class="subscr_upcoming_info__item --next">
						<strong class="subscr_upcoming_info__date"/>
						<div class="subscr_upcoming_info__description">iai_i18n:[S29sZWpuYSBkb3N0YXdh] - iai_i18n:[bW/FvGVzeiBlZHl0b3dhxIcgdG8gemFtw7N3aWVuaWU=].</div>
					</div>
				</div>
				<div class="subscr_upcoming_info__buttons subscr_modal_buttons">
					<button type="button" class="subscr_upcoming_info__button btn --solid --large">iai_i18n:[Um96dW1pZW0=]</button>
				</div>
			</div>
		</template>

		
		<template id="subscr_period_template">
			<div class="subscr_period subscr_summary_block">
				<span class="subscr_period__label">iai_i18n:[V3lzecWCa2EgY28=]:</span>
				<a href="#editPeriod" class="subscr_period__edit subscr_summary_block__link">iai_i18n:[RWR5dHVq]</a>
				<strong class="subscr_period__value"/>
			</div>
		</template>
		<template id="subscr_change_period_template">
			<div class="subscr_change_period">
				<strong class="subscr_change_period__label">iai_i18n:[Wm1pZcWEIGN6xJlzdG90bGl3b8WbxIcgd3lzecWCa2k=]</strong>
				<span class="subscr_change_period__days_label">iai_i18n:[V3lzecWCa2EgY28=]:</span>
				<div class="subscr_change_period__days"/>
				<div class="subscr_change_period__buttons subscr_modal_buttons">
					<button type="button" class="subscr_change_period__button btn --outline --large --return">iai_i18n:[V3LDs8SH]</button>
					<button type="button" class="subscr_change_period__button btn --solid --large --edit">iai_i18n:[Wm1pZcWE]</button>
				</div>
			</div>
		</template>
		<template id="subscr_change_period_day_template">
			<button class="subscr_change_period__day"/>
		</template>

		
		<template id="subscr_address_template">
			<div class="subscr_address subscr_summary_block">
				<span class="subscr_address__label subscr_summary_block__label">iai_i18n:[RGFuZSBkbyB6YW3Ds3dpZW5pYQ==]</span>
				<a href="#editAddress" class="subscr_address__edit subscr_summary_block__link">iai_i18n:[RWR5dHVq]</a>
				<span class="subscr_address__value">iai_i18n:[QWRyZXMgZG9zdGF3eSwgZGFuZSB6YW1hd2lhasSFY2VnbyBpIGRhbmUgbmEgZmFrdHVyemU=]</span>
			</div>
		</template>
		<template id="subscr_address_modal_template">
			<div class="subscr_address_modal">
				<strong class="subscr_address_modal__label">iai_i18n:[RGFuZSBkbyB6YW3Ds3dpZW5pYQ==]</strong>
				<div class="subscr_address_modal__block"/>
			</div>
		</template>
		<template id="subscr_address_modal_item_template">
			<div class="subscr_address_modal__item">
				<h5 class="subscr_address_modal__item_label"/>
				<div class="subscr_address_modal__data">
					<span class="subscr_address_modal__data_item --firm"/>
					<span class="subscr_address_modal__data_item --name"/>
					<span class="subscr_address_modal__data_item --stock"/>
					<span class="subscr_address_modal__data_item --street"/>
					<span class="subscr_address_modal__data_item --city"/>
					<span class="subscr_address_modal__data_item --nip"/>
					<span class="subscr_address_modal__data_item --phone"/>
					<span class="subscr_address_modal__data_item --email"/>
					<a href="#editAddress" class="subscr_address_modal__edit">iai_i18n:[RWR5dHVq]</a>
				</div>
			</div>
		</template>
		<template id="subscr_edit_address_modal_template">
			<form class="subscr_edit_address_modal">
				<strong class="subscr_edit_address_modal__label"/>
				
				<div class="subscr_edit_address_modal__switch subscr_switch">
					<span class="subscr_switch__label">iai_i18n:[WmFtYXdpYXN6IGpha28=]:</span>
					<div class="subscr_switch__radio --private f-group --radio">
						<input type="radio" id="client_type_private" value="private" name="type" class="f-control" data-name="type" checked="checked"/>
						<label class="f-label" for="client_type_private">iai_i18n:[T3NvYmEgcHJ5d2F0bmE=]</label>
					</div>
					<div class="subscr_switch__radio --firm f-group --radio">
						<input type="radio" id="client_type_firm" value="firm" name="type" class="f-control" data-name="type"/>
						<label class="f-label" for="client_type_firm">iai_i18n:[RmlybWE=]</label>
					</div>
				</div>
				<div class="subscr_edit_address_modal__inputs subscr_inputs f-group">
					
					<input type="hidden" name="region" data-name="region"/>
					
					<input type="hidden" name="id" data-name="id"/>
					
					<input type="hidden" name="editable" data-name="editable"/>
					
					<div class="subscr_inputs__item --firm f-feedback --hidden" data-firm="show">
						<input id="client_firm" type="text" class="f-control --validate" name="firm" data-graphql="firm" required="required" data-name="firm" autocomplete="organization" disabled="disabled"/>
						<label for="client_firm" class="f-label">iai_i18n:[TmF6d2EgZmlybXk=]</label>
						<span class="f-control-feedback"/>
						<div class="f-message"/>
					</div>
					
					<div class="subscr_inputs__item --nip f-feedback --hidden" data-firm="show">
						<input id="client_nip" type="text" class="f-control --validate" name="nip" data-name="nip" data-graphql="nip" required="required" data-region="" disabled="disabled"/>
						<label for="client_nip" class="f-label">iai_i18n:[TklQ]</label>
						<span class="f-control-feedback"/>
						<div class="f-message"/>
					</div>
					
					<div class="subscr_inputs__item --firstname f-feedback">
						
						<input id="client_firstname" type="text" class="f-control --validate" data-name="firstname" name="firstname" required="required" autocomplete="given-name"/>
						<label for="client_firstname" class="f-label">iai_i18n:[SW1pxJk=]</label>
						<span class="f-control-feedback"/>
						<div class="f-message"/>
					</div>
					
					<div class="subscr_inputs__item --lastname f-feedback">
						<input id="client_lastname" type="text" class="f-control --validate" name="lastname" data-graphql="lastname" data-name="lastname" required="required" autocomplete="family-name"/>
						<label for="client_lastname" class="f-label">iai_i18n:[TmF6d2lza28=]</label>
						<span class="f-control-feedback"/>
						<div class="f-message"/>
					</div>
					
					<div class="subscr_inputs__item --street f-feedback">
						<input id="client_street" type="text" class="f-control --validate" name="street" required="required" data-graphql="street" data-concat-from="#client_street_number" data-name="street" autocomplete="address-line1" data-region=""/>
						<label for="client_street" class="f-label">iai_i18n:[VWxpY2E=]</label>
						<span class="f-control-feedback"/>
						<div class="f-message"/>
					</div>
					
					<div class="subscr_inputs__item --street-number f-feedback ">
						<input id="client_street_number" type="text" class="f-control --validate" name="streetNumber" data-concat-to="#client_street" data-name="streetNumber"/>
						<label for="client_street_number" class="f-label">iai_i18n:[TnIgZG9tdSAvIGxva2FsdQ==]</label>
						<span class="f-control-feedback"/>
						<div class="f-message"/>
					</div>
					
					<div class="subscr_inputs__item --zipcode f-feedback">
						<input id="client_zipcode" type="text" class="f-control --validate" name="zipcode" required="required" data-graphql="zipcode" data-name="zipcode" autocomplete="postal-code" data-region=""/>
						<label for="client_zipcode" class="f-label">iai_i18n:[S29kIHBvY3p0b3d5]</label>
						<span class="f-control-feedback"/>
						<div class="f-message"/>
					</div>
					
					<div class="subscr_inputs__item --city f-feedback">
						<input id="client_city" type="text" class="f-control --validate" name="city" required="required" data-graphql="city" data-name="city" autocomplete="address-level2"/>
						<label for="client_city" class="f-label">iai_i18n:[TWllanNjb3dvxZvEhw==]</label>
						<span class="f-control-feedback"/>
						<div class="f-message"/>
					</div>
					
					<div class="subscr_inputs__item --phone f-feedback">
						<input id="client_phone" type="tel" class="f-control --validate" name="phone" required="required" data-graphql="phone" autocomplete="tel-national" data-name="phone" data-region=""/>
						<label for="client_phone" class="f-label">iai_i18n:[TnVtZXIgdGVsZWZvbnU=]</label>
						<span class="f-control-feedback"/>
						<div class="f-message"/>
					</div>
					
					<div class="subscr_inputs__item --email f-feedback">
						<input id="client_email" type="email" class="f-control --validate" name="email" required="required" data-graphql="email" autocomplete="email" data-name="email"/>
						<label for="client_email" class="f-label">iai_i18n:[RS1tYWls]</label>
						<span class="f-control-feedback"/>
						<div class="f-message"/>
					</div>
				</div>
				<div class="subscr_edit_address_modal__buttons subscr_modal_buttons">
					<button type="button" class="subscr_edit_address_modal__button btn --outline --large --return">iai_i18n:[V3LDs8SH]</button>
					<button type="button" class="subscr_edit_address_modal__button btn --solid --large --edit">iai_i18n:[Wm1pZcWE]</button>
				</div>
			</form>
		</template>
		<template id="subscr_provinces">
			<div class="subscr_inputs__item --province f-feedback">
				<select name="province" class="f-select" data-name="province"/>
			</div>
		</template>

		
		<template id="subscr_payments_template">
			<div class="subscr_payments subscr_summary_block" data-link="">
				<span class="subscr_payments__label subscr_summary_block__label">iai_i18n:[UMWCYXRub8WbY2k=]</span>
				<a href="#editPayments" class="subscr_payments__edit subscr_summary_block__link">iai_i18n:[RWR5dHVq]</a>
			</div>
		</template>
		<template id="subscr_payments_card_change_in_progress">
			<div class="subscr_payments__card_change_in_progress menu_messages_message --small">
				<p>iai_i18n:[WmxlY29ubyBkb2RhbmllIG5vd2VqIGthcnR5LiBLYXJ0YSB6YWt0dWFsaXp1amUgc2nEmSB3a3LDs3RjZS4gRWR5Y2phIHDFgmF0bm/Fm2NpIGLEmWR6aWUgbW/FvGxpd2EgcG8gd2VyeWZpa2Fjamkgbm93ZWoga2FydHk=].</p>
			</div>
		</template>
		<template id="subscr_payments_something_went_wrong">
			<div class="subscr_payments__something_went_wrong">
				<div class="subscr_payments__warning_message menu_messages_warning --small">
					<p>iai_i18n:[Q2/FmyBwb3N6xYJvIG5pZSB0YWsuIFByemVqZMW6IGRvIHN6Y3plZ8OzxYLDs3cgemFtw7N3aWVuaWEsIGFieSBkb2tvbmHEhyBwxYJhdG5vxZtjaQ==].</p>
				</div>
				<a class="subscr_payments__pay_your_order btn --solid --large">iai_i18n:[T3DFgmHEhyB6YW3Ds3dpZW5pZQ==]</a>
			</div>
		</template>
		<template id="subscr_payments_card">
			<div class="subscr_payments__card_wrapper">
				<div class="subscr_payments__card">
					<span class="subscr_payments__card_icon">
						<img loading="lazy"/>
					</span>
					<strong class="subscr_payments__card_number"/>
				</div>
			</div>
		</template>
		<template id="subscr_payments_no_card">
			<div class="subscr_payments__no_card subscr_no_card">
				<div class="subscr_no_card__card">
					<span class="subscr_no_card__card_icon">
						<img loading="lazy" width="30" height="22">
							<iaixsl:attribute name="alt">iai_i18n:[QnJhayBkb2RhbmVqIGthcnR5IHDFgmF0bmljemVq]</iaixsl:attribute>
						</img>
					</span>
					<strong class="subscr_no_card__label">iai_i18n:[RG9kYWoga2FydMSZIGkga29udHludXVqIHN3b2rEhSBzdWJza3J5cGNqxJk=]</strong>
					<span class="subscr_no_card__sub_label">iai_i18n:[QnJhayBkb2RhbmVqIGthcnQgcMWCYXRuaWN6ZWo=]</span>
				</div>
				<div class="subscr_no_card__info menu_messages_message --small">
					<p>iai_i18n:[VHdvamEgc3Vic2tyeXBjamEgem9zdGHFgmEgd3N0cnp5bWFuYS4gV3lzdGFyY3p5LCDFvGUgZG9kYXN6IG5vd8SFIGthcnTEmSBwxYJhdG5pY3rEhSwgYWJ5IG5hdHljaG1pYXN0] <a class="subscr_no_card__add_card_link" href="#addCardToRenewSubscription">iai_i18n:[d3pub3dpxIcgc3Vic2tyeXBjasSZ]</a>.</p>
				</div>
			</div>
		</template>
		<template id="subscr_payments_upcoming">
			<div class="subscr_payments__upcoming">
				<span class="subscr_payments__upcoming_text">iai_i18n:[RGF0YSBrb2xlam5laiBwxYJhdG5vxZtjaQ==]:</span>
				<strong class="subscr_payments__upcoming_value"/>
			</div>
		</template>
		<template id="subscr_payments_modal_template">
			<div class="subscr_payments_modal">
				<strong class="subscr_payments_modal__title">iai_i18n:[UMWCYXRub8WbY2k=]</strong>
				<div class="subscr_payments_modal__payments">
					<div class="subscr_payments_modal__clause_top"/>
					<div class="subscr_payments_modal__wrapper"/>
				</div>
				<div class="subscr_payments_modal__clauses"/>
				<div class="subscr_payments_modal__buttons subscr_modal_buttons">
					<button type="button" class="subscr_payments_modal__button btn --outline --large --return">iai_i18n:[V3LDs8SH]</button>
					<button type="button" class="subscr_payments_modal__button btn --solid --large --edit">iai_i18n:[V3liaWVyeg==]</button>
				</div>
			</div>
		</template>
		<template id="subscr_payments_modal_item_template">
			<div class="subscr_payments_modal__item f-group --radio">
				<input type="hidden" name="first_payment_id" disabled="disabled"/>
				<input type="hidden" name="payform_id" disabled="disabled"/>
				<input type="radio" name="selected_group_only" class="subscr_payments_modal__input f-control" tabindex="-1"/>
				<label class="subscr_payments_modal__label">
					<span class="subscr_payments_modal__icons">
						<img class="subscr_payments_modal__icon"/>
					</span>
					<span class="subscr_payments_modal__names">
						<strong class="subscr_payments_modal__name"/>
						<span class="subscr_payments_modal__description"/>
					</span>
					<span class="subscr_payments_modal__arrow">
						<i class="icon-options-status"/>
					</span>
				</label>
				<a href="selectPayment" class="sr-only subscr_payments_modal__select_payment">iai_i18n:[V3liaWVyeiB0xJkgbWV0b2TEmSBwxYJhdG5vxZtjaQ==]</a>
				<div class="subscr_payments_modal__details"/>
			</div>
		</template>
		<template id="subscr_payments_modal_details_template">
			<span class="subscr_payments_modal__clause_options"/>
			<div class="subscr_payments_modal__options"/>
			<a href="#showAllPaymentMethods" class="subscr_payments_modal__show_all">
				iai_i18n:[UG9rYcW8IHdzenlzdGtpZQ==]
			</a>
		</template>
		<template id="subscr_payments_modal_option_template">
			<div class="subscr_payments_modal__option">
				<input type="radio" name="payform_id" class="subscr_payments_modal__option_input f-control" disabled="disabled"/>
				<label class="subscr_payments_modal__option_select">
					<span class="subscr_payments_modal__option_icons">
						<img class="subscr_payments_modal__option_icon"/>
					</span>
					<span class="subscr_payments_modal__option_name"/>
				</label>
			</div>
		</template>
		<template id="subscr_go_payment_modal_template">
			<div class="subscr_go_payment_modal">
				<div class="subscr_go_payment_modal__icons"/>
				<div class="subscr_go_payment_modal__payment" id="go_payment"/>
				<div class="subscr_go_payment_modal__buttons subscr_modal_buttons">
					<button type="button" class="subscr_payments_modal__button btn --outline --large --return">iai_i18n:[V3LDs8SH]</button>
				</div>
			</div>
		</template>
		...
		<template id="subscr_deliveries_template">
			<div class="subscr_deliveries subscr_summary_block">
				<span class="subscr_deliveries__label subscr_summary_block__label">iai_i18n:[T3BjamUgZG9zdGF3eQ==]</span>
				<a href="#editDeliveries" class="subscr_deliveries__edit subscr_summary_block__link">iai_i18n:[RWR5dHVq]</a>
				<div class="subscr_deliveries__delivery">
					<span class="subscr_deliveries__delivery_icon"><img loading="lazy"/></span>
					<div class="subscr_deliveries__delivery_info">
						<strong class="subscr_deliveries__delivery_name"/>
						<span class="subscr_deliveries__delivery_time">
							<span class="subscr_deliveries__delivery_time_label">iai_i18n:[UHJ6ZXdpZHl3YW5hIGRvc3Rhd2E=] - </span>
							<span class="subscr_deliveries__delivery_time_value"/>
						</span>
						<span class="subscr_deliveries__pickup_address">
							<div class="subscr_deliveries__pickup_address_wrapper">
								<strong class="subscr_deliveries__pickup_name"/>
								<span class="subscr_deliveries__pickup_street"/>
								<span class="subscr_deliveries__pickup_city"/>
							</div>
						</span>
					</div>
					<strong class="subscr_deliveries__delivery_price"/>
				</div>
			</div>
		</template>
		<template id="subscr_deliveries_modal_template">
			<form class="subscr_deliveries_modal">
				<strong class="subscr_deliveries_modal__label">iai_i18n:[T3BjamUgZG9zdGF3eQ==]</strong>
				<div class="subscr_deliveries_modal__block"/>
				<div class="subscr_deliveries_modal__buttons subscr_modal_buttons">
					<button type="button" class="subscr_deliveries_modal__button btn --outline --large --return">iai_i18n:[V3LDs8SH]</button>
					<button type="button" class="subscr_deliveries_modal__button btn --solid --large --edit">iai_i18n:[Wm1pZcWE]</button>
				</div>
			</form>
		</template>
		<template id="subscr_delivery_template">
			<div class="subscr_deliveries_modal__item subscr_delivery f-group --radio">
				<input type="radio" name="shipping" class="f-control subscr_delivery__input" tabindex="-1"/>
				<label class="f-label subscr_delivery__label">
					<span class="subscr_delivery__icons">
						<img class="subscr_delivery__icon"/>
					</span>
					<span class="subscr_delivery__names">
						<strong class="subscr_delivery__name"/>
						<span class="subscr_delivery__time">
							<span class="subscr_delivery__time_label">iai_i18n:[UHJ6ZXdpZHl3YW5hIGRvc3Rhd2E=] - </span>
							<strong class="subscr_delivery__time_value"/>
						</span>
						<span class="subscr_delivery__minworth">
							<span class="subscr_delivery__minworth_label">iai_i18n:[Rm9ybWEgZG9zdGF3eSBkb3N0xJlwbmEgb2Q=] </span>
							<span class="subscr_delivery__minworth_value"/>
						</span>
						<span class="subscr_delivery__comment"/>
						<span class="subscr_delivery__pickup">
							<a class="subscr_delivery__pickup_find btn --solid" href="#findYourNearestPickupPoint" tabindex="-1">iai_i18n:[Wm5hamTFuiBuYWpibGnFvHN6eSBwdW5rdCBvZGJpb3J1]</a>
							<span class="subscr_delivery__pickup_address">
								<input type="hidden" name="pickup_point" class="subscr_delivery__pickup_input" disabled="disabled"/>
								<div class="subscr_delivery__pickup_address_wrapper">
									...
									<strong class="subscr_delivery__pickup_name"/>
									<span class="subscr_delivery__pickup_street"/>
									<span class="subscr_delivery__pickup_city"/>
								</div>
								<div class="subscr_delivery__client_courier_number">
									<input type="hidden" name="client_courier_number" class="subscr_delivery__client_courier_number_input" disabled="disabled"/>
									<span class="subscr_delivery__client_courier_number_label">iai_i18n:[TnIga2xpZW50YSB3IHN5c3RlbWllIGt1cmllcmE=]: </span>
									<strong class="subscr_delivery__client_courier_number_value"/>
								</div>
								<a class="subscr_delivery__pickup_other btn --outline" href="#chooseAnotherPickupPoint">iai_i18n:[V3liaWVyeiBpbm55IHB1bmt0]</a>
							</span>
						</span>
					</span>
					<div class="subscr_delivery__cost_wrapper">
						<strong class="subscr_delivery__cost"/>
					</div>
				</label>
				<a href="selectDelivery" class="sr-only subscr_delivery__select_delivery">iai_i18n:[V3liaWVyeiB0xJkgZm9ybcSZIGRvc3Rhd3k=]</a>
			</div>
		</template>

		
		<template id="subscr_pickup_points_template">
			<div class="subscr_pickup_points --search --loading">
				<h4 class="subscr__title">iai_i18n:[T2RiacOzciB3IHB1bmtjaWU=]</h4>
				<div class="subscr_pickup_points__wrapper">
					<div class="subscr_pickup_points__nav subscr_pickup_nav">
						<a href="#search" class="subscr_pickup_nav__item --search" tabindex="0">
							<iaixsl:attribute name="aria-label">iai_i18n:[V3lzenVrYWogcHVua3TDs3c=]</iaixsl:attribute>
						</a>
						<a href="#map" class="subscr_pickup_nav__item --map" tabindex="0">
							<iaixsl:attribute name="aria-label">iai_i18n:[UHJ6ZWpkxbogZG8gbWFweQ==]</iaixsl:attribute>
						</a>
						<a href="#filters" class="subscr_pickup_nav__item --filters">
							<iaixsl:attribute name="aria-label">iai_i18n:[RmlsdHJ1aiBwdW5rdHkgb2RiaW9ydQ==]</iaixsl:attribute>
						</a>
					</div>
					<div class="subscr_pickup_points__filters subscr_pickup_filters">
						<div class="subscr_pickup_filters__sub --deliveries">
							<strong class="subscr_pickup_filters__name">iai_i18n:[UHVua3R5IG9kYmlvcnU=]</strong>
						</div>
						<div class="subscr_pickup_filters__sub --submit">
							<a class="subscr_pickup_filters__submit btn --solid --large" href="#filtersPoints">iai_i18n:[WmFzdG9zdWogZmlsdHJvd2FuaWU=]</a>
						</div>
					</div>
					<div class="subscr_pickup_points__search subscr_pickup_search">
						<div class="subscr_pickup_search__wrapper">
							<div class="subscr_pickup_search__query">
								<input class="subscr_pickup_search__input" type="text" autocomplete="off" tabindex="0">
									<iaixsl:attribute name="placeholder">iai_i18n:[V3Bpc3ogYWRyZXM=]</iaixsl:attribute>
                	<iaixsl:attribute name="aria-label">iai_i18n:[V3Bpc3ogYWRyZXM=]</iaixsl:attribute>
								</input>
								<a class="subscr_pickup_search__button" href="#" tabindex="-1">
									<iaixsl:attribute name="aria-label">iai_i18n:[V3lzenVrYWo=]</iaixsl:attribute>
								</a>
								<a class="subscr_pickup_search__clear" href="#" tabindex="0">
									<iaixsl:attribute name="aria-label">iai_i18n:[V3ljennFm8SH]</iaixsl:attribute>
								</a>
							</div>
							<div class="subscr_pickup_search__results"/>
						</div>
					</div>
					<div class="subscr_pickup_points__items subscr_pickup_items">
						<div class="subscr_pickup_items__wrapper"/>
						<div class="subscr_pickup_items__show_more">
							<a href="#showMore" class="subscr_pickup_items__show" tabindex="0">
								<iaixsl:attribute name="data-prev">iai_i18n:[UG9rYcW8IG1uaWVq]</iaixsl:attribute>
								iai_i18n:[UG9rYcW8IHdpxJljZWogcHVua3TDs3c=]
							</a>
						</div>
						<div class="subscr_pickup_items__message menu_messages_message">iai_i18n:[QnJhayBwdW5rdMOzdyBvZGJpb3J1LCBzcHJhd2TFuiBpbm55IGFkcmVz]</div>
					</div>
					<div class="subscr_pickup_points__map subscr_pickup_map">
						<div class="subscr_pickup_map__area">
							<a href="#searchHere" class="subscr_pickup_map__area_button btn --solid --secondary --outline --icon-left icon-search --gps" tabindex="0">iai_i18n:[VcW8eWogbG9rYWxpemFjamk=]</a>
							<a href="#searchHere" class="subscr_pickup_map__area_button btn --solid --secondary --outline --icon-left icon-search --area" tabindex="0">iai_i18n:[U3p1a2FqIHcgdHltIG9ic3phcnpl]</a>
						</div>
						<div class="subscr_pickup_map__wrapper"/>
					</div>
				</div>
			</div>
		</template>
		<template id="subscr_pickup_points_item_template">
			<div class="subscr_pickup_items__item subscr_pickup_item">
				<strong class="subscr_pickup_item__distance"/>
				<div class="subscr_pickup_item__details">
					<strong class="subscr_pickup_item__name"/>
					<span class="subscr_pickup_item__street"/>
					<span class="subscr_pickup_item__city_wrapper"><span class="subscr_pickup_item__zipcode"/><span class="subscr_pickup_item__city"/></span>
					<input type="text" name="client_courier_number" class="subscr_pickup_item__client_courier_number" disabled="disabled">
						<iaixsl:attribute name="placeholder">iai_i18n:[TnIga2xpZW50YSB3IHN5c3QuIGt1cmllcmE=]</iaixsl:attribute>
					</input>
				</div>
				<p class="subscr_pickup_item__description"/>
				<div class="subscr_pickup_item__choose">
					<strong class="subscr_pickup_item__price"/>
					<a href="#selectThisPoint" class="subscr_pickup_item__choose_link" tabindex="0"><iaixsl:attribute name="aria-label">iai_i18n:[V3liaWVyeiBwdW5rdCBvZGJpb3J1]</iaixsl:attribute></a>
				</div>
			</div>
		</template>
		<template id="subscr_pickup_points_marker_template">
			<div class="subscr_pickup_marker">
				<strong class="subscr_pickup_marker__distance"/>
				<div class="subscr_pickup_marker__details">
					<strong class="subscr_pickup_marker__name"/>
					<span class="subscr_pickup_marker__street"/>
					<span class="subscr_pickup_marker__city_wrapper"><span class="subscr_pickup_marker__zipcode"/><span class="subscr_pickup_marker__city"/></span>
				</div>
				<p class="subscr_pickup_marker__description"/>
				<div class="subscr_pickup_marker__choose">
					<a href="#selectThisPoint" tabindex="0" class="subscr_pickup_marker__choose_link btn --solid --large --secondary">iai_i18n:[V3liaWVyeiB0ZW4gcHVua3Q=]</a>
				</div>
			</div>
		</template>

		
		<template id="subscr_remarks_template">
			<div class="subscr_remarks subscr_summary_block">
				<span class="subscr_remarks__title subscr_summary_block__label">iai_i18n:[VXdhZ2kgZG8gemFtw7N3aWVuaWE=]<span class="subscr_remarks__title_desc">iai_i18n:[T3Bjam9uYWxuaWU=]</span></span>
				<div class="subscr_remarks__block">
					<div class="subscr_remarks__item --shop">
						<input class="subscr_remarks__input" type="hidden" name="remarks" disabled="disabled" tabindex="-1"/>
						<a class="subscr_remarks__label" href="showRemarks"><span class="subscr_remarks__label_text">
							<iaixsl:attribute name="aria-describedby">iai_i18n:[VXdhZ2kgZGxhIHNrbGVwdQ==]</iaixsl:attribute>
							iai_i18n:[RGxhIHNrbGVwdQ==]
						</span><span class="subscr_remarks__label_icon"/></a>
						<div class="subscr_remarks__textarea_wrapper f-group --textarea" aria-hidden="true">
							<textarea class="subscr_remarks__textarea f-control" name="remarks_temp" id="subscr_remarks_shop_textarea" disabled="disabled" tabindex="-1">
								<iaixsl:attribute name="placeholder">iai_i18n:[V3Bpc3ogc3dvasSFIHdpYWRvbW/Fm8SH]</iaixsl:attribute>
							</textarea>
							<span class="subscr_remarks__error">iai_i18n:[TmllIHVkYcWCbyBzacSZIHphcGlzYcSHIHdpYWRvbW/Fm2Np]</span>
							<button type="button" class="subscr_remarks__save btn --solid --outline --medium" tabindex="-1">iai_i18n:[WmFwaXN6IHdpYWRvbW/Fm8SH]</button>
						</div>
						<div class="subscr_remarks__message_wrapper" aria-hidden="true">
							<strong class="subscr_remarks__text"/>
							<div class="subscr_remarks__links">
								<a href="#editRemarkMessage" class="subscr_remarks__link --edit" tabindex="-1">iai_i18n:[RWR5dHVq]</a>
								<a href="#removeRemarkMessage" class="subscr_remarks__link --remove" tabindex="-1">iai_i18n:[VXN1xYQ=]</a>
							</div>
						</div>
					</div>
					<div class="subscr_remarks__item --delivery">
						<input class="subscr_remarks__input" type="hidden" name="delivery_remarks" disabled="disabled" tabindex="-1"/>
						<a class="subscr_remarks__label" href="showRemarks"><span class="subscr_remarks__label_text">
					  	<iaixsl:attribute name="aria-describedby">iai_i18n:[VXdhZ2kgZGxhIGt1cmllcmE=]</iaixsl:attribute>
							iai_i18n:[RGxhIGt1cmllcmE=]
						</span><span class="subscr_remarks__label_icon"/></a>
						<div class="subscr_remarks__textarea_wrapper f-group --textarea" aria-hidden="true">
							<textarea class="subscr_remarks__textarea f-control" name="delivery_remarks_temp" id="subscr_remarks_delivery_textarea" disabled="disabled" tabindex="-1">
								<iaixsl:attribute name="placeholder">iai_i18n:[V3Bpc3ogc3dvasSFIHdpYWRvbW/Fm8SH]</iaixsl:attribute>
							</textarea>
							<span class="subscr_remarks__error">iai_i18n:[TmllIHVkYcWCbyBzacSZIHphcGlzYcSHIHdpYWRvbW/Fm2Np]</span>
							<button type="button" class="subscr_remarks__save btn --solid --outline --medium" tabindex="-1">iai_i18n:[WmFwaXN6IHdpYWRvbW/Fm8SH]</button>
		...
		<template id="subscr_unsubscribe_template">
			<div class="subscr_unsubscribe">
				<a href="#terminateSubscription" class="subscr_unsubscribe__link --terminate">iai_i18n:[WmFrb8WEY3ogc3Vic2tyeXBjasSZ]</a>
				<a href="#suspendSubscription" class="subscr_unsubscribe__link --suspend">iai_i18n:[V3N0cnp5bWFqIHN1YnNrcnlwY2rEmQ==]</a>
			</div>
		</template>
		<template id="subscr_terminate_confirm_template">
			<div class="subscr_terminate_confirm">
				<strong class="subscr_terminate_confirm__label">iai_i18n:[WmFrb8WEY3ogc3Vic2tyeXBjasSZ]</strong>
				<span>iai_i18n:[Q3p5IG5hIHBld25vIGNoY2VzeiB6YWtvxYRjennEhyBzdWJza3J5cGNqxJk=]?</span>
				<div class="subscr_terminate_confirm__buttons">
					<button type="button" class="subscr_terminate_confirm__button btn --outline --large --return">iai_i18n:[V3LDs8SH]</button>
					<button type="button" class="subscr_terminate_confirm__button btn --solid --large --edit">iai_i18n:[WmFrb8WEY3o=]</button>
				</div>
			</div>
		</template>
		<template id="subscr_suspend_confirm_template">
			<div class="subscr_suspend_confirm">
				<strong class="subscr_suspend_confirm__label">iai_i18n:[V3N0cnp5bWFqIHN1YnNrcnlwY2rEmQ==]</strong>
				<span>iai_i18n:[Q3p5IG5hIHBld25vIGNoY2VzeiB3c3RyenltYcSHIHN1YnNrcnlwY2rEmQ==]?</span>
				<div class="subscr_suspend_confirm__buttons">
					<button type="button" class="subscr_suspend_confirm__button btn --outline --large --return">iai_i18n:[V3LDs8SH]</button>
					<button type="button" class="subscr_suspend_confirm__button btn --solid --large --edit">iai_i18n:[V3N0cnp5bWFq]</button>
				</div>
			</div>
		</template>
	</div>
...
<iaixsl:choose>
	...
	<script src="/gfx/translatable/envelope.js.gzip?r=1765442856"></script><script src="/gfx/translatable/menu_suggested_shop_for_language.js.gzip?r=1765442856"></script><script src="/gfx/translatable/menu_filter.js.gzip?r=1765442856"></script><script src="/gfx/translatable/menu_basket.js.gzip?r=1765442856"></script><script src="/gfx/translatable/hotspots_javascript.js.gzip?r=1765442856"></script><script src="/gfx/translatable/hotspots_slider.js.gzip?r=1765442856"></script><script src="/gfx/translatable/hotspots_add_to_basket.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_settings.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_literals.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_js.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_return.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_status.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_info.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_products.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_add.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_rebates.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_renewals.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_code.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_upcoming.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_period.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_address.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_payments.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_deliveries.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_pickup.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_remarks.js.gzip?r=1765442856"></script><script src="/gfx/translatable/subscription_unsubscribe.js.gzip?r=1765442856"></script>
