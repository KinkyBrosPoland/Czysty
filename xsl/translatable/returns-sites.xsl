...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
    ...
    <!-- (returns_sites_form, 61f913c8bcc687.81364427.4)-->
	<iaixsl:if test="page/@type = 'return_products' and page/@display = 'stock'">
		<div class="step4a">
			<div class="progress_bar_wrapper pb_step4">
				...
				<a class="_step _step1">
					<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/returns_link/@url"/></iaixsl:attribute>
				...
				<div class="_step _step4" aria-current="step">
					<span>4</span>
					<p>
						<i/>
			...
			<div class="progress__item --rma --fourth --active d-md-none py-3">
				...
				<div class="progress__text">
					<strong class="progress__name"><iaixsl:choose><iaixsl:when test="count(page/pickups/pickup) &gt; 1">iai_i18n:[V3liaWVyeiBhZHJlcyBwdW5rdHUgendyb3R1]</iaixsl:when><iaixsl:otherwise>iai_i18n:[QWRyZXMgcHVua3R1IHp3cm90dQ==]</iaixsl:otherwise></iaixsl:choose></strong>
				</div>
			</div>
			<h1 class="big_label return_label d-none d-md-block" id="return_label"><iaixsl:choose><iaixsl:when test="count(page/pickups/pickup) &gt; 1">iai_i18n:[V3liaWVyeiBhZHJlcyBwdW5rdHUgendyb3R1]</iaixsl:when><iaixsl:otherwise>iai_i18n:[QWRyZXMgcHVua3R1IHp3cm90dQ==]</iaixsl:otherwise></iaixsl:choose></h1>
			<form class="pickup_return_list_form" method="get" aria-labelledby="return_label">
				<div class="pickup_return_list_form__wrapper">
					<iaixsl:for-each select="page/pickups/pickup">
						<div class="pickupl_return">
							<input type="radio" name="stock">
								<iaixsl:if test="position() = 1 and not(/shop/page/pickups/pickup[@checked = 'true'])">
									<iaixsl:attribute name="checked">checked</iaixsl:attribute>
								</iaixsl:if>
								<iaixsl:if test="@checked = 'true'"><iaixsl:attribute name="checked">checked</iaixsl:attribute></iaixsl:if>
								<iaixsl:attribute name="value"><iaixsl:value-of select="id"/></iaixsl:attribute>
								<iaixsl:attribute name="id">input_stock_<iaixsl:value-of select="id"/></iaixsl:attribute>
							</input>
							<label class="pickupl_return_sub">
								<iaixsl:attribute name="for">input_stock_<iaixsl:value-of select="id"/></iaixsl:attribute>
								<strong class="pickupl_return_name"><iaixsl:value-of select="name"/></strong>
								<div class="pickupl_return_address">
									<span class="pickup_return_address"><iaixsl:value-of select="address"/></span>
									<span class="pickupl_return_city"><iaixsl:value-of select="zipcode"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="city"/></span>
								</div>
								<iaixsl:if test="info">
							...
							<div class="pickupl_return_link">
								<a target="_blank">
									<iaixsl:attribute name="href"><iaixsl:value-of select="link"/></iaixsl:attribute>
									<iaixsl:attribute name="title">iai_i18n:[d2nEmWNlaiBpbmZvcm1hY2ppIG8gcHVua2NpZQ==]</iaixsl:attribute>
									<span class="sr-only"><iaixsl:value-of select="name"/></span>
