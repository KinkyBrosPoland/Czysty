...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (client_files_files, 60dd8e7bd6c090.77789436.7)-->
	<div id="client-files" class="n68137">
		<iaixsl:choose>
			<iaixsl:when test="page/client_files/@mode = 'to_download'">
				<div class="n68137_downloadable">
					<h1 class="big_label n68137_label">
						<span class="n68137_label">
							iai_i18n:[SW5mb3JtYWNqZSBvIHBvYmllcmFuaXUgemFrdXBpb255Y2ggcGxpa8Ozdw==]
						</span>
					</h1>
						...
						<iaixsl:for-each select="/shop/page/client_files/product_data">
							<div class="n68137_file">
								...
								<div class="n68137_files_description">
									...
									<div class="n68137_files_description_order"><span class="n68137_desc_label">iai_i18n:[TnVtZXIgemFtw7N3aWVuaWE=]:</span><span class="n68137_desc_value"><a class="n68137_desc_value"><iaixsl:attribute name="href"><iaixsl:value-of select="@order_link"/></iaixsl:attribute><iaixsl:value-of select="@order_sn"/></a></span></div>
									<div class="n68137_files_description_availability">
										<span class="n68137_desc_label">iai_i18n:[RG9zdMSZcG5vxZvEhw==]:</span>
										<span class="n68137_desc_value">
											<iaixsl:choose>
												<iaixsl:when test="@available = 'y'">
													iai_i18n:[cGxpa2kgc8SFIGRvc3TEmXBuZSBkbyBwb2JyYW5pYQ==]
												</iaixsl:when>
												<iaixsl:otherwise>
													iai_i18n:[cGxpa2kgbmllIHPEhSBkb3N0xJlwbmUgZG8gcG9icmFuaWEgcG9uaWV3YcW8IHphbcOzd2llbmllIG5pZSB6b3N0YcWCbyBvcMWCYWNvbmU=]
												</iaixsl:otherwise>
											</iaixsl:choose>
										</span>
									</div>
								...
								<div class="n68137_popup">
									...
									<div class="big_label n68137_label_popup">
										iai_i18n:[SW5mb3JtYWNqZSBkb3R5Y3rEhWNlIHBvYmllcmFuaWEgcGxpa8Ozdw==]
									</div>
									<div class="n68137_description_popup">
										iai_i18n:[V3liaWVyeiBwcmVmZXJvd2FueSBwcnpleiBDaWViaWUgZm9ybWF0IHBsaWt1IGkga2xpa25paiBwb2JpZXJ6IC0gcm96cG9jem5pZSBzacSZIGF1dG9tYXR5Y3puaWUgcG9iaWVyYW5pZSBwbGlrdQ==].<br/><br/>
										...
										<div class="n68137_files_description_popup">
											<div class="n68137_desc_popup">
												...
												<div class="n68137_desc_availability_popup">
													iai_i18n:[ZG9zdMSZcG55IGRvIHBvYnJhbmlh]

													<iaixsl:choose>
														<iaixsl:when test="@unlimited='true'">
															iai_i18n:[YmV6IG9ncmFuaWN6ZcWE]
											...
											<a class="btn --solid n68137_files_download_popup">
												...
												<span class="n68137_button_label_popup">iai_i18n:[UG9iaWVyeiB3IGZvcm1hY2ll]
			...
			<iaixsl:when test="page/client_files/@mode = 'not_available'">
				<div class="n68137_notdownloadable">
					<div class="big_label n68137_label">
						<span class="n68137_label">
							iai_i18n:[SW5mb3JtYWNqZSBvIHBsaWthY2gsIGt0w7NyeWNoIG5pZSBtb8W8bmEganXFvCBwb2JyYcSH]
						</span>
					</div>
					...
					<div class="n68137_files">
						<iaixsl:for-each select="/shop/page/client_files/product_data">
							<div class="n68137_file">
								...
								<div class="n68137_files_description">
									<a class="n68137_desc_name"><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
									<div class="n68137_files_description_order"><span class="n68137_desc_label">iai_i18n:[TnVtZXIgemFtw7N3aWVuaWE=]:</span><a class="n68137_desc_value"><iaixsl:attribute name="href"><iaixsl:value-of select="@order_link"/></iaixsl:attribute><iaixsl:value-of select="@order_sn"/></a></div>
									<div class="n68137_files_description_availability">
										<span class="n68137_desc_label">iai_i18n:[RG9zdMSZcG5vxZvEhw==]:</span>
										<span class="n68137_desc_value">
											<iaixsl:choose>
												<iaixsl:when test="product_attachments/@downloads_left = '0'">
													iai_i18n:[d3ljemVycGFubyBqdcW8IGxpbWl0IHBvYnJhxYQgcGxpa3U=]
												</iaixsl:when>
												<iaixsl:otherwise>
													iai_i18n:[cGxpayBuaWVkb3N0xJlwbnk=]
												</iaixsl:otherwise>
											</iaixsl:choose>
										</span>
									</div>
								...
								<iaixsl:if test="@available='y'">
									<a class="btn --solid n68137_files_buy">
										<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>iai_i18n:[RG9kYWogZG8ga29zenlrYQ==]
									</a>
								</iaixsl:if>
								<div class="clearDiv"/>
							</div>
