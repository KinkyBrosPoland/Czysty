...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (order_open_form, 60dd8e85a6c2b1.12259029.4)-->
	<section class="order_open mb-4">
		
		<h1 class="order_open__label headline">
			<span class="order_open__label_txt headline__name">iai_i18n:[U3ByYXdkemVuaWUgc3RhdHVzdSB6YW3Ds3dpZW5pYQ==]</span>
		</h1>

		
		<div class="order_open__description menu_messages_message mb-4">iai_i18n:[QWJ5IHNwcmF3ZHppxIcgc3RhdHVzIHphbcOzd2llbmlhLCBwb2RhaiBqZWdvIG51bWVyICh6bmFqZHppZXN6IGdvIHcgd2lhZG9tb8WbxIcgZS1tYWlsLCBrdMOzcsSFIG90cnp5bWHFgmXFmyBwbyB6xYJvxbxlbml1IHphbcOzd2llbmlhKSBvcmF6IG51bWVyIHRlbGVmb251IGx1YiBhZHJlcyBlLW1haWw=].</div>
			...
			<div class="order_open__inputs col-12 col-sm-7">
				...
				<div class="f-group order_open__email">
					<div class="f-feedback order_open__feedback --email">
						<input id="order_open__email_input" type="text" class="f-control --validate" name="email" required="required" data-graphql="phone email">
		...
		<div class="order_open__signin d-flex justify-content-center">
			<a href="/login.php" class="order_open__signin_link">iai_i18n:[TWFtIHphcmVqZXN0cm93YW5lIGtvbnRvIGkgY2hjxJkgcHJ6ZWrFm8SHIGRvIGxpc3R5IHN3b2ljaCB6YW3Ds3dpZcWE]</a>
		</div>
	</section>
