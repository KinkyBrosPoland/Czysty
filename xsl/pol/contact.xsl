...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (contact_contact, 60dd8e7c5597f9.74771024.6)-->
  <div class="contact_site">
    <div class="contact_site__block">
      <h2 class="headline">
        <span class="headline__name">Biuro obsługi klienta</span>
      </h2>
      <div class="contact_site__items --contact">
        <iaixsl:for-each select="/shop/page/contact/contact_nodes/node[@value != '']">
          <div class="contact_site__item">
            <iaixsl:attribute name="class">contact_site__item --<iaixsl:value-of select="@type"/></iaixsl:attribute>
            <iaixsl:if test="@title and @title != ''">
              <strong class="contact_site__label"><iaixsl:value-of select="@title"/>:</strong>
            </iaixsl:if>
            <iaixsl:choose>
              <iaixsl:when test="@link">
                <a class="contact_site__value --link">
                  <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                  <iaixsl:value-of select="@value"/>
                </a>
              </iaixsl:when>
              <iaixsl:otherwise>
                <span class="contact_site__value">
                  <iaixsl:value-of select="@value"/>
                </span>
              </iaixsl:otherwise>
            </iaixsl:choose>
        ...
        <iaixsl:if test="/shop/page/contact/shop_data/@shopname and /shop/page/contact/shop_data/@shopname != ''">
          <div class="contact_site__item --shopname">
            <strong class="contact_site__label">Pełna nazwa:</strong>
            <span class="contact_site__value">
              <iaixsl:value-of select="/shop/page/contact/shop_data/@shopname"/>
            </span>
          </div>
        </iaixsl:if>
        <div class="contact_site__item --address">
          <strong class="contact_site__label">Adres:</strong>
          <span class="contact_site__value">
            <iaixsl:if test="/shop/page/contact/shop_data/@street and /shop/page/contact/shop_data/@street != ''">
              <iaixsl:value-of select="/shop/page/contact/shop_data/@street"/>, 
            </iaixsl:if>
            <iaixsl:if test="/shop/page/contact/shop_data/@zipcode and /shop/page/contact/shop_data/@zipcode != ''">
              <iaixsl:value-of select="/shop/page/contact/shop_data/@zipcode"/><iaixsl:text> </iaixsl:text>
            </iaixsl:if>
            <iaixsl:if test="/shop/page/contact/shop_data/@city and /shop/page/contact/shop_data/@city != ''">
              <iaixsl:value-of select="/shop/page/contact/shop_data/@city"/>
            </iaixsl:if>
    ...
    <div class="contact_site__block">
      <h2 class="headline">
        <span class="headline__name">Właściciel sklepu</span>
      </h2>
      <div class="contact_site__firm">
        <iaixsl:if test="/shop/page/contact/owner_data/@firmname and /shop/page/contact/owner_data/@firmname != ''">
          <h3 class="contact_site__firm_name"><iaixsl:value-of select="/shop/page/contact/owner_data/@firmname"/></h3>
        </iaixsl:if>
        <div class="contact_site__firm_address">
          <iaixsl:if test="/shop/page/contact/owner_data/@street and /shop/page/contact/owner_data/@street != ''">
            <iaixsl:value-of select="/shop/page/contact/owner_data/@street"/>, 
          </iaixsl:if>
          <iaixsl:if test="/shop/page/contact/owner_data/@zipcode and /shop/page/contact/owner_data/@zipcode != ''">
            <iaixsl:value-of select="/shop/page/contact/owner_data/@zipcode"/><iaixsl:text> </iaixsl:text>
          </iaixsl:if>
          <iaixsl:if test="/shop/page/contact/owner_data/@city and /shop/page/contact/owner_data/@city != ''">
            <iaixsl:value-of select="/shop/page/contact/owner_data/@city"/>
          </iaixsl:if>
          <iaixsl:if test="/shop/page/contact/owner_data/@country">
            (<iaixsl:if test="/shop/page/contact/owner_data/@province"><iaixsl:value-of select="/shop/page/contact/owner_data/@province"/><iaixsl:text>, </iaixsl:text></iaixsl:if><iaixsl:value-of select="/shop/page/contact/owner_data/@country"/>)
          </iaixsl:if>
        </div>
      </div>
      <div class="contact_site__items --additional">
        <iaixsl:for-each select="/shop/page/contact/additional_nodes/node[@value != '']">
          <div class="contact_site__item">
            <iaixsl:attribute name="class">contact_site__item --<iaixsl:value-of select="@type"/></iaixsl:attribute>
            <iaixsl:if test="@title and @title != ''">
              <strong class="contact_site__label"><iaixsl:value-of select="@title"/>:</strong>
...
<!-- (contact_address, 60dd8e8624c942.68586545.10)-->
  <div id="contact_map">
    <iaixsl:attribute name="data-name"><iaixsl:value-of select="/shop/page/contact/shop_data/@shopname"/></iaixsl:attribute>
    <iaixsl:attribute name="data-lat"><iaixsl:value-of select="/shop/page/contact/location/@latitude"/></iaixsl:attribute>
    <iaixsl:attribute name="data-lng"><iaixsl:value-of select="/shop/page/contact/location/@longitude"/></iaixsl:attribute>
    <iaixsl:attribute name="data-street"><iaixsl:value-of select="/shop/page/contact/shop_data/@street"/></iaixsl:attribute>
    <iaixsl:attribute name="data-zipcode"><iaixsl:value-of select="/shop/page/contact/shop_data/@zipcode"/></iaixsl:attribute>
    <iaixsl:attribute name="data-city"><iaixsl:value-of select="/shop/page/contact/shop_data/@city"/></iaixsl:attribute>
    <iaixsl:attribute name="data-country"><iaixsl:value-of select="/shop/page/contact/shop_data/@country"/></iaixsl:attribute>
  </div>
  <iaixsl:if test="/shop/action/stocks/@available = 'true'">
    <div class="contact_stocks">
      <h2 class="headline">
        <span class="headline__name">Odwiedź jeden z naszych sklepów</span>
      </h2>
      <p class="contact_stocks__info">Jeśli sam chcesz odebrac zamówienie lub obejrzeć nasz asortyment, możesz to zrobić w jednym z wielu naszych sklepów. Sprawdz adresy i godziny dostaw, aby wybrać sklep, który najbardziej odpowiada Twoim potrzebom.</p>
      <a class="contact_stocks__link btn --solid --medium" href="/stocks.php">
        <iaixsl:if test="/shop/action/stocks/@url">
          <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/stocks/@url"/></iaixsl:attribute>
        </iaixsl:if>
        Zobacz nasze sklepy
      </a>
    </div>
  </iaixsl:if>
  <script>window.google_api_key=&apos;<iaixsl:value-of select="/shop/page/contact/google_api_key/@value"/>&apos;;</script>
