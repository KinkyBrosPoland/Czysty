...
<iaixsl:choose>
    ...
    <iaixsl:otherwise><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/common_shop.js.gzip?r=1765442856</iaixsl:attribute></script></iaixsl:otherwise>
			...
			<script src="/gfx/pol/login.js.gzip?r=1765442856"></script>
...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
	...
	<iaixsl:if test="(page/@type = 'login') and (page/login/@type='ok') and not(page/login/response)">
		<h1 class="l_welcome headline">
			<span class="headline__name">Twoje konto</span>
		</h1>
	</iaixsl:if>
				...
				<iaixsl:if test="/shop/action/shoppinglist/@url or /shop/page/actions/products_requests/@url">
					<div class="login_menu" id="products_login">
						<div class="login_menu_sub">
							...
							<div><span>Przeglądaj i edytuj swoje ulubione produkty. W tej sekcji możesz również edytować listę produktów poszukiwanych, które chciałbyś zobaczyć w naszym sklepie.</span></div>
					...
					<div class="login_menu" id="subscriptions_login">
						<div class="login_menu_sub">
							...
							<a class="btn --outline --extrasmall">
								...
								Aktywne
								<span class="sr-only">Subskrypcje</span>
							</a>
							<a class="btn --outline --extrasmall">
					...
					<div class="login_menu" id="orders_login">
						<div class="login_menu_sub">
							...
							<a class="btn --outline --extrasmall">
								...
								Bieżące
								<span class="sr-only">Zamówienia</span>
							</a>
							...
							<iaixsl:if test="page/actions/associated_orders/@count &gt; 0 and $associated_clients">
								<div class="associated_orders">
									...
									<a>
										...
										Zobacz listę
										<span class="sr-only">Oczekujące na akceptację</span>
									</a>
								</div>
							</iaixsl:if>
						</div>
