...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
	...
	<div id="client_rebates_info" class="rebates_info">
		<h1 class="headline">
			<span class="headline__name">Twoje rabaty</span>
		</h1>
				...
				<form class="rebates_form --card d-flex align-items-end" action="/settings.php?from=client_rebate" method="post">
					...
					<div class="f-group m-0">
						<div class="f-feedback">
							...
							<label class="f-label" for="rebates_card_input">Numer karty rabatowej</label>
						</div>
					</div>
					<button class="rebates_form__submit btn --large --solid ml-3" type="submit">Aktywuj <span class="sr-only">kartę rabatową</span></button>
				</form>
			</iaixsl:variable>
				...
				<form class="rebates_form --code d-flex align-items-end" action="/settings.php?from=client_rebate" method="post">
					...
					<div class="f-group m-0">
						<div class="f-feedback">
							...
							<label class="f-label" for="rebates_code_input">Numer kodu rabatowego</label>
						</div>
					</div>
					<button class="rebates_form__submit btn --large --solid ml-3" type="submit">Aktywuj <span class="sr-only">kod rabatowy</span></button>
				</form>
			</iaixsl:variable>
									...
									<iaixsl:for-each select="page/rebate_code/inactive_zones/item">
																						<iaixsl:choose>
																								...
																								<iaixsl:when test="@name = 'discount'">
																										<strong class="label --discount">Promocja!</strong>
																								</iaixsl:when>
							...
							<div class="rebates_inactive__item p-2 d-sm-flex align-items-sm-center p-sm-4">
								...
								<div class="rebates_inactive__sub --buttons">
									<form class="rebates_inactive__sub --form" action="/settings.php?from=client_rebate" method="post">
										...
										<button class="btn --solid rebates_inactive__button --active" type="submit">Aktywuj <span class="sr-only">kartę<iaixsl:value-of select="@number"/></span></button>
									</form>
								</div>
							</div>
						</iaixsl:for-each>
