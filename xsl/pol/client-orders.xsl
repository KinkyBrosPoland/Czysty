...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
					...
					<iaixsl:if test="$isPaymentsOrdersActive = 'true' and count(/shop/page/orders/item[@collective_available = 'true']) &gt; 0">
						<div class="orderpay__select_all_wrapper">
							<div class="f-group --checkbox">
								...
								<label class="f-label" for="orderpay__select_all">Zaznacz wszystkie</label>
							</div>
						</div>
					</iaixsl:if>
					...
					<iaixsl:if test="count(page/orders/navigation/portions) &gt; 1">
						<form class="orders__portions" action="/settings.php">
							<select class="orders__portions_select --small-md" id="select_top_portions" name="orders_portions">
								<iaixsl:attribute name="aria-label">Zmień ilość wyświetlanych zamówień</iaixsl:attribute>
										...
										<iaixsl:if test="$isPaymentsOrdersActive = 'true' and @collective_available = 'true'">
											<div class="orderpay__select f-group --checkbox">
												...
												<label class="f-label" for="orderpay__checkbox">
													...
													<span class="sr-only">Wybierz zamówienie <iaixsl:value-of select="@number"/></span>
												</label>
											</div>
										</iaixsl:if>
										<iaixsl:choose>
									...
									<div><iaixsl:attribute name="class">btn-icon prepaid-icon status-<iaixsl:value-of select="$status_order"/></iaixsl:attribute>
										<iaixsl:choose>
											...
											<iaixsl:when test="$status_order = 'd'">
												<span><i class="icon-order-status_clock"/></span>
												<small>w trakcie realizacji</small>
											</iaixsl:when>
                    ...
                    <iaixsl:attribute name="class">orders__payment_status rma__status --payment</iaixsl:attribute>
									...
									<iaixsl:choose>
										<iaixsl:when test="$isPaymentsOrdersActive = 'true' and /shop/page/orders/@mode = 'opened' and @prepaidstatus ='n' and not(@paymentstatus = 'g') and @orderdetails">
											<a class="btn --solid --small"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute>Zapłać teraz</a>
										</iaixsl:when>
										...
										<iaixsl:when test="$status_order = 'k' or $status_order = 'i' or $status_order = 'j' or $status_order = 's'  or $status_order = 'l'">
											<div class="n54068_prepaid_desc">nie dotyczy</div>
										</iaixsl:when>
										<iaixsl:when test="@paymentstatus = 'g' and (@paid and (number(@cost) &gt; number(@paid)))">
											<div class="n54068_prepaid_desc">wpłacono: 
											<b><iaixsl:value-of select="@paid_formatted"/></b>
											opłać pozostałą kwotę przy odbiorze</div><br/>

										</iaixsl:when>
										<iaixsl:when test="@paymentstatus = 'g'">
											<div class="n54068_prepaid_desc">zapłać przy odbiorze</div>
										</iaixsl:when>
										<iaixsl:otherwise>
											<div>
												<iaixsl:choose>
  ...
  <div class="orderpay__button_wrapper">
  	<div class="orderpay__button --hide">
  		<a class="btn --solid --medium" href="#orderpay">Zapłać zaznaczone - <span class="orderpay__worth"/></a>
  	</div>
  </div>
...
<!-- (menu_maps, 63764495e0cb08.91568922.4)--><!-- (collective_payment, 651c2924bb4345.02166170.3)-->
  ...
  <template id="prepaid_terms_item_template">
		...
		<template id="expchck_retry_modal">
			<h4 class="expchck__title">Płatność</h4>
    ...
    <template id="expchck_summary_orders_details">
      <div class="expchck_summary__orders__details">
        <a class="expchck_summary__more_orders" href="#showMore">
          <iaixsl:attribute name="data-alt_text"> - Zwiń</iaixsl:attribute>
           + Pokaż wszystkie
        </a>
      </div>
    </template>
    ...
    <template id="expchck_summary_order_details">
      <div class="expchck_summary__order__details">
        <span class="order_id_wrapper">ID zamówienia: <strong class="order_id"/></span>
