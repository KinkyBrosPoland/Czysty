		...
		<div class="step4a">
			...
			<div class="progress__item --rma --fourth --active d-md-none py-3">
				...
				<div class="progress__text">
					<strong class="progress__name"><iaixsl:choose><iaixsl:when test="count(page/pickups/pickup) &gt; 1">Wybierz adres punktu reklamacyjnego</iaixsl:when><iaixsl:otherwise>Adres punktu reklamacyjnego</iaixsl:otherwise></iaixsl:choose></strong>
				</div>
			</div>
			<h1 class="big_label return_label d-none d-md-block" id="return_label"><iaixsl:choose><iaixsl:when test="count(page/pickups/pickup) &gt; 1">Wybierz adres punktu reklamacyjnego</iaixsl:when><iaixsl:otherwise>Adres punktu reklamacyjnego</iaixsl:otherwise></iaixsl:choose></h1>
