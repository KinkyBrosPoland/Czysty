		...
		<div class="noproduct__form_wrapper pt-lg-5">
			...
			<p class="mb-3">
				<iaixsl:choose>
					...
					<iaixsl:otherwise>
						Jeśli nie znalazłeś w naszej ofercie produktu, a chciałbyś kupić go w naszym sklepie, możesz skorzystać ze specjalnego formularza i przesłać nam opis szukanego przedmiotu. Aby móc to zrobić musisz być <a class="loginPopUpShow"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/signin/@url"/></iaixsl:attribute>zalogowany</a>.
					</iaixsl:otherwise>
				</iaixsl:choose>
			</p>
			...
			<iaixsl:if test="/shop/basket/@login">
				<form class="noproduct__form" method="post" novalidate="novalidate">
					...
					<div class="noproduct__inputs mt-5">
						<p class="mb-3">Zanim zgłosisz nam produkt upewnij się, czy nie znajduje się on już na <a href="products-requests.php"><iaixsl:attribute name="title">Przejdź do listy poszukiwanych produktów</iaixsl:attribute>Twojej liście poszukiwanych produktów</a>.</p>
						<div class="f-group">
