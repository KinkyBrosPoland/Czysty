...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
	...
	<iaixsl:if test="page/@type = 'return_products' and page/@display = 'repayment'">
		...
		<div class="step5">
			...
			<h1 class="big_label return_label d-none d-md-block" id="return_label">Wybierz formę zwrotu należności</h1>
