...
<iaixsl:choose>
    ...
    <iaixsl:otherwise><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/common_style.css.gzip?r=766164982</iaixsl:attribute></link></iaixsl:otherwise>
			...
			<iaixsl:if test="not(/shop/page/@type = 'main') and not(/shop/page/@type = 'search') and not(/shop/page/@type = 'place-order') and not(/shop/page/@type = 'noproduct') and not($projector_script_bottom and /shop/page/@type = 'projector')">
				<script src="/gfx/pol/jquery.js.gzip?r=1765442857"></script>
				<iaixsl:choose>
					<iaixsl:when test="/shop/@preview &gt; 0">
