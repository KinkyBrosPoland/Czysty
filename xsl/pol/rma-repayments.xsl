...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
	...
	<iaixsl:if test="page/@type = 'return_products' and page/@display = 'repayment'">
		...
		<div class="step5">
			...
			<h1 class="big_label return_label d-none d-md-block" id="return_label">Wybierz sposób i formę realizacji reklamacji</h1>
			...
			<div class="complain_method__select">
				<select class="complain_method__select complain_select" name="complain_method">
					<iaixsl:attribute name="aria-label">Wybierz formę realizacji reklamacji</iaixsl:attribute>
									...
									<div class="f-group">
										<div>
											<div class="f-feedback">
												...
												<label for="iban_number_description">Podaj numer konta w formacie IBAN</label>
