...
<iaixsl:if test="not(/shop/page/client-data/@associated = 'true')">
	...
	<iaixsl:if test="page/client-data/@operation = 'register-wholesale-add' or page/client-data/@operation = 'edit-wholesale-add' or page/client-data/@operation = 'edit-wholesale-edit'">
        ...
        <h2 class="cop__title">Rejestracja hurtownika</h2>
				<div class="cop_wholesaler__item --invoices cop_wholesaler_invoices">
					<span class="cop_wholesaler_invoices__label">Faktury:</span>
					<div class="cop_wholesaler_invoices__radio --domestic f-group --radio">
						...
						<label class="f-label" for="invoice_type_domestic">krajowe</label>
					</div>
					<div class="cop_wholesaler_invoices__radio --european f-group --radio">
						...
						<label class="f-label" for="invoice_type_european">wewnątrzunijne</label>
					</div>
					<div class="cop_wholesaler_invoices__radio --export f-group --radio">
						...
						<label class="f-label" for="invoice_type_export">eksportowe</label>
					</div>
				</div>
				<div class="cop_wholesaler__item --description cop_wholesaler_description f-group --textarea">
					<textarea name="client_description" class="f-control">
						<iaixsl:attribute name="placeholder">Opis działalności</iaixsl:attribute>
				...
				<div class="cop_wholesaler__item --files cop_wholesaler_files">
					<div class="cop_wholesaler_files__item --first">
						<label class="cop_wholesaler_files__label" for="client_attachment1">Załącznik 1 <small>(max 10MB)</small>:</label>
						<input id="client_attachment1" class="cop_wholesaler_files__input" type="file" name="client_attachment1">
						  <iaixsl:attribute name="aria-label">Dodaj załącznik</iaixsl:attribute>
						</input>
					...
					<div class="cop_wholesaler_files__item --second">
						<label class="cop_wholesaler_files__label" for="client_attachment2">Załącznik 2 <small>(max 10MB)</small>:</label>
					...
					<div class="cop_wholesaler_files__item --third">
						<label class="cop_wholesaler_files__label" for="client_attachment3">Załącznik 3 <small>(max 10MB)</small>:</label>
		...
		<template id="cop_rebate_card_template">
            ...
            Jeśli posiadasz naszą plastikową kartę rabatową wpisz jej numer. W ten sposób zyskasz rabaty takie, jak w naszych tradycyjnych sklepach.
				...
				<iaixsl:if test="$isRebateCardActive = 'true'">
					<span class="cop_rebate_card__header">Twoja karta rabatowa jest aktywna!</span>
				</iaixsl:if>
            ...
            <label for="rebate_card_input" class="f-label">Numer karty rabatowej</label>
					</div>
				</div>
			</div>
		</template>
		...
		<div class="cop_summary_client">
			<div class="cop_summary_client__item --terms cop_terms">
					...
					<iaixsl:if test="(page/client-data/@operation = 'edit') and login_options/service[@connected='true']">
						<div class="cop_terms__item --service">
							<span>Twoje konto jest połączone z kontem w serwisie <iaixsl:value-of select="login_options/service[@connected='true']/@name"/></span><iaixsl:text> </iaixsl:text><a><iaixsl:attribute name="href"><iaixsl:value-of select="login_options/service[@connected='true']/@disconnect_url"/></iaixsl:attribute>Rozłącz konto</a>
						</div>
					</iaixsl:if>
			<iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
				...
				<div class="cop_terms__item --mailing f-group --checkbox">
					...
					<label class="f-label" for="cop_terms_mailing_checkbox">Chcę otrzymywać E-mail Newsletter (możliwość późniejszej rezygnacji).</label>
				</div>
				<iaixsl:if test="/shop/page/client-data/contact_data/@send_sms">
					<div class="cop_terms__item --sms f-group --checkbox">
						...
						<label class="f-label" for="cop_terms_sms_checkbox">Chcę otrzymywać SMS Newsletter (możliwość późniejszej rezygnacji).</label>
					</div>
				</iaixsl:if>
			</div>
...
<iaixsl:choose>
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1765442856"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1765442856"></script><script src="/gfx/pol/menu_calendar.js.gzip?r=1765442856"></script><script src="/gfx/pol/menu_basket.js.gzip?r=1765442856"></script><script src="/gfx/pol/hotspots_javascript.js.gzip?r=1765442856"></script><script src="/gfx/pol/hotspots_slider.js.gzip?r=1765442856"></script><script src="/gfx/pol/hotspots_add_to_basket.js.gzip?r=1765442856"></script><script src="/gfx/pol/cop_modules_client-new.js.gzip?r=1765442856"></script><script src="/gfx/pol/cop_modules_literals.js.gzip?r=1765442856"></script><script src="/gfx/pol/cop_modules.js.gzip?r=1765442856"></script><script src="/gfx/pol/cop_modules_wholesaler.js.gzip?r=1765442856"></script><script src="/gfx/pol/cop_modules_signin.js.gzip?r=1765442856"></script><script src="/gfx/pol/cop_modules_client.js.gzip?r=1765442856"></script><script src="/gfx/pol/cop_modules_address.js.gzip?r=1765442856"></script><script src="/gfx/pol/cop_modules_registration.js.gzip?r=1765442856"></script><script src="/gfx/pol/cop_modules_rebate_card.js.gzip?r=1765442856"></script><script src="/gfx/pol/cop_modules_summary_client.js.gzip?r=1765442856"></script>
