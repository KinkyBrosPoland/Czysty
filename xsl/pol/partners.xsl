...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (partners_list, 60dd8e774b14e8.43212670.8)-->
  <h1 class="headline">
    <span class="headline__name">Nasi partnerzy</span>
  </h1>
	<div class="partners_info">
		<p>Zapraszamy do zapoznania z listą naszych partnerów handlowych.</p>
	</div>
	<div id="partners_map"/>
	<div class="partners_list">
		<iaixsl:for-each select="/shop/page/partners/city">
			<div class="partners_list__city">
				<h2 class="partners_list__city_name"><iaixsl:value-of select="@name"/></h2>
				<iaixsl:variable name="city_position"><iaixsl:value-of select="position()"/></iaixsl:variable>
				<div class="partners_list__wrapper">
					<iaixsl:for-each select="partner">
						<div class="partners_list__partner">
							<iaixsl:attribute name="data-id"><iaixsl:value-of select="$city_position"/><iaixsl:value-of select="position()"/></iaixsl:attribute>
							<iaixsl:attribute name="data-name">
								<iaixsl:choose>
									<iaixsl:when test="card/@name and card/@name != ''">
										<iaixsl:value-of select="card/@name"/>
									</iaixsl:when>
									<iaixsl:when test="@firmname and @firmname != ''">
										<iaixsl:value-of select="@firmname"/>
									</iaixsl:when>
									<iaixsl:otherwise>
										<iaixsl:value-of select="@name"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="@lastname"/>
									</iaixsl:otherwise>
								</iaixsl:choose>
							</iaixsl:attribute>
							<iaixsl:attribute name="data-street"><iaixsl:value-of select="@address"/></iaixsl:attribute>
							...
							<iaixsl:attribute name="data-country"><iaixsl:value-of select="@country"/></iaixsl:attribute>
							<iaixsl:attribute name="data-phone1"><iaixsl:value-of select="@phone1"/></iaixsl:attribute>
							<iaixsl:attribute name="data-phone2"><iaixsl:value-of select="@phone2"/></iaixsl:attribute>
							<iaixsl:attribute name="data-email"><iaixsl:value-of select="@email"/></iaixsl:attribute>
							<iaixsl:attribute name="data-www"><iaixsl:value-of select="card/@www"/></iaixsl:attribute>
							<iaixsl:attribute name="data-icon"><iaixsl:value-of select="card/@icon"/></iaixsl:attribute>
							<strong class="partners_list__item --name">
								<iaixsl:choose>
									<iaixsl:when test="card/@name and card/@name != ''">
										<iaixsl:value-of select="card/@name"/>
									</iaixsl:when>
							...
							<iaixsl:if test="@address and @address != ''">
								<span class="partners_list__item --address"><iaixsl:value-of select="@address"/></span>
							</iaixsl:if>
							<iaixsl:if test="(@zipcode and @zipcode != '') or (@city and @city != '')">
								<span class="partners_list__item --city"><iaixsl:if test="@zipcode and @zipcode != ''"><iaixsl:value-of select="@zipcode"/><iaixsl:text> </iaixsl:text></iaixsl:if><iaixsl:if test="@city and @city != ''"><iaixsl:value-of select="@city"/></iaixsl:if></span>
							</iaixsl:if>
							<iaixsl:if test="@country and @country != ''">
								<span class="partners_list__item --country"><iaixsl:value-of select="@country"/></span>
							</iaixsl:if>
							<iaixsl:if test="@phone1 and @phone1 != ''">
								<a class="partners_list__item --phone --first">
									<iaixsl:attribute name="href">tel:<iaixsl:value-of select="@phone1"/></iaixsl:attribute>
									<iaixsl:value-of select="@phone1"/>
								</a>
							</iaixsl:if>
							<iaixsl:if test="@phone2 and @phone2 != ''">
								<a class="partners_list__item --phone --second">
									<iaixsl:attribute name="href">tel:<iaixsl:value-of select="@phone2"/></iaixsl:attribute>
									<iaixsl:value-of select="@phone2"/>
								</a>
							</iaixsl:if>
							<iaixsl:if test="@email and @email != ''">
								<a class="partners_list__item --email">
									<iaixsl:attribute name="href">mailto:<iaixsl:value-of select="@email"/></iaixsl:attribute>
									<iaixsl:value-of select="@email"/>
								</a>
							</iaixsl:if>
							<iaixsl:if test="card/@www and card/@www != ''">
								<a class="partners_list__item --www">
									<iaixsl:attribute name="href"><iaixsl:value-of select="card/@www"/></iaixsl:attribute>
									<iaixsl:value-of select="card/@www"/>
								</a>
							</iaixsl:if>
							<iaixsl:if test="card/desc">
								<div class="partners_list__item --desc">
									<button type="button" class="partners_list__show_desc btn --solid --secondary">
										Pokaż opis
									</button>
									<div class="partners_list__partner_desc">
										<iaixsl:value-of disable-output-escaping="yes" select="card/desc"/>
									</div>
								</div>
							</iaixsl:if>
							<button type="button" class="partners_list__item --map btn --solid">
								Pokaż na mapie
							</button>
						</div>
					</iaixsl:for-each>
  ...
  <script>window.google_api_key=&apos;<iaixsl:value-of select="/shop/page/partners/google_api_key/@value"/>&apos;;</script>
