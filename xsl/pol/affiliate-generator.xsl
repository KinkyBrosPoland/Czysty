      ...
      <form class="affiliate --generator --content --js px-sm-4 pb-4" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-3 d-none" id="border_width">
                <div class="f-group --small ">
                  ...
                  <label for="border_width_input" class="f-label">Grubość (px)</label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
        ...
        <div class="f-group">
          <textarea class="f-control" readonly="true" cols="65" rows="4" name="output">
						<iaixsl:attribute name="aria-label">Kliknij aby skopiować</iaixsl:attribute>
					</textarea>
        </div>
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-3 d-none" id="border_width">
                <div class="f-group --small ">
                  <input id="border_width_input" class="f-control" type="text" name="border_width" value="1"/>
                  <label for="border_width_input" class="f-label">Grubość </label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
								...
								<div class="row mb-4">
									...
									<div class="col-12">
										<div class="f-group --radio d-flex flex-wrap flex-sm-nowrap align-items-center">
											...
											<input name="ikona" class="f-control" type="radio" id="ikona1" checked="checked"><iaixsl:attribute name="aria-label">Tagi</iaixsl:attribute></input><label for="ikona1" class="f-label"><i class="icon-tags"/></label>
											<input name="ikona" class="f-control" type="radio" id="ikona2"><iaixsl:attribute name="aria-label">Gwiazdka</iaixsl:attribute></input><label for="ikona2" class="f-label"><i class="icon-star"/></label>
											<input name="ikona" class="f-control" type="radio" id="ikona3"><iaixsl:attribute name="aria-label">Karta kredytowa</iaixsl:attribute></input><label for="ikona3" class="f-label"><i class="icon-credit-card"/></label>
											<input name="ikona" class="f-control" type="radio" id="ikona4"><iaixsl:attribute name="aria-label">Link</iaixsl:attribute></input><label for="ikona4" class="f-label"><i class="icon-link"/></label>
											<input name="ikona" class="f-control" type="radio" id="ikona5"><iaixsl:attribute name="aria-label">Serce</iaixsl:attribute></input><label for="ikona5" class="f-label"><i class="icon-heart"/></label>
										</div>
									</div>
								</div>
              </div>
...
<iaixsl:choose>
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1765442856"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1765442856"></script><script src="/gfx/pol/menu_basket.js.gzip?r=1765442856"></script><script src="/gfx/pol/hotspots_javascript.js.gzip?r=1765442856"></script><script src="/gfx/pol/hotspots_slider.js.gzip?r=1765442856"></script><script src="/gfx/pol/hotspots_add_to_basket.js.gzip?r=1765442856"></script><script src="/gfx/pol/affiliate_generator_mode.js.gzip?r=1765442856"></script><script src="/gfx/pol/affiliate_generator_javascript.js.gzip?r=1765442856"></script><script src="/gfx/pol/affiliate_generator_code.js.gzip?r=1765442856"></script><script src="/gfx/pol/affiliate_generator_html.js.gzip?r=1765442856"></script>
