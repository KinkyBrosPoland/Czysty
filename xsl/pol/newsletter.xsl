					...
					<iaixsl:choose>
										...
										<iaixsl:when test="/shop/page/client/@email != ''">
											<form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
												...
												<div id="newsletter_privacy_consent" class="f-group --checkbox col-md-6 col-12">
													...
													<label class="f-label" for="newsletter_consent">Chcę otrzymywać E-mail Newsletter. Wyrażam zgodę na przetwarzanie moich danych osobowych do celów marketingowych zgodnie z <a><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/private_policy/@url"/></iaixsl:attribute>polityką prywatności</a></label>
												</div>
											...
											<form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
												...
												<div class="f-group col-md-6 col-12">
													<div class="f-feedback">
														...
														<label for="mailing_email" class="f-label">Podaj Twój e-mail</label>
												...
												<div class="f-group col-md-6 col-12">
													<div class="f-feedback">
														...
														<label for="mailing_name" class="f-label">Podaj Twoje imię</label>
														<span class="f-control-feedback"/>
														<div class="f-message"/>
													</div>
												</div>
												...
												<div class="newsletter_button_wrapper col-md-6 col-12">
													<button id="newsletter_button_add" type="submit" class="btn --solid">Zapisz się</button>
												</div>
											</form>
										</iaixsl:otherwise>
									</iaixsl:choose>
						...
						<iaixsl:otherwise>
							<form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
								...
								<div class="newsletter_button_wrapper col-md-6 col-12">
									<button id="newsletter_button_add" type="submit" class="btn --solid">Zapisz się</button>
									<button id="newsletter_button_remove" type="submit" class="btn --solid --secondary">Wypisz się</button>
								</div>
							</form>
						</iaixsl:otherwise>
					</iaixsl:choose>
