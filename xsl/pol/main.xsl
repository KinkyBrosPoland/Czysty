...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/main_style.css?r=766164982</iaixsl:attribute></link></iaixsl:when>
    <iaixsl:otherwise><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/main_style.css.gzip?r=766164982</iaixsl:attribute></link></iaixsl:otherwise>
</iaixsl:choose>
...
<iaixsl:choose>
    ...
    <iaixsl:otherwise><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/main_shop.js.gzip?r=1765442856</iaixsl:attribute></script></iaixsl:otherwise>
				...
				<script src="/gfx/pol/main_banner_modules.js.gzip?r=1765442856" type="module"></script>
			</iaixsl:if>
                ...
                <iaixsl:variable name="banerItemContent">
                  ...
                  <iaixsl:if test="not($bannerName = '')">
                    <div class="main_slider__content container max-width-1200">
                      ...
                      <iaixsl:if test="@href">
                        <span class="main_slider__button btn --solid --medium">Sprawdź</span>
                      </iaixsl:if>
                    </div>
                  </iaixsl:if>
                </iaixsl:variable>
								...
								<iaixsl:when test="@href">
									<a target="_self" href="{@href}">
										...
										<iaixsl:attribute name="aria-label"><iaixsl:choose>
											...
											<iaixsl:otherwise>Obrazek w sekcji graficznej - <iaixsl:value-of select="position()"/></iaixsl:otherwise>
...
<!-- (main_news2, 60dd8e807bc210.32067134.6)-->
	...
	<iaixsl:variable name="main_blog_after_label">Zobacz wszystko</iaixsl:variable>
...
<!-- (main_news1, 60dd8e80c250e0.04895316.6)-->
	...
	<iaixsl:variable name="main_news_after_label">Zobacz wszystko</iaixsl:variable>
							...
							<iaixsl:choose>
								...
								<iaixsl:otherwise>
									...
									<a class="headline__after" target="blank" tabindex="0">
										...
										<span class="link__text">Sprawdź nasz profil na Instagramie</span>
										<i class="icon icon-ds-arrow-right pl-1"/>
									</a>
								</iaixsl:otherwise>
							</iaixsl:choose>
