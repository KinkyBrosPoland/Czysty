					...
					<div class="affiliate__module --resources col-12 col-md-6">
						<div class="p-3">
							...
							<div class="d-flex align-items-start mb-3">
								...
								Narzędzie pozwala na wypłaty lub wymiany zgromadzonych środków na bon towarowy.
							</div>
							<div class="d-flex justify-content-end flex-wrap flex-sm-nowrap mt-2">
								<a class="btn --solid" href="affiliate-resources.php">
									<iaixsl:attribute name="title">Informacje o stanie konta partnerskiego, mechanizm wypłacania środków w postaci bonów towarowych i historia wypłat</iaixsl:attribute>
									Środki do wykorzystania
								</a>
							</div>
						</div>
