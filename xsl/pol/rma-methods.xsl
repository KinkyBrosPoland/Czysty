...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
	...
	<iaixsl:if test="page/@type = 'rma_products' and page/@display = 'method'">
		...
		<div class="step3">
			...
			<h1 class="big_label return_label d-none d-md-block" id="return_label">W jaki sposób chciałbyś dostarczyć reklamowany produkt?</h1>
