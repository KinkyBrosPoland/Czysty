									...
									<div class="col-md-1 col-12 mb-3 mb-md-0">
										<div class="products-bought__checkbox f-group --checkbox mb-0">
											...
											<label class="f-label">
												...
												<span class="sr-only">Wybierz produkt <iaixsl:value-of disable-output-escaping="yes" select="name/text()"/></span>
											</label>
										</div>
									</div>
									<div class="col-md-1 col-12 mb-3 mb-md-0">
											...
											<iaixsl:choose>
												...
												<iaixsl:otherwise>
													...
													<iaixsl:if test="$var_omnibus != ''">
														<span class="price --omnibus omnibus_price"><span class="omnibus_price__text">Najniższa cena produktu w okresie 30 dni przed wprowadzeniem obniżki: </span><del class="omnibus_price__value"><iaixsl:value-of select="$var_omnibus"/></del><span class="price_percent"><iaixsl:value-of select="$var_omnibus_percent"/></span></span>
													</iaixsl:if>
		...
		<div class="col-12">
			<div class="products-bought__products-button">
				<div class="products-bought__checkbox-all f-group --checkbox">
					...
					<label class="f-label" for="choose_all_products_bought">Wybierz wszystkie</label>
				</div>
