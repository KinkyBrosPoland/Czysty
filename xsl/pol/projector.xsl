...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/projector_style.css?r=766164982</iaixsl:attribute></link></iaixsl:when>
    <iaixsl:otherwise><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/projector_style.css.gzip?r=766164982</iaixsl:attribute></link></iaixsl:otherwise>
</iaixsl:choose>
...
<iaixsl:choose>
    ...
    <iaixsl:otherwise><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/projector_shop.js.gzip?r=1765442856</iaixsl:attribute></script></iaixsl:otherwise>
				...
				<script src="/gfx/pol/projector_photos_core.js.gzip?r=1765442856" type="module"></script>
			</iaixsl:if>
