...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (producers, 610bfde1ef1470.69954167.5)-->
            ...
            <div id="producers-list_sub" class="producers__list">
		        ...
		        <iaixsl:for-each select="page/producers-list/firm">
                    <div class="producers__item">
                      <iaixsl:if test="@icon or @icon_desktop or @icon_tablet or @icon_mobile">
                        <a class="producers__icon" href="{@link}" title="{@name}">
                        <iaixsl:choose>
                          <iaixsl:when test="@icon_desktop and @icon_tablet and @icon_mobile">
                              <picture class="links_producers">
                                <iaixsl:if test="@icon_desktop">
                                  <source media="(min-width:979px)" srcset="{@icon_desktop}"/>
                                </iaixsl:if>
                                <iaixsl:if test="@icon_tablet">
                                  <source media="(min-width:757px)" srcset="{@icon_tablet}"/>
                                </iaixsl:if>
                                <img src="{@icon_mobile}" alt="{@name}" loading="lazy"/>
                              </picture>
                          </iaixsl:when>
                          <iaixsl:otherwise>
                            <iaixsl:choose>
                              <iaixsl:when test="@icon">
                                <img class="links_producers" src="{@icon}" alt="{@name}" loading="lazy"/>
                              </iaixsl:when>
                              <iaixsl:when test="@icon_tablet">
                                <img class="links_producers" src="{@icon_tablet}" alt="{@name}" loading="lazy"/>
                              </iaixsl:when>
                              <iaixsl:when test="@icon_desktop">
                                <img class="links_producers" src="{@icon_desktop}" alt="{@name}" loading="lazy"/>
                              </iaixsl:when>
                            </iaixsl:choose>
                          </iaixsl:otherwise>
                        </iaixsl:choose>
