							...
							<iaixsl:for-each select="page/products/product">
								<tr class="productslist_item">
									...
									<iaixsl:otherwise>
										...
										<div>
											...
											<span class="productslist_quantity">
												<a href="#delQuantity" class="delQuantity"><iaixsl:attribute name="aria-label">Zmniejsz ilość</iaixsl:attribute><i class="icon-minus"/></a>
												<input type="text">
													<iaixsl:attribute name="name">set_quantity[<iaixsl:value-of select="position()"/>]</iaixsl:attribute>
												...
												<a href="#addQuantity" class="addQuantity"><iaixsl:attribute name="aria-label">Zwiększ ilość</iaixsl:attribute><i class="icon-plus"/></a>
									...
									<td class="productslist_product_action">
										...
										<input type="checkbox">
											...
											<iaixsl:attribute name="aria-label">Wybierz ten produkt do zwrotu</iaixsl:attribute>
										</input>
									</td>
								</tr>
								<tr class="productslist_product_action mobile">
									<td class="productslist_product_action mobile" colspan="8">
										<div>
											<a href="#addQuantity" class="addQuantity"><iaixsl:attribute name="aria-label">Zwiększ ilość</iaixsl:attribute><i class="icon-plus"/></a>
											<a href="#delQuantity" class="delQuantity">Zmniejsz ilość<i class="icon-minus"/></a>
										</div>
									</td>
								</tr>
							</iaixsl:for-each>
