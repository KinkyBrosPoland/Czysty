...
<!-- (menu_additional1, 614c5d2d239131.78356405.8)-->
        ...
        <!-- (stocks_list, 60dd8e8690b708.37065397.5)-->
  <h1 class="headline">
    <span class="headline__name">Lista punktów odbioru</span>
  </h1>
  <div id="stocks_map"/>
  <div class="stocks_list">
    <iaixsl:for-each select="/shop/page/stocks/stock">
      <div class="stocks_list__item">
        <iaixsl:attribute name="data-id"><iaixsl:value-of select="@stock_id"/></iaixsl:attribute>
        ...
        <a class="stocks_list__name" target="_blank">
          <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
          <iaixsl:value-of select="@name"/>
        </a>
        <div class="stocks_list__address">
          <span class="stocks_list__street"><iaixsl:value-of select="@street"/></span>
          <span class="stocks_list__city"><iaixsl:value-of select="@zipcode"/><iaixsl:text disable-output-escaping="yes"> </iaixsl:text><iaixsl:value-of select="@city"/></span>
        </div>
        <iaixsl:if test="@phone != '' or @mail != ''">
          <div class="stocks_list__contact">
            <iaixsl:if test="@phone != ''">
              <a class="stocks_list__phone">
                <iaixsl:attribute name="href">tel:<iaixsl:value-of select="@phone"/></iaixsl:attribute>
                <iaixsl:value-of select="@phone"/>
              </a>
            </iaixsl:if>
            <iaixsl:if test="@mail != ''">
              <a class="stocks_list__mail">
        ...
        <a class="stocks_list__link" target="_blank">
          <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
          więcej informacji
        </a>
        <a class="stocks_list__show_on_map btn --solid" href="showOnMap">Pokaż na mapie</a>
      </div>
    </iaixsl:for-each>
  </div>
  <script>window.google_api_key=&apos;<iaixsl:value-of select="/shop/page/stocks/google_api_key/@value"/>&apos;;</script>
